 ...
 **  @date               : 2024/02/10
 **  @vendor             : isoft
 **  @description        : Os header file for Rpc api declarations
 **
 ***********************************************************************************************************************/
 ...
 * @trace              -
 */
extern void Os_InitRpc(void);

/**
 * @brief              Make a remote service call to given core with
 *                     given service ID and input parameters.
 * @param[in]          rpcData: Data transferred across cores.
 * @return             StatusType
 * @synchronous        TRUE
 * @reentrant          TRUE
 * @trace              -
 */
extern StatusType Os_RpcCallService(Os_RpcInputRefType rpcData);
/******************************************************************************/
/*
 ...
 * @trace              -
 */
extern void Os_RpcServiceOperation(Os_CoreIdType coreId);
