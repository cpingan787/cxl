...
{
    (void)Det_ReportError(112U, 0U, (ApiId), (ErrorId));
}
...
static  uint32 CryIf_GetDriverKeyId(uint32 keyid);
...
static boolean CryIf_InitStatus;    
...
CryIf_Init(const CryIf_ConfigType * configPtr)
{
    ...
    if (configPtr != ((void *)0))
    {
        ...
        CRYIF_DET_REPORT(((uint8)0x00), ((uint8)0x01));
    }
    else
    {
         
        CryIf_InitStatus = (boolean)1u;
    }
    return;
}
...
CryIf_ProcessJob(uint32 channelId, Crypto_JobType * job)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x03), ((uint8)0x00));
    }
     
    else if (channelId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x03), ((uint8)0x03));
    }
     
    else if (((void *)0) == job)
    {
        CRYIF_DET_REPORT(((uint8)0x03), ((uint8)0x02));
    }
    ...
    else
    {
        ...
        {
            if (JobPrimitiveInfo->cryIfKeyId >= (1U))
            {
                CRYIF_DET_REPORT(((uint8)0x03), ((uint8)0x03));
            }
            else
            ...
            {
                if (job->jobPrimitiveInputOutput.targetCryIfKeyId >= (1U))
                {
                    CRYIF_DET_REPORT(((uint8)0x03), ((uint8)0x03));
                }
                else
        ...
        if (0U == ret)
        {
            ret = CryIf_DriverApi[(0U)].Crypto_ProcessJob_Name(channelId, job);
        }
    }
    return ret;
}
...
CryIf_CancelJob(uint32 channelId, Crypto_JobType * job)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x0E), ((uint8)0x00));
    }
     
    else if (channelId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x0E), ((uint8)0x03));
    }
     
    else if (((void *)0) == job)
    {
        CRYIF_DET_REPORT(((uint8)0x0E), ((uint8)0x02));
    }
    else
    {
        ret = CryIf_DriverApi[(0U)].Crypto_CancelJob_Name(channelId, job);
    }
    return ret;
}
    ...
    uint32 keyLength)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x04), ((uint8)0x00));
    }
     
    else if (cryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x04), ((uint8)0x03));
    }
     
    else if (((void *)0) == keyPtr)
    {
        CRYIF_DET_REPORT(((uint8)0x04), ((uint8)0x02));
    }
     
    else if (0u == keyLength)
    {
        CRYIF_DET_REPORT(((uint8)0x04), ((uint8)0x04));
    }
    else if (keyElementId >= (2U))
    {
        return ret;
    }
    else
    {
        ret = CryIf_DriverApi[(0U)]
...
CryIf_KeySetValid(uint32 cryIfKeyId)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x05), ((uint8)0x00));
    }
     
    else if (cryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x05), ((uint8)0x03));
    }
    else
    {
        ret = CryIf_DriverApi[(0U)].Crypto_KeySetValid_Name(CryIf_GetDriverKeyId(cryIfKeyId));
    }
    return ret;
}
    ...
    uint32 * resultLengthPtr)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x06), ((uint8)0x00));
    }
     
    else if (cryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x06), ((uint8)0x03));
    }
     
    else if (((void *)0) == resultPtr)
    {
        CRYIF_DET_REPORT(((uint8)0x06), ((uint8)0x02));
    }
     
    else if (((void *)0) == resultLengthPtr)
    {
        CRYIF_DET_REPORT(((uint8)0x06), ((uint8)0x02));
    }
    ...
    {
        CRYIF_DET_REPORT(((uint8)0x06), ((uint8)0x04));
    }
    else if (keyElementId >= (2U))
    {
        return ret;
    ...
    {
        ret = CryIf_DriverApi[(0U)].Crypto_KeyElementGet_Name(
    ...
    uint32 targetKeyElementId)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x0F), ((uint8)0x00));
    }
     
    else if (cryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x0F), ((uint8)0x03));
    }
     
    else if (targetCryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x0F), ((uint8)0x03));
    }
    else if (keyElementId >= (2U))
    ...
    {
        if ((cryIfKeyId == targetCryIfKeyId) || ((1U) < 2u))
        {
            return ret;
        }
        ret = CryIf_DriverApi[(0U)].Crypto_KeyElementCopy_Name(
            CryIf_GetDriverKeyId(cryIfKeyId),
            keyElementId,
    ...
    uint32 targetKeyElementId)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x12), ((uint8)0x00));
    }
     
    else if (
        (cryIfKeyId >= (1U)) || (targetCryIfKeyId >= (1U))
        || (keyElementId >= (2U)) || ((2U) == targetKeyElementId))
    {
        CRYIF_DET_REPORT(((uint8)0x12), ((uint8)0x03));
    }
    else
    {
        if ((cryIfKeyId == targetCryIfKeyId) || ((1U) < 2u))
...
CryIf_KeyCopy(uint32 cryIfKeyId, uint32 targetCryIfKeyId)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x10), ((uint8)0x00));
    }
     
     
    else if ((cryIfKeyId >= (1U)) || (targetCryIfKeyId >= (1U)))
    {
        CRYIF_DET_REPORT(((uint8)0x10), ((uint8)0x03));
    }
    else
    {
        if ((cryIfKeyId == targetCryIfKeyId) || ((1U) < 2u))
        ...
        ret = CryIf_DriverApi[(0U)].Crypto_KeyCopy_Name(
            CryIf_GetDriverKeyId(cryIfKeyId),
            CryIf_GetDriverKeyId(targetCryIfKeyId));
    }
    return ret;
    ...
    uint32 seedLength)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x07), ((uint8)0x00));
    }
     
    else if (cryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x07), ((uint8)0x03));
    }
     
    else if (((void *)0) == seedPtr)
    {
        CRYIF_DET_REPORT(((uint8)0x07), ((uint8)0x02));
    }
     
    else if (0u == seedLength)
    {
        CRYIF_DET_REPORT(((uint8)0x07), ((uint8)0x04));
    }
    else
    {
        ret = CryIf_DriverApi[(0U)].Crypto_RandomSeed_Name(
            CryIf_GetDriverKeyId(cryIfKeyId),
            seedPtr,
            seedLength);
    }
...
CryIf_KeyGenerate(uint32 cryIfKeyId)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x08), ((uint8)0x00));
    }
     
    else if (cryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x08), ((uint8)0x03));
    }
    else
    {
        ret = CryIf_DriverApi[(0U)].Crypto_KeyGenerate_Name(CryIf_GetDriverKeyId(cryIfKeyId));
    }
    return ret;
}
...
CryIf_KeyDerive(uint32 cryIfKeyId, uint32 targetCryIfKeyId)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x09), ((uint8)0x00));
    }
     
     
    else if ((cryIfKeyId >= (1U)) || (targetCryIfKeyId >= (1U)))
    {
        CRYIF_DET_REPORT(((uint8)0x09), ((uint8)0x03));
    }
    else
    {
        if ((cryIfKeyId == targetCryIfKeyId) || ((1U) < 2u))
        ...
        ret = CryIf_DriverApi[(0U)].Crypto_KeyDerive_Name(
            CryIf_GetDriverKeyId(cryIfKeyId),
            CryIf_GetDriverKeyId(targetCryIfKeyId));
    }
    return ret;
    ...
    uint32 * publicValueLengthPtr)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x0A), ((uint8)0x00));
    }
     
    else if (cryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x0A), ((uint8)0x03));
    }
     
     
    else if ((((void *)0) == publicValuePtr) || (((void *)0) == publicValueLengthPtr))
    {
        CRYIF_DET_REPORT(((uint8)0x0A), ((uint8)0x02));
    }
     
    else if (0u == *publicValueLengthPtr)
    {
        CRYIF_DET_REPORT(((uint8)0x0A), ((uint8)0x04));
    }
    else
    {
        ret = CryIf_DriverApi[(0U)].Crypto_KeyExchangeCalcPubVal_Name(
            CryIf_GetDriverKeyId(cryIfKeyId),
            publicValuePtr,
    ...
    uint32 partnerPublicValueLength)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x0B), ((uint8)0x00));
    }
     
    else if (cryIfKeyId >= (1U))
    {
        CRYIF_DET_REPORT(((uint8)0x0B), ((uint8)0x03));
    }
     
    else if (((void *)0) == partnerPublicValuePtr)
    {
        CRYIF_DET_REPORT(((uint8)0x0B), ((uint8)0x02));
    }
     
    else if (0u == partnerPublicValueLength)
    {
        CRYIF_DET_REPORT(((uint8)0x0B), ((uint8)0x04));
    }
    else
    {
        ret = CryIf_DriverApi[(0U)].Crypto_KeyExchangeCalcSecret_Name(
            CryIf_GetDriverKeyId(cryIfKeyId),
    ...
    Crypto_ResultType result)
{
    ...
    if (CryIf_InitStatus != (boolean)1u)
    {
        CRYIF_DET_REPORT(((uint8)0x0D), ((uint8)0x00));
    }
     
    else if (((void *)0) == job)
    {
        CRYIF_DET_REPORT(((uint8)0x0D), ((uint8)0x02));
    }
    else
    {
