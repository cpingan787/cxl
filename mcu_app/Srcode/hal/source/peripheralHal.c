...
{
    if(Dio_ReadChannel(DioConf_DioChannel_DIO_Channel_KL30_Voltage_DET_INT_Pin0_9) == PortGpioHigh)
    {
        return 0;
    }
    else
...
//   InitAdcNtc();
    ...
    // KL30_DOWEN _DET_EN
    PORT.PPCMD1 = _WRITE_PROTECT_COMMAND;
    PORT.PDSC1 &= (uint32_t) ~_PORT_PMn6_MODE_UNUSED;
    PORT.PDSC1 |= _PORT_PDSCn6_SLOW_MODE_SELECT;
    PORT.PPCMD1 = _WRITE_PROTECT_COMMAND;
    PORT.PODC1 &= (uint32_t) ~_PORT_PMn6_MODE_UNUSED;
    PORT.PODC1 |= _PORT_PODCn6_PUSH_PULL;
    PORT.PBDC1 &= (uint16_t)~_PORT_PMn6_MODE_UNUSED;
    PORT.PBDC1 |= _PORT_PBDCn6_PBDC_MODE_DISABLED;
    PORT.P1 &= (uint16_t) ~_PORT_PMn6_MODE_UNUSED;
    PORT.P1 |= _PORT_Pn6_OUTPUT_LOW;
    PORT.PM1 &= (uint16_t) ~_PORT_PMn6_MODE_UNUSED;
    PORT.PM1 |= _PORT_PMn6_MODE_OUTPUT;
