 ...
 * V2.0.2:  17-Apr-2018 : As part of merging activity, #ARDAABD-3466
 *                        Added support for 64 DMA channels.
 * V2.0.3:  13-Nov-2020 : As part of ARDAABD-4063
 *                        Added macro FLS_USEFLASHCONTROLLERHOOK.
 */
/******************************************************************************/
 ...
 * GENERATED ON:  27 Jan 2026 - 22:04:14
 */
#ifndef FLS_CFG_H
#define FLS_CFG_H
...
#define FLS_SW_PATCH_VERSION_VALUE  11U
...
#define FLS_DMA32_ISR_API                 STD_OFF

#define FLS_DMA33_ISR_API                 STD_OFF

#define FLS_DMA34_ISR_API                 STD_OFF

#define FLS_DMA35_ISR_API                 STD_OFF

#define FLS_DMA36_ISR_API                 STD_OFF

#define FLS_DMA37_ISR_API                 STD_OFF

#define FLS_DMA38_ISR_API                 STD_OFF

#define FLS_DMA39_ISR_API                 STD_OFF

#define FLS_DMA40_ISR_API                 STD_OFF

#define FLS_DMA41_ISR_API                 STD_OFF

#define FLS_DMA42_ISR_API                 STD_OFF

#define FLS_DMA43_ISR_API                 STD_OFF

#define FLS_DMA44_ISR_API                 STD_OFF

#define FLS_DMA45_ISR_API                 STD_OFF

#define FLS_DMA46_ISR_API                 STD_OFF

#define FLS_DMA47_ISR_API                 STD_OFF

#define FLS_DMA48_ISR_API                 STD_OFF

#define FLS_DMA49_ISR_API                 STD_OFF

#define FLS_DMA50_ISR_API                 STD_OFF

#define FLS_DMA51_ISR_API                 STD_OFF

#define FLS_DMA52_ISR_API                 STD_OFF

#define FLS_DMA53_ISR_API                 STD_OFF

#define FLS_DMA54_ISR_API                 STD_OFF

#define FLS_DMA55_ISR_API                 STD_OFF

#define FLS_DMA56_ISR_API                 STD_OFF

#define FLS_DMA57_ISR_API                 STD_OFF

#define FLS_DMA58_ISR_API                 STD_OFF

#define FLS_DMA59_ISR_API                 STD_OFF

#define FLS_DMA60_ISR_API                 STD_OFF

#define FLS_DMA61_ISR_API                 STD_OFF

#define FLS_DMA62_ISR_API                 STD_OFF

#define FLS_DMA63_ISR_API                 STD_OFF
...
#define FLS_READIMMEDIATE_API             STD_ON
...
/* Enable/Disable the Fls_UseFlashControllerPreHook
and Fls_UseFlashControllerEndHook function. */
#define FLS_USEFLASHCONTROLLERHOOK        STD_OFF


/* TimeOut Count for a single 4KB BlankCheck */
