...
{
    P2CONST(EcuM_RunTimeType, AUTOMATIC, ECUM_CONST) pRt = &EcuMRunData;
...
#endif /*ECUM_DEV_ERROR_DETECT == STD_ON*/
    {
        ...
        if ((ECUM_STATE_RUN == (pRt->State & ECUM_STATE_RUN)) && (NULL_PTR == pWks->comMChnl)
