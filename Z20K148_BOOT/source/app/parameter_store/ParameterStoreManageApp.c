...
#define WORKFLASH_ECU_PART_NUM_LEN 16 + 2                // ������Ϣ��������
...
#define WORKFLASH_PART_NAME_LEN 16 + 2                   // ������Ϣ��������
#define WORKFLASH_PUBLIC_ASE_KEY 16 + 5                  // ������Ϣ��������
...
#define WORKFLASH_VIN_LEN 32 + 2                         // ������Ϣ��������
#define WORKFLASH_BID_LEN 32 + 2                         // ������Ϣ��������
#define WORKFLASH_ECU_SERIAL_NUM_LEN 32 + 2              // ������Ϣ��������
...
typedef struct
{
  ...
  uint8_t u8VIN_hex[WORKFLASH_VIN_LEN];                                           // VIN Hex�洢
