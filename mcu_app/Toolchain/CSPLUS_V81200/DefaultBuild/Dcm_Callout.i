...
Std_ReturnType  Dcm_Rte_PreConditonCheck = 0U;



 
extern uint32 Dcm_Timer;
...
)
{
    ...
    (void)(ProgConditions);
    return ((Dcm_EcuStartModeType)0x00);
...
void Rte_EnableAllDtcsRecord(void)
{
    ...
    (void)Dem_DcmEnableDTCSetting(0xFFFFFFUL, 0x01u);
 ...
 void Dcm_ResetTime(uint32 * TimerPtr)
{
    *TimerPtr = Dcm_Timer;
 ...
 void Dcm_GetTimeSpan(uint32 TimerPtr,uint32 * TimeSpanPtr)
{
    if (TimerPtr > Dcm_Timer)
    {
        *TimeSpanPtr = (0xFFFFFFFFuL - TimerPtr) + Dcm_Timer;
    }
    else
    {
