...
/* Module       = Wdg_59_DriverB_Private.c                                    */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
...
/*============================================================================*/
/* Purpose:                                                                   */
/* Driver code of the Internal Watchdog Driver B Component                    */
/*                                                                            */
/*============================================================================*/
/*                                                                            */
 ...
 *                             'Wdg_59_DriverB_InitDetCheck' is added to
 ...
 *                              a. WDG_59_DriverB_WDTAReg_BaseAddr is renamed to
 ...
 *                             Memory mapping of 'Wdg_59_DriverB_InitDetCheck'
 *                             API is modified to
 *                             WDG_59_DRIVERB_START/STOP_SEC_PRIVATE_CODE.
...
#define WDG_59_DRIVERB_PRIVATE_C_AR_RELEASE_MAJOR_VERSION \
                                   WDG_59_DRIVERB_AR_RELEASE_MAJOR_VERSION_VALUE
#define WDG_59_DRIVERB_PRIVATE_C_AR_RELEASE_MINOR_VERSION \
                                   WDG_59_DRIVERB_AR_RELEASE_MINOR_VERSION_VALUE
#define WDG_59_DRIVERB_PRIVATE_C_AR_RELEASE_REVISION_VERSION \
                                WDG_59_DRIVERB_AR_RELEASE_REVISION_VERSION_VALUE


/* File version information */
#define WDG_59_DRIVERB_PRIVATE_C_SW_MAJOR_VERSION \
                                           WDG_59_DRIVERB_SW_MAJOR_VERSION_VALUE
#define WDG_59_DRIVERB_PRIVATE_C_SW_MINOR_VERSION \
...
/* Functionality related to R4.0 and R4.2 */
#if (WDG_59_DRIVERB_PRIVATE_AR_RELEASE_MAJOR_VERSION != \
                              WDG_59_DRIVERB_PRIVATE_C_AR_RELEASE_MAJOR_VERSION)
  #error "Wdg_59_DriverB_Private.c : Mismatch in Release Major Version"
#endif

#if (WDG_59_DRIVERB_PRIVATE_AR_RELEASE_MINOR_VERSION != \
                              WDG_59_DRIVERB_PRIVATE_C_AR_RELEASE_MINOR_VERSION)
  #error "Wdg_59_DriverB_Private.c : Mismatch in Release Minor Version"
#endif

#if (WDG_59_DRIVERB_PRIVATE_AR_RELEASE_REVISION_VERSION != \
                           WDG_59_DRIVERB_PRIVATE_C_AR_RELEASE_REVISION_VERSION)
  #error "Wdg_59_DriverB_Private.c : Mismatch in Release Revision Version"
#endif

#if (WDG_59_DRIVERB_PRIVATE_SW_MAJOR_VERSION != \
                                     WDG_59_DRIVERB_PRIVATE_C_SW_MAJOR_VERSION)
  #error "Wdg_59_DriverB_Private.c : Mismatch in Software Major Version"
#endif

#if (WDG_59_DRIVERB_PRIVATE_SW_MINOR_VERSION != \
                                      WDG_59_DRIVERB_PRIVATE_C_SW_MINOR_VERSION)
  #error "Wdg_59_DriverB_Private.c : Mismatch in Software Minor Version"
#endif
...
/*******************************************************************************
** Function Name         : Wdg_59_DriverB_TriggerFunc
**
...
**                         WDG_59_DriverB_GpWDTAReg_BaseAddr.
**
** Functions Invoked     : WDG_59_DRIVERB_ENTER_CRITICAL_SECTION,
...
/* Implements: WDG_ESDD_UD_054, WDG_ESDD_UD_061, WDG_ESDD_UD_010              */
/* Implements: WDG144, SWS_Wdg_00144                                          */
/* Implements: WDG093, SWS_Wdg_00093                                          */
/* Implements: BSW12019, SRS_Wdg_12019, SRS_Wdg_00144                         */
FUNC(void, WDG_59_DRIVERB_FAST_CODE) Wdg_59_DriverB_TriggerFunc
   (boolean LblCriticalSectionFlag)
{
#if (WDG_59_DRIVERB_VAC_ALLOWED == STD_ON)
  uint8 LucEVAC;
#endif
  /* Functionality related to R4.0 and R4.2 */
  ...
  #if (WDG_59_DRIVERB_CRITICAL_SECTION_PROTECTION == STD_ON)
  if (LblCriticalSectionFlag != WDG_59_DRIVERB_EXCLUDE_CRITICAL_SECTION)
  {
  ...
  #if (WDG_59_DRIVERB_VAC_ALLOWED == STD_OFF)

  /* Initialize the register with preconfigured value */

  WDG_59_DRIVERB_WRITE_REG_ONLY(
  (&WDG_59_DriverB_GpWDTAReg_BaseAddr->ucWDTE), (WDG_59_DRIVERB_RESTART))

  #else
  /* WDTAReg_BaseAddr->ucREF changes its value each time the EVAC register is
   * written */
   LucEVAC = WDG_59_DRIVERB_RESTART -WDG_59_DriverB_GpWDTAReg_BaseAddr->ucREF;

   WDG_59_DRIVERB_WRITE_REG_ONLY(
   (&WDG_59_DriverB_GpWDTAReg_BaseAddr->ucEVAC), (LucEVAC))

  #endif /* WDG_59_DRIVERB_VAC_ALLOWED == STD_OFF */
...
/*******************************************************************************
** Function Name         : Wdg_59_DriverB_InitDetCheck
**
** Service ID            : Not Applicable
**
...
#define WDG_59_DRIVERB_START_SEC_PRIVATE_CODE
#include WDG_MEMMAP_FILE
...
FUNC(Std_ReturnType, WDG_59_DRIVERB_FAST_CODE) Wdg_59_DriverB_InitDetCheck
  ...
  LpConfigPtr)
{
  ...
  /* Check If 75% interrupt (WIE bit-field) is disabled */
          ...
          >> WDG_59_DRIVERB_THREE) == WDG_59_DRIVERB_ZERO)
...
#define WDG_59_DRIVERB_STOP_SEC_PRIVATE_CODE
#include WDG_MEMMAP_FILE
#endif
