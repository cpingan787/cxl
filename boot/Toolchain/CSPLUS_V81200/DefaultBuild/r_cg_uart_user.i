...
extern volatile uint8_t  * gp_uart4_tx_address;     
extern volatile uint16_t   g_uart4_tx_count;        
extern volatile uint8_t  * gp_uart4_rx_address;     
extern volatile uint16_t   g_uart4_rx_count;        
extern volatile uint16_t   g_uart4_rx_length;       
extern volatile uint8_t  * gp_uart5_tx_address;     
extern volatile uint16_t   g_uart5_tx_count;        
extern volatile uint8_t  * gp_uart5_rx_address;     
extern volatile uint16_t   g_uart5_rx_count;        
extern volatile uint16_t   g_uart5_rx_length;       
...
void r_uart4_interrupt_receive(void)
{
    ...
    rx_data_8 = (*(volatile struct __tag557 *)0xFFCE2100).LURDR.UINT16; 
...
void r_uart4_interrupt_error(void)
{
    ...
    rx_data_8 = (*(volatile struct __tag557 *)0xFFCE2100).LURDR.UINT16;
    err_type = (uint8_t)((*(volatile struct __tag557 *)0xFFCE2100).LEST);  
    (*(volatile struct __tag557 *)0xFFCE2100).LEST &= (uint8_t) ~(0x7DU);
...
void r_uart4_interrupt_send(void)
{
    ...
    {
        (*(volatile struct __tag557 *)0xFFCE2100).LUTDR.UINT16 = *gp_uart4_tx_address;
        gp_uart4_tx_address++;
        g_uart4_tx_count--;
    }
    else
...
void r_uart5_interrupt_receive(void)
{
    ...
    rx_data_8 = (*(volatile struct __tag557 *)0xFFCE2140).LURDR.UINT16;
...
void r_uart5_interrupt_error(void)
{
    ...
    rx_data_8 = (*(volatile struct __tag557 *)0xFFCE2140).LURDR.UINT16;
    err_type = (uint8_t)((*(volatile struct __tag557 *)0xFFCE2140).LEST);  
    (*(volatile struct __tag557 *)0xFFCE2140).LEST &= (uint8_t) ~(0x7DU);
...
void r_uart5_interrupt_send(void)
{
    ...
    {
        (*(volatile struct __tag557 *)0xFFCE2140).LUTDR.UINT16 = *gp_uart5_tx_address;
        gp_uart5_tx_address++;
        g_uart5_tx_count--;
    }
    else
