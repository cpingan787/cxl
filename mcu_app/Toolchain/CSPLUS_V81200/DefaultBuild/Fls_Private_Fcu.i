...
(
 ...
 Fls_FcuStatusType Fls_PreFcuInitCheck(void)
{
   
  Fls_FcuStatusType LenStatus = FLS_FCU_OK;
   
  if (
      ((uint16)0 != FLS_GpECCReg_BaseAddress->usDFECCCTL) ||
      ((uint8)2 != FLS_GpECCReg_BaseAddress->ucDFERRINT) ||
      ((uint16)0 != FLS_GpECCReg_BaseAddress->usDFTSTCTL)
    )
 ...
 Fls_FcuStatusType Fls_FcuWritePreCheck(void)
{
  ...
  if ((0x00008000uL) != (FLS_GpFACIReg_BaseAddress->ulFSTATR &
                                                    (uint32)(0x0000D040)))
 ...
 Fls_FcuStatusType Fls_FcuCheckSequencerStatus(void)
{
  ...
  uint32  LulTimeout          = (uint32)(0x00000BB8);
  boolean LblFrdyCheck = (boolean)0;  
  ...
  do
  {
    ...
    if ((FLS_GpFACIReg_BaseAddress->ulFSTATR & (0x00008000uL)) !=
        (uint32)(uint8)0)
     
    {
      LblFrdyCheck = (boolean)1;
    }
    else
    {
      LulTimeout--;
  ...
  } while (((uint32)(uint8)0 < LulTimeout) && ((boolean)0 == LblFrdyCheck));
  if ((FLS_GpFACIReg_BaseAddress->ulFSTATR & (0x00004000uL)) !=
                              (uint32)(uint8)0)
  {
    LblCmdLockCheck = (boolean)1;
  }
  else
  {
    LblCmdLockCheck = (boolean)0;
  }

  if ((boolean)1 == LblCmdLockCheck)
  {
  ...
  if (((uint32)(uint8)0 < LulTimeout) && ((boolean)0 == LblCmdLockCheck))
  {
...
(const uint16 LusMode)
{
  ...
  uint32 LulLoopCount;
  LulLoopCount = (uint32)32U;
   
  if (LusMode != FLS_GpFACIReg_BaseAddress->usFENTRYR)
   
  {
    if ((uint16)(0x0000u) == LusMode)
    {
      ...
      { (*(&FLS_GpFACIReg_BaseAddress->usFENTRYR)) = ((uint16)(0x0000u) + (uint16)(0xAA00u)); }
      ...
      do
      {
        LulLoopCount--;
                ...
                ((uint32)0x00000000uL < LulLoopCount) &&
                (
    ...
    else
    {
      ...
      { (*(&FLS_GpFACIReg_BaseAddress->usFENTRYR)) = ((uint16)(0x0080u) + (uint16)(0xAA00u)); }
      ...
      { (*(&FLS_GpFACIReg_BaseAddress->ulFSADDR)) = ((uint32)0x00000000u); }
      { }

       
      { (*(&FLS_GpFACIReg_BaseAddress->ulFEADDR)) = ((uint32)0x00000000u); }
      { }
    ...
    if ((uint32)0x00000000uL == LulLoopCount)
    {
 ...
 Fls_FcuStatusType Fls_FcuPrepareEnvironment(void)
{
  ...
  if (FLS_FCU_BUSY == LenStatus)
  {
    ...
    if ((uint16)1024U <=
        (uint16)(Fls_GstFcuVar.ulFcuDfSize >> (0x0006u)))
    {
 ...
 Fls_FcuStatusType Fls_FcuForcedStop(void)
{
  ...
  ((*((volatile uint8*)(0xFFA20000uL))) = ((0xB3u)));
  ...
  while((LulLoopCount > (uint32)0x00000000uL) && (FLS_FCU_BUSY == LenStatus));

  LucFlsStatusRegValue = FLS_GpFACIReg_BaseAddress->ucFASTAT;
   
  if ( ((uint32)0x00000000uL == LulLoopCount) || ((uint8)0 !=
      (uint8)((uint8)(0x10u) & LucFlsStatusRegValue)))
  {
    LenStatus = FLS_FCU_ERR_INTERNAL;
  }
  else
 ...
 void Fls_FcuClearStatus(void)
{
  ...
  ((*((volatile uint8*)(0xFFA20000uL))) = ((0x50u)));
 ...
 uint32 Fls_FcuGetFWParam(const uint32 LulAddress)
{
  uint32 LulValue;
 ...
 uint32 Fls_FcuGetDFSize(void)
{
  ...
  LulDataAddr = Fls_FcuGetFWParam((0x01030270uL));
   
  LulData = (*((volatile uint32 *)(LulDataAddr + (0xC8uL))));
   
   
  LulData &= (0x0000FFFFuL);
  LulReturn = LulData * (uint32)0x00000400uL;
 ...
 Fls_FcuStatusType Fls_FcuSetFrequency(void)
{
  ...
  LulFwVal  = Fls_FcuGetFWParam((0x01030219uL) &
                                               (~(0x00000003uL)));
  LucFwVer  = (uint8)((LulFwVal >> (uint32)0x00000008uL) & (uint32)(uint8)0xFFu);

  LulFreqData = Fls_FcuGetFWParam((0x01030264uL));

  if ((uint8)0xFFu != LucFwVer)
  {
     
    LulFwVal  = Fls_FcuGetFWParam((0x01030238uL));
    LulMinFreq     = LulFwVal / (uint32)0x000F4240uL;

    LulFwVal  = Fls_FcuGetFWParam((0x01030234uL));
    LulMaxFreq     = LulFwVal / (uint32)0x000F4240uL;

    if (LucFwVer < (0x04u))
    {
      
 
      LucFreqDivider = (uint8)(LulFreqData & (uint32)(uint8)0xFFu);

      
 
      LulFwVal  = Fls_FcuGetFWParam((0x01030274uL));
      LulPClkFreq    = LulFwVal / (uint32)0x000F4240uL;
    ...
    else
    {
      ...
      LulFwVal  = Fls_FcuGetFWParam((0x01030278uL));
      LulPClkFreq    = LulFwVal / (uint32)0x000F4240uL;
      Fls_GstFcuVar.ulFcuBaseAddrECC =
                                      Fls_FcuGetFWParam((0x01030288uL));
    }

    if ((LusCpuFreq >= LulMinFreq) && (LusCpuFreq <= LulMaxFreq))
    {
      if (((uint8)0xFFu != LucFreqDivider) &&         ((uint32)0x00000000uL != LucFreqDivider))
      {
         
        LusFaciFreq = (uint16)(((uint16)(LusCpuFreq) + (uint16)LucFreqDivider)
                                 - (uint16)(uint32)0x00000001uL)/(uint16) LucFreqDivider;
      }
      else
      {
      ...
      { (*(&FLS_GpFACIReg_BaseAddress->usFPCKAR)) = ((uint16)((uint16)(0x1E00u) | LusFaciFreq)); }
 ...
 void Fls_FcuInit(void)
{
  Fls_FcuStatusType LenStatus;
   
  Fls_GstFcuVar.usCpuFrequencyMHz   = 120U;
  Fls_GstFcuVar.usDFPoolSize        = 1024U;
  Fls_GstFcuVar.usFcuFlashMode      = (uint16)(0x0000u);
  Fls_GstFcuVar.ulFcuDfSize         = (uint32)(0x00000000uL);
  Fls_GstFcuVar.ulFcuBaseAddrECC    = (uint32)(0x00000000uL);
  Fls_GstFcuVar.ulFcuChksumEndAddr  = (uint32)(0x00000000uL);
  Fls_GstFcuVar.ulFcuChksumVal      = (uint32)(0x00000000uL);
...
(const uint32 LulSrcAddr, const uint32 LulBufferAddr)
{
  ...
  LulReadData = (*((volatile uint32 *)(LulSrcAddr)));
   
  ((*((volatile uint32*)(LulBufferAddr))) = (LulReadData));
...
(uint32 LulSrcAddr, uint32 LulBufferAddr, const uint8 LucOffset)
{
  ...
  case (uint8)1:
    ...
    LucReadData = (*((volatile uint8 *)(LulSrcAddr)));
     
    ((*((volatile uint8 *)(LulBufferAddr))) = (LucReadData));

  break;
  case (uint8)2:
     
    LusReadData = (*((volatile uint16 *)(LulSrcAddr)));
     
    ((*((volatile uint16 *)(LulBufferAddr))) = (LusReadData));
  ...
  case (uint8)3:
    ...
    ((*((volatile uint16 *)(LulBufferAddr))) = (LusReadData));
    LulBufferAddr = LulBufferAddr + (uint32)(uint8)2;
    LulSrcAddr = LulSrcAddr + (uint32)(uint8)2;
 ...
 Fls_FcuStatusType Fls_FcuCheckJobStatus(void)
{
  ...
  if ((uint32)(uint8)0 != ((uint32)(0x00007000) & LulRegValue))
  {
  ...
  else if ((0x00008000uL) ==
           ((0x00008000uL) & LulRegValue))
  {
    ...
    if (FLS_FCU_OK == LenStatus)
    {
      ...
      if ((boolean)1 == Fls_GblJobSuspendRequest)
 ...
 Fls_FcuStatusType Fls_FcuCheckBCJobStatus(void)
{
  ...
  if ((0x00008000uL) == ((0x00008000uL) & LulRegValue))
  {
    LenStatus = FLS_FCU_OK;
  }
 ...
 Fls_FcuStatusType Fls_FcuBlankCheckResult(void)
{
 ...
 Fls_FcuStatusType Fls_FcuPerformBlankCheck
(
  const uint32 LulStartAddr,
...
)
{
 ...
 Std_ReturnType Fls_FcuResetErrorBits(void)
{
 ...
 void Fls_FcuReturnFromCmdLock(void)
{
   
   
  if ((0x00004000uL) == ((0x00004000uL) &
      FLS_GpFACIReg_BaseAddress->ulFSTATR))
   
  {
     
     
    if ((uint8)(0x08u) == ((uint8)(0x08u) &
     ...
     
    {
      ...
      { (*(&FLS_GpFACIReg_BaseAddress->ucFASTAT)) = ((uint8)(0x00u)); }
 ...
 uint32 Fls_FcuCalculateBlankCheckAddr
                                      (const uint32 LulStartAddr, const uint32 LulEndAddr)
{
  ...
  LulBoundryAddr = LulStartAddr / (uint32)(uint32)(0x00010000);
   
   
  LulBoundryAddr *= (uint32)(uint32)(0x00010000);
   
   
   
  LulBoundryAddr += (uint32)(uint32)(0x00010000) - (uint32)(uint32)0x00000001uL;
