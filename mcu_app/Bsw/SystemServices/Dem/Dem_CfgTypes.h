...
typedef struct
{
    ...
    const boolean StorageConditionStatus;
...
typedef struct
{
    ...
    uint16 StoreMasterContinuousMICounter;
#endif
...
typedef struct
{
    P2CONST(DemComponentTypes, AUTOMATIC, DEM_CONST_PBCFG) pDemComponent;
    P2CONST(Dem_DTCType, AUTOMATIC, DEM_CONST_PBCFG) DemCfgDTC;
    P2CONST(uint32, AUTOMATIC, DEM_CONST_PBCFG) GroupOfDTC;
    uint16 DemDTCNum;
    P2CONST(Dem_DTCAttributesType, AUTOMATIC, DEM_CONST_PBCFG) pDemDTCAttributes;
    P2CONST(Dem_DebounceCounterBasedClassType, AUTOMATIC, DEM_CONST_PBCFG) DebounceCounterBasedClass;
    P2CONST(Dem_DebounceTimeBaseClassType, AUTOMATIC, DEM_CONST_PBCFG) DebounceTimeBaseClass;
    P2CONST(DTRType, AUTOMATIC, DEM_CONST_PBCFG) pDTR;
    P2CONST(Dem_EventParameterType, AUTOMATIC, DEM_CONST_PBCFG) pDemEventParameter;
    uint16 DemEventNum;
    P2CONST(J1939NodeType, AUTOMATIC, DEM_CONST_PBCFG) pJ1939Node;
    P2CONST(DemObdDTCType, AUTOMATIC, DEM_CONST_PBCFG) ObdDTC;
    P2CONST(Dem_PidClassType, AUTOMATIC, DEM_CONST_PBCFG) PidClass;
    P2CONST(Dem_OperationCycleType, AUTOMATIC, DEM_CONST_PBCFG) OperationCycle;
    uint16 DemOperationCycleNum;
    P2CONST(DemRatioType, AUTOMATIC, DEM_CONST_PBCFG) pDemRatio;
    P2CONST(DemDataElementClassTypes, AUTOMATIC, DEM_CONST_PBCFG) pDemDataElementClass;
    P2CONST(Dem_EventIdType, AUTOMATIC, DEM_CONST_PBCFG) DTCMapping;
} Dem_ConfigType;
