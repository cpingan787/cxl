...
const Adc_HwUnitConfigType *Adc_GpHwUnitConfig;

 
const Adc_HwSgUnitType *Adc_GpSgUnitConfig;

 
const Adc_GroupConfigType *Adc_GpGroupConfig;

 
const uint32 *Adc_GpHWGroupTrigg;




 
const uint8 *Adc_GpHwUnitIndex;
 
const uint8 *Adc_GpSgUnitIndex;
 
const AdcVirChRegisters *
                                                        Adc_GpChannelToGroup;
...
boolean *Adc_GpChannelToDisableEnable;

 
Adc_SgUnitRamData *Adc_GpSgUnitRamData;

 
Adc_RunTimeData *Adc_GpRunTimeData;
...
uint8 Adc_GucMaxSwTriggGroups;
 
uint8 Adc_GucNoOfGroups;
