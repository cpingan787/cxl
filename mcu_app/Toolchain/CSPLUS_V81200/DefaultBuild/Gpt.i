...
{
  {
    ...
    versioninfo->moduleID = (uint16)100U;
     
    versioninfo->sw_major_version = 1U;
     
    versioninfo->sw_minor_version = 0U;
     
    versioninfo->sw_patch_version = 10U;
  }
}
 ...
 
{
 ...
 
  {
    ...
    if ((uint32)((((uint32)59U << 22U)) | (((uint32)100U << 14U)) | (((uint32)1U << 8U)) | (((uint32)0U << 3U))) == (configPtr->ulStartOfDbToc))
    {
      ...
      Gpt_GblDriverStatus = (boolean)0x01;
 ...
 void Gpt_DeInit(void)
{
   ...
   
  {
    ...
    Gpt_GblDriverStatus = (boolean)0x00;
 ...
 
{
   
  {
    ...
    if ((uint8)0x01 == Gpt_GpChannelRamData[channel].ucChannelStatus)
  ...
  {
    {
      ...
      Gpt_GpChannelRamData[channel].uiNotifyStatus = 1u;
  ...
  {
    {
      ...
      Gpt_GpChannelRamData[channel].uiNotifyStatus = 0u;
     ...
     
{
  ...
  LddPredefTimerTime = (Gpt_ValueType) ((uint8)0x00);
   
   
  if ((boolean)0x01 != Gpt_GblDriverStatus)
  {
  ...
  if (( PredefTimer > GPT_PREDEF_TIMER_100US_32BIT) ||
   ...
   (PredefTimer >= (Gpt_PredefTimerType) 3u ))
