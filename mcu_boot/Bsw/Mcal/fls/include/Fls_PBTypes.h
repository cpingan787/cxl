 ...
 * V2.1.10  24-Aug-2021 :  As part of ARDAABD-6991, the following changes are
 *                         made:
 *                         a) The values of macros 'FLS_SET_INT_MK' and
 *                            'FLS_RESET_INT_MK' is updated in 'Macro
 *                            Defines' section.
 *                         b) Copyright information is updated.
  * V2.1.11  03-Oct-2025 :  As part of ARDAABD-10763, the following changes are
 *                         made:
 *                         Add FLS_64_KB
 */
/******************************************************************************/
...
#define FLS_64_KB                              (uint32)(0x00010000)
...
#define FLS_SET_INT_MK                        (uint8)0x80
#define FLS_RESET_INT_REQ                     (uint16)0xEFFF
#define FLS_RESET_INT_MK                      (uint8)0x7F
