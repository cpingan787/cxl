...
static int16_t DtcGetEventFailedFlag(                              
    Dem_EventIdType eventId,                                      
    uint8_t *pIsFailed)                                          
{
    ...
    *pIsFailed = ((eventStatus & 0x01u) != 0) ? 1 : 0; 
    return 0;                                                     
}
...
DtcQueryState_e DtcGetObjState(DtcQueryObj_e obj)                  
{
    ...
    switch (obj)                                                  
    {
        ...
        {
            if (DtcGetEventFailedFlag(((Dem_EventIdType)23u), &shortGndFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (DtcGetEventFailedFlag(((Dem_EventIdType)24u), &openFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (shortGndFlag != 0)                               
        ...
        {
            if (DtcGetEventFailedFlag(((Dem_EventIdType)25u), &shortGndFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (DtcGetEventFailedFlag(((Dem_EventIdType)26u), &openFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (shortGndFlag != 0)                               
        ...
        {
            if (DtcGetEventFailedFlag(((Dem_EventIdType)29u), &shortGndFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (DtcGetEventFailedFlag(((Dem_EventIdType)30u), &openFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (shortGndFlag != 0)                               
        ...
        {
            if (DtcGetEventFailedFlag(((Dem_EventIdType)31u), &shortGndFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (DtcGetEventFailedFlag(((Dem_EventIdType)32u), &openFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (shortGndFlag != 0)                               
        ...
        {
            if (DtcGetEventFailedFlag(((Dem_EventIdType)7u), &shortGndFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (DtcGetEventFailedFlag(((Dem_EventIdType)8u), &shortBatFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (DtcGetEventFailedFlag(((Dem_EventIdType)9u), &openFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (shortGndFlag != 0)                               
        ...
        {
            if (DtcGetEventFailedFlag(((Dem_EventIdType)35u), &shortGndFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (DtcGetEventFailedFlag(((Dem_EventIdType)36u), &openFlag) != 0) 
            {
                return E_DTC_QUERY_STATE_UNKNOWN;                 
            }
            if (shortGndFlag != 0u)                               
