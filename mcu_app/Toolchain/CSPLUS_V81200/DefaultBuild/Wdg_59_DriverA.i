...
extern uint8
  Wdg_59_DriverA_GaaRamMirror[(0x02u)];
...
extern const Wdg_59_DriverA_ConfigType *Wdg_59_DriverA_GpConfigPtr;
...
extern uint16 Wdg_59_DriverA_GusTriggerCounter;
...
extern  void Wdg_59_DriverA_TriggerFunc
  ...
  ConfigPtr)
{
    ...
    {
      {
        ...
        (*((volatile uint8*)(WDG_59_DriverA_GpICR_BaseAddr)) = ((*((volatile uint8*)(WDG_59_DriverA_GpICR_BaseAddr)))&(0x7FU)));
...

        {
          ...
          { (*((&WDG_59_DriverA_GpWDTAReg_BaseAddr->ucMD))) = ((LucMD)); (*((&Wdg_59_DriverA_GaaRamMirror[(0x01u)]))) = ((LucMD)); }
          ...
          Wdg_59_DriverA_TriggerFunc((boolean)0x00);
        }
 ...
 Std_ReturnType Wdg_59_DriverA_SetMode
  (WdgIf_ModeType Mode)
{
      ...
      if (WDGIF_OFF_MODE == Wdg_59_DriverA_GddCurrentMode)
      {
        ...
        if (WDGIF_SLOW_MODE == Mode)
        {
          ...
          SchM_Exit_Wdg_59_DriverA_WDG_59_DRIVERA_MODE_SWITCH_PROTECTION();
           ...
           Wdg_59_DriverA_GusTriggerCounter = (uint16)1000 /
 ...
 void Wdg_59_DriverA_SetTriggerCondition
                                                            (uint16 timeout)
{
  ...
  LddReturnValue = 1U;
   {
    ...
    {
      if (WDG_59_DriverA_GpWDTAReg_BaseAddr->ucMD ==                      Wdg_59_DriverA_GaaRamMirror[(0x01u)])
      {
        LddReturnValue = 0U;
      }
      else
