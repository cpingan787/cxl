...
static  Std_ReturnType DspInternalUDS0x22_DidNumbercheck(uint16 numberOfDid, Dcm_MsgLenType length)
{
    Std_ReturnType ret = 0U;
    const Dcm_DspCfgType* pDcmDspCfg = DcmPbCfgPtr->pDcmDspCfg;
    if ((0u == (length & 1u)) || (length < (3U)))
    {
        ret = 1U;
    }
    ...
    DspInternalUDS0x22_DidCheck(Dcm_OpStatusType OpStatus, const Dcm_0x22Types * Dcm_0x22Type)
{
    ...
    (*Dcm_0x22Type->pRangeDidFlag) = 0u;
     
    for (Index = 0; (Index < DidNum) && (0u == Flag); Index++)
    {
         
        if ((Dcm_0x22Type->RecDid == pDcmDspDid[Index].DcmDspDidId) && (1u == pDcmDspDid[Index].DcmDspDidUsed))
        {
            {
                Flag = 1u;
...
static  Std_ReturnType DspInternalUDS0x22_DidInfoCheck(uint16 DidInfoCfgIdx)
{
    Std_ReturnType ret = 1U;
    const Dcm_DspDidInfoType* pDcmDspDidInfo = DcmPbCfgPtr->pDcmDspCfg->pDcmDspDidInfo;
    if (pDcmDspDidInfo[DidInfoCfgIdx].pDcmDspDidRead != ((void *)0))
    {
        ret = 0U;
    }
    return ret;
...
static  Std_ReturnType DspInternalUDS0x22_DidSessionCheck(
    ...
    Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    else
    {
        ...
        if (SesRefNum != 0u)
        {
            for (Index = 0; (Index < SesRefNum) && (0u == Flag); Index++)
            {
...
static  Std_ReturnType Dsp_UDS0x22_DidEcuSignalCheck(
    const Dcm_0x22Types * Dcm_0x22Type)
{
    ...
    *Dcm_0x22Type->readDidSignalFlag = 0u;
...
static  Std_ReturnType DspInternalUDS0x22_DidConditionCheck(
    Dcm_OpStatusType OpStatus,
    uint16 DidCfgIndex,
    Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    for (DidSignalIndex = 0; DidSignalIndex < DidSignalNum; DidSignalIndex++)
    {
        ...
        if ((1u == DcmConditionCheckReadFncUsed) && (((void *)0) != DataConditionCheckReadFnc))
        {
...
static  Std_ReturnType Dcm_UdsAssembleResponse(
    Dcm_OpStatusType OpStatus,
    uint16 DidCfgIndex,
    uint32 * ResOffset,
    const Dcm_DslBufferType* pDcmChannelCfg,
    Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    DidSignalNum = pDcmDspDid[DidCfgIndex].DcmDspDidSignalNum;
    for (DidSignalIndex = 0; (DidSignalIndex < DidSignalNum) && (0U == ret); DidSignalIndex++)
    {
        pDspDidData = pDcmDspDidSignal[DidSignalIndex].pDcmDspDidData;
        Size = 0;
        {
        ...
        if (0U == ret)
        {
            DidSignalPos = (uint32)pDcmDspDidSignal[DidSignalIndex].DcmDspDidDataPos;
             
            dataoffset = DidSignalPos + (uint32)Size;
            if ((((void *)0) == pDspDidData->DcmDspDataReadFnc) || ((DidSignalPos + (uint32)Size) > (2048u)))
            {
            ...
            {
                if ((dataoffset + *ResOffset - pDcmChannelCfg->offset) > pDcmChannelCfg->Dcm_DslBufferSize)
                {
                     
                    *pNrc = ((Dcm_NegativeResponseCodeType)0x14u);
                    ret = 1U;
                }
                else
                {
                    ret = pDspDidData->DcmDspDataReadFnc(OpStatus, &Dcm_Channel[DidSignalPos + *ResOffset], pNrc);
                }
            }
        }
    }
    *ResOffset += dataoffset;
    return ret;
}
...
static  Std_ReturnType DspInternalUDS0x22_NonObdDidNOrangeDeal(
    Dcm_OpStatusType OpStatus,
    uint8 ProtocolCtrlId,
    const Dcm_0x22Types * Dcm_0x22Type,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    ret = Dsp_UDS0x22_DidEcuSignalCheck(
        Dcm_0x22Type);
    if (0u == *Dcm_0x22Type->readDidSignalFlag)
    {
        ...
        {
            {
                ...
                ret = Dcm_UdsAssembleResponse(
                    OpStatus,
                    Dcm_0x22Type->DidCfgIndex,
                    Dcm_0x22Type->ResOffset,
                    pDcmChannelCfg,
                    ErrorCode);
                if (((Std_ReturnType)10) == ret)
                {
...
static  Std_ReturnType DspInternalUDS0x22_NonObdDidDeal(
    Dcm_OpStatusType OpStatus,
    uint8 ProtocolCtrlId,
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    {
        DidInfoCfgIndex = (1u == *Dcm_0x22Type->pRangeDidFlag)
 ...
 
{
    ...
    else
    {
        ...
        {
            for (; (Index0 < DidNum) && ((0U == ret) || (((Std_ReturnType)10) == ret))
                     ;
                 Index0++)
            {
                ...
                if (((MixPid == 0x03u) || (MixPid == 0x00u))
                    && ((0U == ret) || (((Std_ReturnType)10) == ret)))
                {
                ...
                if ((OpStatus == ((Dcm_OpStatusType)0x01u)) && (((Std_ReturnType)10) == ret))
                {
                    break;
                }
            }
        ...
        if ((Dcm_0x22DidReadNvmFlag == ((Dcm_OpStatusType)0x01u)) || ((OpStatus != ((Dcm_OpStatusType)0x01u)) && (Dcm_0x22DidReadNvmFlag == 0U)))
        {
            if (ret != 1U)
            {
