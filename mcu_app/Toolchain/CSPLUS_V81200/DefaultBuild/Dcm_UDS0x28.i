...
static  Dcm_CommunicationModeType DspInternalUDS0x28GetReqMode_0x01(uint8 subFunc)
{
    Dcm_CommunicationModeType RequestedMode = 0x00u;
...
static  Dcm_CommunicationModeType DspInternalUDS0x28GetReqMode_0x02(uint8 subFunc)
{
    Dcm_CommunicationModeType RequestedMode = 0x00u;
...
static  Dcm_CommunicationModeType DspInternalUDS0x28GetReqMode_0x03(uint8 subFunc)
{
    Dcm_CommunicationModeType RequestedMode = 0x00u;
...
static  Dcm_CommunicationModeType DspInternalUDS0x28_0x00_0x03_GetReqMode(uint8 subFunc, uint8 comType)
{
    Dcm_CommunicationModeType RequestedMode = 0x00u;
 ...
 void DspInternalUDS0x28_CheckNewSes(Dcm_SesCtrlType NewSes)
{
    uint8 iloop;
    Dcm_CommunicationModeType RequestedMode = 0x08u;
    Std_ReturnType ret = 0U;
    ...
    if (((1U == ret) || (((Dcm_SesCtrlType)0x01u) == NewSes)) && (((0xFFu) != ProtocolCtrlId))
        && ((((void *)0) != pDcmDspCfg) && (((void *)0) != pDcmDspCfg->pDcmDspComControl)))
    {
        pDcmDspComControl = pDcmDspCfg->pDcmDspComControl;
        pDcmDspComControlAllChannel = pDcmDspComControl->DcmDspComControlAllChannel;

        if (((void *)0) != pDcmDspComControlAllChannel)
        {
            ...
            for (iloop = 0; iloop < AllChannelNum; iloop++)
            {
                ...
                if (1u == pDcmDspComControlAllChannel[iloop].DcmDspComControlAllChannelUsed)
                {
                    BswM_Dcm_CommunicationMode_CurrentState(DcmDspComMChannelId, RequestedMode);
                }
            }
        }
        if ((((void *)0) != pDcmDslProtocolRow) && (((void *)0) != pDcmDslProtocolRow[ProtocolCtrlId].pDcmDslConnection)
            && (((void *)0) != pDcmDslProtocolRow[ProtocolCtrlId].pDcmDslConnection->pDcmDslMainConnection))
        {
    ...
    DspInternalUDS0x28_0x00_0x03_SubFuction(uint8 ProtocolCtrlId, uint8 subFunc, uint8 comType, uint16 subnet)
{
    ...
    if ((((void *)0) != pDcmDspCfg) && (((void *)0) != pDcmDspCfg->pDcmDspComControl))
    {
        pDcmDspComControl = pDcmDspCfg->pDcmDspComControl;
        pDcmDspComControlAllChannel = pDcmDspComControl->DcmDspComControlAllChannel;
        if ((((void *)0) != pDcmDspComControlAllChannel) && (subnet == 0u))
        {
            AllChannelNum = pDcmDspComControl->DcmDspComControlAllChannelNum;
            for (iloop = 0; iloop < AllChannelNum; iloop++)
            {
...
static  Std_ReturnType
    Dcm_UDS0x28_ConditionCheck(uint8 ProtocolCtrlId, Dcm_NegativeResponseCodeType * ErrorCode)
{
    uint8 MsgCtrlId;
    uint8 subFunc;
    uint8 iloop;
    ...
    for (SidTabIndex = 0; (SidTabIndex < ServiceTable_Num) && (0u == Flag); SidTabIndex++)
    {
        if (SidTabId == (pDcmDsdServiceTable[SidTabIndex].DcmDsdSidTabId))
        {
            ...
            for (ServiceIndex = 0; (ServiceIndex < ServiceNum) && (0u == Flag); ServiceIndex++)
            {
                if ((0x28u == (pService[ServiceIndex].DcmDsdServiceId))
                    && (pService[ServiceIndex].DcmDsdSubfuncAvial == 1u))
                {
                    SubService_Num = pService[ServiceIndex].DcmDsdSubService_Num;
                    for (iloop = 0; ((iloop < SubService_Num) && (Flag == 0u)); iloop++)
                    {
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        ...
        ret = DsdInternal_SubSesCheck(ProtocolCtrlId, 0x28u, ErrorCode);
    }

    if (0U == ret)
    {
         
        ret = DsdInternal_SubSecurityCheck(ProtocolCtrlId, 0x28u, ErrorCode);
    }
     
    if ((0U == ret)
        && ((((5U) != ReqDataLen) && ((subFunc == 0x04u) || (subFunc == 0x05u)))
            || (((3U) != ReqDataLen) && (subFunc < 0x04u))))
    {
    ...
    if (0U == ret)
    {
        if (subFunc < 0x04u)
        {
            if (1U == DspInternalUDS0x28_0x00_0x03_SubFuction(ProtocolCtrlId, subFunc, comType, Subnet))
            {
                *ErrorCode = ((Dcm_NegativeResponseCodeType)0x31u);
                ret = 1U;
            }
    ...
    if (0U == ret)
    {
        ...
        {
            Dcm_Channel[Offset] = 0x68;          
            Dcm_Channel[Offset + 1u] = subFunc;  
