...
#define   DCM_START_SEC_CONST_UNSPECIFIED
#include  "Dcm_MemMap.h"
static CONST(Dcm_DspDataType, DCM_CONST) Dcm_DspDataCfg[129] =
{
    {
    ...
    },
    {
        ...
        NULL_PTR, /*DcmDspDataReturnControlToECUFnc*/
        NULL_PTR, /*DcmDspDataShortTermAdjustmentFnc*/
        Rte_Call_DataServices_Data_0xF187_DID_0xF187_WriteData, /*DcmDspDataWriteFnc*/
        5u, /*DcmDspDataByteSize*/
        DCM_UINT8_N, /*DcmDspDataType*/
        USE_DATA_ASYNCH_CLIENT_SERVER, /*DcmDspDataUsePort*/
        0u, /*DcmDspDataBlockId*/
...
#define   DCM_START_SEC_CONST_UNSPECIFIED
#include  "Dcm_MemMap.h"
static CONST(Dcm_DspDidType,DCM_CONST)Dcm_DspDidCfg[126] =
{
    { /* Did_0xF130 */
        0xF130u,     /*DcmDspDidId*/
        TRUE,     /*DcmDspDidUsed*/
