...
extern volatile uint16_t         g_riic0_slave_address;            
extern volatile const uint8_t *  gp_riic0_tx_address;              
extern volatile uint16_t         g_riic0_tx_count;                 
extern volatile uint8_t *        gp_riic0_rx_address;              
extern volatile uint16_t         g_riic0_rx_count;                 
extern volatile uint16_t         g_riic0_rx_length;                
 
extern volatile uint8_t g_i2cSendEndFlag;
extern volatile uint8_t g_i2cReciveEndFlag;
extern volatile uint8_t g_i2cReciveErrorFlag;
...
{
    if (g_riic0_mode_flag == (0x0DU))
    {
        if (g_riic0_state == (0x01U))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).DRT.UINT32 = (uint8_t)(g_riic0_slave_address << (0x01U));
            g_riic0_state = (0x05U);
        }
        else if (g_riic0_state == (0x02U))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).DRT.UINT32 = (uint8_t)(((g_riic0_slave_address & (0x0300U)) >> (0x07U)) | (0x00F0U));
            g_riic0_state = (0x04U);
        }
        else if (g_riic0_state == (0x04U))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).DRT.UINT32 = (uint8_t)(g_riic0_slave_address & (0x00FFU));
            g_riic0_state = (0x05U);
        }
        else if (g_riic0_state == (0x05U))
        {
            if (g_riic0_tx_count > 0U)
            {
                (*(volatile struct __tag550 *)0xFFCA0000).DRT.UINT32 = *gp_riic0_tx_address;
                gp_riic0_tx_address++;
                g_riic0_tx_count--;
            } 
            else
    ...
    else if (g_riic0_mode_flag == (0x0CU))
    {
        if (g_riic0_state == (0x00U))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).DRT.UINT32 = (uint8_t)((g_riic0_slave_address << (0x01U))  | (0x0001U));
            g_riic0_state = (0x08U);
        }
        else if (g_riic0_state == (0x02U))
        {
        ...
        else if (g_riic0_state == (0x0EU))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).IER.UINT32 |= (0x00000004UL);
             
            (*(volatile struct __tag550 *)0xFFCA0000).CR2.UINT32 |= (0x00000004UL);
        }
        else if (g_riic0_state == (0x03U))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).DRT.UINT32 = (uint8_t)(((g_riic0_slave_address &  (0x0300U)) >> (0x07U)) | (0x00F0U) | (0x0001U));
            g_riic0_state = (0x08U);
        }
    }
}
...
{
    if (g_riic0_state == (0x06U))
    {
        (*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 &= (uint32_t) ~(0x00000008UL);
...
void r_riic0_receive_interrupt(void)
{
    ...
    if (g_riic0_state == (0x08U))
    {
        if (g_riic0_rx_length < 3U)					
        {					
            (*(volatile struct __tag550 *)0xFFCA0000).MR3.UINT32 |= (0x00000040UL);					
            if (g_riic0_rx_length == 1U)					
            {					
                (*(volatile struct __tag550 *)0xFFCA0000).MR3.UINT32 |= (0x00000010UL);					
                (*(volatile struct __tag550 *)0xFFCA0000).MR3.UINT32 |= (0x00000008UL);					
            }					
        }					
        dummy = (*(volatile struct __tag550 *)0xFFCA0000).DRR.UINT32;					
    ...
    else if (g_riic0_state == (0x09U))
    {
        ...
        if (g_riic0_rx_count < temp)
        {
            ...
            {
                (*(volatile struct __tag550 *)0xFFCA0000).MR3.UINT32 |= (0x00000040UL);
                *gp_riic0_rx_address = (*(volatile struct __tag550 *)0xFFCA0000).DRR.UINT32;
                gp_riic0_rx_address++;
                g_riic0_rx_count++;
            }
    ...
    else if (g_riic0_state == (0x0AU))
    {
        ...
        *gp_riic0_rx_address = (*(volatile struct __tag550 *)0xFFCA0000).DRR.UINT32;
        gp_riic0_rx_address++;
        g_riic0_rx_count++;
        (*(volatile struct __tag550 *)0xFFCA0000).MR3.UINT32 &= (uint32_t) ~(0x00000040UL);
        g_riic0_state = (0x0BU);
    }
}
...
void r_riic0_error_interrupt(void)
{
    ...
    if(((*(volatile struct __tag550 *)0xFFCA0000).IER.UINT32 & (0x00000002UL)) && ((*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 & (0x00000002UL)))
    {
        r_riic0_callback_receiveerror(((0x80U) + 0x02U));
    }
    else if(((*(volatile struct __tag550 *)0xFFCA0000).IER.UINT32 & (0x00000001UL)) && ((*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 & (0x00000001UL)))
    {
        r_riic0_callback_receiveerror(((0x80U) + 0x03U));
    }
    else if(((*(volatile struct __tag550 *)0xFFCA0000).IER.UINT32 & (0x00000010UL)) && ((*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 & (0x00000010UL))) 
    {
         
        dummy = (*(volatile struct __tag550 *)0xFFCA0000).DRR.UINT32;
        (*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 &= (uint32_t) ~(0x00000010UL);
        r_riic0_callback_receiveerror(((0x80U) + 0x04U));
    }
    else if (g_riic0_mode_flag == (0x0DU))
    {
        if ((g_riic0_state == (0x01U)) || (g_riic0_state == (0x02U)))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 &= (uint32_t) ~(0x00000004UL);
            (*(volatile struct __tag550 *)0xFFCA0000).IER.UINT32 &= (uint32_t) ~(0x00000004UL);
        }
        else if (g_riic0_state == (0x07U))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 &= (uint32_t) ~(0x00000010UL);
            (*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 &= (uint32_t) ~(0x00000008UL);
    ...
    {
        if ((g_riic0_state == (0x00U)) || (g_riic0_state == (0x02U)))
        {
            (*(volatile struct __tag550 *)0xFFCA0000).SR2.UINT32 &= (uint32_t) ~(0x00000004UL);
            (*(volatile struct __tag550 *)0xFFCA0000).IER.UINT32 &= (uint32_t) ~(0x00000004UL);
        }
