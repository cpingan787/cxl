...
BswM_ChkBswMInitStatus(uint8 sid)
{
    ...
    if (BSWM_INITED != BswM_RuntimeStatus.bswmInitState)
    {
        ...
        (void)Det_ReportError(42, 0, sid, 0x01);
    }
    return ret;
}
...
BswM_DetChkCanSMInd(CanSM_BswMCurrentStateType CurrentState)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x05))
    {
        ret = 1U;
    }
...
BswM_DetChkComMInd(ComM_ModeType RequestedMode)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x0e))
    {
        ret = 1U;
    }
    else if (
        (RequestedMode != 0u) && (RequestedMode != 1u)
        && (RequestedMode != 2u))
    {
        ret = 1U;
        (void)Det_ReportError(
...
BswM_DetChkComMInitRst(void)
{
    ...
    if ((Std_ReturnType)0U == BswM_ChkBswMInitStatus(0x22))
    {
        ret = 0U;
    }
    return ret;
...
BswM_DetChkDcmUpdate(void)
{
    ...
    if ((Std_ReturnType)0U == BswM_ChkBswMInitStatus(0x14))
    {
        ret = 0U;
    }
    return ret;
...
BswM_DetChkDcmModeCurState(Dcm_CommunicationModeType RequestedMode)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x06))
    {
        ret = 1U;
    }
...
BswM_DetChkEcuMCurWakeUp(EcuM_WakeupStatusType state)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x10))
    {
        ret = 1U;
    }
    else if (
        (state != (EcuM_WakeupStatusType)0) && (state != (EcuM_WakeupStatusType)1) && (state != (EcuM_WakeupStatusType)2)
        && (state != (EcuM_WakeupStatusType)3)
    )
    {
        ret = 1U;
        (void)Det_ReportError(
...
BswM_DetChkRequestedState(EcuM_StateType State, EcuM_RunStatusType CurrentStatus)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x23))
    {
        ret = 1U;
    }
    else if (!((State == (EcuM_StateType)0x32) || (State == (EcuM_StateType)0x33)))
    {
        ret = 1U;
        (void)Det_ReportError(
            42,
    ...
    else if (CurrentStatus > (EcuM_RunStatusType)2)
    {
        ret = 1U;
        (void)Det_ReportError(
            42,
...
BswM_DetChkEcuMCurState(void)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x0f))
    {
        ret = 1U;
    }
    return ret;
...
BswM_DetChkNmCarWkUp(void)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x24))
    {
        ret = 1U;
    }
    return ret;
...
BswM_DetChkGenericRqst(BswM_UserType requestingUser)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x02))
    {
        ret = 1U;
    }
    else
    {
        ...
        {
            (void)Det_ReportError(42, 0, 0x02, 0x06);
        }
    }
    return ret;
}
...
BswM_DetChkWgmParRst(void)
{
    ...
    if ((Std_ReturnType)0U != BswM_ChkBswMInitStatus(0x11))
    {
        ret = 1U;
    }
    return ret;
