 ...
 *                           WDG_59_DRIVERA_USE_WRITE_VERIFY_ERROR_NOTIFICATION
 *                           with WDG_59_DRIVERA_USE_WRITE_ERROR_INTERFACE and
 *                           WDG_59_DRIVERA_WRITE_VERIFY_ERROR_INTERFACE with
 *                           WDG_59_DRIVERA_ERROR_NOTIFICATION.
 * V1.0.6:  09-Jun-2017    : 1. As part of ARDAABD-1897 Jira ticket, code was
...
#ifndef WDG_59_DRIVERA_REGWRITE_H
#define WDG_59_DRIVERA_REGWRITE_H
...
**                     Macro Definitions                                      **
*******************************************************************************/
/* Api ID of Wdg_59_DriverA_TriggerFunc. */
#define WDG_59_DRIVERA_TRIGGERFUNC_API_ID           (uint8)0x07

/* Write verify options */
#define WDG_59_DRIVERA_WV_DISABLE                     0U
#define WDG_59_DRIVERA_WV_INIT_ONLY                   1U
#define WDG_59_DRIVERA_WV_INIT_RUNTIME                2U

/* Ram Mirroring options */
#define WDG_59_DRIVERA_MIRROR_DISABLE                 3U
#define WDG_59_DRIVERA_MIRROR_ENABLE                  4U
/******************************************************************************/
/***************************Register Write and RAM Mirroring*******************/
/******************************************************************************/
/*******************************************************************************
** Macro Name            : Wdg_59_DriverA_WRITE_REG_ONLY
**
...
#define WDG_59_DRIVERA_WRITE_REG_ONLY(pWriteRegAddr, uiRegWriteValue)  \
{ \
    (*(pWriteRegAddr)) = (uiRegWriteValue); \
}

/*******************************************************************************
** Macro Name            : INTERNAL_WDG_59_DRIVERA_WRITE_REG_AND_MIRROR
**
** Description           : This macro is to perform the write operation to the
...
#define INTERNAL_WDG_59_DRIVERA_WRITE_REG_AND_MIRROR(pWriteRegAddr, \
...
/* END Msg(4:3458)-1 */
/*******************************************************************************
** Macro Name            : Wdg_59_DriverA_WRITE_REG_AND_MIRROR
**
** Description           : This macro is to do the write and RAM mirroring for
**                         Wdg_59_DriverA registers. This macro shall not be
...
#define WDG_59_DRIVERA_WRITE_REG_AND_MIRROR(pWriteRegAddr, uiRegWriteValue,\
                                                              pMirrorAddr) \
INTERNAL_WDG_59_DRIVERA_WRITE_REG_AND_MIRROR(pWriteRegAddr, pMirrorAddr,\
                                                       uiRegWriteValue)
/* END Msg(4:3453)-3 */
#else
#define WDG_59_DRIVERA_WRITE_REG_AND_MIRROR(pWriteRegAddr, uiRegWriteValue,\
                                                              pMirrorAddr) \
     WDG_59_DRIVERA_WRITE_REG_ONLY(pWriteRegAddr, uiRegWriteValue)
#endif
...
/*******************************************************************************
** Macro Name            : WDG_59_DRIVERA_WRITE_VERIFY_REPORT_ERROR
**
...
/* WDG_59_DRIVERA_REGWRITE_H_003 : WDG_ESDD_UD_071, WDG_ESDD_UD_035           */
#if ( WDG_59_DRIVERA_USE_WRITE_ERROR_INTERFACE == STD_ON )
#define INTERNAL_WDG_59_DRIVERA_WRITE_VERIFY_REPORT_ERROR(WVErrId, ErrStat,\
                                                                    ApiId) \
WDG_59_DRIVERA_ERROR_NOTIFICATION(WVErrId, ApiId);
#else
#define INTERNAL_WDG_59_DRIVERA_WRITE_VERIFY_REPORT_ERROR(WVErrId, ErrStat,\
                                                                   ApiId) \
...
#endif
/*******************************************************************************
** Macro Name            : INTERNAL_WDG_59_DRIVERA_CHECK_WRITE_VERIFY
**
...
** Functions invoked     : None
*******************************************************************************/
#define INTERNAL_WDG_59_DRIVERA_CHECK_WRITE_VERIFY(pCompareRegAddr,\
                                        uiCheckValue, uiMaskValue, ApiId) \
  { \
    if ((uiCheckValue) != ((*(pCompareRegAddr)) & (uiMaskValue))) \
    { \
     INTERNAL_WDG_59_DRIVERA_WRITE_VERIFY_REPORT_ERROR( \
       WDG_59_DRIVERA_E_REG_WRITE_VERIFY, DEM_EVENT_STATUS_FAILED, ApiId) \
    } \
    else \
    { \
    } \
...
/* END Msg(4:3412)-2 */
/*******************************************************************************
** Macro Name            : WDG_59_DRIVERA_CHECK_WRITE_VERIFY_INIT
**
...
** Functions invoked     : None
*******************************************************************************/
/* WDG_59_DRIVERA_REGWRITE_H_001 : WDG_ESDD_UD_070, WDG_ESDD_UD_018 */
#if (WDG_59_DRIVERA_WRITE_VERIFY != WDG_59_DRIVERA_WV_DISABLE)
/* MISRA Violation: START Msg(4:3453)-3 */
#define WDG_59_DRIVERA_CHECK_WRITE_VERIFY_INIT(pCompareRegAddr, uiCheckValue,\
                                                        uiMaskValue, ApiId)\
INTERNAL_WDG_59_DRIVERA_CHECK_WRITE_VERIFY(pCompareRegAddr, uiCheckValue, \
                                                        uiMaskValue, ApiId)
/* END Msg(4:3453)-3 */
#else
#define WDG_59_DRIVERA_CHECK_WRITE_VERIFY_INIT(pCompareRegAddr, uiCheckValue,\
...
#endif
/*******************************************************************************
** Macro Name            : WDG_59_DRIVERA_CHECK_WRITE_VERIFY_RUNTIME
**
...
*******************************************************************************/
/* WDG_59_DRIVERA_REGWRITE_H_001 : WDG_ESDD_UD_070, WDG_ESDD_UD_018 */
#if (WDG_59_DRIVERA_WRITE_VERIFY == WDG_59_DRIVERA_WV_INIT_RUNTIME)
/* MISRA Violation: START Msg(4:3453)-3 */
#define WDG_59_DRIVERA_CHECK_WRITE_VERIFY_RUNTIME(pCompareRegAddr,\
                             uiCheckValue, uiMaskValue, ApiId)  \
INTERNAL_WDG_59_DRIVERA_CHECK_WRITE_VERIFY(pCompareRegAddr,\
                                        uiCheckValue, uiMaskValue, ApiId)
/* END Msg(4:3453)-3 */
#else
#define WDG_59_DRIVERA_CHECK_WRITE_VERIFY_RUNTIME(pCompareRegAddr,\
...
#endif /* WDG_59_DRIVERA_REGWRITE_H */
