...
#define DCM_NRC22_SPECIFIC_CAUSE_CODE STD_ON
...
typedef struct
{
    ...
    P2CONST(uint8, TYPEDEF, DCM_CONST) DcmDspRequestRoutineResultsRoleRef;
...
typedef struct
{
    P2CONST(Dcm_DspRoeOnChangeOfDataIdentifierType, TYPEDEF, DCM_CONST) DspRoeOnChangeOfDataIdentifier;
    P2CONST(Dcm_DspRoeOnDTCStatusChangeType, TYPEDEF, DCM_CONST) pDcmDspRoeOnDTCStatusChange;
...
typedef struct
{
    ...
    P2CONST(Dcm_DspRoeEventPropertiesType, TYPEDEF, DCM_CONST) DspRoeEventProperties;
} Dcm_DspRoeEventType;
...
typedef struct
{
    ...
    P2CONST(Dcm_DspRoeEventType, TYPEDEF, DCM_CONST) DspRoeEvent;
    uint8 DcmDspRoeEventWindowTimeNum;
    P2CONST(Dcm_DspRoeEventWindowTimeTypes, TYPEDEF, DCM_CONST) pDspRoeEventWindowTime;
} Dcm_DspRoeTypes;
...
/*DcmDspVehInfo configeration*/
    ...
    P2CONST(Dcm_DspPeriodicTransmissionTypes, TYPEDEF, DCM_CONST) DspPeriodicTransmission;
#if (DCM_DSP_ROE_NUM > 0)
    P2CONST(Dcm_DspRoeTypes, TYPEDEF, DCM_CONST) DcmDspRoe;
#endif
...
typedef struct
{
    ...
    uint8 PagedBuffer[DCM_CHANNEL_LENGTH];
    uint32 FilledSize;
