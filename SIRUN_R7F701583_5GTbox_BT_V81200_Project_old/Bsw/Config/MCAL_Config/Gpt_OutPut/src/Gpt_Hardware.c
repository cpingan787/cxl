...
{
  /* Index: 0 - 0 */
  (volatile TAUDBChReg *) &TAUD0CH9REG,

  /* Index: 1 - 1 */
  (volatile TAUDBChReg *) &TAUD0CH8REG,

  /* Index: 2 - 2 */
  (volatile TAUDBChReg *) &TAUB0CH12REG
};
...
{
  /* Index: 0 - 0 */
  (volatile OSTMReg  *) &IO_COMMON_OSTM0CMP,

  /* Index: 1 - 1 */
  (volatile OSTMReg  *) &IO_COMMON_OSTM1CMP,

  /* Index: 2 - 2 */
  (volatile OSTMReg  *) &IO_COMMON_OSTM2CMP,

  /* Index: 3 - 3 */
  (volatile OSTMReg  *) &IO_COMMON_OSTM3CMP
};
