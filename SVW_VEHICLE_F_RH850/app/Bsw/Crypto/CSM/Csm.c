...
/* PRQA S 3218 ++ */ /* VL_Csm_3218 */
static VAR(Csm_JobInQueueType, CSM_VAR_CLEARED_UNSPECIFIED) Csm_JobQueBuf[CSM_QUEUE_TOTAL_SIZE];
/* PRQA S 3218 -- */
...
#define CSM_START_SEC_VAR_CLEARED_BOOLEAN
#include "Csm_MemMap.h"
VAR(boolean, CSM_VAR_CLEARED_BOOLEAN) Csm_InitStatus; /* PRQA S 1514 */ /* VL_Csm_1514 */
...
static FUNC(Std_ReturnType, CSM_CODE) Csm_DequeueJobInQue(VAR(uint32, AUTOMATIC) jobId, VAR(uint32, AUTOMATIC) queId)
{
    ...
    /* PRQA S 3678 -- */ /* VL_Csm_3678 */
    P2CONST(Csm_JobInQueueType, AUTOMATIC, AUTOMATIC) temNode;
    uint32 idx;
