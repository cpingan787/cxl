 ...
 *                            improved.
 * V2.1.6:  24-Aug-2021  : As part of ARDAABD-6991, the following changes are
 *                         made:
 *                         a) API FLS_FLENDNM_ISR is updated such that ICRxxx
 *                            register will be accessed in 8 bits when setting
 *                            MKxxx bit using 'RH850_SV_MODE_ICR_xxx' macros.
 *                         b) Copyright information is updated.
 * V2.1.7:  22-Sep-2021  : As part of review based on ARDAABD-6991, updated
 *                         'Registers Used' field to add 'ICDMAm' register for
 *                         the function FLS_FLENDNM_ISR and 'ICFLENDNM' register
 *                         for the function FLS_DMAmn_ISR.
 */
/******************************************************************************/
...
**
** Registers Used        : ICFLENDNM, ICDMAm
*******************************************************************************/
