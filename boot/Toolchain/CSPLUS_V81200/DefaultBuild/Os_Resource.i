...
extern const uint16* const Os_TaskResourceAccessMask[(3U)];
extern const uint16* const Os_IsrResourceAccessMask[(5U)];
extern Os_ResourceType Os_ICBisrC2ResourceStack[(5U)][(1U)];
extern Os_ResourceType Os_TCBTaskResourceStack[(3U)][(1U)];
