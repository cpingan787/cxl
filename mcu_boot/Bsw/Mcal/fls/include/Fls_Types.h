 ...
 *                            improved.
 * V2.0.10: 06-Nov-2020  :  Following changes are made:
 *                          1. As part of ARDAABD-4063, added the data 
 *                             type which used as the return value of
 *                             Fls_UseFlashControllerPreHook and 
 *                             Fls_UseFlashControllerEndHook API.
 */
/******************************************************************************/
#ifndef FLS_TYPES_H
#define FLS_TYPES_H
...
/* FLS_TYPES_H_030:  FLS_ESDD_UD_269                                          */
/*
 type for Fls_UseFlashControllerPreHook and Fls_UseFlashControllerEndHook API
 return value.
*/
typedef enum ETag_Fls_AccessStatusType
{
  /* Flash access ready  */
  FLS_ACCESS_OK = 0,
  /* Flash access not ready but instruct to accept FLS command */
  FLS_ACCESS_BUSY,
  /* Flash access not ready and instruct to reject FLS command */
  FLS_ACCESS_NG
} Fls_AccessStatusType;
