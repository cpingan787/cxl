...
void r_riic0_error_interrupt(void)
{
	...
	/* 兜底：清除所有残留的 START/STOP 标志，防止死循环 */
    RIIC0.SR2.UINT32 &= (uint32_t)~(_RIIC_START_CONDITION_DETECTED | _RIIC_STOP_CONDITION_DETECTED | _RIIC_NACK_DETECTED | _RIIC_ARBITRATION_LOST | _RIIC_TIMEOUT_DETECTED) ;
}
/***********************************************************************************************************************
