...
static CONST(Can_HohConfigType, CAN_RSCAN_CONFIG_DATA) Can_GaaHohConfig0[] =
{
  ...
  /* Index: 1 - CanHardwareObject_Rx1 -> RxFIFO[1] */
  {
    ...
    0x00U,
    /* ulXXCCRegValue */
    CAN_RSCAN_RFIM | CAN_RSCAN_RFIE | CAN_RSCAN_RFDC_16 | CAN_RSCAN_RFPLS_64
  },
  /* Index: 2 - CanHardwareObject_Tx0 -> TxRxFIFO(Tx)[0] linked to TxBuffer[0] */
  {
    /* enHoh */
    CAN_HOH_HTH,
    /* ucMainFunctionRIndex */
    ...
    0x00U,
    /* ulXXCCRegValue */
    CAN_RSCAN_CFITT(0) | CAN_RSCAN_CFTML(0) | CAN_RSCAN_CFM_TX | CAN_RSCAN_CFIM | CAN_RSCAN_CFTXIE | CAN_RSCAN_CFDC_48 | CAN_RSCAN_CFPLS_64
  },
  /* Index: 3 - CanHardwareObject_Tx1 -> TxRxFIFO(Tx)[1] linked to TxBuffer[1] */
  {
    /* enHoh */
    CAN_HOH_HTH,
    /* ucMainFunctionRIndex */
...
{
  /* Index: 0 - CanHardwareObject_Rx0/CanHwFilter: RSCANFD00 -> RxFIFO[0] */
  {
    /* ulGAFLID */
    0x00000000UL,
    /* ulGAFLM */
  ...
  /* Index: 1 - CanHardwareObject_Rx1/CanHwFilter: RSCANFD00 -> RxFIFO[1] */
  {
    /* ulGAFLID */
    0x00000000UL,
    /* ulGAFLM */
