...
static StatusType Os_GetAlarm(AlarmType alarmId, TickRefType tick);
...
static void Os_ProcessAlarm(Os_CounterType counterId, Os_AlarmType* alarmNextVal, Os_SCBType *pScb, Os_CCBType *pCcb, Os_ArchMsrType *msr);
...
static void Os_InsertAlarm(Os_AlarmType alarmId, Os_AlarmRefType alarmQueue, Os_TickType curTick);
...
static void Os_DeleteAlarm(Os_AlarmType alarmId, Os_AlarmRefType alarmQueue);
...
static StatusType Os_AbsAlarmCheckStatus(AlarmType alarmId, TickType start, TickType cycle);
...
static inline  void Os_GetAlarmBase(AlarmType alarmId, AlarmBaseRefType Info);
...
static StatusType Os_RelAlarmCheckStatus(AlarmType alarmId, TickType increment, TickType cycle);
...
static StatusType Os_SetRelAlarm(AlarmType alarmId, TickType increment, TickType cycle);
...
static StatusType Os_SetAbsAlarm(AlarmType alarmId, TickType start, TickType cycle);
 ...
 
{
    ...
    *alarmNextVal = Os_ACB[*alarmNextVal]->AlarmNext;
    ...
    if (((void *)0) != Os_AlarmCfg[alarmCurVal].AlarmCallback)
    {
...
{
    if (Os_ObjectIDCheck((ObjectType)alarmId, (uint8)OS_OBJECT_ALARM) == 1u)
    {
...
static StatusType Os_AbsAlarmCheckStatus(
    AlarmType alarmId,
    TickType start,
    TickType cycle)
{
...
static StatusType Os_RelAlarmCheckStatus(
    AlarmType alarmId,
    TickType increment,
    TickType cycle)
{
...
static StatusType Os_SetRelAlarm(
    AlarmType alarmId,
    TickType increment,
    TickType cycle)
{
 ...
 
{
    ...
    else if (Os_ObjectIDCheck((ObjectType)AlarmID, (uint8)OS_OBJECT_ALARM) != 1u)
    {
        err = 3U;
    }
    else
