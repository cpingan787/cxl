...
boolean PEU_PTCANFD_50ms_FrP05_CONTROLLER_0_IAM_0x200_Rx(PduIdType PduId, const PduInfoType* PduInfoPtr);
...
boolean ICB_RZCUCANFD_200ms_FrP82_CONTROLLER_0_IAM_0x469_Rx(PduIdType PduId, const PduInfoType* PduInfoPtr);

boolean RHZCU_RHBKBCANFD_100ms_FrP10_CONTROLLER_0_IAM_0x33d_Rx(PduIdType PduId, const PduInfoType* PduInfoPtr);

boolean RHZCU_RHBKBCANFD_50ms_FrP01_CONTROLLER_0_IAM_0x289_Rx(PduIdType PduId, const PduInfoType* PduInfoPtr);

boolean IBS_CHCANFD_100ms_FrP15_CONTROLLER_0_IAM_0x3dc_Rx(PduIdType PduId, const PduInfoType* PduInfoPtr);

boolean RHZCU_RHBKBCANFD_100ms_FrP09_CONTROLLER_0_IAM_0x355_Rx(PduIdType PduId, const PduInfoType* PduInfoPtr);
