...
/* Enable/disable the register read back for TAUDB
   ...
   GPT_WV_INIT_ONLY         1
   GPT_WV_INIT_RUNTIME      2 */
#define GPT_TAUDB_WRITE_VERIFY              GPT_WV_INIT_RUNTIME
...
/* Enable/disable the ram mirroring for TAUDB
   GPT_MIRROR_DISABLE           0
   GPT_MIRROR_ENABLE            1 */
#define GPT_TAUDB_RAM_MIRROR                GPT_MIRROR_ENABLE
...
#define GPT_OSTM0_CH00_ISR_API    STD_ON
#define GPT_OSTM1_CH00_ISR_API    STD_ON
#define GPT_OSTM2_CH00_ISR_API    STD_ON
#define GPT_OSTM3_CH00_ISR_API    STD_ON
...
#define GPT_TAUB0_CH12_ISR_API    STD_ON
...
#define GPT_TAUD0_CH09_ISR_API    STD_ON
...
#define GPT_TAUD0_CH09 0x00U
#define GPT_TAUD0_CH08 0x01U
#define GPT_TAUB0_CH12 0x02U
#define GPT_TAUJ0_CH00 0x03U
#define GPT_OSTM0_CH00 0x04U
#define GPT_OSTM1_CH00 0x05U
#define GPT_OSTM2_CH00 0x06U
#define GPT_OSTM3_CH00 0x07U
...
#define GptConf_GptChannelConfiguration_GptChannelConfiguration1 \
                 (Gpt_ChannelType)0x01
#define GptConf_GptChannelConfiguration_GptChannelConfiguration2 \
                 (Gpt_ChannelType)0x02
#define GptConf_GptChannelConfiguration_GptChannelConfiguration3 \
                 (Gpt_ChannelType)0x03
#define GptConf_GptChannelConfiguration_GptChannelConfiguration4 \
                 (Gpt_ChannelType)0x04
#define GptConf_GptChannelConfiguration_GptChannelConfiguration5 \
                 (Gpt_ChannelType)0x05
#define GptConf_GptChannelConfiguration_GptChannelConfiguration6 \
                 (Gpt_ChannelType)0x06
#define GptConf_GptChannelConfiguration_GptChannelConfiguration7 \
                 (Gpt_ChannelType)0x07
