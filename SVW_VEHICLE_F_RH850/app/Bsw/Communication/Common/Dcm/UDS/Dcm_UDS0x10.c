...
#define DCM_APP_10_02_EPTRDYV_VALID_VALUE    ((uint8)0u)   //0:��Ч
#define DCM_APP_10_02_EPTRDY_NOT_READY_VALUE ((uint8)0u)   //0:δ����
#define DCM_APP_10_02_VEHSPD_VALID_VALUE     ((uint8)0u)   //0:��Ч
#define DCM_APP_10_02_VEHSPD_THRESHOLD       ((uint16)256u)   //����С��4km/h��4 / 0.015625 = 256����������4��Ӧ256

#define DCM_APP_0X10_NON_02_VEHSPD_VALID_VALUE    ((uint8)0u)  //0:��Ч
