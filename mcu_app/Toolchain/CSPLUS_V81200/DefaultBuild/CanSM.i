...
static boolean CanSM_ValidateAllNetworksNoCom(void);
...
static  void CanSM_PnNot_CC_Stopped(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_PnNot_CC_Stopped_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_PnNot_CC_Sleep(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_PnNot_CC_Sleep_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);
...
static  void CanSM_WUVAL_S_CC_Stopped(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_WUVAL_S_CC_Stopped_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_WUVAL_S_CC_Started(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_WUVAL_S_CC_Started_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static boolean CanSM_BsmWuValidation(uint8 netID);

static  void CanSM_Prefullcom_S_CC_Stopped(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_Prefullcom_S_CC_Stopped_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_Prefullcom_S_CC_Started(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_Prefullcom_S_CC_Started_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static boolean CanSM_BsmSPreFullCom(uint8 netID);

static  void CanSM_FullCom_S_Bus_off_Check(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static void CanSM_FullCom_S_No_Bus_Off(uint8 netID, const CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_FullCom_S_CC_Stopped(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_FullCom_S_CC_Stopped_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_FullCom_S_CC_Started(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_FullCom_S_CC_Started_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_FullCom_S_Restart_CC(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_FullCom_S_Restart_CC_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);

static  void CanSM_FullCom_S_Tx_Off(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr);
...
static  void CanSM_EFullComAction(uint8 netID);

static  void CanSM_EFullToSilentComAction(uint8 netID);

static  void CanSM_EPreNoComAction(uint8 netID);
...
static boolean CanSM_CheckNetworkAllControllerMode(uint8 netID, CanIf_ControllerModeType controllerMode);
static void CanSM_ModeRequestTimeout(uint8 netID);

static  void CanSM_TimerHandler(CanSM_NetWorkRunTimeType* networkPtr);

static CanSM_NetworkIndexType CanSM_FindNetworkIndex(NetworkHandleType networkHandle);

static void CanSM_ComMModeIndication(uint8 netID, ComM_ModeType ComMode, CanSM_RequestModeType RequestedComMode);
...
static CanSM_StateType CanSM_Status = CANSM_UNINITED;
...
static const CanSM_ConfigType * CanSM_ConfigPtr;
...
static CanSM_NetWorkRunTimeType CanSM_NetWorkRunTime[1u];
static CanIf_ControllerModeType CanSM_ControllerMode[1u];
...
CanSM_Init(const CanSM_ConfigType * ConfigPtr)
{
    ...
    if (((void *)0) == ConfigPtr)
    {
        (void)Det_ReportError(140U, (0U), 0x00, (0x02u));
        detNoErr = 0u;
    }
    if ((boolean)1u == detNoErr)
    {
        if (CANSM_UNINITED == CanSM_Status)
        {
            ...
            for (netLoop = 0u; netLoop < 1u; netLoop++)
            {
                {
                ...
                CanSM_NetWorkRunTime[netLoop].busOffEvent = 0u;
                CanSM_NetWorkRunTime[netLoop].canIfIndicated = T_NO_INDICATED;
                CanSM_NetWorkRunTime[netLoop].requestComMode = CANSM_NO_REQUEST;
                CanSM_NetWorkRunTime[netLoop].curComMode = 0u;
            }
            for (controller = 0u; controller < (uint8)1u; controller++)
            {
...
void CanSM_DeInit(void)
{
    ...
    {
        for (CanSM_NetworkIndexType networkIndex = 0u; networkIndex < 1u; ++networkIndex)
        {
...
static CanSM_NetworkIndexType CanSM_FindNetworkIndex(NetworkHandleType networkHandle)
{
    ...
    for (; networkIndex < 1u; ++networkIndex)
    {
...
void CanSM_MainFunction(void)
{
    ...
    if (CANSM_INITED == CanSM_Status)
    {

        for (uint8 netLoop = 0u; netLoop < 1u; netLoop++)
        {
...
Std_ReturnType CanSM_RequestComMode(NetworkHandleType network, ComM_ModeType comMMode)
{
    ...
    if (CANSM_UNINITED == CanSM_Status)
    {
        (void)Det_ReportError(140U, (0U), 0x02, (0x01u));
        detNoErr = 0u;
    }
    if (detNoErr)
    {
...

{
    ...
    if (CANSM_UNINITED == CanSM_Status)
    {
        (void)Det_ReportError(140U, (0U), 0x03, (0x01u));
        detNoErr = 0u;
    }
    if (((void *)0) == comMModePtr)
    {
        (void)Det_ReportError(
            140U,
            (0U),
...
CanSM_StartWakeupSource(NetworkHandleType network)
{
    ...
    if (CANSM_UNINITED == CanSM_Status)
    {
        (void)Det_ReportError(140U, (0U), 0x11, (0x01u));
        detNoErr = 0u;
    }
    if ((boolean)1u == detNoErr)
    {
...
CanSM_StopWakeupSource(NetworkHandleType network)
{
    ...
    if (CANSM_UNINITED == CanSM_Status)
    {
        (void)Det_ReportError(140U, (0U), 0x12, (0x01u));
        detNoErr = 0u;
    }
    if ((boolean)1u == detNoErr)
    {
...
void CanSM_ControllerBusOff(uint8 ControllerId)
{
    ...
    if (CANSM_UNINITED == CanSM_Status)
    {
        (void)Det_ReportError(140U, (0U), 0x04, (0x01u));
        detNoErr = 0u;
    }
    if ((boolean)1u == detNoErr)
    {
        boolean findController = 0u;
        for (uint8 netLoop = 0u; (netLoop < 1u) && !findController; netLoop++)
        {
            uint8 controllerId;
            do { (controllerId) = (CanSM_ConfigPtr->CanSMManagerNetworkRef[(netLoop)]. ControllerRef)->CanSMControllerId[0];
            {
                if (ControllerId == controllerId)
                {
                    findController = 1u;
                    {
                        ...
                        CanSM_NetWorkRunTime[netLoop].busOffEvent = 1u;
                    }
                    break;
                }
            }
...
void CanSM_ControllerModeIndication(uint8 ControllerId, CanIf_ControllerModeType ControllerMode)
{
    ...
    {
        boolean findController = 0u;
        for (networkIndex = 0u; (networkIndex < 1u) && !findController; ++networkIndex)
        {
            uint8 controllerId;
            do { (controllerId) = (CanSM_ConfigPtr->CanSMManagerNetworkRef[(networkIndex)]. ControllerRef)->CanSMControllerId[0];
            {
                if (ControllerId == controllerId)
                {
                    findController = 1u;
...
{
    CanSM_NetWorkRunTimeType* networkPtr = ((void *)0);
    boolean detNoErr = 1u;
    if (CANSM_UNINITED == CanSM_Status)
    {
        (void)Det_ReportError(
    ...
    if ((boolean)1u == detNoErr)
    {
        for (uint8 netLoop = 0u; netLoop < 1u; netLoop++)
        {
            if (((void *)0) != CanSM_ConfigPtr->CanSMManagerNetworkRef[netLoop].TrcvRef)
            {
...
CanSM_TxTimeoutException(NetworkHandleType Channel)
{
    ...
    if (CANSM_UNINITED == CanSM_Status)
    {
        (void)Det_ReportError(140U, (0U), 0x0b, (0x01u));
        detNoErr = 0u;
    }
    if ((boolean)1u == detNoErr)
    {
...
static  void CanSM_PnNot_CC_Stopped(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr)
{
    ...
    networkPtr->waitCanIfIndicatedStartTime = CanSM_ConfigPtr->CanSMModeRequestRepetitionTime;
}
...
static  void CanSM_FullCom_S_Bus_off_Check(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr)
{
    ...
    else
    {
        ...
        if (busOffPassive)
        {
            if (((void *)0) != CanSM_ConfigPtr->CanSMManagerNetworkRef[netID].CanSMDemEventParameterRefs)
            {
                if (((void *)0) != CanSM_ConfigPtr->CanSMManagerNetworkRef[netID].CanSMDemEventParameterRefs->BusOffPara)
                {
...
static  void CanSM_FullCom_S_CC_Started_Wait(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr)
{
    ...
    if (CanSM_CheckNetworkAllControllerMode(netID, CANIF_CS_STARTED))
    {
        ...
        uint8 controllerId;
        do { (controllerId) = (CanSM_ConfigPtr->CanSMManagerNetworkRef[(netID)]. ControllerRef)->CanSMControllerId[0];
        {
...
static  void CanSM_FullCom_S_Tx_Off(uint8 netID, CanSM_NetWorkRunTimeType* networkPtr)
{
    ...
    if (networkPtr->busOffEventStartTime >= busOffContinueTime)
    {
        ...
        if (networkPtr->busOffCounter < 255u)
        {
...
static void CanSM_ModeRequestTimeout(uint8 netID)
{
    ...
    if (networkPtr->repeatCounter >= CanSM_ConfigPtr->CanSMModeRequestRepetitionMax)
    {
        ...
        if (demEventParameterRef != ((void *)0))
        {
            if (demEventParameterRef->ModeReqTimeoutPara != ((void *)0))
            {
                Dem_ReportErrorStatus(*demEventParameterRef->ModeReqTimeoutPara, 0x03u);
            }
        }
...
static boolean CanSM_ValidateAllNetworksNoCom(void)
{
    ...
    if (error != (0x00u))
    {
        (void)Det_ReportError(140U, (0U), 0x14, error);
    }
    return error == (0x00u);
}
