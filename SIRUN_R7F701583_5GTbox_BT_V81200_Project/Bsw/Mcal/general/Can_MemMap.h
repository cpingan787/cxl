...
*******************************************************************************/
/*
 * V1.0.0:  17-Jan-2017  : Initial Version
 * V1.0.1:  12-Oct-2018  : Remove published information macros.
 * V1.0.2:  22-Sep-2019  : Add AUTOSAR version and file version macros.
 *          24-Oct-2019  : As part of ARDAACH-80, remove un-used memory
 *                         sections.
 * V1.0.3:  25-Aug-2020  : As per ARDAABD-4733, Add prefix "CAN_" for
 *                         macros version information.
 */
/******************************************************************************/
...
#define CAN_MEMMAP_SW_PATCH_VERSION   3
