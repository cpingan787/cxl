...
extern void SchM_Enter_CryIf_ExclusiveArea_Channel(void);
extern void SchM_Exit_CryIf_ExclusiveArea_Channel(void);
...
void SchM_Enter_CryIf_ExclusiveArea_Channel(void)
{
...
void SchM_Exit_CryIf_ExclusiveArea_Channel(void)
{
    ResumeAllInterrupts();
}
