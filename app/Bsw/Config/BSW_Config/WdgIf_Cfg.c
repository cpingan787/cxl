...
#define WDGIF_CFG_C_AR_MAJOR_VERSION  (4U)
#define WDGIF_CFG_C_AR_MINOR_VERSION  (5U)
#define WDGIF_CFG_C_AR_PATCH_VERSION  (0U)
#define WDGIF_CFG_C_SW_MAJOR_VERSION  (1U)
#define WDGIF_CFG_C_SW_MINOR_VERSION  (0U)
#define WDGIF_CFG_C_SW_PATCH_VERSION  (3U)
