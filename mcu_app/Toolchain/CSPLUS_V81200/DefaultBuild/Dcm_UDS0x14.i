...
static  Std_ReturnType Dcm_UDS0x14_ConditionCheck(
    Dcm_OpStatusType OpStatus,
    uint8 ProtocolCtrlId,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if ((0U == ret) && (OpStatus == ((Dcm_OpStatusType)0x00u)))
    {
        ...
        returnClearDTC = Dem_DcmCheckClearParameter(groupOfDTC, 0x01u, 0x01u);
        ...
        case 0x03u:
            ...
            *ErrorCode = ((Dcm_NegativeResponseCodeType)0x22u);
            ...
            break;
        case 0x00u:
            if ((pDcmDspClearDTC != ((void *)0)) && (pDcmDspClearDTC->DcmDsp_ClearDTCCheckFnc != ((void *)0)))
            {
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        ...
        returnClearDTC = Dem_DcmClearDTC(groupOfDTC, 0x01u, 0x01u);
        switch (returnClearDTC)
        {
        case 0x00u:
        ...
        case 0x04u:
            ...
            break;
        case 0x06u:
            *ErrorCode = ((Dcm_NegativeResponseCodeType)0x72u);
            ret = 1U;
            break;
        case 0x05u:
        case 0x03u:
