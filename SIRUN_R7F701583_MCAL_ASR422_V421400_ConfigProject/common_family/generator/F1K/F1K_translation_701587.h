...
/* Module       = F1K_translation_701587.h                                    */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 *                          are removed.
 *                          4. Macros required for the GPT module are added.
 ...
 * V1.0.5:  31-Mar-2016   : As part of F1K Ver4.00.01.001 CANFD activity,
 *                          following changes are made:
 *                          1.As per ARDAAGA-217,the macro value of
 *                          RENESAS_CANMCUPPLCLOCK is
 *                          changed from McuPpllClk to
 *                          McuClockReferencePointFrequency.
 *                          2.As per ARDAAGA-217, the value of the macro
 *                          RENESAS_CANPLLDIVVALUE is changed from 2 to 1, to
 *                          get clkc directly, without any division.
 * V2.0.0:  28-Oct-2016   : Switch from PE to VCI registers
 * V2.0.1:  04-Nov-2016   : As part of JIRA ARDAABD-714 : Add suffixes for VCI
 *                          registers
 * V2.0.2:  31-Jan-2017   : As part of ARDAABD-714 added suffix for
 *                          RENESAS_CF1STERSTR_VCI register
 * V2.0.3:  09-Feb-2017   #ARDAABD-891
 ...
 *                          8. As part of ARDAABD-2047, RENESAS_RSCAN0CFDRPGACC0
 *                             macro is added.
...
#define RENESAS_PWGA_R7F701587        72
...
/*Start address of 701587 */
#define RENESAS_START_ADDR        0xFEBD0000
/*End address of 701587 */
