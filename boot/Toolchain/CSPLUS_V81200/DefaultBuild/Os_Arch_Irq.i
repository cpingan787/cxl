...
Os_isrhnd Os_Vector_Handler[(358U)];
 ...
 
{
    ...
    __ldsr_rh((3U), (1U), (uint32)&Os_ExceptionTable);    
    __ldsr_rh((5U), (0U), __stsr_rh((5U), (0U)) | (1UL << (15U)));

     
    for (isrNum = 0U; isrNum < (358U); ++isrNum)
    {
        Os_Vector_Handler[isrNum] = (Os_isrhnd)&Os_IntHandler;
    }

    for (isrNum = 0U; isrNum < (32U); ++isrNum)
    {
        Os_FE_Handler[isrNum] = &Os_FEIntHandler;
    }
    
     
    (*(uint32 volatile*)(0xFFC00104U)) = (0xFFFFFFFFUL);
}
 ...
 
{
    ...
    if (0U != (isrSrc & (0x1000U)))
    {
        isrNum                      = ((isrSrc) & 0x0FFFU);
        (*(volatile Os_EICRegType*)(isrNum < 32U ? ((0xFFFEEA00U) + isrNum * 0x02U) : ((0xFFFFB000U) + isrNum * 0x02U))).bit.P  = (uint16)((16U) - (isrPrio));
        (*(volatile Os_EICRegType*)(isrNum < 32U ? ((0xFFFEEA00U) + isrNum * 0x02U) : ((0xFFFFB000U) + isrNum * 0x02U))).bit.TB = 0U;
        (*(volatile Os_EICRegType*)(isrNum < 32U ? ((0xFFFEEA00U) + isrNum * 0x02U) : ((0xFFFFB000U) + isrNum * 0x02U))).bit.MK = 0U;
        Os_Vector_Handler[isrNum]   = isrHandler;
    }
    else
    {
        isrNum = ((isrSrc) & 0x001FU);
        (*(uint32 volatile*)(0xFFC00104U)) &= ~(uint32)(1U << isrNum);
...
void Os_Hal_SetIpl(Os_IPLType ipl, Os_IsrDescriptionType isrdesc)
{
    ...
    cpuPrio = (0U != ipl) ? ((((Os_IPLType)1U << ipl) - 1U) << ((16U) - ipl)) : 0U;
       
    
 
    __ldsr_rh((11U), (2U), cpuPrio);
}
...
{
    uint32 psw = __stsr_rh((5U), (0U));
    Os_ArchMsrType id  = psw & (0x00000020UL);
    if (0UL == id)
    {
...
void Os_Hal_RestoreInt(Os_ArchMsrType msr)
{
    if (0UL == msr)
    {
        __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL));    
    }
}
 ...
 
{
    ...
    if (0 != (vIsrSrc & (0x1000U)))
    {
        (*(volatile Os_EICRegType*)(((vIsrSrc) & 0x0FFFU) < 32U ? ((0xFFFEEA00U) + ((vIsrSrc) & 0x0FFFU) * 0x02U) : ((0xFFFFB000U) + ((vIsrSrc) & 0x0FFFU) * 0x02U))).bit.MK = 0U;
    }
    else
    {
        (*(uint32 volatile*)(0xFFC00104U)) &= ~(uint32)(1U << ((vIsrSrc) & 0x001FU));
    }
 ...
 
{
    ...
    if (0 != (vIsrSrc & (0x1000U)))
    {
        (*(volatile Os_EICRegType*)(((vIsrSrc) & 0x0FFFU) < 32U ? ((0xFFFEEA00U) + ((vIsrSrc) & 0x0FFFU) * 0x02U) : ((0xFFFFB000U) + ((vIsrSrc) & 0x0FFFU) * 0x02U))).bit.MK = 1U;
    }
    else
    {
        (*(uint32 volatile*)(0xFFC00104U)) |= (uint32)(1U << ((vIsrSrc) & 0x001FU));
 ...
 
{
    ...
    if (0 != (vIsrSrc & (0x1000U)))
    {
        (*(volatile Os_EICRegType*)(((vIsrSrc) & 0x0FFFU) < 32U ? ((0xFFFEEA00U) + ((vIsrSrc) & 0x0FFFU) * 0x02U) : ((0xFFFFB000U) + ((vIsrSrc) & 0x0FFFU) * 0x02U))).bit.RF = 0U;
    }
    else
    {
        (*(uint32 volatile*)(0xFFC00108U)) |= (uint32)(1U << ((vIsrSrc) & 0x001FU));
    }
    Os_Hal_RestoreInt(state);
}
...
void Os_Hal_SetPendingInterrupt(uint32 vIsrSrc, uint32 vIsrSrcType)
{
    ...
    if (0 != (vIsrSrc & (0x1000U)))
    {
        (*(volatile Os_EICRegType*)(((vIsrSrc) & 0x0FFFU) < 32U ? ((0xFFFEEA00U) + ((vIsrSrc) & 0x0FFFU) * 0x02U) : ((0xFFFFB000U) + ((vIsrSrc) & 0x0FFFU) * 0x02U))).bit.RF = 1U;
    }
    Os_Hal_RestoreInt(state);
}
 ...
 
{
    ...
    if (0 != (vIsrSrc & (0x1000U)))
    {
        if (0U == (*(volatile Os_EICRegType*)(((vIsrSrc) & 0x0FFFU) < 32U ? ((0xFFFEEA00U) + ((vIsrSrc) & 0x0FFFU) * 0x02U) : ((0xFFFFB000U) + ((vIsrSrc) & 0x0FFFU) * 0x02U))).bit.MK)
        {
    ...
    {
        if (0U == ((*(uint32 volatile*)(0xFFC00104U)) & (uint32)(1U << ((vIsrSrc) & 0x001FU))))
        {
            isrSourceState = OS_ISR_ENABLED;
        }
    }
...
{
    uint32 eiic = __stsr_rh((13U), (0U));
    return (eiic & (0x0FFFUL));
}
...
{
    uint32 eiic = __stsr_rh((14U), (0U));
    return (eiic & (0x00FFUL));
}
