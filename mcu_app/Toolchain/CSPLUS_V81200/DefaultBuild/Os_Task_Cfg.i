...
static const Os_StackType Os_SystemStackCore0 =
{
    ...
    ((Os_StackPtrType)((&(Os_SysStack_Core0)[0]) + (sizeof(Os_SysStack_Core0) / sizeof((Os_SysStack_Core0)[0])) - 8U)), ((Os_StackPtrType)(Os_SysStack_Core0))
...
const Os_StackType Os_TaskStack[(7U)] =
 
{
       
    {((Os_StackPtrType)((&(Os_OsTask_Init_Stack)[0]) + (sizeof(Os_OsTask_Init_Stack) / sizeof((Os_OsTask_Init_Stack)[0])) - 8U)), ((Os_StackPtrType)(Os_OsTask_Init_Stack))},
    {((Os_StackPtrType)((&(Os_OsTask_1ms_Stack)[0]) + (sizeof(Os_OsTask_1ms_Stack) / sizeof((Os_OsTask_1ms_Stack)[0])) - 8U)), ((Os_StackPtrType)(Os_OsTask_1ms_Stack))},
    {((Os_StackPtrType)((&(Os_OsTask_5ms_Stack)[0]) + (sizeof(Os_OsTask_5ms_Stack) / sizeof((Os_OsTask_5ms_Stack)[0])) - 8U)), ((Os_StackPtrType)(Os_OsTask_5ms_Stack))},
    {((Os_StackPtrType)((&(Os_OsTask_10ms_Stack)[0]) + (sizeof(Os_OsTask_10ms_Stack) / sizeof((Os_OsTask_10ms_Stack)[0])) - 8U)), ((Os_StackPtrType)(Os_OsTask_10ms_Stack))},
    {((Os_StackPtrType)((&(Os_OsTask_50ms_Stack)[0]) + (sizeof(Os_OsTask_50ms_Stack) / sizeof((Os_OsTask_50ms_Stack)[0])) - 8U)), ((Os_StackPtrType)(Os_OsTask_50ms_Stack))},
    {((Os_StackPtrType)((&(Os_OsTask_100ms_Stack)[0]) + (sizeof(Os_OsTask_100ms_Stack) / sizeof((Os_OsTask_100ms_Stack)[0])) - 8U)), ((Os_StackPtrType)(Os_OsTask_100ms_Stack))},
    {((Os_StackPtrType)((&(Os_TaskStack_Idle_Core0)[0]) + (sizeof(Os_TaskStack_Idle_Core0) / sizeof((Os_TaskStack_Idle_Core0)[0])) - 8U)), ((Os_StackPtrType)(Os_TaskStack_Idle_Core0))},
...
const Os_TaskCfgType Os_TaskCfg[(7U)] =
{
       

	{
        (Os_EventMaskType)0x0ULL,                      
	...
	{
        (Os_EventMaskType)0x0ULL,                      
        &Os_TaskEntry_OsTask_1ms,	 
           
        {((Os_StackPtrType)((&(Os_OsTask_1ms_Stack)[0]) + (sizeof(Os_OsTask_1ms_Stack) / sizeof((Os_OsTask_1ms_Stack)[0])) - 8U)), ((Os_StackPtrType)(Os_OsTask_1ms_Stack))},
         
        1U,   
        6U,   
        ((Os_AppModeType)0x0000U),	 
        0x1U,	 
        0U,                     
        ((Os_CoreIdType)0U),
    },
    ...
    {
        (Os_EventMaskType)0x0ULL,              
       	&Os_TaskEntry_IdleCore0,			 
           
        {((Os_StackPtrType)((&(Os_TaskStack_Idle_Core0)[0]) + (sizeof(Os_TaskStack_Idle_Core0) / sizeof((Os_TaskStack_Idle_Core0)[0])) - 8U)), ((Os_StackPtrType)(Os_TaskStack_Idle_Core0))},
		 
        1U,									 
		0U,									 
		((Os_AppModeType)0xFFFFU),						 
		0x1U,					 
        0U,                                  
        ((Os_CoreIdType)0U),
    }
...
const Os_StackType* const Os_SystemStack_Inf[(1U)] =
...
const Os_TaskType Os_TASK_IDLE_Inf[(1U)] =
...
const uint16 Os_CfgPriorityMax_Inf[(1U)] =
...
const Os_TaskPropertyType Os_TaskIdRange[(1U)] = 
{
       
    {
        {CFG_BASIC_TASK_ID_CORE0_BEGIN, (Os_TaskType)(OS_TASK_IDLE_CORE0 + 1U)}, 
        {INVALID_TASK, INVALID_TASK}, 
        {CFG_BASIC_TASK_ID_CORE0_BEGIN, CFG_BASIC_TASK_ID_CORE0_END}, 
    },
