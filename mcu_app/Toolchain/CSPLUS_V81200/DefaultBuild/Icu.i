 ...
 
{
  ...
  if ((boolean)0x01 == Icu_GblDriverStatus)
  {
     
     
    (void)Det_ReportError(122U, 0U,
                                    (uint8)0x00, (uint8)0x17);
    LddReturnValue = 0U;
  }  
  else
  {
  ...
  if (((void *)0) == ConfigPtr)
  {
        ...
        (void)Det_ReportError(122U, 0U, (uint8)0x00,
          (uint8)0x0D);
  ...
  if (1U == LddReturnValue)
  {
    ...
    if ( (uint32)(((uint32)59U << 22U) | ((uint32)122U << 14U) | ((uint32)1U << 8U) | ((uint32)1U << 3U)) == (ConfigPtr->ulStartOfDbToc))
     ...
     
    {
      ...
      for (LucChannelNo = (uint8)0x00; LucChannelNo < 8U;
                                                                LucChannelNo++)
      {
        ...
        LpRamData->uiResultComplete = (boolean)0x00;
         
         
        LpRamData->uiWakeupEnable = (boolean)0x00;
         
         
        LpRamData->uiNotificationEnable = (boolean)0x00;

         
        LpRamData->uiChannelMeasurementRunning = (boolean)0x00;
         

         
        Icu_GaaChannelMeasureStatus[LucChannelNo] = (uint8)0x00;
      }  

       
      Icu_HW_Init();
       
      Icu_GblDriverStatus = (boolean)0x01;
       
       
      Icu_GenModuleMode = ICU_MODE_NORMAL;
       
      Icu_GulWakeupSource = (EcuM_WakeupSourceType) 0x00000000;
    }  
 ...
 void Icu_DeInit(void)
{
  ...
  if ((boolean)0x01 != Icu_GblDriverStatus)
  {
    ...
    (void)Det_ReportError (122U, 0U, (uint8)0x01,
                                                                 (uint8)0x14);
    LddReturnValue = 0U;
  }  
  else
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_GblDriverStatus = (boolean)0x00;
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    if ((boolean)0x00 == Icu_GpChannelConfig[Channel].uiIcuWakeupCapability)
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_GpChannelRamData[Channel].uiWakeupEnable = (uinteger)(boolean)0x00;
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_GpChannelRamData[Channel].uiWakeupEnable = (uinteger)(boolean)0x01;
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    if (LddReturnValue == 1U)
    {
       
       
      if ((uinteger)(boolean)0x00 ==
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_GpChannelRamData[Channel].uiNotificationEnable = (uinteger)(boolean)0x00;
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_GpChannelRamData[Channel].uiNotificationEnable = (uinteger)(boolean)0x01;
    ...
    if ((boolean)0x01 == Icu_GpChannelConfig[Channel].uiIcuWakeupCapability)
 ...
 
{
  ...
  if ((uint8)0x00 == BufferSize)
   
  {
     
    (void)Det_ReportError (122U, 0U,
                         (uint8)0x09, (uint8)0x0E);
    LddReturnValue = 0U;
  }  
  else
  {
  ...
  if ((uint8)0x01 > NotifyInterval)
   
  {
     
    (void)Det_ReportError (122U, 0U,
                         (uint8)0x09, (uint8)0x18);
    LddReturnValue = 0U;
  }  
  else
  {
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_HW_StartCountMeasurement(Channel, (uint8)0x09);

     
     
    SchM_Enter_Icu_ICU_TIMESTAMP_DATA_PROTECTION();
    ...
    LpRamData->uiChannelMeasurementRunning = (uinteger)(boolean)0x01;
    ...
    SchM_Exit_Icu_ICU_TIMESTAMP_DATA_PROTECTION();
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    if (1U == LddReturnValue)
    {
      ...
      if ((boolean)0x00 == LpRamData->uiChannelMeasurementRunning)
      {
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_HW_StopCountMeasurement(Channel, (uint8)0x0A);
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    if (((void *)0) != Icu_GpTimeStampData[LucIndex].pBufferPointer)
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_HW_StartCountMeasurement(Channel, (uint8)0x0D);
    ...
    LpRamData->uiChannelMeasurementRunning = (boolean)0x01;
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_HW_StopCountMeasurement(Channel, (uint8)0x0E);
 ...
 
{
...

  {
    ...
    if ((uint8)0x00 == Icu_GpChannelConfig[Channel].uiIcuChannelType)
    ...
    else
    {
        ...
        Icu_HW_StartCountMeasurement(Channel, (uint8)0x16);
    } 
    ...
    Icu_GpChannelRamData[Channel].uiChannelMeasurementRunning = (boolean)0x01;
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    else
    {
      ...
      Icu_HW_StopCountMeasurement(Channel, (uint8)0x17);
    }
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_HW_StartCountMeasurement(Channel, (uint8)0x13);
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_HW_StopCountMeasurement(Channel, (uint8)0x14);
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    SchM_Enter_Icu_ICU_SIGNALMEASURE_DATA_PROTECTION();
    ...
    if ((uinteger)(boolean)0x01 == Icu_GpChannelRamData[Channel].uiResultComplete)
     ...
     
    {
       ...
       
      {
        ...
        LpSignalMeasurementData->ulSignalActiveTime = (uint8)0x00;
      } 
      ...
      else  
      {
        ...
        LpSignalMeasurementData->ulSignalPeriodTime = (uint8)0x00;
    ...
    SchM_Exit_Icu_ICU_SIGNALMEASURE_DATA_PROTECTION();
 ...
 
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    if (((void *)0) == DutyCycleValues)
    {
       
      (void)Det_ReportError(122U, 0U,
                      (uint8)0x11, (uint8)0x0A);
      LddReturnValue = 0U;
    }  
    else
    {
  ...
  if (1U == LddReturnValue)
  {
    ...
    DutyCycleValues->ActiveTime = (uint8)0x00;
     
     
    DutyCycleValues->PeriodTime = (uint8)0x00;
 ...
 
{
 ...
 Icu_CounterValueType Icu_GetTAUInCountValue
(Icu_ChannelType Channel)
 
{
  ...
  LddTAUInCounterValue = (uint32)0x00000000;
 ...
 void Icu_SynchronousInit(void)
{
  ...
  if ((boolean)0x01 == Icu_GblSyncInitStatus)
  {
     
    (void)Det_ReportError(122U, 0U,
                      (uint8)0x1A, (uint8)0x17);
    LddReturnValue = 0U;
  }  
  else
  {
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_GblSyncInitStatus = (boolean)0x01;
  }
  else
  {
 ...
 void Icu_SynchronousStart(void)
{
  ...
  if (((boolean)0x01 != Icu_GblDriverStatus) ||
                                   ((boolean)0x01 != Icu_GblSyncInitStatus))
  {
     
    (void)Det_ReportError (122U, 0U,
                                  (uint8)0x1B, (uint8)0x14);
    LddReturnValue = 0U;
  }  
  else
  {
  ...
  if ((boolean)0x01  ==  Icu_GblSyncStartStatus)
  {
     
    (void)Det_ReportError(122U, 0U,
                   (uint8)0x1B, (uint8)0xF3);
    LddReturnValue = 0U;
  }  
  else
  {
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_GblSyncStartStatus = (boolean)0x01;
  }  
  else
  {
 ...
 void Icu_SynchronousStop(void)
{
  ...
  if (1U == LddReturnValue)
  {
    ...
    Icu_GblSyncStartStatus = (boolean)0x00;
  }  
  else
  {
 ...
 void Icu_SynchronousDeInit(void)
{
                                   ...
                                   ((boolean)0x01 == Icu_GblSyncInitStatus))
  {
    ...
    Icu_GblSyncInitStatus = (boolean)0x00;
  }
  else
  {
     
    (void)Det_ReportError (122U, 0U,
                                  (uint8)0x1D, (uint8)0x14);
  }
}  
 ...
 
{
  ...
  else
  {
    ...
    versioninfo->moduleID = (uint16)122U;
     
    versioninfo->sw_major_version = 1U;
     
    versioninfo->sw_minor_version = 1U;
     
    versioninfo->sw_patch_version = 8U;
  }
}
 ...
 Std_ReturnType Icu_CheckHWConsistency
                                   (Icu_HWConsistencyModeType HWConsistencyMode)
