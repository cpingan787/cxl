...
extern void SchM_Enter_Wdg_59_DriverB_WDG_59_DRIVERB_MODE_SWITCH_PROTECTION(void);
extern void SchM_Exit_Wdg_59_DriverB_WDG_59_DRIVERB_MODE_SWITCH_PROTECTION(void);

extern void SchM_Enter_Wdg_59_DriverB_WDG_59_DRIVERB_TRIGG_PROTECTION(void);
extern void SchM_Exit_Wdg_59_DriverB_WDG_59_DRIVERB_TRIGG_PROTECTION(void);
...
extern uint8
  Wdg_59_DriverB_GaaRamMirror[(0x02u)];
...
extern const Wdg_59_DriverB_ConfigType *Wdg_59_DriverB_GpConfigPtr;
...
extern uint16 Wdg_59_DriverB_GusTriggerCounter;
...
extern  void
                    Wdg_59_DriverB_TriggerFunc(boolean LblCriticalSectionFlag);
  ...
  ConfigPtr)
{
 ...
 
  {
    ...
    if (((((uint32) 59U) << 22) | (((uint32)102U) << 14) | ((uint32)(1U) << 8) | (((uint32)0U) << 3)) == (ConfigPtr->ulStartOfDbToc))
    {
      {
        ...
        (*((volatile uint8*)(WDG_59_DriverB_GpICR_BaseAddr)) = ((*((volatile uint8*)(WDG_59_DriverB_GpICR_BaseAddr)))&(0x7FU)));
...

        {
          ...
          { (*((&WDG_59_DriverB_GpWDTAReg_BaseAddr->ucMD))) = ((LucMD)); (*((&Wdg_59_DriverB_GaaRamMirror[(0x01u)]))) = ((LucMD)); }
          ...
          Wdg_59_DriverB_TriggerFunc((boolean)0x00);
        }
 ...
 Std_ReturnType Wdg_59_DriverB_SetMode
  (WdgIf_ModeType Mode)
{
        ...
        else
    {
      ...
      if (WDGIF_OFF_MODE == Wdg_59_DriverB_GddCurrentMode)
      {
        ...
        if (WDGIF_SLOW_MODE == Mode)
        {
          ...
          SchM_Enter_Wdg_59_DriverB_WDG_59_DRIVERB_MODE_SWITCH_PROTECTION();
          ...
          SchM_Exit_Wdg_59_DriverB_WDG_59_DRIVERB_MODE_SWITCH_PROTECTION();
           ...
           SchM_Enter_Wdg_59_DriverB_WDG_59_DRIVERB_TRIGG_PROTECTION();

            
           Wdg_59_DriverB_GusTriggerCounter = (uint16)1000 /
           ...
           SchM_Exit_Wdg_59_DriverB_WDG_59_DRIVERB_TRIGG_PROTECTION();
        }
 ...
 void Wdg_59_DriverB_SetTriggerCondition
                                                            (uint16 timeout)
{
  ...
  LddReturnValue = 1U;
   {
    ...
    {
      if (WDG_59_DriverB_GpWDTAReg_BaseAddr->ucMD ==                      Wdg_59_DriverB_GaaRamMirror[(0x01u)])
      {
        LddReturnValue = 0U;
      }
      else
