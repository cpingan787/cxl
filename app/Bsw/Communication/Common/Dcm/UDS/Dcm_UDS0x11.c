...
#define DCM_APP_0X11_EPTRDYV_VALID_VALUE    ((uint8)0u)   //0:有效
#define DCM_APP_0X11_EPTRDY_NOT_READY_VALUE ((uint8)0u)   //0:未就绪
#define DCM_APP_0X11_VEHSPD_VALID_VALUE     ((uint8)0u)   //0:有效
#define DCM_APP_0X11_VEHSPD_THRESHOLD_RAW   ((uint16)256u)   //车速小于4km/h，4 / 0.015625 = 256，物理车速4对应256
...
{                                                                             
    ...
    if ((comRet != E_OK) || (EPTRdy != DCM_APP_0X11_EPTRDY_NOT_READY_VALUE)) 
    {                                                                         
        *ErrorCode = (Dcm_NegativeResponseCodeType)0x83u;                     
        return E_NOT_OK;                                                      
    }                                                                         
    ...
    if ((comRet != E_OK) || (VehSpdAvg >= DCM_APP_0X11_VEHSPD_THRESHOLD_RAW))
    {                                                                         
        *ErrorCode = (Dcm_NegativeResponseCodeType)0x88u;                     
        return E_NOT_OK;                                                      
    }                                                                         
