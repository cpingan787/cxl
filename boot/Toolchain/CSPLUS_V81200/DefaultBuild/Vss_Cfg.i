...
const uint8_t ecc_public_key[(65)] = {
...
static uint32_t VssConfig_VSNActiveRw(VssFlashOperaType_e rwflag, uint8_t keyId, uint8_t *pData, uint32_t pLength)
{
    ...
    if (rwflag == VSS_FLASH_Write)
    {
        ...
        tem = EEIf_Write(addrOffset, 0x01u, pData);
        if (tem != 0U)
        {
            ret = 0x1D; 
        }
    ...
    else if (rwflag == VSS_FLASH_Read)
    {
        ...
        tem = EEIf_Read(addrOffset, 0x01u, pData);
        if (tem != 0U)
        {
            ret = 0x1C; 
        }
...
static uint32_t VssConfig_SM4CmacKeyByindex(VssFlashOperaType_e rwflag, uint8_t keyId, uint8_t *pData, uint32_t pLength)
{
    ...
    if (rwflag == VSS_FLASH_Write)
    {
        ...
        uint32_t addrOffset = SM4_KEY_IDX + keyId * (16);
        uint8_t tem = 1U;
        
        tem = EEIf_Write(addrOffset, (16), pData);
        if (tem != 0U)
        {
            ret = 0x1D; 
        }
    ...
    else if (rwflag == VSS_FLASH_Read)
    {
        ...
        tem = EEIf_Read(addrOffset, (16), pData);
        if (tem != 0U)
        {
            ret = 0x1C; 
        }
...
static uint32_t VssConfig_SM2KeyByindex(VssFlashOperaType_e rwflag, uint8_t keyId, uint8_t *pData, uint32_t pLength)
{
    ...
    if (rwflag == VSS_FLASH_Write)
    {
        ...
        uint32_t addrOffset = SM2_KEY_IDX + keyId * (65);
        uint8_t tem = 1U;
...
static uint32_t VssConfig_Ecc256KeyByindex(VssFlashOperaType_e rwflag, uint8_t keyId, uint8_t *pData, uint32_t pLength)
{
    ...
    if (rwflag == VSS_FLASH_Write)
    {
        ...
        uint32_t addrOffset = ECC256_KEY_IDX + keyId * (65);
        uint8_t tem = 1U;
        
        tem = EEIf_Write(addrOffset, (65), pData);
        if (tem != 0U)
        {
            ret = 0x1D; 
        }
    ...
    else if (rwflag == VSS_FLASH_Read)
    {
        ...
        tem = EEIf_Read(addrOffset, (65), pData);
        if (tem != 0U)
        {
            ret = 0x1C; 
        }
