 ...
 *  V2.1.28   20250522  tong.zhao     Modify the logical for ComTxModeFalseRefId when PduIdTypeEnum is 8bit.
 *  V2.1.29   20250528  tong.zhao     Modify notify and error notify about Signal and SignalGroup.
 *  V2.1.30   20251020  jianyu.yang   In the mainfunction remove Com_TX_TRANSMITING_EN condition check before sending.
 ******************************************************************************/
...
/**
  ...
  RuleSource:puhua-rule.rcf 3.0.0
    ...
    \li VL_Com_2932
      Reason: Offset index of pointer is valid
      Risk: No risk.
      Prevention: Code review and full test.

    \li VL_Com_2983
      Reason: Under another configuration of Com this vaule is usefull.
      Risk: No risk.
      Prevention: Code review and full test.
  ...
  and protocols and user configuration
    ...
    \li VL_Com_ResultAlwaysFalse
      Reason:The result will be changed to true when the configuration is modified.
      Risk:The test branch may be incomplete.
      Prevention:Code inspection and test of the different configurations in the component test.

    \li VL_Com_1753
      Reason:Customized external interface
      Risk: No risk.
...
#define COM_SW_PATCH_VERSION            30u
...
*******************************************************************************/
#define COM_UNUSED_RXIPDUCOUNTERID       (Com_RxIPduCounterIdType)(~(Com_RxIPduCounterIdType)0)
#define COM_UNUSED_RXIPDUGROUPID         (Com_RxIpduGroupIdType)(~(Com_RxIpduGroupIdType)0)
#define COM_UNUSED_TXIPDUGROUPID         (Com_TxIpduGroupIdType)(~(Com_TxIpduGroupIdType)0)
#define COM_UNUSED_RXSIGTIMEOUTID        (Com_RxSigTimeoutIdType)(~(Com_RxSigTimeoutIdType)0)
#define COM_UNUSED_RXSIGGRPTIMEOUTID     (Com_RxSigGrpTimeoutIdType)(~(Com_RxSigGrpTimeoutIdType)0)
#define COM_UNUSED_GWSOURCEDESCRIPTIONID (Com_GwSourceDescriptionIdType)(~(Com_GwSourceDescriptionIdType)0)
#define COM_UNUSED_RXSIGNALID            (Com_RxSignalIdType)(~(Com_RxSignalIdType)0)
#define COM_UNUSED_RXSIGNALGROUPID       (Com_RxSignalGroupIdType)(~(Com_RxSignalGroupIdType)0)
#define COM_UNUSED_GWDESTINATIONDESCRIPTIONID \
    (Com_GwDestinationDescriptionIdType)(~(Com_GwDestinationDescriptionIdType)0)
#define COM_UNUSED_TXSIGNALID             (Com_TxSignalIdType)(~(Com_TxSignalIdType)0)
#define COM_UNUSED_TXSIGNALGROUPID        (Com_TxSignalGroupIdType)(~(Com_TxSignalGroupIdType)0)
#define COM_UNUSED_TXIPDUCOUNTERID        (Com_TxIPduCounterIdType)(~(Com_TxIPduCounterIdType)0)
#define COM_UNUSED_RXSIGNALINVALIDID      (Com_RxSignalInvalidIdType)(~(Com_RxSignalInvalidIdType)0)
#define COM_UNUSED_RXSIGNALFILTERID       (Com_RxSignalFilterIdType)(~(Com_RxSignalFilterIdType)0)
#define COM_UNUSED_SIGNALPOSITION         (Com_SignalPositionType)(~(Com_SignalPositionType)0)
#define COM_UNUSED_TXSIGNALINVALIDID      (Com_TxSignalInvalidIdType)(~(Com_TxSignalInvalidIdType)0)
#define COM_UNUSED_TXSIGNALFILTERID       (Com_TxSignalFilterIdType)(~(Com_TxSignalFilterIdType)0)
#define COM_UNUSED_TXSIGERRANDNOTIFYID    (Com_TxSigErrAndNotifyIdType)(~(Com_TxSigErrAndNotifyIdType)0)
#define COM_UNUSED_TXSIGNALTIMEOUTID      (Com_TxSignalTimeoutIdType)(~(Com_TxSignalTimeoutIdType)0)
#define COM_UNUSED_RXGROUPSIGNALID        (Com_RxGroupSignalIdType)(~(Com_RxGroupSignalIdType)0)
#define COM_UNUSED_TXGROUPSIGNALID        (Com_TxGroupSignalIdType)(~(Com_TxGroupSignalIdType)0)
#define COM_UNUSED_TXSIGGRPERRANDNOTIFYID (Com_TxSigGrpErrAndNotifyIdType)(~(Com_TxSigGrpErrAndNotifyIdType)0)
#define COM_UNUSED_TXSIGGRPTIMEOUTID      (Com_TxSigGrpTimeoutIdType)(~(Com_TxSigGrpTimeoutIdType)0)
#define COM_UNUSED_RXGRPSIGFILTERID       (Com_RxGrpSigFilterIdType)(~(Com_RxGrpSigFilterIdType)0)
#define COM_UNUSED_TXGRPSIGFILTERID       (Com_TxGrpSigFilterIdType)(~(Com_TxGrpSigFilterIdType)0)
#define COM_UNUSED_DESTSIGNALFILTERID     (Com_DestSignalFilterIdType)(~(Com_DestSignalFilterIdType)0)
#define COM_UNUSED_COM_RXIPDUBUFID        (Com_RxIpduBufIdType)(~(Com_RxIpduBufIdType)0)
#define COM_UNUSED_COM_TXIPDUBUFID        (Com_TxIpduBufIdType)(~(Com_TxIpduBufIdType)0)
#define COM_UNUSED_COM_SIGNALGROUPARRYID  (Com_SignalGroupArryIdType)(~(Com_SignalGroupArryIdType)0)
#define COM_UNUSED_COM_PDUID              (PduIdType)(~(PduIdType)0)
/*******************************************************************************
**                      Global Data                                           **
*******************************************************************************/
/*define in Com.c*/
...
uint8 Com_GetSatelliteData(void);
void Com_IncreaseSatelliteData(void);
void Com_SetSatelliteData(uint8 data);
#endif /*end of COM_H*/
/*******************************************************************************
**                      End of file                                           **
*******************************************************************************/
