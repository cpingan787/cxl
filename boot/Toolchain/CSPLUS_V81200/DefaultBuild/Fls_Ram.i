...
Fls_FcuDataType Fls_GstFcuVar;

 
const Fls_ConfigType * Fls_GpConfigPtr;
 
 
const Fls_DmaUnitConfig *Fls_GpDmaUnitConfig;

 
 
volatile Fls_GstVarProperties Fls_GstVar;

 
 
volatile Fls_GstVarProperties Fls_GstBackUpVar;
...
volatile MemIf_JobResultType Fls_GenJobResult = MEMIF_JOB_OK;

 
 
 
volatile MemIf_StatusType Fls_GenState = MEMIF_UNINIT;

 
 
 
MemIf_ModeType Fls_GenCurrentMode = MEMIF_MODE_SLOW;
...
boolean Fls_GblInitStatus = (boolean)0;
 
 
volatile boolean Fls_GblTimeOutMonitor = (boolean)0;
...
volatile boolean Fls_GblJobSuspended;
 
volatile boolean Fls_GblJobSuspendRequest;
...
volatile uint32 Fls_GulTimeOutCounter;
