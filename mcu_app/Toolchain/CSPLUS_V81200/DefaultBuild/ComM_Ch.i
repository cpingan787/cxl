...
static const ComM_ChannelConfigType * ComM_ChannelConfigPtr;
...
static ComM_ChVarType ComM_ChVarTable[1u];
...
static void ComM_ChStateTransitionToNoCom(uint32 chIdx, uint32 currentReqCnt);
static void ComM_ChBeh_EntryFullCom(uint32 chIdx, uint32 currentReqCnt);
static void ComM_ChBeh_EntryComReadySleep(uint32 chIdx);
static void ComM_ChBeh_EntrySlientMode(uint32 chIdx);
static void ComM_ChannelNmModeEventHandle(NetworkHandleType Channel, uint32 currentReqCnt);
...
static  void ComM_ChBeh_EntryFullComReq(uint32 chIdx, uint32 currentReqCnt)
{
    ...
    chVarPtr->specMode = 2u;

    boolean passiveWakeup = ComM_CommonGetBit(chVarPtr->funcMask, 0x2u);
    ...
    if ((oldSepcMode != 2u) && ((chCfgPtr->nmVariant & nmVariantMask) != 0u))
    {
        ...
        if (passiveWakeup)
        {
            ...
            if (nmRet == 0U)
            {
                ...
                ComM_CommonSetBit(chVarPtr->funcMask, 0x6u);
    ...
    SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
    ComM_CommonClrBit(chVarPtr->funcMask, 0x2u);
    SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();
}
...
static  void ComM_ChBeh_EntryNoComRequestPending(uint32 chIdx, uint32 currentReqCnt)
{
    ComM_ChVarType* chVarPtr = &ComM_ChVarTable[chIdx];
    chVarPtr->specMode = 1u;
    


 
    if (ComM_CommonGetBit(chVarPtr->funcMask, 0x0u))
    {
...
static  void ComM_ChBeh_EntryNoCom(uint32 chIdx)
{
    ComM_ChVarType* chVarPtr = &ComM_ChVarTable[chIdx];
    chVarPtr->specMode = 0u;
    const ComM_ChannelConfigType* chCfgPtr = &ComM_ChannelConfigPtr[chIdx];
    

 
    if (((void *)0) != chCfgPtr->busSmCfgType)
    {

        chVarPtr->busSmReqMode = 0u;

        (void)chCfgPtr->busSmCfgType->busSm_RequestComMode(chCfgPtr->busIndex, 0u);
    }
    

 
    if ((chCfgPtr->nmVariant == 0x01u) && (ComM_CommonGetBit(chVarPtr->funcMask, 0x6u)))
    {
        SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
        ComM_CommonClrBit(chVarPtr->funcMask, 0x6u);
        SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();
...
static  void ComM_ChBeh_EntryFullCom(uint32 chIdx, uint32 currentReqCnt)
{
    ...
    if ((((void *)0) != chCfgPtr->busSmCfgType)
        && ((oldState != 3u) && (oldState != 2u)))
    {
        ComM_ModeType busSmReqMode = 2u;
        


 
        if ((chVarPtr->busSmIndMode != 2u) || (chVarPtr->busSmReqMode != busSmReqMode)
...
static  void ComM_ChBeh_EntrySlientMode(uint32 chIdx)
{
    ...
    if (((void *)0) != chCfgPtr->busSmCfgType)
    {
        ...
        chVarPtr->busSmReqMode = 1u;
        SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();

        (void)chCfgPtr->busSmCfgType->busSm_RequestComMode(chCfgPtr->busIndex, 1u);
    }
}
...
static void ComM_ChReqModeMainHandle(uint8 chIdx)
{
    ComM_ChVarType* chVarPtr = &ComM_ChVarTable[chIdx];
    uint32 currentReqCnt = chVarPtr->reqCnt;
    const ComM_ChannelConfigType* chCfgPtr = &ComM_ChannelConfigPtr[chIdx];
    if ((chCfgPtr->nmVariant == 0x01u) || (chCfgPtr->nmVariant == 0x08u))
    {
    ...
    SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();
    if ((modeReq == 2u) || (modeReq == 3u)
        || ComM_CommonGetBit(chVarPtr->funcMask, 0x2u))
    {
...
static void ComM_ChStateTransitionToNoCom(uint32 chIdx, uint32 currentReqCnt)
{
    ...
    do
    {
        ...
        case 2u:
            ...
            if (ComM_CommonGetBit(chVarPtr->funcMask, 0x4u))
            {
        ...
        case 1u:
            ...
            if ((chVarPtr->reqCnt == 0u) && !ComM_CommonGetBit(chVarPtr->funcMask, 0x2u))
            {
...
void ComM_ChInit(const ComM_ChannelConfigType* channelConfigPtr, uint32 chNum)
{
    ...
    for (uint32 chIdx = 0u; chIdx < chNum; chIdx++)
    {
        ...
        chVarPtr->busSmIndMode = 0u;
        chVarPtr->reqCnt = 0u;
        chVarPtr->reqMask = chCfgPtr->requestMask;

        chVarPtr->funcMask[0] = 0u;
        chVarPtr->NmModeEvent = 0x5u;



        for (uint32 i = 0u; i < chCfgPtr->requestMaskLen; i++)
        {
 ...
 void ComM_ChComAllow(uint32 chIdx, boolean allowed)
{
    ...
    {
        SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
        ComM_CommonSetBit(chVarPtr->funcMask, 0x0u);
        SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();
    }
    else
    {
        SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
        ComM_CommonClrBit(chVarPtr->funcMask, 0x0u);
        SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();
    }
}
 ...
 void ComM_ChBusSmModeInd(uint32 chIdx, ComM_ModeType comMode)
{
    ...
    if (comMode != ComM_ChVarTable[chIdx].busSmIndMode)
    {
        ...
        if (((void *)0) != chCfgPtr->dcmNotifyIdPtr)
        {
            switch (comMode)
            {
            case 2u:
 ...
 Std_ReturnType ComM_ChRequstCommMode(uint32 chIdx, uint32 reqIdex, ComM_ModeType comMode)
{
    ...
    const ComM_ChannelConfigType* chCfgPtr = &ComM_ChannelConfigPtr[chIdx];
    if (chCfgPtr->nmVariant != 0x08u)
    {
        if (!ComM_CommonGetBit(chVarPtr->reqMask, reqIdex)
            && ((comMode == 2u) || (comMode == 3u)))
        {
            SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
        ...
        else if (ComM_CommonGetBit(chVarPtr->reqMask, reqIdex) && (comMode == 0u))
        {
            SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
 ...
 void ComM_ChEcuMWakeup(uint32 chIdx)
{
    ...
    if (chVarPtr->specMode == 0u)
    {
        SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
        ComM_CommonSetBit(chVarPtr->funcMask, 0x2u);
        SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();
    }
}
 ...
 void ComM_ChDiagIndication(uint32 chIdx, boolean flag)
{
    ...
    if (1u == flag)
    {
        ...
        if (0u != (chCfgPtr->nmVariant & 0x1u))
        {
            (void)ComM_ChRequstCommMode(chIdx, chCfgPtr->dcmInReqIdx, 2u);
        }
    }
    else
    {
        (void)ComM_ChRequstCommMode(chIdx, chCfgPtr->dcmInReqIdx, 0u);
    }
}



static void ComM_ChannelStoreNmModeEvent(uint8* Object, uint8 Desired)
{
    SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
    *Object = Desired;
    SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();
...
static boolean ComM_ChannelCompareAndClearNmModeEvent(uint8* Object, uint8 Expected)
{
    boolean equal = 0u;
    SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
    if (*Object == Expected)
...
static void ComM_ChannelNmModeEventHandle(NetworkHandleType Channel, uint32 currentReqCnt)
{
    ...
    if (ComM_ChannelCompareAndClearNmModeEvent(&chVarPtr->NmModeEvent, 0x1u))
    {
        
 
        if (chVarPtr->specMode == 3u)
        {
            ComM_ChBeh_EntrySlientMode(Channel);
        }
    }

    if (ComM_ChannelCompareAndClearNmModeEvent(&chVarPtr->NmModeEvent, 0x3u))
    {
        if (chVarPtr->specMode == 4u)
        {
            ComM_ChBeh_EntryFullCom(Channel, currentReqCnt);
        }
    }

    if (ComM_ChannelCompareAndClearNmModeEvent(&chVarPtr->NmModeEvent, 0x0u))
    {
        if ((chVarPtr->specMode != 0u)
            && (chVarPtr->specMode != 1u))
        {
