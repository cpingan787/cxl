...
/* BEGIN_FUNCTION_HDR
************************************************************************************************
* Function Name : BootM_GetCounterValue
* Description   : This function is used for getting counter value directly without mode switch.
*
* Inputs        : counterId: Counter ID
*                 value: Pointer to store counter value
*
* Outputs       : none
*
* Limitations   : This function should only be used in BootM module during initialization.
*
************************************************************************************************
END_FUNCTION_HDR */
static void BootM_GetCounterValue(uint32 counterId, uint16* value)
{
    /* Directly read counter value without mode switch */
...
static uint8 BootM_StayInBootProcess(void)
{
    ...
    while(((CurrentSIBTimer - StartSIBTimer) < BOOTM_SIB_REQUEST_TIME) && (isValidSIBRequest == 0));
