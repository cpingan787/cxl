...
extern const CanIf_ControllerCfgType CanIf_CtrlCfgData[1u];

 
extern const Can_DriverApiType Can_DriverApi[1u];

extern CanIf_TxBufferType CanIf_TxBuffer[1u];


extern CanIfRxPduUserRxIndicationNameApiType CanIf_UpRxIndicationArray[4u];
extern CanIfTxPduUserTxConfirmationNameApiType CanIf_UpTxConfirmationArray[3u];
...
extern  void CanIf_InitTxBuffer(void);

extern  Std_ReturnType CanIf_TxBusyHandle(const Can_PduType * pduPtr);

extern  void CanIf_FreeControllerTxBuffer(uint8 Controller);

extern  void CanIf_TransmitBufferedPdu(PduIdType CanTxPduId);
...
extern  void CanIf_FreeDynamicTxPduCanIds(uint8 Controller);

extern  void CanIf_InitDynamicTxPduCanId(void);
...
static CanIf_InitStatusType CanIf_InitStatus = CANIF_UNINIT;
...
const CanIf_ConfigType * CanIf_ConfigStd = ((void *)0);
...
static CanIf_NotifStatusType CanIf_TxConfirmationState[1u];
...
static CanIf_PduModeType CanIf_PduMode[1u];
...
static CanIf_ControllerModeType CanIf_ControllerMode[1u];
...
static  void CanIf_FreeBufInStopped(uint8 Controller);

static  void CanIf_InitAllBuffer(void);

static  Std_ReturnType CanIf_SetControllStarted(uint8 Controller);

static  Std_ReturnType CanIf_SetControllSleep(uint8 Controller);

static  Std_ReturnType CanIf_SetControllStopped(uint8 Controller);

static  void CanIf_PduPack(
    PduIdType CanTxPduId,
    const PduInfoType * PduInfoPtr,
    Can_PduType * canPdu);

static  Std_ReturnType
    CanIf_CanIdRangCheck(Can_HwHandleType hrhId, CanIf_IdType canId, PduIdType * pduIdIndex);

static  Std_ReturnType CanIf_RxPduHrhSearchByLinear(
...
static  Std_ReturnType
    CanIf_GetPduHrh(PduIdType pduIdIndex, CanIf_IdType CanId, PduIdType * rxPduIndex);

static  void CanIf_RxIndicationHandle(
    PduIdType pduIdIndex,
    const PduInfoType * PduInfoPtr);

static  Std_ReturnType
    CanIf_TransmitHandle(PduIdType CanIfTxSduId, const PduInfoType * PduInfoPtr);
...
CanIf_Init(const CanIf_ConfigType * ConfigPtr)
{
    uint8 canLoop;
    {
        ...
        if (CANIF_INITED != CanIf_InitStatus)
        {
            ...
            for (canLoop = 0u; canLoop < 1u; canLoop++)
            {
...
CanIf_Transmit(PduIdType CanIfTxSduId, const PduInfoType * PduInfoPtr)
{
...

    {
        ...
        {
            (void)Det_ReportRuntimeError(60u, 0u, ((0x05u)), ((62u)));
        }
    }
    return result;
}
...
{
    {
        const CanIf_TxPduConfigType* txPduConfigPtr = &CanIf_ConfigStd->CanIfTxPduConfigRef[(CanTxPduId)];
        Can_HwHandleType hthIndex = txPduConfigPtr->CanIfTxPduHthId;
        Can_HwHandleType controllerId = CanIf_ConfigStd->CanIfHthCfgRef[(hthIndex)].CanIfHthCanCtrlId;
        ...
        if (((void *)0) != CanIf_UpTxConfirmationArray[txPduConfigPtr->CanIfUpTxConfApiIndex])
        {
...
{
    {
        ...
        CanIf_GetCanIfCtrlId(&controllerId, Mailbox->ControllerId);
        {
            ...
            Can_HwHandleType canIfHrhId = (Can_HwHandleType)CanIf_CanHoh2Hrh[CanIf_CtrlCfgData[(controllerId)]. CanDriverId]
                                              .CanIfCanHoh2HrhRef[Mailbox->Hoh];
            PduIdType rxPduIndex;
            if (0U == CanIf_CanIdRangCheck(canIfHrhId, canId, &rxPduIndex))
            {
                 
                if (CanIf_ConfigStd->CanIfRxPduConfigRef[(rxPduIndex)].CanIfRxPduDataLengthCheck
                    && (PduInfoPtr->SduLength < (CanIf_ConfigStd->CanIfRxPduConfigRef[(rxPduIndex)].CanIfRxPduDlc)))
                {
                    (void)Det_ReportRuntimeError(60u, 0u, ((0x14u)), ((61u)));
                }
                else
                {
...
{
    {
        ...
        CanIf_GetCanIfCtrlId(&controllerId, ControllerId);
        {
            ...
            SchM_Exit_CanIf_ExclusiveArea_Channel();
            if (((void *)0) != CanIf_DispatchConfigData.CanIfDispatchUserCtrlBusOffName)
            {
...
{
    {
         ...
         
        {
            ...
            SchM_Exit_CanIf_ExclusiveArea_Channel();
            if (((void *)0) != CanIf_DispatchConfigData.CanIfDispatchUserCtrlModeIndicationName)
            {
    ...
    Can_PduType * canPdu)
{
    ...
    case CANIF_TX_STANDARD_FD_CAN:
        canId |= (CanIf_IdType)(0x40000000u);
        break;
    default:  
        break;
    }
    ...
    PduIdType * rxPduIndex)
{
    ...
    const CanIfHrhCfgType* hrhConfigPtr = &CanIf_ConfigStd->CanIfHrhCfgRef[(hrhIndex)];
    ...
    for (cnt = 0u; cnt < hrhRefPduNum; cnt++)
    {
        ...
        rxPduConfigPtr = &CanIf_ConfigStd->CanIfRxPduConfigRef[(pduIdIndex)];
...
{
    Std_ReturnType result = 1U;
    const CanIf_RxPduConfigType* rxPduConfigPtr = &CanIf_ConfigStd->CanIfRxPduConfigRef[(pduIdIndex)];
    if ((rxPduConfigPtr->CanIfRxCanIdRangeRef == ((void *)0))
        || ((rxPduConfigPtr->CanIfRxCanIdRangeRef != ((void *)0))
            && ((CanId & (0x1FFFFFFFu)) >= rxPduConfigPtr->CanIfRxCanIdRangeRef[0].CanIfRxPduLowerCanId)
            && ((CanId & (0x1FFFFFFFu)) <= rxPduConfigPtr->CanIfRxCanIdRangeRef[0].CanIfRxPduUpperCanId)))
    {
    ...
    const PduInfoType * PduInfoPtr)
{
    ...
    if (((void *)0) != CanIf_UpRxIndicationArray[rxPduConfigPtr->CanIfUpRxIndicationApiIndex])
    {
    ...
    CanIf_TransmitHandle(PduIdType CanIfTxSduId, const PduInfoType * PduInfoPtr)
{
    ...
    const CanIf_TxPduConfigType* txPduConfigPtr = &CanIf_ConfigStd->CanIfTxPduConfigRef[(CanIfTxSduId)];
     
    Can_HwHandleType hthConfigIndex = txPduConfigPtr->CanIfTxPduHthId;
     
    const CanIfHthCfgType* hthPtr = &CanIf_ConfigStd->CanIfHthCfgRef[(hthConfigIndex)];
     
    uint8 canControllerId = hthPtr->CanIfHthCanCtrlId;
    test_can=CanIf_ControllerMode[canControllerId];
    if (CANIF_CS_STARTED == CanIf_ControllerMode[canControllerId])
    {
        if (CANIF_ONLINE == CanIf_PduMode[canControllerId])
        {
            ...
            else if (CAN_BUSY == retVal)
            {
                ...
                if ((0U == result) && ((PduInfoPtr->SduLength) > (PduLengthType)(canPdu.length)))
                {
                    (void)Det_ReportRuntimeError(60u, 0u, ((0x05u)), ((62u)));
                }
            }
        ...
        {
            (void)Det_ReportRuntimeError(60u, 0u, ((0x05u)), ((70u)));
        }
    }
    else  
    {
