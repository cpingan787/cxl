...
/**
  ...
  RuleSorce:puhua-rule.rcf 2.3.1
    ...
    \li VL_QAC_Crypto
      Reason: Design implementation needs.
      Risk: No risk.
  ...
  design.
    ...
    \li VL_Crypto_62_1506
      Reason: The type name conflicts with the variable name, but its usage has no impact.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
