...
#define MCU_SYSN_VERSION "002" // mcu内部版本号
...
static const uint8_t g_F120[] = {0x00, 0x00, 0xAA, 0x55, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF};//size:16  did:F120
...
int16_t ProjectConfigSetMpuVersion(const uint8_t *pMpuVersion, uint16_t versionLen)
{
    ...
    else
    {
        ...
        // Ensure MCU version part remains unchanged 当前MPU只传输9位MPU版本号
