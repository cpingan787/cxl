/*************************************************
 ...
 Description: 车辆安全服务（VSS）模块类型定义头文件，包含错误码和枚举类型
 Others: 定义了VSS模块使用的各种数据类型和错误码
*************************************************/
#ifndef VSS_TYPES_H
#define VSS_TYPES_H
/****************************** include ***************************************/
 ...
 */
typedef enum {
    VSS_ITEM_VSN = 0,             // VSN数据
    VSS_ITEM_VSN_ACTIVE,           // VSN激活标志
    VSS_ITEM_SM4_KEY,              // SM4密钥
    VSS_ITEM_SM4_KEY_ACTIVE,       // SM4密钥激活标志
    VSS_ITEM_AES_KEY,              // AES密钥
    VSS_ITEM_AES_KEY_ACTIVE,       // AES密钥激活标志
    VSS_ITEM_SM2_KEY,              // SM2密钥
    VSS_ITEM_ECC256_KEY,           // ECC256密钥
    VSS_ITEM_MAX                   // 项类型最大值
} VssItemType_e;
 ...
 */
typedef enum {
    VSS_FLASH_Write = 0,    // 写入操作
    VSS_FLASH_Read,         // 读取操作
    VSS_OPERA_TYPE_MAX      // 操作类型最大值
} VssFlashOperaType_e;
