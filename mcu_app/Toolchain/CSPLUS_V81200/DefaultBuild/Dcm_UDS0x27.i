...
static  Std_ReturnType Dcm_Uds0x27ServiceSubfunctionCheck(
    uint8 ProtocolCtrlId,
    uint8 * SecCfgIndex,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
...
static  Std_ReturnType Dcm_Uds0x27ServiceActiveSecLevelCheck(uint8 ProtocolCtrlId, uint8 SeedSize)
{
    uint8 Index;
    Std_ReturnType ret = 0U;
...
static  Std_ReturnType Dcm_Uds0x27ServiceMsgLenCheck(
    Dcm_OpStatusType OpStatus,
    uint8 ProtocolCtrlId,
    uint8 SecCfgIndex,
    Dcm_NegativeResponseCodeType * ErrorCode)
    ...
    if (ReqLen != ReqCfgLen)
    {
            ...
            && (Dcm_SecCtrl.Dcm_SecServiceState == DCM_SERVICE_SEED))
        {
            *pFalseAcessCount += (uint8)1;
            ...
            {
                if (pSecurityRow->Dcm_SetSecurityAttemptCounterFnc != ((void *)0))
                {
...
static  Std_ReturnType Dcm_UDS0x27_SubReqSeed(
    Dcm_OpStatusType OpStatus,
    uint8 ProtocolCtrlId,
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0x02u != (Dcm_SecCtrl.Dcm_SecFlag & 0x02u))
    {
    ...
    if ((0U == ret) && ((0x02u + (uint32)SeedSize) > pDcmChannelCfg->Dcm_DslBufferSize))
    {
...
static  Std_ReturnType Dcm_UDS0x27_SubCompareKey(
    Dcm_OpStatusType OpStatus,
    uint8 ProtocolCtrlId,
    const Dcm_0x27Types * Dcm_0x27Type,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
        ...
        || (1u != (SubFunction - Dcm_SecCtrl.Dcm_SubfunctionForSeed)))
    {
        ...
        *FalseAcessCount += (uint8)1;
        ...
        if (((1u == pSecurityRow->DcmDspSecurityAttemptCounterEnabled)
             && ((USE_ASYNCH_FNC == pSecurityRow->DcmDspSecurityUsePort)
                 || (USE_ASYNCH_CLIENT_SERVER == pSecurityRow->DcmDspSecurityUsePort)))
            && (pSecurityRow->Dcm_SetSecurityAttemptCounterFnc != ((void *)0)))
        {
        ...
        {  
            ...
            *FalseAcessCount += (uint8)1;
            ...
            if (*FalseAcessCount >= pSecurityRow->DcmDspSecurityNumAttDelay)
            {
                ...
                Dcm_RunDlyCtrl->Dcm_SecTimerState[SecCfgIndex] = DCM_SECTIMER_ON;
                DslInternal_SetSecurityAccessStatus(DCM_SERVICE_IDLE);
                *ErrorCode = ((Dcm_NegativeResponseCodeType)0x36u);  
                ret = 1U;
            }
            else
            {
                DslInternal_SetSecurityAccessStatus(DCM_SERVICE_IDLE);
                *ErrorCode = ((Dcm_NegativeResponseCodeType)0x35u);  
                ret = 1U;
            }
        }
        else
    ...
    if ((0U == ret) && ((2u) > pDcmChannelCfg->Dcm_DslBufferSize))
    {
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    Dcm_CompareKeyFncType ComparedKey = ((void *)0);
    Dcm_GetSeedFncType GottSeed = ((void *)0);
    ...
    if (0U == ret)
    {
        ...
        ret = DsdInternal_SubSesCheck(ProtocolCtrlId, 0x27u, ErrorCode);
    }
    if (0U == ret)
    {
         
        ret = DsdInternal_SubSecurityCheck(ProtocolCtrlId, 0x27u, ErrorCode);
    }

     
    if ((0U == ret) && (DCM_SERVICE_SEED != Dcm_SecCtrl.Dcm_SecServiceState) && (0x01u != (SubFunction & 0x01u)))
    {
    ...
    if ((0U == ret) && (DCM_SECTIMER_ON == Dcm_SecCtrl.Dcm_RunDlyCtrl.Dcm_SecTimerState[SecCfgIndex])
        && (Dcm_SecCtrl.Dcm_FalseAcessCount[SecCfgIndex]
            >= pDcm_DspSecurity->pDcm_DspSecurityRow[SecCfgIndex].DcmDspSecurityNumAttDelay))
    {
        *ErrorCode = ((Dcm_NegativeResponseCodeType)0x37u);
        ret = 1U;
    }
    ...
    if (0U == ret)
    {
        ...
        if ((((void *)0) == ComparedKey) || (((void *)0) == GottSeed))
        {
