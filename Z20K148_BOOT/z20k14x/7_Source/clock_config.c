...
//��������Ҫʹ�õ�ͷ�ļ�
#include "platform_cfg.h"	// ����MCUƽ̨������Ϣ��ͷ�ļ�
#include "common_drv.h"		// ����SDK�г�����Ϣ��ͷ�ļ�
...
CLK_PLLConfig_t PLL80M =
{
    ...
    .pllRefClock = PLL_HSOSC_CLK,               /* PLL select OSC as reference clock */
...
void Ex_ClockInit(void)
{
    ...
    /* Enable HSOSC */
    CLK_HSOSCEnable(CLK_OSC_FREQ_MODE_HIGH, ENABLE, CLK_OSC_XTAL);
