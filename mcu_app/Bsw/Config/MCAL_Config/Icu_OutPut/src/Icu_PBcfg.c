 ...
 * GENERATED ON:  13 Mar 2026 - 16:37:17
 */
...
VAR(Icu_ChannelRamDataType, ICU_NOINIT_DATA) Icu_GstChannelRamData[8];
...
CONST(Icu_ChannelConfigType, ICU_CONST) Icu_GstChannelConfig[] =
{
  ...
  /* Index: 2 - IcuChannel_1_KL30 */
  {
    ...
    /* pIntrCntlAdress */
    /* MISRA Violation: START Msg(4:0303)-1 */
    (P2VAR(volatile uint16, TYPEDEF, ICU_CONFIG_DATA)) &ICP14,
    /* END Msg(4:0303)-1 */
  ...
  /* Index: 6 - IcuChannel_5_Imu_Int2 */
  {
    ...
    /* pIntrCntlAdress */
    /* MISRA Violation: START Msg(4:0303)-1 */
    (P2VAR(volatile uint16, TYPEDEF, ICU_CONFIG_DATA)) &ICP7,
    /* END Msg(4:0303)-1 */
                        ...
                        Icu_GaaReg_8bit[ICU_MAX_8BIT_REGISTERS] =
{
  ...
  /* pCntlRegs */
  (P2VAR(volatile uint8, TYPEDEF,ICU_CONFIG_DATA))0xffc34058UL,

  (P2VAR(volatile uint8, TYPEDEF,ICU_CONFIG_DATA))0xffc34038UL,

  (P2VAR(volatile uint8, TYPEDEF,ICU_CONFIG_DATA))0xffc34044UL,

  (P2VAR(volatile uint8, TYPEDEF,ICU_CONFIG_DATA))0xffc34034UL,

  (P2VAR(volatile uint8, TYPEDEF,ICU_CONFIG_DATA))0xffc3403cUL,
