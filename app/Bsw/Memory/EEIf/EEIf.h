...
#define PROGRAM_CNT_LEN                         ((uint32)0x02U)
#define ALLOW_F190_WRITE_LEN                    ((uint32)0x01U)
#define VSN_LEN                                 ((uint32)0x20U)
#define VSN_ACTIVE_FLAG_LEN                     ((uint32)0x01U)
#define ALG_FLAG_LEN                            ((uint32)0x01U)
#define SM4_KEY_LEN                             ((uint32)0x20U)
#define SM4_KEY_ACTIVE_FLAG_LEN                 ((uint32)0x01U)
#define SM2_KEY_LEN                             ((uint32)0x41U)
#define ECC256_KEY_LEN                          ((uint32)0x41U)
