...
static cy_stc_gpio_pin_config_t g_canFDStbPortPinCfg =
{
...
static const StcPinConfig_t g_canPinCfg[] =
{
            /* CAN0_1 */
    {
    ...
    },
    {
        ...
        .pinNum  = T2G_CANFD3_TX_PIN,
        {
         ...
         //CAN1_1
    {
        .portReg = T2G_CANFD4_RX_PORT, 
        .pinNum  = T2G_CANFD4_RX_PIN,
        {
            .outVal = 0,
            .driveMode = CY_GPIO_DM_HIGHZ,
            .hsiom = T2G_CANFD4_RX_MUX,
            .intEdge = 0,
            .intMask = 0,
            .vtrip = 0,
            .slewRate = 0,
    ...
    {
        .portReg = T2G_CANFD4_TX_PORT,
        .pinNum  = T2G_CANFD4_TX_PIN,
        {
            .outVal = 1,
            .driveMode = CY_GPIO_DM_STRONG,
            .hsiom = T2G_CANFD4_TX_MUX,
            .intEdge = 0,
            .intMask = 0,
            .vtrip = 0,
            .slewRate = 0,
       ...
       //CAN1_2
    {
        .portReg = T2G_CANFD5_RX_PORT, 
        .pinNum  = T2G_CANFD5_RX_PIN,
        {
            .outVal = 0,
            .driveMode = CY_GPIO_DM_HIGHZ,
            .hsiom = T2G_CANFD5_RX_MUX,
            .intEdge = 0,
            .intMask = 0,
            .vtrip = 0,
            .slewRate = 0,
    ...
    {
        .portReg = T2G_CANFD5_TX_PORT,
        .pinNum  = T2G_CANFD5_TX_PIN,
        {
            .outVal = 1,
            .driveMode = CY_GPIO_DM_STRONG,
            .hsiom = T2G_CANFD5_TX_MUX,
            .intEdge = 0,
            .intMask = 0,
            .vtrip = 0,
            .slewRate = 0,
            ...
            .vohSel = 0,
              ...
              //CAN1_0
    {
        .portReg = T2G_CANFD6_RX_PORT, 
        .pinNum  = T2G_CANFD6_RX_PIN,
        {
            .outVal = 0,
            .driveMode = CY_GPIO_DM_HIGHZ,
            .hsiom = T2G_CANFD6_RX_MUX,
            .intEdge = 0,
            .intMask = 0,
            .vtrip = 0,
            .slewRate = 0,
    ...
    {
        .portReg = T2G_CANFD6_TX_PORT,
        .pinNum  = T2G_CANFD6_TX_PIN,
        {
            .outVal = 1,
            .driveMode = CY_GPIO_DM_STRONG,
            .hsiom = T2G_CANFD6_TX_MUX,
            .intEdge = 0,
            .intMask = 0,
            .vtrip = 0,
            .slewRate = 0,
...
#define CAN_CHANNEL_NUMBER_MAX		          6
...
static void Can0TxCallBack(uint8_t messageMarker)
{
...
static void Can1TxCallBack(uint8_t messageMarker)
{
    cy_stc_canfd_msg_t stcCanFDmsg;
...
static void Can2TxCallBack(uint8_t messageMarker)
{
    cy_stc_canfd_msg_t stcCanFDmsg;
...
static void Can3TxCallBack(uint8_t messageMarker)
{
    cy_stc_canfd_msg_t stcCanFDmsg;
...
static void Can4TxCallBack(uint8_t messageMarker)
{
    cy_stc_canfd_msg_t stcCanFDmsg;
...
static void Can5TxCallBack(uint8_t messageMarker)
{
    cy_stc_canfd_msg_t stcCanFDmsg;
...
*/
static const cy_stc_id_filter_t g_stdIdFilter[] = 
{
...
static const cy_stc_extid_filter_t g_extIdFilter[] = 
{
    ...
    CANFD_CONFIG_EXT_ID_FILTER_RANGE(0x00000800u,0x1FFFFFFFu,1u),
};

static void CAN1RxMsgCallback(bool bRxFifoMsg, uint8_t u8MsgBufOrRxFifoNum, cy_stc_canfd_msg_t* pstcCanFDmsg)
{
...
static void CAN2RxMsgCallback(bool bRxFifoMsg, uint8_t u8MsgBufOrRxFifoNum, cy_stc_canfd_msg_t* pstcCanFDmsg)
{
...
static void CAN3RxMsgCallback(bool bRxFifoMsg, uint8_t u8MsgBufOrRxFifoNum, cy_stc_canfd_msg_t* pstcCanFDmsg)
{
...
static void CAN4RxMsgCallback(bool bRxFifoMsg, uint8_t u8MsgBufOrRxFifoNum, cy_stc_canfd_msg_t* pstcCanFDmsg)
{
...
static void CAN5RxMsgCallback(bool bRxFifoMsg, uint8_t u8MsgBufOrRxFifoNum, cy_stc_canfd_msg_t* pstcCanFDmsg)
{
...
static void CAN6RxMsgCallback(bool bRxFifoMsg, uint8_t u8MsgBufOrRxFifoNum, cy_stc_canfd_msg_t* pstcCanFDmsg)
{
...
static const cy_stc_canfd_config_t g_can1Cfg = 
{
    .txCallback     = Can0TxCallBack, // 
    .rxCallback     = CAN1RxMsgCallback,//CAN_RxMsgCallback,
    ...
    {
        .numberOfSIDFilters = sizeof(g_stdIdFilter) / sizeof(g_stdIdFilter[0]),
        .sidFilter          = g_stdIdFilter,
    },
    .extidFilterConfig  =   // Extended ID filter
    {
        .numberOfEXTIDFilters   = sizeof(g_extIdFilter) / sizeof(g_extIdFilter[0]),
        .extidFilter            = g_extIdFilter,
...
static const cy_stc_canfd_config_t g_can2Cfg = 
{
    .txCallback     = Can1TxCallBack, // 
    .rxCallback     = CAN2RxMsgCallback,//CAN_RxMsgCallback,
    .rxFifoWithTopCallback = NULL, //CAN_RxFifoWithTopCallback,
    .statusCallback = CAN_StatusCallback, // Un-supported now
...
static const cy_stc_canfd_config_t g_can3Cfg = 
{
    .txCallback     = Can2TxCallBack, // 
    .rxCallback     = CAN3RxMsgCallback,//CAN_RxMsgCallback,
    .rxFifoWithTopCallback = NULL, //CAN_RxFifoWithTopCallback,
    .statusCallback = CAN_StatusCallback, // Un-supported now
...
static const cy_stc_canfd_config_t g_can4Cfg = 
{
    .txCallback     = Can3TxCallBack, // 
    .rxCallback     = CAN4RxMsgCallback,//CAN_RxMsgCallback,
...
static const cy_stc_canfd_config_t g_can5Cfg = 
{
    .txCallback     = Can4TxCallBack, // 
    .rxCallback     = CAN5RxMsgCallback,//CAN_RxMsgCallback,
    .rxFifoWithTopCallback = NULL, //CAN_RxFifoWithTopCallback,
    .statusCallback = CAN_StatusCallback, // Un-supported now
...
static const cy_stc_canfd_config_t g_can6Cfg = 
{
    .txCallback     = Can5TxCallBack, // 
    .rxCallback     = CAN6RxMsgCallback,//CAN_RxMsgCallback,
    .rxFifoWithTopCallback = NULL, //CAN_RxFifoWithTopCallback,
    .statusCallback = CAN_StatusCallback, // Un-supported now
...
static int16_t T2GCanFDSetBandrate(cy_stc_canfd_config_t* pcanCfg,uint8_t canfdFlag,CanBaudType_e idBandrate,CanBaudType_e dataBandrateRate)
{
...
static void T2GCanFDInit(uint8_t canIndex,uint8_t canfdFlag,CanBaudType_e idBandrate,CanBaudType_e dataBandrateRate )
{
    ...
    {
    case 0:
      memcpy(&canCfg,&g_can1Cfg,sizeof(canCfg));  
      ...
      break;
    case 1:
      memcpy(&canCfg,&g_can2Cfg,sizeof(canCfg));  
      T2GCanFDSetBandrate(&canCfg,canfdFlag, idBandrate,dataBandrateRate);
      ...
      break;
    case 2:
      memcpy(&canCfg,&g_can3Cfg,sizeof(canCfg));  
      T2GCanFDSetBandrate(&canCfg,canfdFlag, idBandrate,dataBandrateRate);
      ...
      break;
    case 3:
      memcpy(&canCfg,&g_can4Cfg,sizeof(canCfg)); 
      T2GCanFDSetBandrate(&canCfg,canfdFlag, idBandrate,dataBandrateRate);
      ...
      break;
    case 4:
      memcpy(&canCfg,&g_can5Cfg,sizeof(canCfg));  
      T2GCanFDSetBandrate(&canCfg,canfdFlag, idBandrate,dataBandrateRate);
      ...
      break;
    case 5:
      memcpy(&canCfg,&g_can6Cfg,sizeof(canCfg));  
      T2GCanFDSetBandrate(&canCfg,canfdFlag, idBandrate,dataBandrateRate);
...
static int16_t CanTransmitFromIsr(uint8_t u8Channel, uint32_t id, uint8_t u8Len, uint8_t* pu8CmdData,uint8_t fdFlag)
{
    ...
    case 5:
      ...
      break;
    default:
            return CAN_ERROR_INVALID_PARAMETER;
    }
    //__disable_irq();
