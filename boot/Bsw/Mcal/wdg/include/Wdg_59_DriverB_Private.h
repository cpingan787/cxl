...
/* Module       = Wdg_59_DriverB_Private.h                                    */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 *                              for API 'Wdg_59_DriverB_InitDetCheck' is added.
 ...
 */
/******************************************************************************/
#ifndef WDG_59_DRIVERB_PRIVATE_H
#define WDG_59_DRIVERB_PRIVATE_H
...
#define WDG_59_DRIVERB_PRIVATE_AR_RELEASE_MAJOR_VERSION \
                                        WDG_59_DRIVERB_AR_RELEASE_MAJOR_VERSION
#define WDG_59_DRIVERB_PRIVATE_AR_RELEASE_MINOR_VERSION \
                                        WDG_59_DRIVERB_AR_RELEASE_MINOR_VERSION
#define WDG_59_DRIVERB_PRIVATE_AR_RELEASE_REVISION_VERSION \
                                     WDG_59_DRIVERB_AR_RELEASE_REVISION_VERSION

/* Module Software version information */
#define WDG_59_DRIVERB_PRIVATE_SW_MAJOR_VERSION  WDG_59_DRIVERB_SW_MAJOR_VERSION
#define WDG_59_DRIVERB_PRIVATE_SW_MINOR_VERSION  WDG_59_DRIVERB_SW_MINOR_VERSION
...
/* WDTAnMD */
#define WDG_59_DRIVERB_MASK_FIRST_7_BITS           (uint8) 0x7F
/* WDTAnWDTE, WDTAnEVAC, WDTAnREF */
#define WDG_59_DRIVERB_MASK_FIRST_8_BITS           (uint8) 0xFF
/*******************************************************************************
...
/* Declaration of API "Wdg_59_DriverB_TriggerFunc". */
extern FUNC(void, WDG_59_DRIVERB_FAST_CODE)
                    Wdg_59_DriverB_TriggerFunc(boolean LblCriticalSectionFlag);


/* Declaration of API "Wdg_59_DriverB_InitDetCheck". */
extern FUNC(Std_ReturnType, WDG_59_DRIVERB_FAST_CODE)
...
#endif /* WDG_59_DRIVERB_PRIVATE_H */
