...
/**
  ...
  the array elements.
    ...
    \li VL_WdgM_2987
      Reason: Function will change value of output parameter.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
    ...
    \li VL_WdgM_4342
      Reason: Enumeration type conversion warning.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
...
extern FUNC(void, WDGM_CODE) WdgM_Init(const WdgM_ConfigType* ConfigPtr);
