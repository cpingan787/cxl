...
#define AUTOSAR_NET_MANAGE_MAX_INSTANCE           1

//CBV(Control Bit Vector) bit definition
#define CBV_BIT_REPEAT_MESSAGE_REQUEST        0
#define CBV_BIT_ACTIVE_WAKEUP                 4
#define CAN_DATA_FOUR_KL15ON                    1  
#define CAN_DATA_FOUR_KL15OFF_RemoteService     5     
#define CAN_DATA_FOUR_Diagnosis_Sevice          6     
