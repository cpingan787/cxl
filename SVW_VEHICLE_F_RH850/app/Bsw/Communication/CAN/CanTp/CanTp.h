 ...
 *  V2.1.23      2025-06-30  xue.han      CPT-15030,Resolve the timing of As will be overridden by the timing of Cs
 *               2025-08-27  xue.han      CPT-15629,Fix CanTp_ChangeParameter only takes effect once.
 *                                        CPT-15694,Fix the variable BS to a fixed value when accepting.
 */
/*============================================================================*/
...
#define CANTP_SW_PATCH_VERSION         23U
