...
static  void Can_ClearRxBuffers(
  const uint8 LucUnit, const uint8 LucCtrlIndex,
  const uint8 LucApiId);

static  void Can_EnableTxBuffers(
  const uint8 LucUnit, const uint8 LucCtrlIndex,
  const uint8 LucApiId);
 ...
 
{
  ...
  LenReturnValue = Can_CommonDetCheck((uint8)0x03, Controller);
  ...
  else
  {
    ...
    if (LenCurrentMode == Transition)
    {
      ...
      if (CAN_T_START == Transition)
      {
        ...
        CanIf_ControllerModeIndication(
         (uint8)(Controller + 0U), CANIF_CS_STARTED);
      }
      else if (CAN_T_STOP == Transition)
      {
         
        CanIf_ControllerModeIndication(
          (uint8)(Controller + 0U), CANIF_CS_STOPPED);
      }
      else if (CAN_T_SLEEP == Transition)
      {
         
        CanIf_ControllerModeIndication(
         (uint8)(Controller + 0U),CANIF_CS_SLEEP);
      }
      else
      {
    ...
    else
    {
      ...
      {
      case CAN_T_START:
        Can_StartMode(Controller, (uint8)0x03);
        break;
      case CAN_T_STOP:
        ...
        if ((boolean)0x00 == Can_GaaCtrlState[Controller].blBusOff)
        {
           
          Can_StopMode(Controller, (uint8)0x03);
        }
        else
        {
        ...
        break;
      case CAN_T_SLEEP:
        Can_SleepMode(Controller, (uint8)0x03);
        break;
      default:  
            ...
            Can_GaaCtrlState[Controller].enSubState))
        {
          ...
          Can_GaaCtrlState[Controller].blWakeupByHW = (boolean)0x00;
          ...
          if (((void *)0) != LpPCController->pICWakeup)
          {
            ...
            (*((volatile uint8*)(LpPCController->pICWakeup)) = ((*((volatile uint8*)(LpPCController->pICWakeup)))|((uint8)(uint16)0x0080U))); (*((volatile uint8*)(LpPCController->pICWakeup))); __syncp();
        ...
        else
        {
          ...
          Can_WakeupMode(Controller, (uint8)0x03);
        }
        break;
      }
    }
 ...
 Std_ReturnType Can_SelfTestChannel
                      (uint8 LucController, Can_SelfTestType LenTest_Transition)
 ...
 
{
  ...
  volatile uint32 * LpRCANCmCTRReg;
  ...
  LucReturnValue = 0U;
    ...
    LenReturnValue = Can_CommonDetCheck((uint8)0x15, LucController);
  if (CAN_OK != LenReturnValue)
  {
    LucReturnValue = 1U;
  }
  ...
  if (1U != LucReturnValue)
  {
    ...
    LucReturnValue =
      Can_ChannelModeChange(LucUnit, LucController, 0x00000002UL,
      &LulTimeoutDuration, (uint8)0x15);
    if (0U != LucReturnValue)
    {
    ...
    else
    {
      ...
      case CAN_T_SELF_OFF:
        ...
        LulCTR_RegValue = *(LpRCANCmCTRReg) & 0xF8FFFFFFUL;
         
         
        { { (*(LpRCANCmCTRReg)) = (LulCTR_RegValue);} { (*(&Can_GaaMirrorChannelReg[LucController]. ulCTR)) = (LulCTR_RegValue); } }
        break;
      case CAN_T_SELF_EXTERNAL:
         
         
         
        LulCTR_RegValue = *(LpRCANCmCTRReg) | 0x01000000UL;
        ...
        LulCTR_RegValue = *(LpRCANCmCTRReg) &
                            (0xF8FFFFFFUL | 0x01000000UL);
        { { (*(LpRCANCmCTRReg)) = (LulCTR_RegValue);} { (*(&Can_GaaMirrorChannelReg[LucController]. ulCTR)) = (LulCTR_RegValue); } }
         
         

         
        LulCTR_RegValue = *(LpRCANCmCTRReg) | 0x04000000UL;
      ...
      case CAN_T_SELF_INTERNAL:
        ...
        LulCTR_RegValue = *(LpRCANCmCTRReg) | 0x06000000UL;
      ...
      LucReturnValue =
        Can_ChannelModeChange(LucUnit, LucController, 0x00000000UL,
        &LulTimeoutDuration, (uint8)0x15);
      if (0U != LucReturnValue)
      {
 ...
 void Can_SleepMode(const uint8 LucCtrlIndex,
  const uint8 LucApiId)
 ...
 
{
  ...
  if (CAN_NO_PENDING_TRANSITION == LenSubState)
  {
    ...
    LucResult = Can_ChannelModeChange(LucUnit, LucCtrlIndex,
      0x00000004UL | 0x00000001UL, &LulTimeoutDuration, LucApiId);
    ...
    (0UL ==
      (Can_GaaRegs[LucUnit].pCmn->aaChReg[LucCh].ulSTS & 0x00000004UL)))
  {
    ...
    (CAN_PENDING_SLEEP_WAIT_STOP == LenSubState))
  {
    ...
    if (0UL == Can_GaaActiveControllers[LucUnit])
    {
      ...
      Can_GaaGlobalStateTransition[LucUnit] = (boolean)0x01;
       
      LblGlobalTransitionRequired = (boolean)0x01;
    }
    else
    {
      LblGlobalTransitionRequired = (boolean)0x00;
    }
    SchM_Exit_Can_CAN_RAM_DATA_PROTECTION();
     

     
    if ((boolean)0x01 == LblGlobalTransitionRequired)
    {
       
      LenSubState = CAN_PENDING_SLEEP_WAIT_GLOBALRESET;
      LucResult = Can_GlobalModeChange(
        LucUnit, 0x00000001UL, &LulTimeoutDuration, LucApiId);
  ...
  else if ((0U == LucResult) &&
    (CAN_PENDING_SLEEP_WAIT_GLOBALRESET == LenSubState) &&
    (0x00000001UL !=
      (Can_GaaRegs[LucUnit].pCmn->ulGSTS & 0x00000007UL)))
  {
    ...
    (CAN_PENDING_SLEEP_WAIT_GLOBALRESET == LenSubState))
  {
    ...
    (0UL == (Can_GaaRegs[LucUnit].pCmn->ulGSTS & 0x00000004UL)))
  {
  ...
  if (0U == LucResult)
  {
    ...
    if (CAN_PENDING_SLEEP_WAIT_GLOBALSTOP == LenSubState)
    {
      ...
      Can_GaaGlobalStateTransition[LucUnit] = (boolean)0x00;
    ...
    if (((void *)0) != LpPCController->pICWakeup)
    {
      ...
      if ((0U != (LpPCController->ucIntEnable & 0x08U)) &&
        (0UL == Can_GaaCtrlState[LucCtrlIndex].ulIntCount))
      {
         
        (*((volatile uint16*)(LpPCController->pICWakeup)) = ((*((volatile uint16*)(LpPCController->pICWakeup)))&((uint16)(~((uint16)0x1000U | (uint16)0x0080U)))));
         
      }
      else
      {
         
        (*((volatile uint16*)(LpPCController->pICWakeup)) = ((*((volatile uint16*)(LpPCController->pICWakeup)))&((uint16)(~(uint16)0x1000U))));
    ...
    if(((void *)0) != LpPCController->pFCLAReg)
    {
      *(LpPCController->pFCLAReg) = (uint8) 0x02U;
    ...
    if(((void *)0) != LpPCController->pDNFAReg)
    {
      *(LpPCController->pDNFAReg) |=
          (uint16)(1UL << (uint32)(LpPCController->ucChannelOffset));
    ...
    CanIf_ControllerModeIndication(
      (uint8)(LucCtrlIndex + 0U), CANIF_CS_SLEEP);
  }
  else
  {
 ...
 void Can_WakeupMode(const uint8 LucCtrlIndex,
  const uint8 LucApiId)
 ...
 
{
    ...
    (CAN_PENDING_WAKEUP_WAIT_GLOBALCHANGE == LenSubState))
  {
    ...
    if ((boolean)0x01 == Can_GaaGlobalStateTransition[LucUnit])
    {
    ...
    if ((boolean)0x01 == LblGlobalTransitionRequired)
    {
      ...
      LucResult = Can_GlobalModeChange(LucUnit, 0x00000001UL,
    ...
    (0UL == (Can_GaaRegs[LucUnit].pCmn->ulGSTS & 0x00000001UL)))
  {
    ...
    (CAN_PENDING_WAKEUP_WAIT_GLOBALRESET == LenSubState))
  {
    ...
    LucResult = Can_GlobalModeChange(LucUnit, 0x00000000UL,
      &LulTimeoutDuration, LucApiId);
  }
    ...
    (0x00000000UL != Can_GaaRegs[LucUnit].pCmn->ulGSTS))
  {
    ...
    (CAN_PENDING_WAKEUP_WAIT_RESET != LenSubState))
  {
    ...
    LucResult = Can_ChannelModeChange(LucUnit, LucCtrlIndex,
      0x00000001UL, &LulTimeoutDuration, LucApiId);
    ...
    (0x00000001UL !=
      (Can_GaaRegs[LucUnit].pCmn->aaChReg[LucCh].ulSTS & 0x00000007UL)))
  {
    LucResult = 1U;
  }
  else
  ...
  if (0U == LucResult)
  {
    ...
    if ((boolean)0x01 == Can_GaaCtrlState[LucCtrlIndex].blWakeupByHW)
    {
    ...
    {
      CanIf_ControllerModeIndication(
         (uint8)(LucCtrlIndex + 0U), CANIF_CS_STOPPED);
    }
  }
  else
  {
 ...
 void Can_StartMode(const uint8 LucCtrlIndex,
  const uint8 LucApiId)
{
  ...
  if ((CAN_NO_PENDING_TRANSITION == LenSubState) &&
    ((boolean)0x01 == Can_GaaCtrlState[LucCtrlIndex].blBusOff))
  {
     
    { (*(&Can_GaaRegs[LucUnit]. pCmn->aaChReg[LucCh]. ulERFL)) = (0x00000000UL);}
     
    Can_GaaCtrlState[LucCtrlIndex].blBusOff = (boolean)0x00;
    ...
    (0UL ==
      (Can_GaaRegs[LucUnit].pCmn->aaChReg[LucCh].ulSTS & 0x00000001UL)))
  {
    LucResult = 1U;
  }
  else
    ...
    (CAN_PENDING_START_WAIT_RESET == LenSubState)))
  {
    ...
    LucResult = Can_ChannelModeChange(LucUnit, LucCtrlIndex,
      0x00000000UL, &LulTimeoutDuration, LucApiId);
  }
  ...
  if (0U == LucResult)
  {
    ...
    { { (*(&Can_GaaRegs[LucUnit]. pCmn->aaTHLCC[LucCh])) = ((LpPCController->ulTHLCC | 0x00000001UL));} }
    ...
    CanIf_ControllerModeIndication(
      (uint8)(LucCtrlIndex + 0U), CANIF_CS_STARTED);
  }
  else
  {
    ...
    LulHohIndex < (uint32)4U; LulHohIndex++)
  {
      ...
      (CAN_HOH_HRH == LpHoh->enHoh))
    {
      ...
      case CAN_BUFFERTYPE_RXFIFO:
        ...
        { { (*(&Can_GaaRegs[LucUnit]. pCmn->aaRFCC[LpHoh->ucBufferIndex])) = (LpHoh->ulXXCCRegValue);} }
         
         
         
         
        { { (*(&Can_GaaRegs[LucUnit]. pCmn->aaRFCC[LpHoh->ucBufferIndex])) = ((LpHoh->ulXXCCRegValue | 0x00000001UL));} { (*(&Can_GaaMirrorHohReg[LulHohIndex]. ulRFCC)) = ((LpHoh->ulXXCCRegValue | 0x00000001UL)); } }
 ...
 
{
    ...
    LulHohIndex < (uint32) 4U; LulHohIndex++)
  {
    ...
    if (LpHoh->ucController == LucCtrlIndex)
    {
        ...
        (CAN_BUFFERTYPE_GATEWAY == LpHoh->enBufferType))
      {
        ...
        { { (*(&Can_GaaRegs[LucUnit]. pCmn->aaCFCC[LpHoh->ucBufferIndex])) = ((LpHoh->ulXXCCRegValue | 0x00000001UL));} { (*(&Can_GaaMirrorHohReg[LulHohIndex]. ulCFCC)) = ((LpHoh->ulXXCCRegValue | 0x00000001UL)); } }
 ...
 void Can_StopMode(const uint8 LucCtrlIndex,
  const uint8 LucApiId)
{
  ...
  if (CAN_TENTATIVE_TRANSITION == LenSubState)
  {
    ...
    LucResult = Can_ChannelModeChange(LucUnit, LucCtrlIndex,
      0x00000002UL, &LulTimeoutDuration, LucApiId);
  }
    ...
    (0UL ==
      (Can_GaaRegs[LucUnit].pCmn->aaChReg[LucCh].ulSTS & 0x00000002UL)))
  {
    LucResult = 1U;
  }
  else
 ...
 Std_ReturnType Can_GlobalModeChange(
  const uint8 LucUnit, const uint32 LulMdBits,
  uint32 * const LpTimeoutDuration,
  const uint8 LucApiId)
 
{
  ...
  { { (*(&Can_GaaRegs[LucUnit]. pCmn->ulGCTR)) = (LulMdBits);} { (*(&Can_GaaMirrorGlobalReg[LucUnit]. ulGCTR)) = (LulMdBits); } }

  LucResult = Can_WaitRegisterChange(&Can_GaaRegs[LucUnit].pCmn->ulGSTS,
    0x00000007UL, LulMdBits, LpTimeoutDuration);
 ...
 Std_ReturnType Can_ChannelModeChange(
  const uint8 LucUnit, const uint8 LucCtrlIndex, const uint32 LulMdBits,
  uint32 * const LpTimeoutDuration,
  const uint8 LucApiId)
 
{
  ...
  const volatile uint32 * LpSTSReg;
  uint8 LucCh;
  ...
  LulCTR_RegValue =
    ((Can_GaaRegs[LucUnit].pCmn->aaChReg[LucCh].ulCTR & ~0x00000007UL)
     | LulMdBits);
  { { (*(&Can_GaaRegs[LucUnit]. pCmn->aaChReg[LucCh]. ulCTR)) = (LulCTR_RegValue);} { (*(&Can_GaaMirrorChannelReg[LucCtrlIndex]. ulCTR)) = (LulCTR_RegValue); } }
   
   

  LpSTSReg = &Can_GaaRegs[LucUnit].pCmn->aaChReg[LucCh].ulSTS;
  LucResult = Can_WaitRegisterChange(
    LpSTSReg, 0x00000007UL, LulMdBits, LpTimeoutDuration);
 ...
 Std_ReturnType Can_WaitRegisterChange(
  volatile const uint32 * const LpReg,
  const uint32 LulMask, const uint32 LulBits,
  uint32 * const LpTimeoutDuration)
{
  ...
  (void)GetCounterValue((uint8)0u, &LulPrevTime);

   
  while (((*LpReg & LulMask) != LulBits) && (0U == LucResult))
  {
     
    (void)GetCounterValue((uint8)0u, &LulCurrentTime);
    ...
    if (LulPrevTime > LulCurrentTime)
    {
      ...
      LulTimeLapse = LulTimeLapse + (uint32)(
        (((TickType)1000U - LulPrevTime) + 1UL) +
        LulCurrentTime);
    }
    else
    {
