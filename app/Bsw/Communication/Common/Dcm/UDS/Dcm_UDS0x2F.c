...
{                                                                             
    ...
    if (VehSpdAvg >= DCM_APP_0X2F_VEHSPD_THRESHOLD_RAW)
    {
...
/* PRQA S 6010 -- */
{
    ...
    /*check inputOutputControlParameter and length for ReturnControlToEcu*/
    if (E_OK == ret)
    {
        /*get inputOutputControlParameter*/
        uint8 InputOutControlParameter = pMsgContext->pReqData[3u];
        /*for ReturnControlToEcu (0x00), no additional data is needed*/
