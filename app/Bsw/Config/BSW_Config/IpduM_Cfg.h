...
#define  IPDUM_MAX_BUFFER_SIZE                           192u

/* Maximum number of transmitted IPdus */
#define IPDUM_TX_UP_PDU_MAX                         11u

/* maximum number of IPDUM_TRANSMIT_TYPE_CONTAINED TX */
#define IPDUM_CONTAINED_TX_NUMBER_MAX               11u
...
#define CONTAINED_TX_PDU_IpduM_Contained_Tx_0x3A2_Pdu41     9u
#define CONTAINED_TX_PDU_IpduM_Contained_Tx_0x3A2_Pdu57     10u
...
#define IPDUM_CONTAINER_TX_QUEUE_NUM_MAX                   3u

/* maximum number of module support tx contained */
#define IPDUM_SUPPORT_TX_CONTAINED_NUM_MAX                    15u
