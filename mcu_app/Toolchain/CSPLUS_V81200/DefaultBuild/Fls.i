...

  {
    ...
    else
    {
         ...
         )
     {
        ...
        Fls_GstVar.ulRequestedLength = (uint32)(uint8)0;
        Fls_GstVar.ulCurrentLength = (uint32)(uint8)0;
...
)
{
  ...
  TargetAddress = TargetAddress + 4280287232UL;
  ...
  Fls_GstVar.ulJobEndAddress = (TargetAddress + Length) - (uint32)(uint8)1;
...

  {
...

    {
      ...
      if ((uint32)(uint8)0 != (Length & (uint32)(64U - (uint8)1)))
      {
        Length = (Length + (uint32)(64U - (uint8)1)) &
                                (~((uint32)(64U - (uint8)1)));
        Fls_GstVar.ulJobEndAddress = (TargetAddress + Length) - (uint32)(uint8)1;
      }
      else
 ...
 void Fls_MainFunction(void)
{
  ...
  if ((boolean)0 == Fls_GblInitStatus)
  {
  }
  else
  {
     ...
     
    {
      ...
      case FLS_COMMAND_ERASE :
          ...
          if ((boolean)1 == Fls_GblTimeOutMonitor)
...
)
{
  ...
  LucReturnValue = 0U;
  {
    ...
    SourceAddress = SourceAddress + 4280287232UL;
...

    {
       
      {
        ...
        if ((uint8)0 != Fls_GstVar.ucOffset)
        {
        ...
        if ((uint32)(uint8)0 != (Length & (uint32)((uint8)4 - (uint8)1)))
        {
           
          Length = Length + ((uint32)(uint8)4 -
                             (Length & (uint32)((uint8)4 - (uint8)1)));
        }
        else
        {
...
)
{
...

  {
...

    {
      ...
      Fls_GstVar.pTempBufferAddress =
                                   (const uint8*)&Fls_GulTempBuffer[(uint8)0];
 ...
 void Fls_SetMode(MemIf_ModeType LenMode)
 
{
 ...
 Std_ReturnType Fls_ReadImmediate
(
  Fls_AddressType                           SourceAddress,
 ...
 Std_ReturnType Fls_Suspend(void)
{
...

  {
      ...
      )
    {
      ...
      {
        Fls_GblJobSuspendRequest = (boolean)1;
      }
      else
      {
 ...
 void Fls_Resume(void)
{
  {
     
       
       
    if (((boolean)1 == Fls_GblJobSuspended) &&                                         (MEMIF_IDLE == Fls_GenState))
