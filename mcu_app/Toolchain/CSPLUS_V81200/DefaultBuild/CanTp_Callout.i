...
extern uint32 CanTp_Timer;
 ...
 void
CanTp_ResetTime(uint32 * TimerPtr)
{
 ...
 void
CanTp_GetTimeSpan(uint32 TimerPtr, uint32 * TimeSpanPtr)
{
    if (TimerPtr > CanTp_Timer)
    {
        *TimeSpanPtr = (0xFFFFFFFFuL - TimerPtr) + CanTp_Timer;
    }
    else
    {
