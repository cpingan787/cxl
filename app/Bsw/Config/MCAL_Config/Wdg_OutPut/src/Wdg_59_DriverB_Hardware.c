...
/* Module       = Wdg_59_DriverB_Hardware.c                                   */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 *                         2. As part of ARDAABD-2466:
 *                         ->Iocommon_Defines.h added instead of Iocommon.h
 *                         3. As part of ARDAABD-2734:
...
#define WDG_59_DRIVERB_HARDWARE_C_AR_RELEASE_MAJOR_VERSION  4U
#define WDG_59_DRIVERB_HARDWARE_C_AR_RELEASE_MINOR_VERSION  2U
#define WDG_59_DRIVERB_HARDWARE_C_AR_RELEASE_REVISION_VERSION  2U

/* File version information */
#define WDG_59_DRIVERB_WDG_HARDWARE_C_SW_MAJOR_VERSION  1U
#define WDG_59_DRIVERB_WDG_HARDWARE_C_SW_MINOR_VERSION  0U
...
volatile WDTAReg*  const WDG_59_DriverB_GpWDTAReg_BaseAddr =
              (volatile  WDTAReg *) &WDTA1  ;
/*Structure pointer for INTWDT ICR*/
/* MISRA Violation: START Msg(4:0310)-2 */

volatile  unsigned long* const WDG_59_DriverB_GpICR_BaseAddr =
              (volatile  unsigned long*) &ICWDTA1  ;
/* END Msg(4:0310)-2 */
/* END Msg(4:0303)-1 */
