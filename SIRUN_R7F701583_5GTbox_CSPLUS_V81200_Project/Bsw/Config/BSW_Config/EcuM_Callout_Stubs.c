...
)
{
     ...
     */
    /* custom code.... */
    CanSM_StartWakeupSource(ComMChannel_0);//manually add
    (void)wakeupSource;
    /** DO NOT CHANGE THIS COMMENT!
     * </USERBLOCK>
     */
 ...
 * Return value: NA
 */
extern uint8 validNmMsgFlag;//manually add
...
)
{
     ...
     */
    /* custom code.... */
    CanSM_StopWakeupSource(ComMChannel_0);
    (void)wakeupSource;
    /** DO NOT CHANGE THIS COMMENT!
     * </USERBLOCK>
     */
