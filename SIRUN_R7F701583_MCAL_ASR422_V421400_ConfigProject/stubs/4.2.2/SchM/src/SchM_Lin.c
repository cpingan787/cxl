 ...
 *
 * V1.0.2:  08-Aug-2014  : As per CR 586, following changes are made:
 *                         1. Data and Register protection related function are
 *                            added.
 *                         2. Copyright information is updated.
 *
 * V1.0.3:  04-June-2015 : As part of Mantis #26199, following changes are made:
...
/*******************************************************************************
**              SchM_Enter_Lin_REGISTER_PROTECTION()               **
*******************************************************************************/
void SchM_Enter_Lin_LIN_REGISTER_PROTECTION(void)
{
  DISABLE_INTERRUPT();
}
/*******************************************************************************
**            SchM_Exit_Lin_REGISTER_PROTECTION()                  **
*******************************************************************************/
void SchM_Exit_Lin_LIN_REGISTER_PROTECTION(void)
{
  ENABLE_INTERRUPT();
}
