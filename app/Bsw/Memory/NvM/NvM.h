...
/**
  ...
  RuleSorce:puhua_rules-2024.12.rcf
    ...
    \li VL_NvM_3408
      Reason: Configuration variables design needs and autosar API
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
...
/* PRQA S 3449, 3451 EOF */ /* VL_NvM_3449, VL_NvM_3451 */
 ...
 *   V2.0.13    2025-10-24  haibin.shao CPT-16144,Remove the allocation of redundant RAM to avoid memory resource
 *                                      consumption
============================================================================*/
