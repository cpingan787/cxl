...
EcuM_WakeupSourceType Mcu_CheckWakeSource(void)
{
	...
	if(Dio_ReadChannel(DioConf_DioChannel_DIO_Channel_ACC_INT_Pin8_5) == STD_HIGH)
		Mcu_WakeSource.Ecall_WakeFlag = TRUE;
...
void Power_Detect(void)
{
	...
	gIOHwAbDI_ECALL_BUTTON_St = Dio_ReadChannel(DioConf_DioChannel_DIO_Channel_ACC_INT_Pin8_5);
