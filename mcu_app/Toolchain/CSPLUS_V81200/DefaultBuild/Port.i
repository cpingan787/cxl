...
extern volatile  PortReg* const
                 Port_GaaPortReg_BaseAddress[0x09U];
...
extern volatile  APortReg* const
                 Port_GaaAPortReg_BaseAddress[0x02U];

extern volatile  DNFAReg* const
                 Port_GaaDnfaReg_BaseAddress[0x1U];
...
extern const Port_NumRegs
                                Port_GstNumRegs[0x09U];

extern const Port_JTAGRegs
                                  Port_GstJTAGRegs[0x01U];

extern const Port_AnalogRegs
                              Port_GstAnalogRegs[0x02U];

extern const Port_IPortRegs
                                Port_GstInputRegs[0x01U];

extern const Port_PinChangeableDetails
             Port_GstPinChangeableDetailsList[0x07U];

extern const Port_DNFARegs Port_GstDNFARegs[0x01U];
...
typedef struct STag_Port_ConfigType
{
  ...
  const Port_IPortRegs * pPortInputRegs;
  ...
  const Port_DNFARegs * pPortDNFARegs;
...
extern Port_NumRegRamMirror
                    Port_GstRamMirrorPortReg[0x09U];
 ...
 
{
  ...
  const Port_IPortRegs * LpIPortReg;
  ...
  if (PORT_GROUP_NUMERIC == LenGroupType)
  {
    ...
    while ((LucLoopCount < LusNoOfPortReg) && (0U == LddReturnValue))
    {
      ...
      if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
          ((uint8)0x10 == (LpPortReg->ucDeepStopSupp & (uint8)0x10)))
      ...
      if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
       ((uint8)0x01 != (LpPortReg->ucDeepStopSupp & (uint8)0x01)))
  ...
  else
  {
     ...
     
    {
      ...
      if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
          ((uint8)0x10 == (LpJPortReg->ucDeepStopSupp & (uint8)0x10)))
      ...
      if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
      ((uint8)0x01 != (LpJPortReg->ucDeepStopSupp & (uint8)0x01)))
    ...
    else
    {
      ...
      if (PORT_GROUP_ANALOG == LenGroupType)
      {
        ...
        while ((LucLoopCount < LucNoOfPortReg) && (0U == LddReturnValue))
        {
          ...
          if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
              ((uint8)0x10 == (LpAPortReg->ucDeepStopSupp
                                                           & (uint8)0x10)))
          ...
          if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
              ((uint8)0x01 != (LpAPortReg->ucDeepStopSupp
                                                         & (uint8)0x01)))
      ...
      else
      {
        ...
        if (PORT_GROUP_INPUT == LenGroupType)
        {
          ...
          { (*(&Port_GpIPortReg_BaseAddress->usIPIBC)) = ((LpIPortReg->usInitModeIPIBCRegVal)); }
...
static  void Port_FilterConfig(void)
{
  ...
  const volatile Port_DNFARegs * LpDNFAReg;
  ...
  while ((uint8)0x00 < LucNoOfRegs)
  {
    ...
    { (*(&Port_GaaDnfaReg_BaseAddress[LpDNFAReg->usDNFARegAddrIndex]->ucCTL)) = (LpDNFAReg->ucDNFACTL); }
    { }
    ...
    { (*(&Port_GaaDnfaReg_BaseAddress[LpDNFAReg->usDNFARegAddrIndex]->usEN)) = ((LpDNFAReg->usDNFAEN)); }
    { }
 ...
 
{
   ...
   
  {
    if (PORT_HW_CONSIST_CHECK_STATIC == CheckType)
    {
      ...
      LpDNFAReg = Port_GpConfigPtr->pPortDNFARegs;
      for (LucNoOfRegs = (uint8)0x00; (0U == LddCheckStatus) &&
