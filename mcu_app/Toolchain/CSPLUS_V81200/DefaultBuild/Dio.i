              ...
              Std_VersionInfoType * const versioninfo)
{
  ...
  if (((void *)0) != versioninfo)
  {
    ...
    versioninfo->moduleID             = (uint16)120U;
     
    versioninfo->sw_major_version     = 2U;
     
    versioninfo->sw_minor_version     = 0U;
     
    versioninfo->sw_patch_version     = 7U;
  }
  else
  {
  }
...
{
  const Dio_PortGroup * LpPortGroup;
   ...
   
  {
    ...
    if ((Dio_PortType)2 == LpPortGroup->ucPortType)
    {
    ...
    {
      LddPortLevel = (Dio_PortLevelType)(uint16)0x0000;
    }
  }
                                  ...
                                  const Dio_PortLevelType Level)
{
   ...
   
  {
    ...
    {
      LulPortModeLevel = (uint32)(uint16)0x0000;
    }

    LulPortModeLevel = LulPortModeLevel | 0xFFFF0000UL;
     
     
     
     
    if ((uint32)(uint16)0x0000 != (~LulPortModeLevel))
    {
      LulPSRContent = (((uint32)Level & (~(LulPortModeLevel))) |
                                  (~(LulPortModeLevel) * 0x10000UL));
      ...
      if ((Dio_PortType)2 == LpPortGroup->ucPortType)
      {
        { (*(&Dio_GaaPortReg_BaseAddress[LusDioPortGroupIndex]->ulPSR)) = (LulPSRContent); }
        {}
      }  
  ...
  
{
  ...
  const Dio_PortGroup *   LpPortGroup;
  const Dio_PortChannel * LpPortChannel;
  ...
  
{
   ...
   
  {
    ...
    LulPSRContent = ((uint32)LpPortChannel->usMask) * (0x10000UL);
    ...
    
  {
    ...
    if ((Dio_PortType)2 == LpPortGroup->ucPortType)
    {
      ...
      if ((uint32)(uint16)0x0000 == LulPortModeLevel)
      {
        ...
        { (*(&Dio_GaaPortReg_BaseAddress[LusDioPortGroupIndex]->usPNOT)) = (LpPortChannel->usMask); }
        {}
      }
      else
      {
  ...
  
{
  ...
  const Dio_ChannelGroupType * LpChannelGroupPtr;
  ...
  LusChGrpPtrValue = (uint16)0x0000;
  ...
  LusChGrpPtrValue = (uint16)(((uint32)ChannelGroupIdPtr) -
                     ...
                     [(uint32)(uint16)0x0000])));
   
  LusDioChannelGroupId = LusChGrpPtrValue / 4U;
                                                        ...
                                                        Dio_PortLevelType Level)
{
 ...
 Std_ReturnType Dio_CheckHWConsistency(
                     const Dio_HWConsistencyCheckType CheckType)
{
 ...
 
{
   ...
   
  {
    ...
    {
        LulPSRContent = (Level |
        ((uint32)((~LulPortModeLevel) & (Mask)) << 16U));
 ...
 Dio_LevelType Dio_ReadChannelOutputValue(
                                const Dio_ChannelType ChannelId )
{
  Dio_LevelType LddLevel;
  const Dio_PortGroup *   LpPortGroup;
 ...
 Dio_PortLevelType Dio_ReadChannelGroupOutputValue(
    const Dio_ChannelGroupType * const ChannelGroupIdPtr )
{
  Dio_PortLevelType LddPortLevel;
  ...
  LusChGrpPtrValue = (uint16)(((uint32)ChannelGroupIdPtr) -
            ((uint32)(&Dio_GstChannelGroupData[(uint32)(uint16)0x0000])));
