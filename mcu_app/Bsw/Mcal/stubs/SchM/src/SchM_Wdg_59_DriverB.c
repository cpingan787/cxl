 ...
 *                         'SchM_<Enter/Exit>_Wdg_59_DriverB_<Exclusive_Area>'
 *                         to
 *                         'SchM_<Enter/Exit>_Wdg_59_DRIVERB_<Exclusive_Area>'.
 ...
 *                            'SchM_Wdg_59_DriverB.c' to
 *                            'SchM_Wdg_59_DRIVERB.c'.
 *                         b) Updated SchM header file include name from
 *                            'SchM_Wdg_59_DriverB.h' to
...
*******************************************************************************/
void SchM_Enter_Wdg_59_DriverB_WDG_59_DRIVERB_MODE_SWITCH_PROTECTION(void)
{
  DISABLE_INTERRUPT();
}
...
*******************************************************************************/
void SchM_Exit_Wdg_59_DriverB_WDG_59_DRIVERB_MODE_SWITCH_PROTECTION(void)
{
  ENABLE_INTERRUPT();
}
...
*******************************************************************************/
void SchM_Enter_Wdg_59_DriverB_WDG_59_DRIVERB_TRIGG_PROTECTION(void)
{
  DISABLE_INTERRUPT();
}
...
*******************************************************************************/
void SchM_Exit_Wdg_59_DriverB_WDG_59_DRIVERB_TRIGG_PROTECTION(void)
{
  ENABLE_INTERRUPT();
}
