...
/* PRQA S 6520, 1520 EOF */ /* VL_MTR_Dcm_STVAR, VL_Dcm_1520 */
/*******************************************************************************
 ...
 */
/*************************************************************************/
static FUNC(void, DCM_CODE) DslInternal_SetSecurityLevel(Dcm_SecLevelType NewSec);
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) Dcm_InterInit(void)
{
    uint16 Index;
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) Dcm_InterMainFunction(void)
{
#if (STD_ON == DCM_SESSION_FUNC_ENABLED)
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) Dcm_MainFunction_Pending2A(uint8 ProtocolCtrlId)
{
#if (STD_ON == DCM_UDS_SERVICE0X2A_ENABLED)
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) DspInternal_DcmConfirmation_0x27(uint8 ProtocolCtrlId)
{
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) DspInternal_DcmConfirmation_0x10(uint8 ProtocolCtrlId)
{
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) DspInternal_DcmConfirmation_0x11(uint8 ProtocolCtrlId)
{
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) DsdInternal_ManufacturerConfirmation(uint8 ProtocolCtrlId)
{
#if (STD_ON == DCM_DSD_REQUEST_MANUFACTURER_NOTIFICATION_ENABLED)
    uint8 MsgCtrlIndexx;
    uint16 PortIndex;
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) DsdInternal_SupplierConfirmation(uint8 ProtocolCtrlId)
{
#if (STD_ON == DCM_DSD_REQUEST_SUPPLIER_NOTIFICATION_ENABLED)
    uint8 MsgCtrlIndexx;
    uint16 PortIndex;
 ...
 */
/*************************************************************************/
static FUNC(void, DCM_CODE) DslInternal_S3ServerStop(void)
{
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) DslInternal_ProtocolStartSession(void)
{
#if (STD_ON == DCM_SESSION_FUNC_ENABLED)
 ...
 */
/*************************************************************************/
FUNC(uint8, DCM_CODE) Dcm_GetChannelNum(void)
{
 ...
 */
/*************************************************************************/
FUNC(void, DCM_CODE) Dcm_StopS3timer(void)
{
#if (STD_ON == DCM_SESSION_FUNC_ENABLED)
    /*Stop S3Server timer*/
#if !DCM_DELAY_COMM_INACTIVE
 ...
 */
/*************************************************************************/
FUNC(boolean, DCM_CODE) Dcm_CheckUDS0x86_TxConfirmation(uint8 ProtocolCfgCtrlId)
{
    boolean ret;
#if (STD_ON == DCM_UDS_SERVICE0X86_ENABLED)
...
#include "Dcm_MemMap.h"
FUNC(void, DCM_CODE) Dcm_TxConfirmation_2A(PduIdType DcmTxPduId)
{
#if (STD_ON == DCM_UDS_SERVICE0X2A_ENABLED)
    uint8 index;
 ...
 */
/*************************************************************************/
FUNC(uint8, DCM_CODE) Dcm_GetRxIdNum(void)
{
 ...
 */
/*************************************************************************/
FUNC(uint8, DCM_CODE) Dcm_GetTxIdNum(void)
{
        ...
        for (SecCfgIndex = 0; SecCfgIndex < DCM_SECURITY_NUM; SecCfgIndex++)
        {
            if (DCM_SECTIMER_ON == (pDcm_RunDlyCtrl->Dcm_SecTimerState[SecCfgIndex]))
            {
                ...
                if (Timer >= ExpireTimer)
                {
                    ...
                    /*********************************/
                    Dcm_SecCtrl.Dcm_FalseAcessCount[SecCfgIndex] = 1;
 ...
 */
/*************************************************************************/
FUNC(Std_ReturnType, DCM_CODE) Dcm_TpRxIndication_3E80(uint8 connectionId)
{
    Std_ReturnType ret = E_OK;
