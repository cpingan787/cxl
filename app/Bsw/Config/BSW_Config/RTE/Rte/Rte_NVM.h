...
uint8 NvMBlock_DIDB001_RomAddress[20]={0};
uint8 NvMBlock_DIDB004_RomAddress[24]={0};
uint8 NvMBlock_listentiming_RomAddress[8]={0};
uint8 NvMBlock_canUserMode_RomAddress[8]={0};
uint8 NvMBlock_dtcEepromCheck_RomAddress[8]={0};
