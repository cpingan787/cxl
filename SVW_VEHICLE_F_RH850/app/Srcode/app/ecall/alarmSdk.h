...
/* ========================= AID/MID/Subcommand 宏定义 ========================= */
/* AID - 应用标识 */
#define ALARM_SDK_AID                           0x04U

/* MID - 消息标识 */
#define ALARM_SDK_MID_LOG_REPORT               0x01U   /* 日志上报 */
#define ALARM_SDK_MID_ECALL                    0x10U   /* ECALL相关操作 */
#define ALARM_SDK_MID_ECALL_TRIIGRD            0x16U   /* ECALL触发状态 */

/* Subcommand - 子命令 (MID = 0x10 时使用) */
#define ALARM_SDK_SUBCMD_ECALL_TRIGGER          0x01U   /* ECALL触发 */
#define ALARM_SDK_SUBCMD_ECALL_STATUS           0x02U   /* ECALL状态请求/响应 */
#define ALARM_SDK_SUBCMD_ECALL_SELFCHK_PERIOD   0x04U   /* 自检周期发送 */
#define ALARM_SDK_SUBCMD_ECALL_AMP_SDZ          0x05U   /* 功放静音控制 */
#define ALARM_SDK_SUBCMD_ECALL_STOP             0x11U   /* ECALL停止 */

/* Subcommand - 子命令 (MID = 0x01 时使用) */
#define ALARM_SDK_SUBCMD_LOG_REPORT             0x01U   /* 日志上报 */

/* Subcommand - 子命令 (MID = 0x16 时使用) */
#define ALARM_SDK_SUBCMD_ECALL_TRIIGRD_REQUEST            0x01U   /* 请求ECALL触发状态 */
#define ALARM_SDK_SUBCMD_ECALL_TRIIGRD_RESPONSE           0x02U   /* 响应ECALL触发状态 */

/* ========================= 其他配置宏 ========================= */
#define SELFCHECK_RESULT_SEND   1
#define ECALL_SYNC_TRIIGED   1
#define ECALL_SYNC_NO_TRIIGED   0
typedef enum
{
...
typedef enum {
    ...
    ECALL_CORE_TEST_MODE,      // 测试模式，主动触发一次自检（重新开始自检），超时时间为10秒
...
typedef struct {
    ...
    uint16_t testModeTimeMs;     // 测试模式超时 (ms)
} EcallCoreConfig_t;
