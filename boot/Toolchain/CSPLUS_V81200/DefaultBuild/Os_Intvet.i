...
void Os_ISR_RCAN0ERR_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RCAN0ERR_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RCAN0ERR_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RCAN0ERR_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RCAN0ERR_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RCAN0ERR_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RCAN0TRX_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RCAN0TRX_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RCAN0TRX_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RCAN0TRX_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RCAN0TRX_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RCAN0TRX_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_WDTA1_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_WDTA1_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_WDTA1_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_WDTA1_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_WDTA1_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_WDTA1_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
