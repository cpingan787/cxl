...
#define ECUM_MAX_WAKE_UP_SOURCE_NUM         3
...
#define ECUM_ALL_WKSOURCE                    ((uint32)(EcuMWakeupSource_CAN|EcuMWakeupSource_Local|EcuMWakeupSource_Time))

#define EcuMDriverInitListBswM_0                       0u
#define EcuMDriverInitListBswM_Diag                       1u
