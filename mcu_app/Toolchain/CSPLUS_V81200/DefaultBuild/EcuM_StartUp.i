...
static  void EcuM_InternalInit(void);



 
static  void EcuM_StartPreOS(void);

 
static  void EcuM_MapReset2WakeupSource(Mcu_ResetType resetReason);
...
EcuM_StartupTwo(void)
{

    {
        ...
        EcuMRunData.State = (EcuM_StateType)0x10;
        BswM_EcuM_CurrentState((EcuM_StateType)0x10);

        if ((*EcuMRunData.Wks.Validated) != 0u)
        {
            BswM_EcuM_CurrentWakeup((*EcuMRunData.Wks.Validated), (EcuM_WakeupStatusType)2);
        }
    }
}
...
static  void EcuM_StartPreOS(void)
{
    Mcu_ResetType resetReason;
    {
        ...
        if ((EcuM_ConfigPtr == ((void *)0)) || (EcuM_ConfigConsistencyHash != EcuM_ConfigPtr->configConsistencyHash))
        {
...
static  void EcuM_MapReset2WakeupSource(Mcu_ResetType resetReason)
{
    ...
    for (wkSrcIdx = 0u; wkSrcIdx < (uint8)3; wkSrcIdx++)
    {
