...
/*============================================================================*/
/* Purpose:                                                                   */
/* This file contains the declaration of structure pointer for accessing      */
/* the hardware registers of ADC module                                       */
 ...
 *                              Added declaration for global register
 *                              structure for DMA.
 ...
 *                              Updated memory sections usage and updated
 *                              includes.
 ...
 *                            Inclusion for Iocommon_Types.h is added
 * V2.1.3:  16-Jun-2021    : The following changes are made:
 ...
 * GENERATED ON:  11 Mar 2026 - 19:28:40
 */

#ifndef ADC_HARDWARE_H
#define ADC_HARDWARE_H
...
#define ADC_HARDWARE_AR_RELEASE_MAJOR_VERSION  4U
#define ADC_HARDWARE_AR_RELEASE_MINOR_VERSION  2U
#define ADC_HARDWARE_AR_RELEASE_REVISION_VERSION  2U

/* File version information */
#define ADC_HARDWARE_SW_MAJOR_VERSION  1U
#define ADC_HARDWARE_SW_MINOR_VERSION  1U
...
/* ADC units supporting configuration registers*/
/* Implements ADC_ESDD_UD_175 */
#define ADC_CONFREG_INSTANCES               0x02U

/* ADC units supporting virtual channel registers */
#define ADC_VIRCHREG_INSTANCES              0x02U

/* Scan Groups supported */
#define ADC_SGREG_INSTANCES                 0x06U
...
/*Extern Decelerations*/

extern volatile AdcConfReg* const Adc_GaaConfReg_BaseAddress[ADC_CONFREG_INSTANCES];

extern volatile AdcVirChReg* const Adc_GaaVirChReg_BaseAddress
                                                   [ADC_VIRCHREG_INSTANCES];

extern volatile AdcSGReg* const Adc_GaaSGReg_BaseAddress[ADC_SGREG_INSTANCES];

  #define ADC_STOP_SEC_CONST_UNSPECIFIED
#include ADC_MEMMAP_FILE

#endif /* ADC_HARDWARE_H */
/*******************************************************************************
**                          End of File                                       **
*******************************************************************************/
