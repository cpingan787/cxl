...
static const uint8 Ecum_WkSources_0[2]={0, 1};
...
const EcuM_SleepModeCfgType EcuM_SleepModeCfgs[1]=
{
     
    {
        ...
        2,     
        &Ecum_WkSources_0[0], 
        (uint32)((uint32)0x01u << (5))|(uint32)((uint32)0x01u << (6)) 
    }
};
...
static const NetworkHandleType EcuM_WkSource0RefComMCh =
{
    0u
};

 
const EcuM_WakeupSourceCfgType EcuM_WkSourceCfgs[3]=
{
...
const Mcu_ModeType EcuM_NormalMcuModeCfg = ((Mcu_ModeType)0xffu);     
...
const EcuM_UserCfgType EcuM_UserCfgs[1]=
{
...
const EcuM_AlarmClockCfgType     EcuM_AlarmClkCfgs[1]=
{
