...
static boolean StopProtocolFaild = 0u;
...
static  Std_ReturnType Dcm_CheckProtocol(uint8 ProtocolCfgId, uint8 ServiceType);
...
static inline  Std_ReturnType Dcm_CopyTxData_CheckCtrlStatus(PduIdType DcmTxPduId);
...
static  Std_ReturnType Dcm_TpRxIndication_IsFuncAddress(PduIdType DcmRxPduId);
...
static  void Dcm_CancelPendingService(uint8 ProtocolCfgId);
 ...
 void Dcm_ComM_NoComModeEntered(uint8 NetworkId)
{
    ...
    {
        DCM_DET_REPORTERROR((0x21u), (0x05u));
    }
    else
    {
 ...
 void Dcm_ComM_SilentComModeEntered(uint8 NetworkId)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x22u), (0x05u));
    }
    else
    {
        SchM_Enter_Dcm_ExclusiveArea();
 ...
 void Dcm_ComM_FullComModeEntered(uint8 NetworkId)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x23u), (0x05u));
    }
    else
    {
        SchM_Enter_Dcm_ExclusiveArea();
 ...
 void DslInternal_P2ServerTimeout(uint8 ProtocolCtrlId)
{
    const Dcm_DslCfgType* pDcmDslCfg = DcmPbCfgPtr->pDcmDslCfg;
    ...
    if ((PendingNumx < PendingMaxTimes) || (PendingMaxTimes == 0u))
    {
        ...
        DsdInternal_SetNrc(ProtocolCtrlId, ((Dcm_NegativeResponseCodeType)0x78u));
    ...
    else
    {
        ...
        DsdInternal_SetNrc(ProtocolCtrlId, ((Dcm_NegativeResponseCodeType)0x10u));
        DsdInternal_ProcessingDone(ProtocolCtrlId);
    }
}
...
static  Std_ReturnType DslInternal_ProtocolStart(uint8 ProtocolCtrlId)
{
    boolean Flag;
    uint8 Index;
    uint8 NotOkNum = 0u;
    ...
    if (DCM_PROTOCOL_INVALID == Dcm_ProtocolCtrl[ProtocolCtrlId].Dcm_ProtocolState)
    {
        ...
        Flag = 0u;
        for (Index = 0; (Index < Request_PortNum) && (0u == Flag); Index++)
        {
            if (((void *)0) == pDcmDslCallback_DCMRequestService[Index].StartProtocol)
            {
                Flag = 1u;
            }
            else
 ...
 Std_ReturnType DslInternal_ProtocolStop(uint8 ProtocolCtrlId)
{
    boolean Flag;
    uint8 Index;
    uint8 NotOkNum = 0u;
    ...
    if (DCM_PROTOCOL_VALID == Dcm_ProtocolCtrl[ProtocolCtrlId].Dcm_ProtocolState)
    {
        ...
        for (Index = 0; (Index < Request_PortNum) && (0u == Flag); Index++)
        {
            if (((void *)0) == pDcmDslCallback_DCMRequestService[Index].StopProtocol)
            {
                Flag = 1u;
            }
            else
 ...
 void DslInternal_ResetResource(uint8 ProtocolCtrlId)
{
    PduIdType TxPduId;
    ...
    if ((((Dcm_SesCtrlType)0x01u) == Dcm_MkCtrl.Dcm_ActiveSes) && ((0xFFu) != NetworkChannel))
    {
        Flag = 0u;
        ...
        if (0u == Flag)
        {
            ...
            Dcm_MkCtrl.Dcm_ActiveNetwork = (0xFFu);
        }
    }
    ...
    PduLengthType * bufferSizePtr)
{
    ...
    else
    {
        ...
        {
                if (0u == Dcm_ConnectionCtrl[ConnectionCfgCtrlId].Dcm_ConnectionActive)
                {
                    ...
                    {
                        if (1u == pDcmDslCfg->pDcmDslDiagRespCfg->DcmDslDiagRespOnSecondDeclinedRequest)
                        {
                             
                            Dcm_ProtocolCtrl[ProtocolCfgCtrlId].MsgCtrlIndex = MsgCtrlIndex;
                            DsdInternal_SetNrc(ProtocolCfgCtrlId, ((Dcm_NegativeResponseCodeType)0x21u));
    ...
    if (BUFREQ_OK == bufRet)
    {
        if ((info != ((void *)0)) && (len < (uint32)info->SduLength))
        {
            *bufferSizePtr = 0;
        }
        else
    ...
    PduLengthType * bufferSizePtr)
{
    ...
    if (DCM_ON != (Dcm_MkCtrl.Dcm_MkState))
    {
        DCM_DET_REPORTERROR((0x46u), (0x05u));
    }
    else if (((void *)0) == bufferSizePtr)
    {
         
        DCM_DET_REPORTERROR((0x46u), (0x07u));
    }
    else if (id >= RxIdNum)
    {
         
        DCM_DET_REPORTERROR((0x46u), (0x06u));
    }
    else
    {
    ...
    PduLengthType * bufferSizePtr)
{
    ...
    if (DCM_ON != (Dcm_MkCtrl.Dcm_MkState))
    {
        DCM_DET_REPORTERROR((0x44u), (0x05u));
    }
    else if ((((void *)0) == info) || (((void *)0) == bufferSizePtr))
    {
         
        DCM_DET_REPORTERROR((0x44u), (0x07u));
    }
    else if (id >= RxIdNum)
    {
         
        DCM_DET_REPORTERROR((0x44u), (0x06u));
    }
    else
    {
 ...
 void Dcm_TpRxIndication(PduIdType id, Std_ReturnType result)
{
    ...
    if (DCM_ON != (Dcm_MkCtrl.Dcm_MkState))
    {
        DCM_DET_REPORTERROR((0x45u), (0x05u));
    }
    else
    {
        pDsl_Protocol_ConnectionCfg = DcmPbCfgPtr->DslProtocolConnectionCfg;
        ...
        if (result != 0U)
        {
            if (Dcm_FunctionalMessage.ConcurrentTesterFailed == 0u)
            {
            ...
            else
            {
                ...
                Dcm_FunctionalMessage.ConcurrentTesterFailed = 0u;
            }
        }
        else
        {
            ...
            {
                {
                    ...
                    else
                    {
                        ...
                        Dcm_MsgCtrl[MsgCtrlIndexx].Dcm_TxCtrlChannelIndex = TxChannelCfgCtrlId;
                        SchM_Exit_Dcm_ExclusiveArea();
                        if (((void *)0) == pDslConnection->pDcmDslMainConnection->pDcmDslProtocolTx)
                        {
                            Dcm_MsgCtrl[MsgCtrlIndexx].DcmTxPduId = (0xFFu);
                        }
                        else
                        {
                        ...
                        for (Index = 0; Index < MainConnectionNum; Index++)
                        {
                            if (NetworkChannel == Dcm_CommCtrl[Index].DcmDslProtocolComMChannelId)
                            {
                                ...
                                if ((DCM_COMM_ACTIVE == Dcm_CommCtrl[Index].Dcm_ActiveDiagnostic)
                                    && (((Dcm_SesCtrlType)0x01u) == Dcm_MkCtrl.Dcm_ActiveSes))
                                {
    ...
    PduLengthType * availableDataPtr)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x43u), (0x05u));
    }
     
    else if ((((void *)0) == info) || (((void *)0) == availableDataPtr))
    {
        DCM_DET_REPORTERROR((0x43u), (0x07u));
    }
     
    else if (id >= TxIdNum)
    {
        DCM_DET_REPORTERROR((0x43u), (0x06u));
    }
    else
    {
        ...
        else
        {
            ...
            Len = *Position + (uint32)info->SduLength;
            {
                ...
                {
                    if ((((void *)0) == retry) || (TP_DATACONF == retry->TpDataState))
                    {
 ...
 void Dcm_TpTxConfirmation(PduIdType id, Std_ReturnType result)
{
    ...
    if (DCM_ON != (Dcm_MkCtrl.Dcm_MkState))
    {
        DCM_DET_REPORTERROR((0x40u), (0x05u));
    }
    else
    {
        pDsl_Protocol_ConnectionCfg = DcmPbCfgPtr->DslProtocolConnectionCfg;
        ...
        case 1U:
            ...
            break;
        case 0U:
            if (1u == Dcm_CheckUDS0x86_TxConfirmation(ProtocolCfgCtrlId))
            {
 ...
 void Dcm_TxConfirmation(PduIdType DcmTxPduId)
{
 ...
 void DslInternal_ProcessingDone(uint8 ProtocolCtrlId)
{
    ...
    for (Index = 0; Index < ConnectionNum; Index++)
    {
        if (pDsl_Protocol_ConnectionCfg[Index].DcmDslParentProtocolRowCtrlId == ProtocolCtrlId)
        {
            ...
            {
                if ((pDcmDslMainConnection != ((void *)0))
    ...
    if ((ProcessOn == 1u) && (DcmTxPduIdx == (0xFFu)))
    {
    ...
    if (ProcessOn == 1u)
    {
        ret = PduR_Transmit(DcmTxPduIdx, &PduInfo);
        if (1U == ret)
        {
...
static inline  Std_ReturnType Dcm_CopyTxData_CheckCtrlStatus(PduIdType DcmTxPduId)
{
    ...
    if ((0U == ret) && (DCM_MSG_TRANSMISSION != Dcm_MsgCtrl[MsgCtrlId].Dcm_MsgState)
    )
    {
    ...
    if ((0U == ret) && (DCM_CH_OCCUPIED != Dcm_ChannelCtrl[RxChannelCtrlId].Dcm_ChannelRxState))
    {
         
        ret = 1U;
    }
    if ((0U == ret) && (DCM_CH_OCCUPIED != Dcm_ChannelCtrl[TxChannelCtrlId].Dcm_ChannelTxState))
    {
 ...
 
{
    ...
    if (DCM_PROTOCOL_VALID != Dcm_ProtocolCtrl[ProtocolCfgId].Dcm_ProtocolState)
    {
        ...
        for (iloop = 0; (iloop < ProtocolMsgNum) && (FindProtocolValid == 0u); iloop++)
        {
            ...
            {
                FindProtocolValid = 1u;  
            }
        }
        if (FindProtocolValid == 1u)
        {
            if (ServiceType == (0x00u))
            {
            ...
            else
            {
                ...
                if (0U == ret)
                {
                    ...
                    {
                        if (0U != DslInternal_ProtocolStop(FindProtocolCfgId))
                        {
                            StopProtocolFaild = 1u;
                            ret = 1U;
                        }
                        else
                        {  
                            if (MsgCtrlIndexx != (0xFFu))
                            {
...
static  Std_ReturnType Dcm_TpRxIndication_IsFuncAddress(PduIdType DcmRxPduId)
{
 ...
 Std_ReturnType DslInternal_RxIndicationDeal(uint8 ProtocolCfgCtrlId)
{
    Std_ReturnType ret = 1U;
    Dcm_ProtocolType ProtocolId =
        DcmPbCfgPtr->pDcmDslCfg->pDcmDslProtocol->pDcmDslProtocolRow[ProtocolCfgCtrlId].DcmDslProtocolID;
     
    if (0U != Dcm_CheckProtocol(ProtocolCfgCtrlId, Dcm_ClassifyServiceType(ProtocolId)))
    {
        SchM_Enter_Dcm_ExclusiveArea();
        if (1u == StopProtocolFaild)
        {
            StopProtocolFaild = 0u;
            DsdInternal_SetNrc(ProtocolCfgCtrlId, ((Dcm_NegativeResponseCodeType)0x22u));
            DsdInternal_ProcessingDone(ProtocolCfgCtrlId);
        }
        else if (DcmPbCfgPtr->pDcmDslCfg->pDcmDslDiagRespCfg->DcmDslDiagRespOnSecondDeclinedRequest == 1u)
        {
            Dcm_MsgCtrl[ProtocolCfgCtrlId].NRC = ((Dcm_NegativeResponseCodeType)0x21u);
    ...
    else
    {
        ...
        else
        {
            ...
            if (((Dcm_NegativeResponseCodeType)0x21u) == Dcm_MsgCtrl[ProtocolCfgCtrlId].NRC)
            {
                DsdInternal_ProcessingDone(ProtocolCfgCtrlId);
            }
            else
...
static  void Dcm_CancelPendingService(uint8 ProtocolCfgId)
{
    ...
    if (((Dcm_OpStatusType)0x01u) == Dcm_MsgCtrl[MsgCtrlIndexx].Dcm_OpStatus)
    {
         
        Std_ReturnType (*Dcm_DiagnosticServicex)
        (Dcm_OpStatusType OpStatus,
         uint8 ProtocolCtrlId,
         Dcm_NegativeResponseCodeType * ErrorCode);
        Dcm_NegativeResponseCodeType errorCode;
        ...
        Dcm_DiagnosticServicex =
            ((DcmPbCfgPtr->pDcmDsdCfg->pDcmDsdServiceTable)[SidTabCfgIndex].pDcmDsdService)[SidTabServiceCfgIndex]
                .DcmDsdSidTabFnc;
        (void)(*Dcm_DiagnosticServicex)(((Dcm_OpStatusType)0x02u), ProtocolCfgId, &errorCode);
    }
}
