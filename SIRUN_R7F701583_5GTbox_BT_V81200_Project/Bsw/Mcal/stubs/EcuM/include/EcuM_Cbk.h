 ...
 * V1.0.1:  25-Sep-2019    : Add EcuM macro
 *                           EcuMConf_EcuMWakeupSource_EcuMWakeupSource_X
 */
/*******************************************************************************
**                         Input File                                         **
*******************************************************************************/
...
#define ECUM_CBK_SW_MINOR_VERSION    2
...
#define  EcuMConf_EcuMWakeupSource_EcuMWakeupSource_1     (uint8)5
#define  EcuMConf_EcuMWakeupSource_EcuMWakeupSource_2     (uint8)8
#define  EcuMConf_EcuMWakeupSource_EcuMWakeupSource_3     (uint8)6
#define  EcuMConf_EcuMWakeupSource_EcuMWakeupSource_4     (uint8)8
#define  EcuMConf_EcuMWakeupSource_EcuMWakeupSource_5     (uint8)8
#define  EcumWkSourceReset                                (EcuM_WakeupSourceType)1

#define  GPT_WKP_SRC_1                                    (EcuM_WakeupSourceType)32ul
#define  GPT_WKP_SRC_2                                    (EcuM_WakeupSourceType)64ul
#define  GPT_WKP_SRC_3                                    (EcuM_WakeupSourceType)128ul
#define  GPT_WKP_SRC_4                                    (EcuM_WakeupSourceType)256ul
