 ...
 * V2.0.2   17-Jan-2017    : WDG_59_DRIVERA_E_MODE_FAILED_REPORTING check added
 * V2.0.3   23-Feb-2017    : #ARDAABD-568
 *                           1. Removed WDG_59_DRIVERA_DEM_TYPE and
 *                           WDG_59_DRIVERA_DEM_TYPE macro definition.
 *                           Macro usage was related to Autosar 3.2.2.
 * V2.0.4   13-Mar-2017    : #ARDAABD-1207
 *                           Traceability update
 * V2.0.5   15-Mar-2017    : #ARDAABD-1207
 *                           Traceability update
 * V2.0.6   15-Jun-2017    : As part of ARDAABD-1897 Jira ticket, code was
 *                           updated after QAC analysis
 * V2.0.7   06-Jul-2017    : Following Changes are made :
 ...
 * V2.0.8   06-Aug-2018    : Following changes are made:
 *                           1. As part of ARDAABD-2266 Jira ticket,
 *                              a. Wdg_59_DriverA_GusTiggerCounter is renamed to
 *                                 Wdg_59_DriverA_GusTriggerCounter.
 *                              b. WDG_59_DriverA_WUFReg_BaseAddr is renamed to
 *                                 WDG_59_DriverA_GpWUFReg_BaseAddr.
...
** Preconditions         : None
**
** Global Variables Used : Wdg_59_DriverA_GusTriggerCounter,
**                         WDG_59_DriverA_GpWUFReg_BaseAddr.
**
...
/* Implements: EAAR_PN0064_NR_0018, EAAR_PN0064_FR_0035, EAAR_PN0064_FR_0031  */
...
#endif
{
  ...
  /* Implements: WDG_ESDD_UD_066, WDG_ESDD_UD_068                             */
  /* Implements: MP_F1x_V3.03.06_WDG_RS_1                                     */
  #if (WDG_59_DRIVERA_WAKEUP_FACTOR_CLEAR_ISR == STD_ON)

  (WDG_59_DriverA_GpWUFReg_BaseAddr->ulWUFC0) = WDG_59_DRIVERA_INT_MASKVALUE;

  #endif

  /* Check if the trigger counter has completed the timeout value requested */
  if (Wdg_59_DriverA_GusTriggerCounter > WDG_59_DRIVERA_ZERO)
  {
...
** Registers Used        : None
*******************************************************************************/
/* Implements: WDG_ESDD_UD_030, WDG_ESDD_UD_010                            */
...
{
  /* Check if WdgWakeUpFactor enabled  */
  /* Implements: WDG_ESDD_UD_066                                              */
  /* Implements: MP_F1x_V3.03.06_WDG_RS_1                                     */
  #if (WDG_59_DRIVERA_WAKEUP_FACTOR_CLEAR_ISR == STD_ON)

  (WDG_59_DriverA_GpWUFReg_BaseAddr->ulWUFC0) = WDG_59_DRIVERA_NMI_MASKVALUE;
