...
static  Std_ReturnType
    Dcm_UDS0x19_01(uint8 ProtocolCtrlId, Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    uint16 DtcCount = 0;
    uint32 Offset;
    boolean NotAllowedFlag = 0u;
    boolean PendingFlag = 0u;
    Std_ReturnType ret = 0U;
    Dcm_MsgLenType MsgLen;
    ...
    if ((3U) != pMsgContext->ReqDataLen)
    {
        ...
        *ErrorCode = ((Dcm_NegativeResponseCodeType)0x13u);
        ret = 1U;
    }
    if (0U == ret)
    {
        ...
        if (1u == NotAllowedFlag)
        {
             
            *ErrorCode = ((Dcm_NegativeResponseCodeType)0x22u);
            ret = 1U;
        }
        else if (1u == PendingFlag)
        {
             
            Dcm_MsgCtrl[MsgCtrlId].Dcm_OpStatus = ((Dcm_OpStatusType)0x01u);
            ret = ((Std_ReturnType)10);
        }
        else
        {
            ...
            if ((MsgLen) > pDcmChannelCfg->Dcm_DslBufferSize)
            {
                ...
                *ErrorCode = ((Dcm_NegativeResponseCodeType)0x14u);
                ret = 1U;
            }
            if (0U == ret)
            {
...
static  Std_ReturnType Dcm_UDS0x19_02_SubDealTwo(uint8 ProtocolCtrlId, Dcm_MsgLenType MsgLen)
{
    uint8 TxChannelCtrlIndex;
    uint8 TxChannelCfgIndex;
    uint8 MsgCtrlId;
...
static  void Dcm_UDS0x19_02_SubDealone(
    uint8 ProtocolCtrlId,
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0x00u == ReturnSetDTCFilter)
    {
        ...
        case 0x00u:
            Flag = 0u;
            uint32 totalsize = (uint32)((uint32)(*Dcm_UDS0x19Type->DtcCount) * 4uL) + 3uL;
            if (totalsize > pDcmChannelCfg->Dcm_DslBufferSize)
            {
                {
                    Flag = 1u;
                    *ErrorCode = ((Dcm_NegativeResponseCodeType)0x14u);
            ...
            for (uint16 index = 0;
                 ((index < (*Dcm_UDS0x19Type->DtcCount)) && (0u == Flag)
                 );
                 ++index)
            {
                ...
                case 0x00u:
                    ...
                    break;
                case 0x02u:
                    *(Dcm_UDS0x19Type->PendingFlag) = 1u;
                    Flag = 1u;
                    break;
                case 0x03u:
                case 0x01u:
                default:
                    Flag = 1u;
                    {
                        *(Dcm_UDS0x19Type->NotAllowedFlag) = 1u;
                    }
                    break;
                }
            }
...
static  Std_ReturnType
    Dcm_UDS0x19_02(uint8 ProtocolCtrlId, Dcm_NegativeResponseCodeType * ErrorCode)
{
    uint8 TxChannelCtrlIndex;
    uint8 TxChannelCfgIndex;
    uint8 MsgCtrlId;
    ...
    if (0U == ret)
    {
        ...
        MsgLen = 3u;  
        {
            ...
            Dcm_Channel[Offset + 1u] = 0x02u;
             
            ret = Dem_DcmGetDTCStatusAvailabilityMask(&Dcm_Channel[Offset + MsgLen - 1u]);
            mask = Dcm_Channel[Offset + MsgLen - 1u];
        }
        if (0U != ret)
        {
            NotAllowedFlag = 1u;
        ...
        else
        {
            ...
            if (((mask != 0u) && (Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[2] != 0u))
            )
            {
                ...
                Dcm_UDS0x19_02_SubDealone(ProtocolCtrlId, &Dcm_UDS0x19Type, ErrorCode);
            }
        }
        if (1u == NotAllowedFlag)
        {
        ...
        {
            {
                ret = Dcm_UDS0x19_02_SubDealTwo(ProtocolCtrlId, MsgLen);
            }
        }
    }
    return ret;
...
static  Std_ReturnType Dcm_UDS0x19_04_SubSubDeal(
    uint8 ProtocolCtrlId,
    const Dcm_UDS0x19Types * Dcm_UDS0x19Type,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    *(MsgLen) = *(MsgLen) + 1u;
    ...
    retGetStatusOfDTC = Dem_DcmGetStatusOfDTC(Dtc, 0x01u, &DtcStatus);
    if (retGetStatusOfDTC != 0x00u)
    {
        *(Dcm_UDS0x19Type->NotAllowedFlag) = 1u;
    }
    else
    {
        ...
        Dcm_Channel[Offset + *(MsgLen)] = DtcStatus;
        *(MsgLen) = *(MsgLen) + 1u;
        ReturnDisableDTCRecordUpdate = Dem_DcmDisableDTCRecordUpdate(Dtc, 0x01u);
        if (0x00u == ReturnDisableDTCRecordUpdate)
        {
            for (Index = 0u; (Index < 0xFFu) && (ret == 0U); Index++)
            {
                ...
                retGetFreezeFrameDataByDTC = Dem_DcmGetFreezeFrameDataByDTC(
                    ...
                    &BufferSize);
                if (0x00u == retGetFreezeFrameDataByDTC)
                {
                    Dcm_Channel[Offset + *(MsgLen)] = Index;
                    *(MsgLen) = *(MsgLen) + (uint32)BufferSize + 1u;
                }
                else if (0x05u == retGetFreezeFrameDataByDTC)
                {
                    *(Dcm_UDS0x19Type->PendingFlag) = 1u;
                    break;
                }
                else if (
                    (0x01u == retGetFreezeFrameDataByDTC)
                    || (0x02u == retGetFreezeFrameDataByDTC))
                {
                     
                    *ErrorCode = ((Dcm_NegativeResponseCodeType)0x31u);
                    (void)Dem_DcmEnableDTCRecordUpdate();
                    ret = 1U;
                }
                else
                {
                    if (0x03u == retGetFreezeFrameDataByDTC)
                    {
                        cnt++;
                    }
                    if (cnt == 0xFFu)
            ...
            if (0U != Dem_DcmEnableDTCRecordUpdate())
            {
                *(Dcm_UDS0x19Type->NotAllowedFlag) = 1u;
            }
        }
        else if (0x01u == ReturnDisableDTCRecordUpdate)
        {
            *(Dcm_UDS0x19Type->NotAllowedFlag) = 1u;
        }
        else
...
static  Std_ReturnType Dcm_UDS0x19_04_SubDeal(
    uint8 ProtocolCtrlId,
    const Dcm_UDS0x19Types * Dcm_UDS0x19Type,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
            ...
            if (0x00u == ReturnDisableDTCRecordUpdate)
            {
                ...
                else if (0x05u == retGetFreezeFrameDataByDTC)
                {
                    *(Dcm_UDS0x19Type->PendingFlag) = 1u;
                    ...
                    (0x01u == retGetFreezeFrameDataByDTC)
                    || (0x02u == retGetFreezeFrameDataByDTC)
                    || (0x03u == retGetFreezeFrameDataByDTC))
                {
...
static  Std_ReturnType
    Dcm_UDS0x19_04(uint8 ProtocolCtrlId, Dcm_NegativeResponseCodeType * ErrorCode)
{
    uint8 TxChannelCtrlIndex;
    uint8 TxChannelCfgIndex;
    uint8 MsgCtrlId;
...
static  Std_ReturnType Dcm_UDS0x19_06SubDeal(
    uint8 ProtocolCtrlId,
    boolean * PendingFlag,
    Dcm_MsgLenType * MsgLen,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    for (; Index <= 0xEFu; Index++)
    {
        ...
        ReturnGetExtendedDataRecord = Dem_DcmGetExtendedDataRecordByDTC(
            ...
            &Dcm_Channel[Offset + (*MsgLen) + 1u],
            &Size);
        if ((0x00u == ReturnGetExtendedDataRecord) && (Size != 0u))
        {
        ...
        else if (0x05u == ReturnGetExtendedDataRecord)
        {
            *PendingFlag = 1u;
            break;
        }
        ...
        {
            if ((0x01u == ReturnGetExtendedDataRecord)
                || (0x02u == ReturnGetExtendedDataRecord))
            {
        ...
        {
            if (0x03u == ReturnGetExtendedDataRecord)
            {
                cnt++;
            }
            if (cnt == count)
...
static  Std_ReturnType
    Dcm_UDS0x19_06(uint8 ProtocolCtrlId, Dcm_NegativeResponseCodeType * ErrorCode)
{
    uint8 TxChannelCtrlIndex;
    uint8 TxChannelCfgIndex;
    uint32 CurChannelSize;
            ...
            if (0x00u == ReturnDisableDTCRecordUpdate)
            {
                ...
                else
                {
                    ...
                    else if (0x05u == ReturnGetExtendedDataRecord)
                    {
                        ...
                        (0x01u == ReturnGetExtendedDataRecord)
                        || (0x02u == ReturnGetExtendedDataRecord)
                        || (0x03u == ReturnGetExtendedDataRecord))
                    {  
                        *ErrorCode = ((Dcm_NegativeResponseCodeType)0x31u);
                        (void)Dem_DcmEnableDTCRecordUpdate();
                        ret = 1U;
                ...
                if (1U == Dem_DcmEnableDTCRecordUpdate())
                {
                    NotAllowedFlag = 1u;
                }
            }
...
static  Std_ReturnType Dcm_UDS0x19_0ADeal(
    uint8 ProtocolCtrlId,
    uint16 * DtcCount,
    Dcm_MsgLenType * MsgLen,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0x00u == ReturnSetDTCFilter)
    {
        ...
        case 0x00u:
            Flag = 0u;
            for (Index = 0; (Index < *DtcCount) && (0u == Flag)
                     ;
                 Index++)
            {
                ReturnGetNextFilteredDTC = Dem_DcmGetNextFilteredDTC(&Dtc, &DtcStatus);
                ...
                {
                case 0x00u:
                    if ((*MsgLen + 4u) > pDcmChannelCfg->Dcm_DslBufferSize)
                    {
                        {
                            *ErrorCode = ((Dcm_NegativeResponseCodeType)0x14u);
                            ret = 1U;
...
static  Std_ReturnType
    Dcm_UDS0x19_0A(uint8 ProtocolCtrlId, Dcm_NegativeResponseCodeType * ErrorCode)
{
    uint8 TxChannelCtrlIndex;
    uint8 TxChannelCfgIndex;
    uint8 MsgCtrlId;
    ...
    uint16 DtcCount = 0;
    Std_ReturnType ret = 0U;
    Dcm_MsgLenType MsgLen = 3u;
    const Dcm_DslBufferType* pDcmChannelCfg;
    static uint8 mask = 0u;

    MsgCtrlId = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
    if ((2U) != Dcm_MsgCtrl[MsgCtrlId].MsgContext.ReqDataLen)
    {
...
static  Std_ReturnType Dcm_Uds0x19SubfunctionAnalyse(
    uint8 ProtocolCtrlId,
    uint8 Subfunction,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    default:
        ...
        *ErrorCode = ((Dcm_NegativeResponseCodeType)0x12u);
        ret = 1U;
        break;
    }
    return ret;
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        ret = DsdInternal_SubSesCheck(ProtocolCtrlId, 0x19u, ErrorCode);
    }
    if (0U == ret)
    {
         
        ret = DsdInternal_SubSecurityCheck(ProtocolCtrlId, 0x19u, ErrorCode);
    }
