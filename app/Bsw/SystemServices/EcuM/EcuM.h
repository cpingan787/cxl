...
/**
  ...
  RuleSorce:puhua-rule.rcf 2.3.1
    ...
    \li VL_EcuM_4604
      Reason: The function parameter time defined by the standard has the same name as the time in the C library.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

    \li VL_MTR_EcuM_STCDN
    ...
    \li VL_EcuM_1039
      Reason: The data type is defined by standard.
      Risk: No risk.
