...
static  void Dcm_MainFunction_PendingManage(void);
...
static  void Dcm_MainFunction_P2ServerTimer(void);
...
static  void Dcm_GetUDSPhyPduID(PduIdType * rxPhyPduId);

static  void Dcm_BootloaderResponse(void);
...
const Dcm_CfgType * DcmPbCfgPtr = ((void *)0);
...
boolean gAppl_UpdataOK_ResponseFlag = 0u;

boolean Dcm_ReqSetProgConditions = 0u;
...
Dcm_DspProgramType Dcm_DspProgram;
...
uint32 Dcm_Timer = 0u;
 ...
 void Dcm_Init(const Dcm_CfgType * ConfigPtr)
{
    uint32 Index;
    ...
    if (((void *)0) == ConfigPtr)
    {
        DCM_DET_REPORTERROR((0x01u), (0x07u));
    }
    else
    {
        ...
        for (Index = 0; Index < DcmPbCfgPtr->pDcmDslCfg->pDcmDslProtocol->DcmDslProtocolRow_Num; Index++)
        {
            ...
            Dcm_ProtocolCtrl[(uint8)Index].ProtocolId = (0xFFu);
            Dcm_ProtocolCtrl[(uint8)Index].ProtocolPri = (0xFFu);
            Dcm_ProtocolCtrl[(uint8)Index].MsgCtrlIndex = (0xFFu);
            Dcm_ProtocolCtrl[(uint8)Index].P2ServerMax = 50UL;        
            Dcm_ProtocolCtrl[(uint8)Index].P2StarServerMax = 5000UL;  
            Dcm_ProtocolCtrl[(uint8)Index].P2ServerMin = 0UL;
            Dcm_ProtocolCtrl[(uint8)Index].P2StarServerMin = 0UL;
            Dcm_ProtocolCtrl[(uint8)Index].S3Server = 5000UL;  
        ...
        SchM_Enter_Dcm_ExclusiveArea();
        Dcm_MkCtrl.Dcm_ActiveSes = ((Dcm_SesCtrlType)0x01u);
        Dcm_MkCtrl.Dcm_ActiveSec = ((Dcm_SecLevelType)0x00u);
        Dcm_MkCtrl.Dcm_ActiveProtocol = ((Dcm_ProtocolType)0x0Cu);
        Dcm_MkCtrl.Dcm_ActiveNetwork = (0xFFu);
        Dcm_MkCtrl.Dcm_ActiveProtocolCfgCtrlId = (0xFFu);
 ...
 void Dcm_GetVersionInfo(Std_VersionInfoType * VersionInfo)
{
    ...
    {
        DCM_DET_REPORTERROR((0x24u), (0x05u));
    }
    else if (((void *)0) == VersionInfo)
    {
        DCM_DET_REPORTERROR((0x24u), (0x07u));
    }
    else
    {
        VersionInfo->vendorID = (62u);
        VersionInfo->moduleID = (0x35u);
        VersionInfo->sw_major_version = (0x02u);
        VersionInfo->sw_minor_version = (0x01u);
        VersionInfo->sw_patch_version = (0x13u);
    }
}
 ...
 Std_ReturnType Dcm_GetVin(uint8 * Data)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x07u), (0x05u));
    }
    else if (((void *)0) == Data)
    {
        DCM_DET_REPORTERROR((0x07u), (0x07u));
    }
    else
    {
        if (Dcm_VIN.Flag == 1u)
        {
            Dcm_MemoryCopy(Dcm_VIN.DcmVIN, Data, 17);
            ret = 0U;
        }
    }
    return ret;
...
Dcm_DemTriggerOnDTCStatus(uint32 DTC, Dem_UdsStatusByteType DTCStatusOld, Dem_UdsStatusByteType DTCStatusNew)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x2Bu), (0x05u));
    }
    else
    {
...
Dcm_GetSecurityLevel(Dcm_SecLevelType * SecLevel)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x0Du), (0x05u));
    }
    else if (((void *)0) == SecLevel)
    {
        DCM_DET_REPORTERROR((0x0Du), (0x07u));
    }
    else
    {
 ...
 Std_ReturnType
Dcm_GetSesCtrlType(Dcm_SesCtrlType * SesType)
{
    Std_ReturnType ret = 1U;
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x06u), (0x05u));
    }
    else if (((void *)0) == SesType)
    {
        DCM_DET_REPORTERROR((0x06u), (0x07u));
    }
    else
    {
...
Dcm_GetActiveProtocol(Dcm_ProtocolType * ActiveProtocol)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x0Fu), (0x05u));
    }
    else if (((void *)0) == ActiveProtocol)
    {
        DCM_DET_REPORTERROR((0x0Fu), (0x07u));
    }
    else
    {
        *ActiveProtocol = Dcm_MkCtrl.Dcm_ActiveProtocol;
        if ((((Dcm_ProtocolType)0x00u) == *ActiveProtocol) || (((Dcm_ProtocolType)0x01u) == *ActiveProtocol)
            || (((Dcm_ProtocolType)0x02u) == *ActiveProtocol))
        {
            *ActiveProtocol = ((Dcm_ProtocolType)0x0Cu);
        }
        ret = 0U;
    }
    return ret;
 ...
 Std_ReturnType Dcm_ResetToDefaultSession(void)
{
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x2Au), (0x05u));
    }
    else
    {
 ...
 Std_ReturnType Dcm_TriggerOnEvent(uint8 RoeEventId)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x2Du), (0x05u));
        ret = 1U;
    }
    else
    {
 ...
 Std_ReturnType Dcm_SetActiveDiagnostic(boolean active)
{
    ...
    if (DCM_ON != Dcm_MkCtrl.Dcm_MkState)
    {
        DCM_DET_REPORTERROR((0x56u), (0x05u));
    }
    else
    {
        if (0u == active)
 ...
 void Dcm_MainFunction(void)
{
    if (DCM_ON == Dcm_MkCtrl.Dcm_MkState)
    {
        if (Dcm_Timer < (0xFFFFFFFFuL - Dcm_GeneralCfg.DcmTaskTime))
        {
            Dcm_Timer += Dcm_GeneralCfg.DcmTaskTime;
        }
        else
        {
            Dcm_Timer = Dcm_GeneralCfg.DcmTaskTime - (0xFFFFFFFFuL - Dcm_Timer);
        }
...
static  void Dcm_MainFunction_PendingManage(void)
{
    ...
    Std_ReturnType ret = 0U;
    Dcm_NegativeResponseCodeType errorCode = ((Dcm_NegativeResponseCodeType)0x00u);
    ...
    for (iloop = 0; iloop < pDcmDslProtocol->DcmDslProtocolRow_Num; iloop++)
    {
        ...
        if ((0xFFu) != MsgCtrlId)
        {
            ...
            {
                if (DslInternal_RxIndicationDeal(iloop) == 0U)
                {
                    ...
                    if (
                        (((Dcm_OpStatusType)0x03u) == Dcm_MsgCtrl[MsgCtrlId].Dcm_OpStatus))
                    {
                        Dcm_MsgCtrl[MsgCtrlId].Dcm_Ret = 1U;
                    }
                    else if (
                        (((Dcm_OpStatusType)0x01u) == Dcm_MsgCtrl[MsgCtrlId].Dcm_OpStatus)
                        || (((Dcm_OpStatusType)0x00u) == Dcm_MsgCtrl[MsgCtrlId].Dcm_OpStatus))
                    {
                    ...
                    if (ret == 0U)
                    {
                        ...
                        if ((ret != 0U) && (ret != ((Std_ReturnType)12)) && (ret != ((Std_ReturnType)10)))
                        {
                            if (((Dcm_NegativeResponseCodeType)0x00u) == errorCode)
                            {
                                if (ret == 1U)
                                {
                                ...
                                {
                                    DsdInternal_SetNrc(iloop, ((Dcm_NegativeResponseCodeType)0x22u));
                ...
                (0u == Dcm_MsgCtrl[MsgCtrlId].SendFlag)
...
static  void Dcm_MainFunction_P2ServerTimer(void)
{
    ...
    {
        MsgCtrlId = Dcm_ProtocolCtrl[iloop].MsgCtrlIndex;
        if (((0xFFu) != MsgCtrlId) && (DCM_P2TIMER_ON == (Dcm_MsgCtrl[MsgCtrlId].Dcm_P2Ctrl.Dcm_P2State)))
        {
...
static  void Dcm_GetUDSPhyPduID(PduIdType * rxPhyPduId)
{
    ...
    if (((void *)0) != rxPhyPduId)
    {
        for (iloop = 0u; iloop < ProtocolRow_Num; iloop++)
        {
            if (((Dcm_ProtocolType)0x03u) == pDcmDslProtocolRow[iloop].DcmDslProtocolID)
            {
...
static  void Dcm_BootloaderResponse(void)
{
    ...
    if (Dcm_ReqSetProgConditions == 1u)
    {
        ret = Dcm_SetProgConditions(((Dcm_OpStatusType)0x01u), &Dcm_ProgConditions);
        if (ret == 0U)
        {
             
            (void)SchM_Switch_DcmEcuReset(((Rte_ModeType_DcmEcuReset)0x06u));
            Dcm_ReqSetProgConditions = 0u;
        }
        else if (ret == 1U)
        {
            Dcm_ReqSetProgConditions = 0u;
    ...
    if (((Dcm_EcuStartModeType)0x01) == Dcm_GetProgConditions(&Dcm_ProgConditions))
    {
        if (Dcm_ProgConditions.ApplUpdated == 1u)
        {
            gAppl_UpdataOK_ResponseFlag = 1u;
            Dcm_ProgConditions.ApplUpdated = 0u;
