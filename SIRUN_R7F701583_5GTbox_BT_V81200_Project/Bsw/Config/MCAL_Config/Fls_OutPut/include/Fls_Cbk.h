...
extern FUNC(void, FLS_APPL_CODE) JobOkNotification(void);
extern FUNC(void, FLS_APPL_CODE) JobErrorNotification(void);
extern FUNC(void, FLS_APPL_CODE) EccSedNotification(uint32 ErrAddress);
extern FUNC(void, FLS_APPL_CODE) EccDedNotification(uint32 ErrAddress);
