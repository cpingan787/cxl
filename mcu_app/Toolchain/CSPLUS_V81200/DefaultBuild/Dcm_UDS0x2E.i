    ...
    Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    *Dcm_0x2EType->pRangeDidFlag = 0u;
     
     
    for (Index = 0; (Index < pDcmDspCfg->DcmDspDidNum) && (0u == Flag); Index++)
    {
...
static Std_ReturnType DspInternalUDS0x2E_DidSesCheck(uint16 DidInfoCfgIndex)
{
    ...
    else
    {
        ...
        if (SessionRefNum != 0u)
        {
            for (Index = 0; (Index < SessionRefNum) && (1U == ret); Index++)
            {
    ...
    Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    else
    {
        ...
        if (SecRefNum != 0u)
        {
            for (Index = 0; (Index < SecRefNum) && (1U == ret); Index++)
            {
...
static  Std_ReturnType Dcm_Uds0x2EServiceConditionCheck(
    Dcm_OpStatusType OpStatus,
    uint8 ProtocolCtrlId,
    const Dcm_0x2ETypes * Dcm_0x2EType,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        ...
        if ((1u == (pDcmDspDidInfo[*Dcm_0x2EType->DidInfoCfgIndex].DcmDspDidDynamicallyDefined))
            || (pDcmDspDidInfo[*Dcm_0x2EType->DidInfoCfgIndex].pDcmDspDidWrite == ((void *)0)))
        {
...
static  Std_ReturnType Dcm_UDS0x2ESubCheck(
    uint8 ProtocolCtrlId,
    uint16 RecDid,
    uint16 DidInfoCfgIndex,
    Dcm_NegativeResponseCodeType * ErrorCode)
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        if (0u == RangeDidFlag)
        {
            ...
            if ((0U == ret) && ((3u + DidSize) != (uint16)pMsgContext->ReqDataLen))
            {
        ...
        else
        {
            ...
            if (((void *)0) == pDcmDspDidRange[RangeDidCfgIndex].DcmDspDidRangeReadDataLengthFnc)
            {
            ...
            if ((0U == ret) && (((void *)0) == pDcmDspDidRange[RangeDidCfgIndex].DcmDspDidRangeWriteDidFnc))
            {
                *ErrorCode = ((Dcm_NegativeResponseCodeType)0x22u);
                ret = 1U;
            }
    ...
    if ((0U == ret) && ((3u) > (DcmPbCfgPtr->pDcmDslCfg->pDcmChannelCfg[TxChannelCfgIndex].Dcm_DslBufferSize)))
    {
