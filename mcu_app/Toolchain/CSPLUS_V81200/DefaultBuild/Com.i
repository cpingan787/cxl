...
const Com_ConfigType *
Com_ConfigStd = ((void *)0);
...
boolean Com_IpduGroupDMEnable[2u];
...
boolean Com_IpduGroupEnable[2u];
...
static  void Com_SetAllPduRToDisableState(void);

 
static  void Com_PduRTAndBufferInit(void);

 
static  void Com_SignalBufferInit(void);
 
 
static  void Com_RxTimeOutInit(void);
...
{
    {
        ...
        (void)ILib_memset(&Com_IpduGroupEnable[0], 0, 2u);
        (void)ILib_memset(&Com_IpduGroupDMEnable[0], 0, 2u);
...
void Com_IpduGroupControl(Com_IpduGroupVector ipduGroupVector, boolean initialize)
{
 
    {
        ...
        for (Com_IpduGroupIdType ipduGroupCnt = 0u; ipduGroupCnt < 2u; ++ipduGroupCnt)
        {
...
void Com_EnableReceptionDM(Com_IpduGroupIdType IpduGroupId)
{
    ...
    {
        Com_IpduGroupDMEnable[IpduGroupId] = 1u;
        Com_RxPduDMCtrHandle();
    }
    (void)(IpduGroupId);
}
...
void Com_DisableReceptionDM(Com_IpduGroupIdType IpduGroupId)
{
    ...
    {
        Com_IpduGroupDMEnable[IpduGroupId] = 0u;
        Com_RxPduDMCtrHandle();
    }
    (void)(IpduGroupId);
}
...
{
    {
        uint8 vectorByteLength = ((2u - 1u) >> 3u) + 1u;
...
void Com_MainFunctionRx(Com_MainFunctionType mainFunctionId)
{
    if ((COM_INIT == Com_Status) && (mainFunctionId < 1u))
    {
        {
...
void Com_MainFunctionTx(Com_MainFunctionType mainFunctionId)
{
    if ((COM_INIT == Com_Status) && (mainFunctionId < 1u))
    {
        {
...
void Com_MainFunctionRouteSignals(Com_MainFunctionType mainFunctionId)
{
...
static  void Com_SetAllPduRToDisableState(void)
{
    ...
    for (cirCnt = 0u; cirCnt < 118u; ++cirCnt)
    {
    ...
    for (cirCnt = 0u; cirCnt < 44u; ++cirCnt)
    {
...
static  void Com_SignalBufferInit(void)
{
    ...
    (void)
        ILib_memcpy(&Com_RxGroupSignal8BitShadowBuff[0], &Com_Signal8BitInitValue[0], 378u);
    (void)ILib_memcpy(&Com_Signal8BitRuntimeBuff[0], &Com_Signal8BitInitValue[0], 817u);
