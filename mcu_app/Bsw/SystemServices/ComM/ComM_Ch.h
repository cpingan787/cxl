...
extern void ComM_ChLimitWakeUp(uint32 chIdx, boolean stu);
#endif

#if (COMM_MODE_LIMITATION_ENABLED == STD_ON)
extern void ComM_ChLimitNoCom(uint32 chIdx, boolean stu);
#endif
...
extern void ComM_ChGetInhibitionStu(uint32 chIdx, ComM_InhibitionStatusType* chStu);
#endif
