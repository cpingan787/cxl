...
static void PowerManageCheckSpiReady(void);
...
static const uint32_t g_voltageStateHoldTime = 17; // 20 cycles = 200ms (since each cycle is 10ms) GAC need 170-220ms
...
/*************************************************
  Function:       PowerManageCheckSpiReady
  Description:    检查NAD SPI模块是否就绪
  Input:          无
  Output:         无
  Return:         无
*************************************************/
