...
/**
  ...
  RuleSource:puhua-rule.rcf 3.0.0
    ...
    \li VL_MTR_CanTSyn_Unchanged
      Reason: Because the code structure is complex, we'll keep it as it is.
      Risk: No risk.
      Prevention: Ensure that the project is working properly through unit testing.

    \li VL_CanTSyn_2053
      Reason: Special code design of the CanTSyn.
      Risk: No risk.
...
#define CANTSYN_AR_MAJOR_VERSION 4U
#define CANTSYN_AR_MINOR_VERSION 5U
#define CANTSYN_AR_PATCH_VERSION 0U
#define CANTSYN_SW_MAJOR_VERSION 2U
#define CANTSYN_SW_MINOR_VERSION 0U
#define CANTSYN_SW_PATCH_VERSION 9U
