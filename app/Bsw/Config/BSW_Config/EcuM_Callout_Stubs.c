...
FUNC(void, ECUM_MCUSETMODE_CODE) EcuM_McuSetMode(Mcu_ModeType mode)
{
    ...
    if(APP_ReqSleepMode == APP_LISTEN_MODE)
    {
        ...
        mode = McuConf_McuModeSettingConf_McuModeSettingConf_Listen;
        EcuM_SetWakeupEvent(EcuMWakeupSource_CAN);
    }
    else
    {
        Adc_StopGroupConversion(AdcConf_AdcGroup_AdcGroup);
        ...
        mode = McuConf_McuModeSettingConf_McuModeSettingConf_Sleep;
    }
    /** DO NOT CHANGE THIS COMMENT!
     * </USERBLOCK>
     */
 ...
 * Return value: NA
 */
/*PRQA S 0317,0401 ++*/ /*VL_QAC_0317,VL_EcuM_0401*/
...
)
{
     ...
     * </USERBLOCK>
     */
    Wdg_59_DriverB_Init(pbCfg->wdgPbCfg);
    /** DO NOT CHANGE THIS COMMENT!
...
)
{
    ...
    else if (EcuMDriverInitListBswM_Diag == drvInitIdx)
    {
...
)
{
   switch (wakeupSource)
   {
        ...
        case EcuMWakeupSource_Local:
             ...
             */
            break;
        case EcuMWakeupSource_Time:
            /** DO NOT CHANGE THIS COMMENT!
             * <USERBLOCK EcuM_EnableWakeupSources EcuMWakeupSource_Time>
             */
            /* custom code.... */
            /** DO NOT CHANGE THIS COMMENT!
             * </USERBLOCK>
...
)
{
    ...
    else if ((wakeupSource & EcuMWakeupSource_Time)
      == EcuMWakeupSource_Time)
    {
        /** DO NOT CHANGE THIS COMMENT!
         * <USERBLOCK EcuM_DisableWakeupSources EcuMWakeupSource_Time>
         */
        /* custom code.... */
        /** DO NOT CHANGE THIS COMMENT!
         * </USERBLOCK>
...
)
{
     ...
     */
    /* custom code.... */
    if ((wakeupSource & EcuMWakeupSource_CAN) != 0u)
    {
        (void)CanSM_StartWakeupSource(ComMChannel_0);
    }
    /** DO NOT CHANGE THIS COMMENT!
     * </USERBLOCK>
     */
...
)
{
    switch(wakeupSource)
    {
        case EcuMWakeupSource_CAN:
             ...
             */ 
            /* Validate the wakeup only after CanIf has received an NM PDU. */
            (void)CanIf_CheckValidation(EcuMWakeupSource_CAN);
            /** DO NOT CHANGE THIS COMMENT!
             * </USERBLOCK>
             */
            break;
        ...
        case EcuMWakeupSource_Time:
            /** DO NOT CHANGE THIS COMMENT!
             * <USERBLOCK EcuM_CheckValidation EcuMWakeupSource_Time>
             */ 
            /* custom code.... */
            /** DO NOT CHANGE THIS COMMENT!
             * </USERBLOCK>
...
)
{
    ...
    if ((wakeupSource & EcuMWakeupSource_CAN) != 0u)
    {
        (void)CanSM_StopWakeupSource(ComMChannel_0);
    }
    /** DO NOT CHANGE THIS COMMENT!
     * </USERBLOCK>
     */
...
uint32 EcuM_CurrentTimestampMS(void)
{
    ...
    case OS_CORE_ID_0: {
        ...
        /*tick to ms*/
        /* PRQA S 3469,1840 ++ */ /* VL_EcuM_3469, VL_EcuM_1840*/
...
)
{
    switch(wakeupSource)
    {
        case EcuMWakeupSource_CAN:
             ...
             */
            /* Let CanIf query the configured CAN driver wakeup source. */
            (void)CanIf_CheckWakeup(EcuMWakeupSource_CAN);
            /** DO NOT CHANGE THIS COMMENT!
             * </USERBLOCK>
             */
            break;
        ...
        case EcuMWakeupSource_Time:
            /** DO NOT CHANGE THIS COMMENT!
             * <USERBLOCK EcuM_CheckWakeup EcuMWakeupSource_Time>
             */
            /* custom code.... */
            /** DO NOT CHANGE THIS COMMENT!
             * </USERBLOCK>
