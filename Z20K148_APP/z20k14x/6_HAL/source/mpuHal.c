...
#define MPU_HAL_CYC_TIME_CNT_55MS               500     // base cycleTime = 10
...
/*************************************************
 Function:       MpuHalSetSpiReady
 Description:    Set SPI ready status
 Input:          uint8_t ready: 1 to set ready, 0 to clear ready
 Output:         None
 Return:         None
 Others:         Sets the ready status of the SPI interface
*************************************************/
