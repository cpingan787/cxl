    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if ((0u) != Dcm_MsgCtrl[MsgCtrlId].Subfunction)
    {
    ...
    if (0U == ret)
    {
        ...
        ret = DsdInternal_SubSesCheck(ProtocolCtrlId, 0x3Eu, ErrorCode);
    }
    if (0U == ret)
    {
         
        ret = DsdInternal_SubSecurityCheck(ProtocolCtrlId, 0x3Eu, ErrorCode);
    }
     
    if ((0U == ret) && ((2U) != pMsgContext->ReqDataLen))
    {
