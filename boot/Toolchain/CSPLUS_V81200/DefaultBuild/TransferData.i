...
static uint8 TransDataBuf[((uint16)0x0402U)];
...
{
    CommF_DataSet(TransDataBuf, ((uint8)0xFFU), ((uint16)0x0402U));
}
...
{
    CommF_DataCopy(TransDataBuf, data, ((uint16)0x0402U));
}
...
{
    return CommF_DataCompare(TransDataBuf,data,((uint16)0x0402U));
}
