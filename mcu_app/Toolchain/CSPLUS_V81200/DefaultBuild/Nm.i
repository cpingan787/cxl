...
static  Std_ReturnType Nm_BusNmNetworkRequest(uint8 chIndex);

 
static  Std_ReturnType Nm_BusNmNetworkRelease(uint8 chIndex);
...
Nm_DisableCommunication(NetworkHandleType NetworkHandle)
{
    Std_ReturnType ret = 1U;
    {
        ...
        if (((void *)0) != Nm_ChLConfig[chIndex].busNmApi)
        {
            ...
            if (((void *)0) != specific_DisableCommunication)
            {
...
Nm_EnableCommunication(NetworkHandleType NetworkHandle)
{
...

    {
        ...
        if (((void *)0) != Nm_ChLConfig[chIndex].busNmApi)
        {
            ...
            if (((void *)0) != specific_EnableCommunication)
            {
...
Std_ReturnType Nm_RepeatMessageRequest(NetworkHandleType networkHandle)
{
    Std_ReturnType ret = 1U;
    {
        ...
        if (((void *)0) != Nm_ChLConfig[chIndex].busNmApi)
        {
            ...
            if (((void *)0) != specific_RepeatMessageRequest)
            {
...
Std_ReturnType Nm_GetNodeIdentifier(NetworkHandleType networkHandle, uint8* nmNodeIdPtr)
{
...

    {
        ...
        if (((void *)0) != Nm_ChLConfig[chIndex].busNmApi)
        {
            ...
            if (((void *)0) != specific_GetNodeIdentifier)
            {
...
Std_ReturnType Nm_GetLocalNodeIdentifier(NetworkHandleType networkHandle, uint8* nmNodeIdPtr)
{
...

    {
        ...
        if (((void *)0) != Nm_ChLConfig[chIndex].busNmApi)
        {
            ...
            if (((void *)0) != specific_GetLocalNodeIdentifier)
            {
...
{
    {
        ...
        if ((boolean)1u == Nm_ChLConfig[chIndex].NmStateReportEnabled)
        {
            ...
            uint32 index;
            boolean findflag = 0u;
            for (index = 0u; (index < (sizeof(Nm_StateReportKind) / sizeof((Nm_StateReportKind)[0]))) && ((boolean)0u == findflag); index++)
            {
...
static  Std_ReturnType Nm_BusNmNetworkRequest(uint8 chIndex)
{
    ...
    if (((void *)0) != Nm_ChLConfig[chIndex].busNmApi)
    {
        ...
        if (((void *)0) != specific_NetworkRequest)
        {
...
static  Std_ReturnType Nm_BusNmNetworkRelease(uint8 chIndex)
{
    ...
    if (((void *)0) != Nm_ChLConfig[chIndex].busNmApi)
    {
        ...
        if (((void *)0) != specific_NetworkRelease)
        {
