...
static Os_ReadyQueueType Os_ReadyQueueMark_Core0[(3U)];
...
static Os_TaskType* const Os_ReadyQueue_Core0[(3U)] =
{
...
static const uint32 Os_ActivateQueueSize_Core0[(3U)] =
{
    1U,
    2U,
    2U,
...
static Os_PriorityType Os_ReadyMap_Core0[(((((3U)) - 1U) / (sizeof(Os_PriorityType) * 8U)) + 1U)];
