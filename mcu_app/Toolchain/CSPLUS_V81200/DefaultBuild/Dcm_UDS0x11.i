...
static  Std_ReturnType
    Dcm_UDS0x11_ConditionCheck(uint8 ProtocolCtrlId, Dcm_NegativeResponseCodeType * ErrorCode)
{
    uint8 MsgCtrlId;
    Std_ReturnType ret;
    ...
    if (0U == ret)
    {
        ret = DsdInternal_SubSesCheck(ProtocolCtrlId, 0x11u, ErrorCode);
    }
    if (0U == ret)
    {
         
        ret = DsdInternal_SubSecurityCheck(ProtocolCtrlId, 0x11u, ErrorCode);
    }
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        ...
        Dcm_Channel[Offset] = 0x51;            
        Dcm_Channel[Offset + 1u] = resetType;  
