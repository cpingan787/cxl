                        ...
                        Port_GaaPortReg_BaseAddress[0x09U] =
{
  ...
  (volatile PortReg *)&(*((volatile PortReg *)0xffc10000UL)),

   
  (volatile PortReg *)&(*((volatile PortReg *)0xffc10004UL)),

   
  (volatile PortReg *)&(*((volatile PortReg *)0xffc10020UL)),

   
  (volatile PortReg *)&(*((volatile PortReg *)0xffc10024UL)),

   
  (volatile PortReg *)&(*((volatile PortReg *)0xffc10028UL)),

   
  (volatile PortReg *)&(*((volatile PortReg *)0xffc1002cUL)),

   
  (volatile PortReg *)&(*((volatile PortReg *)0xffc10030UL)),

   
  (volatile PortReg *)&(*((volatile PortReg *)0xffc10048UL)),

   
  (volatile PortReg *)&(*((volatile PortReg *)0xffc10050UL))
};
...
volatile  JPortReg* const Port_GpJPortReg_BaseAddress = 
  (volatile JPortReg *) &(*((volatile JPortReg *)0xffc20000UL));

 
volatile  IPortReg* const Port_GpIPortReg_BaseAddress = 
  (volatile IPortReg *) &(*((volatile IPortReg *)0xffc102f0UL));
                        ...
                        Port_GaaAPortReg_BaseAddress[0x02U] =
{
  ...
  (volatile APortReg *) &(*((volatile APortReg *)0xffc100c8UL)),

   
  (volatile APortReg *) &(*((volatile APortReg *)0xffc100ccUL))
};
                        ...
                        Port_GaaDnfaReg_BaseAddress[0x1U] =
{
  ...
  (volatile DNFAReg *) &(*((volatile DNFAReg *)0xffc30020UL))
};
