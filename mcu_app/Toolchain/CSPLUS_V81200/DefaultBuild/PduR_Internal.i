...
boolean PduR_RoutingPathEnabled[255u];
...
PduR_RouteStatusType PduR_DestinationRouteStatus[173u];
PduR_RouteStatusType PduR_SourceRouteStatus[173u];
...
void PduR_RoutingPathGroupInit(void)
{
    ...
    {
        PduR_RoutingPathEnabled[index] = 1u;
    }
    for (index = 0u; index < PduR_ConfigStd->routingPathGroupCnt; index++)
    {
        if (0u == PduR_ConfigStd->PduRRoutingPathGroupRef[index].PduRIsEnabledAtInit)
        {
            PduIdType destPduNumber = PduR_ConfigStd->PduRRoutingPathGroupRef[index].PduRDestPduRefNumber;
            for (PduIdType cnt = 0u; cnt < destPduNumber; cnt++)
            {
                PduIdType destIndex = PduR_ConfigStd->PduRRoutingPathGroupRef[index].PduRDestPduIdRef[cnt];
