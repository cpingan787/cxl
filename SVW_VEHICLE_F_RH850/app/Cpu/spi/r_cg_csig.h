...
***********************************************************************************************************************/
#if 1
#define _CSIG1_SELECT_BASIC_CLOCK                 (0xE000U) /* Selects the basic clock */
#define _CSIG1_BAUD_RATE                          (0x0000U) /* baudrate set */
#else
#define _CSIG1_SELECT_BASIC_CLOCK                 (0x0000U) /* Selects the basic clock */
#define _CSIG1_BAUD_RATE                          (0x000DU) /* baudrate set */
#endif
...
MD_STATUS R_CSIG1_Send(const uint16_t *tx_buf, uint16_t tx_num);
