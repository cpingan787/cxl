...
**  Vendor      :                                                             **
**  DESCRIPTION : Memory mapping abstraction declaration of Csm              **
**                                                                            **
...
#elif defined CSM_START_SEC_CALLBACK_CODE_NOTIFICATION_CODE
#undef CSM_START_SEC_CALLBACK_CODE_NOTIFICATION_CODE
#undef MEMMAP_ERROR
#ifndef MEMMAP_ERROR_SEC_NO_MATCH
#define MEMMAP_ERROR_SEC_NO_MATCH
#else
#error "Csm_MemMap.h, section is used consecutively many times."
#endif
#define CSM_START_SEC_CALLBACK_CODE_NOTIFICATION_CODE_NO_MATCH
#define START_SEC_CALLBACK_CODE

#elif defined CSM_STOP_SEC_CALLBACK_CODE_NOTIFICATION_CODE
#undef CSM_STOP_SEC_CALLBACK_CODE_NOTIFICATION_CODE
#undef MEMMAP_ERROR
#ifdef CSM_START_SEC_CALLBACK_CODE_NOTIFICATION_CODE_NO_MATCH
#undef CSM_START_SEC_CALLBACK_CODE_NOTIFICATION_CODE_NO_MATCH
#else
#error "Csm_MemMap.h, no matching section was used."
#endif
...
#error "Csm_MemMap.h, section is used consecutively many times."
#endif
#define CSM_START_SEC_CODE_NO_MATCH
#define START_SEC_CODE

#elif defined CSM_STOP_SEC_CODE
#undef CSM_STOP_SEC_CODE
#undef MEMMAP_ERROR
#ifdef CSM_START_SEC_CODE_NO_MATCH
#undef CSM_START_SEC_CODE_NO_MATCH
#else
#error "Csm_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "Csm_MemMap.h, section is used consecutively many times."
#endif
#define CSM_START_SEC_CONST_UNSPECIFIED_NO_MATCH
#define START_SEC_CONST_UNSPECIFIED

#elif defined CSM_STOP_SEC_CONST_UNSPECIFIED
#undef CSM_STOP_SEC_CONST_UNSPECIFIED
#undef MEMMAP_ERROR
#ifdef CSM_START_SEC_CONST_UNSPECIFIED_NO_MATCH
#undef CSM_START_SEC_CONST_UNSPECIFIED_NO_MATCH
#else
#error "Csm_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "Csm_MemMap.h, section is used consecutively many times."
#endif
#define CSM_START_SEC_VAR_CLEARED_BOOLEAN_NO_MATCH
#define START_SEC_VAR_CLEARED_BOOLEAN

#elif defined CSM_STOP_SEC_VAR_CLEARED_BOOLEAN
#undef CSM_STOP_SEC_VAR_CLEARED_BOOLEAN
#undef MEMMAP_ERROR
#ifdef CSM_START_SEC_VAR_CLEARED_BOOLEAN_NO_MATCH
#undef CSM_START_SEC_VAR_CLEARED_BOOLEAN_NO_MATCH
#else
#error "Csm_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "Csm_MemMap.h, section is used consecutively many times."
#endif
#define CSM_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
...
#undef MEMMAP_ERROR
#ifdef CSM_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
#undef CSM_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
#else
#error "Csm_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
