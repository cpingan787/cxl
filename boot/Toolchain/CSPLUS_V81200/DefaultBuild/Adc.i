 ...
 void Adc_Init (const Adc_ConfigType * ConfigPtr)
{
  ...
  uint8 LucLoopCount;
  {
    ...
    if ((uint32)(((59U << 22) | (123U << 14) | (1U << 8) | (1U << 3))) == ConfigPtr->ulStartOfDbToc)
     
    {
      ...
      for (LucLoopCount = (uint8)0; LucLoopCount < LucNoChannelInGroup;
                                                    LucLoopCount++)
      {
         
         
        Adc_GpChannelToDisableEnable[LucLoopCount] = (boolean)1;
...
{
  {
    ...
    Adc_GpGroupRamData[Group].ucNotifyStatus = (boolean)0;
...
Adc_ValueGroupType * DataBufferPtr)
{
  const Adc_GroupConfigType * LpGroup;
  Adc_ValueGroupType * LpChannelBuffer;
  uint8 LucHwSGUnit;
...

  {
...

    {
      ...
      LpChannelBuffer = &LpChannelBuffer[LucLoopCount - (uint8)1];
       
       
       
      LucLoopCount = (uint8)0;
      ...
      SchM_Enter_Adc_ADC_RAMDATA_PROTECTION();
      ...
      SchM_Exit_Adc_ADC_RAMDATA_PROTECTION();
       
       
      Adc_GpGroupRamData[Group].blResultRead = (boolean)1;
...
{
  {
    ...
    if ((boolean)1 == Adc_GpGroupRamData[Group].ucHwTriggStatus)
     
    {
      ...
      Adc_GpGroupRamData[Group].ucHwTriggStatus = (boolean)0;
...
{
  {
    ...
    Adc_GpGroupRamData[Group].ucNotifyStatus = (boolean)1;
...

  {
    ...
    *PtrToSamplePtr = ((void *)0);
     ...
     
    {
      ...
      if(LddSampleCount > (uint8)0)
      {
         
         
        *PtrToSamplePtr = &LpBuffer[LddSampleCount - (uint8)1];
      ...
      if ((uint8)0x00 == (LpGroup->ucGroupSettings &
                                                  (uint8)0x04))
      {
         
        LddSampleCount = (uint8)1;
      }
      else
      {
...
Adc_ChannelType ChannelId)
{
  ...
  uint8 LucAvailChannelCount;
  {
    ...
    if ((uint8)1 >= LucAvailChannelCount)
    {
    }
    else
    {
      ...
      Adc_IntDisableEnableChannel(Group, ChannelId, (boolean)0);
    }
  }
}
...
{
  {
    ...
    Adc_IntDisableEnableChannel(Group, ChannelId, (boolean)1);
  }
}
 ...
 Adc_AddressType Adc_CusGetADCAnDRmAddr
                                                        (Adc_GroupType Group)
{
 ...
 void Adc_CusSetSamplingClock(Adc_HardwareIndexType
                                   HwIndex, Adc_SamplingClockType SamplingClock)
{
  {
...
{
  {
    ...
    versioninfo->moduleID = (uint16)123U;
 ...
 Std_ReturnType Adc_CheckHWConsistency
                   (Adc_HWConsistencyCheckType LddCheckType)
{
