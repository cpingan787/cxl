...
const Icu_ChannelConfigType * Icu_GpChannelConfig;
...
const Icu_TAUUnitConfigType * Icu_GpTAUUnitConfig;
...
Icu_ModeType Icu_GenModuleMode;
...
Icu_FclaRegsMirror Icu_GaaFclaRegsMirror[8U];
...
EcuM_WakeupSourceType Icu_GulWakeupSource;
...
boolean Icu_GblDriverStatus = (boolean)0x00;
 

 
 
 
boolean Icu_GblSyncInitStatus = (boolean)0x00;
 
 
boolean Icu_GblSyncStartStatus = (boolean)0x00;
...
uint8 Icu_GaaChannelMeasureStatus[8U];
