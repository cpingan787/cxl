...
static Os_TaskCBExtType Os_TaskCBExtCore0[(7U)];
...
static uint32 Os_IsrNestStackCore0[(28U)];
...
static uint32 Os_ISR1SPCore0[(32U)];
 ...
 
{
    ...
    (*(uint16 volatile*)(0xFFC01000U)) = (uint16)0x00U;
    (*(uint16 volatile*)(0xFFC01004U)) = (uint16)0x00U;
    ...
    (*(uint16 volatile*)(((0xFFE30000U) + ((0U) * 1000U)) + 0x1C4U)) |= 0x01U;    
 ...
 
{
    ...
    case ((Os_CoreIdType)0U):
        logCoreId = ((Os_CoreIdType)0U);
        break;

    default:
        logCoreId = ((Os_CoreIdType)0xFFFFU);
        break;
    }
 ...
 
{
    ...
    {
    case ((Os_CoreIdType)0U):
        phyCoreId = ((Os_CoreIdType)0U);
        break;

    default:
        phyCoreId = ((Os_CoreIdType)0xFFFFU);
        break;
    }
 ...
 
{
    ...
    while ((0x50003A1UL) != __stsr_rh((6U), (1U)))
    {
