...
{
    Dsd_Nrc78ResponseProcess(((uint8)0x00));
}
...
uint8 Diag_FlagCompare(uint8 flagId)
{
    ...
    if((retValue != 0U) || (dataRead != g_FlagsInfo[flagId].flagData))
    {
        retValue = 1U;
    }
