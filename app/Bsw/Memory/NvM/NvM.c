...
FUNC(Std_ReturnType, NVM_CODE)
NvM_GetDataIndex(NvM_BlockIdType BlockId, P2VAR(uint8, AUTOMATIC, NVM_VAR) DataIndexPtr)
{
    Std_ReturnType l_ReturnValue = E_NOT_OK;
...
/* PRQA S 6030 -- */
{
...
#endif
    {
        ...
        else
        {
            ...
            {
                /* PRQA S 0316, 0311 ++ */ /* VL_NvM_0316, VL_NvM_0311 */
 ...
 */
FUNC(void, NVM_CODE)
NvM_JobEndNotification(void) /* PRQA S 3408 */ /* VL_NvM_3408 */
{
    return;
}
 ...
 */
FUNC(void, NVM_CODE)
NvM_JobErrorNotification(void) /* PRQA S 3408 */ /* VL_NvM_3408 */
{
    return;
}
