...
static const struct pregs_t PortList[]=
{
  ...
  {(volatile uint16_t *)&PORT.P1,(volatile uint16_t *) &PORT.PNOT1,(volatile uint16_t *) &PORT.PM1,(volatile uint16_t *) &PORT.PMC1, (volatile uint16_t *)&PORT.PFC1, (volatile uint16_t *)&PORT.PFCE1, 0, 0, (volatile uint16_t *)&PORT.PIBC1,(volatile uint16_t *) &PORT.PPR1, (volatile uint16_t *)&PORT.PD1, (volatile uint16_t *)&PORT.PU1,(volatile uint32_t *)&PORT.PODC1, (volatile uint32_t *)&PORT.PDSC1, (volatile uint32_t *)&PORT.PPROTS1, (volatile uint32_t *)&PORT.PPCMD1},
  ...
  {(volatile uint16_t *)&PORT.P12,(volatile uint16_t *) &PORT.PNOT12,(volatile uint16_t *) &PORT.PM12,(volatile uint16_t *) &PORT.PMC12, (volatile uint16_t *)&PORT.PFC12, (volatile uint16_t *)&PORT.PFCE12, 0, 0, (volatile uint16_t *)&PORT.PIBC12,(volatile uint16_t *) &PORT.PPR12, (volatile uint16_t *)&PORT.PD12, (volatile uint16_t *)&PORT.PU12,(volatile uint32_t *)&PORT.PODC12, (volatile uint32_t *)&PORT.PDSC12, (volatile uint32_t *)&PORT.PPROTS12, (volatile uint32_t *)&PORT.PPCMD12},
