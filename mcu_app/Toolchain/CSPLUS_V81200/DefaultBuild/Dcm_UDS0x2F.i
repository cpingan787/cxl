    ...
    Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    else
    {
        ...
        *pNrc = ((Dcm_NegativeResponseCodeType)0x22u);
        ret = 1U;
    }
    return ret;
}
...
static  Std_ReturnType DspInternalUDS0x2F_DidConditionCheck(
    const Dcm_0x2FTypes * Dcm_0x2FType,
    Dcm_NegativeResponseCodeType * pNrc)
{
    Std_ReturnType ret = 0U;
    ...
    const uint8* pSecurityLevelRow = Dcm_0x2FType->pDspDidControl->pDcmDspDidControlSecurityLevelRow;
    {
        ...
        if (SecRefNum != 0u)
        {
            for (Index = 0; (Index < SecRefNum) && (0u == Flag); Index++)
            {
...
static  Std_ReturnType Dcm_Uds0x2FServiceDidCallAPI_SubDeal(
    Dcm_OpStatusType OpStatus,
    const Dcm_0x2FTypes * Dcm_0x2FType,
    uint8 ProtocolCtrlId,
    Dcm_NegativeResponseCodeType * ErrorCode)
...
{
    Std_ReturnType ret;
    const uint8* pcontrolState = ((void *)0);
    ...
    {
    case (0u):  
        if (pDcmDspDidData->DcmDspDataReturnControlToECUFnc != ((void *)0))
        {
        ...
        break;
    case (1u):  
        if ((Dcm_0x2FType->pDspDidControl->DcmDspDidResetToDefault == 1u)
            && (pDcmDspDidData->DcmDspDataResetToDefaultFnc != ((void *)0)))
        {
            ret = DspInternalUDS0x2F_DidConditionCheck(
                Dcm_0x2FType,
                ErrorCode);
        ...
        break;
    case (2u):  
        if ((Dcm_0x2FType->pDspDidControl->DcmDspDidFreezeCurrentState == 1u)
            && (pDcmDspDidData->DcmDspDataFreezeCurrentStateFnc != ((void *)0)))
        {
            ret = DspInternalUDS0x2F_DidConditionCheck(
                Dcm_0x2FType,
                ErrorCode);
        ...
        break;
    case (3u):  
        if ((Dcm_0x2FType->pDspDidControl->DcmDspDidShortTermAdjustement == 1u)
            && (pDcmDspDidData->DcmDspDataShortTermAdjustmentFnc != ((void *)0)))
        {
            ret = DspInternalUDS0x2F_DidConditionCheck(
                Dcm_0x2FType,
                ErrorCode);
...
static  Std_ReturnType Dcm_Uds0x2FServiceDidCallAPI(
    Dcm_OpStatusType OpStatus,
...
{
    Std_ReturnType ret = 0U;
    uint8* pControlEnableMaskRecord = ((void *)0);
    uint8* pControlStatusRecord;
    uint8 MsgCtrlId = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
    ...
    Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    for (Index = 0; (Index < pDcmDspCfg->DcmDspDidNum) && (1U == ret); Index++)
    {
         
        if ((RecDid == pDcmDspDid[Index].DcmDspDidId) && (1u == pDcmDspDid[Index].DcmDspDidUsed))
        {
            *pDidCfgIndex = Index;
            ret = 0U;
        }
...
static  Std_ReturnType Dcm_Uds0x2FServiceConditionCheck(
    uint8 ProtocolCtrlId,
    uint16 * DidCfgIndex,
    uint16 * InputDidSize,
    Dcm_NegativeResponseCodeType * ErrorCode)
 
{
    Std_ReturnType ret = 0U;
    uint8 MsgCtrlId = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
    const Dcm_DspDidSignalType* pDcmDspDidSignal = ((void *)0);
    ...
    if (0U == ret)
    {
        ...
        if ((InputOutControlParameter > (3u))
            || ((InputOutControlParameter == (3u))
                && (pDspDidControl->DcmDspDidShortTermAdjustement == 0u))
            || ((InputOutControlParameter == (1u))
                && (pDspDidControl->DcmDspDidResetToDefault == 0u))
            || ((InputOutControlParameter == (2u))
                && (pDspDidControl->DcmDspDidFreezeCurrentState == 0u)))
        {
    ...
    if ((0U == ret) && (pDspDidControl->DcmDspDidControlSessionRefNum != 0u))
    {
        for (Index = 0; (Index < pDspDidControl->DcmDspDidControlSessionRefNum) && (0u == Flag); Index++)
        {
    ...
    if (0U == ret)
    {
        if ((InputOutControlParameter == (3u)))
        {
            if ((pDcmDspDid[*DidCfgIndex].pDcmDspDidSignal != ((void *)0)))
            {
                pDcmDspDidSignal = pDcmDspDid[*DidCfgIndex].pDcmDspDidSignal;
                for (iloop = 0; ((iloop < pDcmDspDid[*DidCfgIndex].DcmDspDidSignalNum) && (ret == 0U)); iloop++)
                {
        ...
        {
            if (((4U) + pDspDidControl->DcmDspDidControlMaskSize)
...
static  Std_ReturnType Dcm_UDS0x2FSubDeal(
    Dcm_OpStatusType OpStatus,
    uint8 ProtocolCtrlId,
    Dcm_0x2FTypes * Dcm_0x2FType,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        if (DidSignalNum > 1u)
        {
            if (pDcmDspDid->pDcmDspDidSignal != ((void *)0))
            {
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if ((0U == ret) && ((4u + (uint32)ControlStatusRecordSize) > pDcmChannelCfg->Dcm_DslBufferSize))
    {
