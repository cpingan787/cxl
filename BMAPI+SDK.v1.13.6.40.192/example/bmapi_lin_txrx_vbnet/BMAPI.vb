...
Class BMAPI
    ...
    '*/
    <DllImport("BMAPI.DLL", CallingConvention:=CallingConvention.Cdecl)>
    Public Shared Function BM_EnumerateRemote(ByVal channelinfos As IntPtr, ByRef nchannels As Integer, ByRef addr As BM_IpAddrTypeDef, timeout As Integer) As BM_StatusTypeDef
    End Function
