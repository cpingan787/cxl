...
{
    volatile uint32_t i; (*(volatile struct __tag523 *)0xFFA00000). PCMD = 0xa5; (*(volatile struct __tag523 *)0xFFA00000). CNT = (0x01u); (*(volatile struct __tag523 *)0xFFA00000). CNT = ~(0x01u); (*(volatile struct __tag523 *)0xFFA00000). CNT = (0x01u); for (i = 0; i < 10000; i++) { }
}
...
{
    volatile uint32_t i; (*(volatile struct __tag523 *)0xFFA00000). PCMD = 0xa5; (*(volatile struct __tag523 *)0xFFA00000). CNT = (0x00u); (*(volatile struct __tag523 *)0xFFA00000). CNT = ~(0x00u); (*(volatile struct __tag523 *)0xFFA00000). CNT = (0x00u); for (i = 0; i < 10000; i++) { }
}
