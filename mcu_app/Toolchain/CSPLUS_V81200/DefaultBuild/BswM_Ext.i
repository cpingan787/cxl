...
void WakeupSource_Validated(void)
{
    ...
    else if (Mcu_WakeSource.KL30_WakeFlag == 1u)
    {
         
        APP_SetWakeupSource(11);
    }
    else if(Mcu_WakeSource.NAD_WakeFlag == 1u)
    {
         
        APP_SetWakeupSource(9);
    }
    else if (Mcu_WakeSource.Crash_WakeFlag == 1u)
    {
         
        APP_SetWakeupSource(16);
    }
    else if(Mcu_WakeSource.Ecall_WakeFlag == 1u)
    {
         
        APP_SetWakeupSource(17);
    }
    else if (Mcu_WakeSource.Imu_Int1_WakeFlag == 1u)
    {
         
        APP_SetWakeupSource(15);
    }
    else if(Mcu_WakeSource.Imu_Int2_WakeFlag == 1u)
    {
         
        APP_SetWakeupSource(15);
    }
    else if (Mcu_WakeSource.Rtc_WakeFlag == 1u)
    {
         
        APP_SetWakeupSource(14);
    }
    else
    {
    ...
    APP_WakeupNotified = 1u;  
    BswM_RequestMode(1,1);
    BswM_EcuM_CurrentWakeup((uint32)((uint32)0x01u << (5)),(EcuM_WakeupStatusType)3);
    BswM_EcuM_CurrentWakeup((uint32)((uint32)0x01u << (6)),(EcuM_WakeupStatusType)3);
}
extern  uint8 validNmMsgFlag;
void User_EcuM_ClearWakeUpSource_EcuMWakeupSource_CAN(void)
{
    EcuM_ClearWakeupEvent((uint32)((uint32)0x01u << (5)));
    EcuM_ClearWakeupEvent((uint32)((uint32)0x01u << (6)));
