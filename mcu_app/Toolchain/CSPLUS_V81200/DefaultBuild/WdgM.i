...
static WdgM_SEInfoType WdgM_SEInfoRelated[1U];  

 
static WdgM_AliveSupInfoType WdgM_AliveSupInfoTab[1U];  
...
static const WdgM_ModeCfgType* WdgM_CurModeCfg = ((void *)0);

 
static const WdgM_ConfigType* WdgM_Config = ((void *)0);

 
static WdgM_ModeInfoType WdgM_ModeInfo = {WDGM_INIT_NOT, 0, 0};  

 
 
static WdgM_GlobalInfoType WdgM_GlobalInfo = {1U, WDGM_GLOBAL_STATUS_DEACTIVATED};
...
static  void WdgM_InitSEStatus(const WdgM_ModeCfgType* cerModeCfgPtr);
static  void
...
static  void WdgM_ConfirmSELocalStatus(const WdgM_SECfgType* cerSEInfo);
static  void WdgM_DeinitSEStatus(const WdgM_ModeCfgType* cerModeCfgPtr);
static  void WdgM_ConfirmGlobalStatus(void);
...
static  void WdgM_InitAllTabStatus(void);
static  void WdgM_SetTrigger(void);
static  uint16 WdgM_GetSupervisedEntityTabIndex(WdgM_SupervisedEntityIdType cerSEID);
static  Std_ReturnType WdgM_ModeExistenceConfirmation(WdgM_ModeType modeId);
static  Std_ReturnType WdgM_InitModeConfirmation(const WdgM_ConfigType* ConfigPtr);

static  void WdgM_UpdateAICounter(uint16 CPIdx, const WdgM_SECfgType* cerSECfg);
static  void WdgM_ConfirmAliveSupResultEachSE(const WdgM_SECfgType* cerSEInfo);
static  Std_ReturnType WdgM_ConfirmAliveSupResult(uint16 supIdx, uint16 refCycle);
...
static  uint8 WdgM_GetWordBitState(uint16 wordNum, uint8 getBit);
 ...
 void WdgM_Init(const WdgM_ConfigType* ConfigPtr)
{
    ...
    if (((void *)0) == ConfigPtr)
    {
        ...
        (void)Det_ReportError(13u, 0u, (0x00u), (0x14u));
    }
    else if ((Std_ReturnType)1U == WdgM_InitModeConfirmation(ConfigPtr))
    {
        (void)Det_ReportError(13u, 0u, (0x00u), (0x11u));  
    }
    else
    {
        ...
        *(volatile uint16*)0x00000000U = 0;
        *(volatile uint16*)0x00000000U = 0;
           

        WdgM_GlobalInfo.WdgMFirstExpiredSEIDSaved = 1U;
...
WdgM_DeInit(void)
{
    ...
    {
        (void)Det_ReportError(13u, 0u, (0x01u), (0x10u));  
         
    }
    else
    {
        if ((Std_ReturnType)0U == WdgM_SetMode((WdgM_ModeType)0UL))
        {
...
WdgM_SetMode(WdgM_ModeType Mode)
{
    ...
    if ((WDGM_INIT_NOT == WdgM_ModeInfo.WdgMModeInitStatus)
        || (WDGM_GLOBAL_STATUS_DEACTIVATED == WdgM_GlobalInfo.WdgMGlobalResult))
    {
        (void)Det_ReportError(13u, 0u, (0x03u), (0x10u));  
        retValue = 1U;
    }
    else if ((Std_ReturnType)1U == WdgM_ModeExistenceConfirmation(Mode))
    {
        (void)Det_ReportError(13u, 0u, (0x03u), (0x12u));  
        retValue = 1U;
    }
    ...
    else
    {
            ...
            || (WDGM_GLOBAL_STATUS_FAILED == WdgM_GlobalInfo.WdgMGlobalResult))
        {
            for (triggerIdx = 0; triggerIdx < WdgM_Config->WdgMModeRef[Mode].WdgMModeTriggerCnt; triggerIdx++)
            {
                ...
                ret = WdgIf_SetMode(deviceId, WdgIfMode);  
                if ((Std_ReturnType)1U == ret)
                {
                     
                    ((void)Det_ReportRuntimeError(13u, 0u, (0x03u), (0x1D)));
...
WdgM_GetMode(WdgM_ModeType* Mode)
{
    ...
    if ((WDGM_INIT_NOT == WdgM_ModeInfo.WdgMModeInitStatus)
        || (WDGM_GLOBAL_STATUS_DEACTIVATED == WdgM_GlobalInfo.WdgMGlobalResult))
    {
        (void)Det_ReportError(13u, 0u, (0x0Bu), (0x10u));  
        retValue = 1U;
    }
    else if (((void *)0) == Mode)
    {
        (void)Det_ReportError(13u, 0u, (0x0Bu), (0x14u));  
        retValue = 1U;
    }
    else
    {
...
WdgM_CheckpointReached(WdgM_SupervisedEntityIdType SEID, WdgM_CheckpointIdType CheckpointID)
{
    ...
    else if ((Std_ReturnType)1U == WdgM_GetModeSEIndex(SEID, &modeSEIdx, WdgM_CurModeCfg))
    {
    ...
    {
        (void)
            Det_ReportError(13u, 0u, (0x0Eu), (0x16u));  
        retValue = 1U;
    }
    else
    {
...
Std_ReturnType WdgM_GetLocalStatus(WdgM_SupervisedEntityIdType SEID, WdgM_LocalStatusType* Status)
{
    ...
    {
        (void)
            Det_ReportError(13u, 0u, (0x0Cu), (0x10u));  
        retValue = 1U;
    }
    else if (1U <= SEStatusTabIdx)
    {
    ...
    else if ((Std_ReturnType)0U == WdgM_GetModeSEIndex(SEID, &modeSETabIdx, WdgM_CurModeCfg))
    {
...
WdgM_PerformReset(void)
{
    ...
    if ((WDGM_INIT_NOT == WdgM_ModeInfo.WdgMModeInitStatus)
        || (WDGM_GLOBAL_STATUS_DEACTIVATED == WdgM_GlobalInfo.WdgMGlobalResult))
    {
        (void)Det_ReportError(13u, 0u, (0x0Fu), (0x10u));  
...
WdgM_GetFirstExpiredSEID(WdgM_SupervisedEntityIdType* SEID)
{
    ...
    uint16 FirstExpiredSEID = *(volatile uint16*)0x00000000U;
    uint16 FirstExpiredInverseSEID = *(volatile uint16*)0x00000000U;
...
static  void WdgM_ConfirmAliveSupResultEachSE(const WdgM_SECfgType* cerSEInfo)
{
    ...
    if ((uint16)0 < cerSEInfo->WdgMSEAliveCnt)
    {
        ...
        for (idx = 0; idx < cerSEInfo->WdgMSEAliveCnt; idx++)
        {
            ...
            if ((Std_ReturnType)0U == WdgM_ConfirmAliveSupResult(tabIdx, aliveRefCycle))
            {
...
void WdgM_MainFunction(void)
{
    ...
    {
        if (WDGM_GLOBAL_STATUS_DEACTIVATED != WdgM_GlobalInfo.WdgMGlobalResult)  
        {
...
static  void WdgM_ConfirmSELocalStatus(const WdgM_SECfgType* cerSEInfo)
{
    ...
    if ((Std_ReturnType)1U == ret)
    {
        ...
        SchM_Enter_WdgM_Exclusive();
        if ((Std_ReturnType)1U == WdgM_GlobalInfo.WdgMFirstExpiredSEIDSaved)
        {
               
            *(volatile uint16*)0x00000000U = cerSEInfo->WdgMSEId;
            *(volatile uint16*)0x00000000U = ~(cerSEInfo->WdgMSEId);
               

            WdgM_GlobalInfo.WdgMFirstExpiredSEIDSaved = 0U;
        }
        SchM_Exit_WdgM_Exclusive();
    }
}
...
static  void WdgM_ConfirmGlobalStatus(void)
{
    uint16 seIdx;
    uint16 seTabIdx;
    boolean oneExipredFlag = 0u;
    boolean failedFlag = 0u;
...
static  void WdgM_ChangeSEStatus(const WdgM_ModeCfgType* oldModeCfg, const WdgM_ModeCfgType* newModeCfg)
{
    uint16 innerIdx = 0;
    uint16 oldIdx;
    uint16 oldSEStaTabIdx;
    uint16 oldIdxMax = oldModeCfg->WdgMModeSECnt;  
    uint16 newIdx;
    uint16 newSETabStaIdx;
    uint16 newIdxMax = newModeCfg->WdgMModeSECnt;  
    volatile Std_ReturnType retActive = 1U;
     
       
    WdgM_LocalStatusType oldSEStaArray[1U] = {WDGM_LOCAL_STATUS_OK};
    ...
    for (newIdx = 0; newIdx < newIdxMax; newIdx++)
    {
        ...
        WdgM_SEInfoRelated[newSETabStaIdx].WdgMFailedAliveSupCounter = 0;  
    }
    ...
    for (oldIdx = 0; oldIdx < oldIdxMax; oldIdx++)
    {
        ...
        for (newIdx = innerIdx; newIdx < newIdxMax; newIdx++)
        {
            ...
            if (oldModeCfg->WdgMSERelated[oldIdx].WdgMSEId
                == newModeCfg->WdgMSERelated[newIdx].WdgMSEId)  
            {
        ...
        if ((Std_ReturnType)1U == retActive)
        {
            oldSEStaTabIdx = WdgM_GetSupervisedEntityTabIndex(oldModeCfg->WdgMSERelated[oldIdx].WdgMSEId);
             
            WdgM_SEInfoRelated[oldSEStaTabIdx].WdgMLocalStatus = WDGM_LOCAL_STATUS_DEACTIVATED;
            WdgM_SEDeactivateInternal(oldModeCfg, oldIdx, oldSEStaTabIdx);  
        }
    }
