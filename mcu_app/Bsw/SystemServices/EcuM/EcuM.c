 ...
 *  V2.1.17      2024-11-05  Jian.Jiang      Resolving the issue of modehandle being invalid in single-core scenarios
 */
...
#define ECUM_C_SW_PATCH_VERSION 17u
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
...
EcuM_GetBootTarget(P2VAR(EcuM_BootTargetType, AUTOMATIC, ECUM_APPL_DATA) target)
{
    Std_ReturnType ret = E_OK;
