...
)
{
    ...
    EcuMRunData.State = (EcuM_StateType)0x30;
    BswM_EcuM_CurrentState((EcuM_StateType)0x30);
...
{
    if ((wakeupSource & (uint32)((uint32)0x01u << (5)))
    ...
    else if ((wakeupSource & (uint32)((uint32)0x01u << (6)))
...
uint32 EcuM_CurrentTimestampMS(void)
{
    ...
    case ((Os_CoreIdType)0U): {
        (void)GetCounterValue(0, &OSCurMs);
         
           
        OSCurMs = ((OSCurMs)*1000/1000);
...
uint32 EcuM_CalculateElapsedMS(uint32 OldCurMs)
{
    ...
    case ((Os_CoreIdType)0U): {
        ...
        tempOldCurMs = ((OldCurMs)*1000/1000);
           
        (void)GetElapsedValue(0, &tempOldCurMs, &ElapsedMs);
           
        ElapsedMs = ((ElapsedMs)*1000/1000);
