...
{
    uint32    id_au32[4];               /**< Authentication ID array               */
    uint32    addrRam_u32;              /**< Copy location for FCL routines in RAM */
    uint16    frequencyCpuMHz_u16;      /**< Flash hardware frequency in MHz       */
} r_fcl_descriptor_t;
...
typedef volatile struct R_FCL_REQUEST_T
{
    ...
    uint32            bufferAdd_u32;    /**< Buffer address for input data or result          */
    uint32            idx_u32;          /**< Write operation: \n
                                               Write destination address \n
                                               Erase operation: \n
                                               Block number of the first block to erase \n
                                               Read config area: \n
                                               Start address of area to read                    */
    uint16 cnt_u16;                     /**< Write operation: \n
