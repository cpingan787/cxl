...
static boolean Os_StackMonitorCheck(const Os_StackPtrType StackPtr);
 ...
 
{
    ...
    Os_StackDataType CheckLoop = (Os_StackDataType)8U;   
                                                                  
    while (CheckLoop > 0U)
    {
        CheckLoop--;
            
        if (*(StackPtr + CheckLoop) != 0xCCCCCCCCU)
 ...
 
{
    ...
    if ((Os_StackMonitorCheck(stack->StackBottom) == 0u)
    ||(Os_StackMonitorCheck(stack->StackTop) == 0u)
    )
     
    {
        ...
        Os_ShutdownOS(14U, OS_SHUTDOWN_OS);
    }
}
...
void Os_FillStack(const Os_StackType *stack)
{
    ...
    Os_StackPtrType endPtr = (Os_StackDataType *)(stack->StackTop + (Os_StackDataType)8U);
