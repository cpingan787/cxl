...
const CryIf_KeyCfgType CryIf_KeyCfg[(1U)] =        
{
    {
        0,     
        0         
...
const CryIf_FuncNameConfigType CryIf_DriverApi[(1U)] =
{
    {
        &Crypto_ISoft_ProcessJob,                   
        &Crypto_ISoft_CancelJob,                     
        &Crypto_ISoft_KeyElementSet,                 
        &Crypto_ISoft_KeySetValid,                     
        &Crypto_ISoft_KeyElementGet,                 
        &Crypto_ISoft_KeyElementCopy,                 
        &Crypto_ISoft_KeyElementCopyPartial,         
        &Crypto_ISoft_KeyCopy,                         
        &Crypto_ISoft_RandomSeed,                     
        &Crypto_ISoft_KeyGenerate,                     
        &Crypto_ISoft_KeyDerive,                     
        &Crypto_ISoft_KeyExchangeCalcPubVal,         
        &Crypto_ISoft_KeyExchangeCalcSecret,         
    },
};
