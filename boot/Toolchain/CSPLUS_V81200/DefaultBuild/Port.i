...
extern const Port_NumRegs
                                Port_GstNumRegs[0x05U];

extern const Port_JTAGRegs
                                  Port_GstJTAGRegs[0x01U];

extern const Port_AnalogRegs
                              Port_GstAnalogRegs[0x01U];


extern const Port_PinChangeableDetails
             Port_GstPinChangeableDetailsList[0x14U];


extern const Port_FCLARegs Port_GstFCLARegs[0x04U];
...
typedef struct STag_Port_ConfigType
{
  ...
  const Port_NumRegs * pPortNumRegs;


  

 
  const Port_JTAGRegs * pPortJRegs;


  

 
  const Port_AnalogRegs * pPortAnalogRegs;
  ...
  const Port_PinChangeableDetails *
                                                       pPinChangeableDetails;


   
  const Port_FCLARegs * pPortFCLARegs;
...
extern  void Port_SetPinDefaultDirection
                                  (Port_PinType Pin);
 
 
extern  void Port_SetPinDefaultMode
                                  (Port_PinType Pin);
...
extern  void Port_SetToDioMode (Port_PinType Pin);

extern  void Port_SetToAlternateMode (Port_PinType Pin);
 
extern  Std_ReturnType Port_CheckHWConsistency
...
extern const Port_ConfigType
                                   Port_GstConfiguration[0x01U];
...
extern void
            SchM_Enter_Port_PORT_REGISTER_PROTECTION(void);
extern void
            SchM_Exit_Port_PORT_REGISTER_PROTECTION(void);
...
extern Port_NumRegRamMirror
                    Port_GstRamMirrorPortReg[0x05U];
extern Port_JTAGRegRamMirror
...
static  Std_ReturnType Port_InitConfig
                                                 (Port_GroupType LenGroupType);

static  void Port_FilterConfig(void);

 
static
 const volatile Port_PinChangeableDetails *
        Port_SearchChangeablePinDetail(
        Port_PinType LddPinNumber, uint8* pPortRegIndex, uint8 LucModeCheck);

static  void Port_RefreshPortInternal
                                                 (Port_GroupType LenGroupType);

 
static
 void Port_SetToDioOrAltMode (Port_PinType Pin,
                                              boolean LblDioMode);
 ...
 
{
  ...
  else
  {
    ...
    if ((((uint32)59U << 22) | ((uint32)124U << 14) | ((uint32)2U << 8) | ((uint32)4U << 3)) == (ConfigPtr->ulStartOfDbToc))
     
    {
      ...
      LucLoopCount = (uint8)4;
      do
      {
        LucLoopCount--;
       
      } while ((uint8)0x00 < LucLoopCount);
      ...
      if (((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL) == (uint32)0x00000001UL)
       
        {
          ...
          LucLoopCount = (uint8)0x14;
           
          do
          {
             
             
            { (*(&(*((volatile uint32 *)0xfff80000UL)))) = (0xA5U); }
             
            { (*(&(*((volatile uint32 *)0xFFF80B00UL)))) = ((uint32)0x00000000UL); }
            { (*(&(*((volatile uint32 *)0xFFF80B00UL)))) = (~(uint32)0x00000000UL); }
            { (*(&(*((volatile uint32 *)0xFFF80B00UL)))) = ((uint32)0x00000000UL); }
            LucLoopCount--;
                                 ...
                                 ((uint8)0x01 == (*((volatile uint32 *)0xfff80004UL))));
          ...
          if ((*((volatile uint32 *)0xfff80004UL)) == (uint8)0x01)
           ...
           
          {
            ...
            Dem_ReportErrorStatus ((Dem_EventIdType)1,
                                  (Dem_EventStatusType) (Dem_EventStatusType)0x01);
 ...
 
{
    ...
    
  {
    ...
    LpChangeablePinDet = Port_SearchChangeablePinDetail (Pin,
                           &LucPortRegIndex, (uint8)0x40);

     
    if (((void *)0) != LpChangeablePinDet)
    {
      ...
      if ((uint8)PORT_GROUP_NUMERIC == (LucPortType & (uint8)0x0F))
       
      {
             ...
             LusPinPositionMask))
        {
          ...
          { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->ulPSR)) = (LulSRRegContent); }
          {}
           
           
          LulSRRegContent = (LulSRRegContent & (uint32)0xFFFF0000UL) |
                              (uint16)(~LusPinPositionMask);
          ...
          { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->ulPMSR)) = (LulSRRegContent); }
          {}
      }  
       ...
       
      {
          ...
          LusPinPositionMask))
        {
          ...
          { (*(&Port_GpJPortReg_BaseAddress->ulJPSR)) = (LulSRRegContent); }
          {}
          ...
          { (*(&Port_GpJPortReg_BaseAddress->ulJPMSR)) = (LulSRRegContent); }
          {}
        }  
        else if (PORT_PIN_IN == Direction)
        {
       ...
       
      {
             ...
             LusPinPositionMask))
        {
          ...
          { (*(&Port_GaaAPortReg_BaseAddress[LucPortGroupIndex]->ulAPSR)) = (LulSRRegContent); }
          {}
          ...
          { (*(&Port_GaaAPortReg_BaseAddress[LucPortGroupIndex]->ulAPMSR)) = (LulSRRegContent); }
          {}
        }  
        else if (PORT_PIN_IN == Direction)
        {
 ...
 
{
    ...
    
  {
    ...
    LpModeChangeablePin = Port_SearchChangeablePinDetail (Pin,
                          &LucPortRegIndex, (uint8)0x20);
     
     
     
    if (((void *)0) == LpModeChangeablePin)
    {
    ...
    else
    {
       ...
       
      {
        ...
        if ((Port_PinModeType)0x01 < Mode)
        {
          

 
          LddMode = Mode + (Port_PinModeType)0x0E;
        }
        else
        {
         ...
         
        {
          ...
          if ((uint8)0x00 == (LddMode & (uint8)0x02))
           
          {
            ...
            LusSRRegContentTemp =
              ...
              (uint16)(~LusPinPositionMask);
            { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->usPFC)) = (LusSRRegContentTemp); (*(&Port_GstRamMirrorPortReg[LucPortGroupIndex]. usPFC)) = (LusSRRegContentTemp); }
         ...
         
        {
          ...
          if ((uint8)0x00 == (LddMode & (uint8)0x04))
           
          {
            ...
            LusSRRegContentTemp =
              ...
              (uint16)(~LusPinPositionMask);
            { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->usPFCE)) = (LusSRRegContentTemp); (*(&Port_GstRamMirrorPortReg[LucPortGroupIndex]. usPFCE)) = (LusSRRegContentTemp); }
         ...
         
        {
          ...
          if ((uint8)0x00 == (LddMode & (uint8)0x08))
           
          {
            ...
            LusSRRegContentTemp =
                ...
                (uint16)(~LusPinPositionMask);
            { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->usPFCAE)) = (LusSRRegContentTemp); (*(&Port_GstRamMirrorPortReg[LucPortGroupIndex]. usPFCAE)) = (LusSRRegContentTemp); }
         ...
         
        {
          ...
          if ((uint8)0x82 <= Mode)
          {
            ...
            LusSRRegContentTemp =
              ...
              (uint16)(LusPinPositionMask));
            { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->usPIPC)) = (LusSRRegContentTemp); (*(&Port_GstRamMirrorPortReg[LucPortGroupIndex]. usPIPC)) = (LusSRRegContentTemp); }
            {}
            Mode = Mode & (uint8)0x1F;
          }
          else
          {
        ...
        if (((Port_PinModeType)0x00 == Mode) && ((Port_PinModeType)0x00 != LusCurrentDirection))
         ...
         
        {
          ...
          if ((uint8)0x00 == (LddMode & (uint8)0x10))
          ...
          { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->ulPMCSR)) = (LulSRRegContent); }
          {}
        ...
        if ((uint8)0x00 == (LddMode & (uint8)0x01))
      ...
      else
      {
         ...
         
        {
           ...
           
          {
            ...
            { (*(&Port_GpJPortReg_BaseAddress->ucJPFC)) = (LucSRRegContentTemp); (*(&Port_GstRamMirrorJPortReg . ucJPFC)) = (LucSRRegContentTemp); }
           ...
           
          {
            ...
            { (*(&Port_GpJPortReg_BaseAddress->ucJPFCE)) = (((Port_GpJPortReg_BaseAddress->ucJPFCE) & (uint8)(~LusPinPositionMask))); (*(&Port_GstRamMirrorJPortReg . ucJPFCE)) = (((Port_GpJPortReg_BaseAddress->ucJPFCE) & (uint8)(~LusPinPositionMask))); }
            {}
          }
          else
          {
          ...
          if(((Port_PinModeType)0x00 == Mode) &&
                                      ((Port_PinModeType)0x00 != LusCurrentDirection))
          ...
          { (*(&Port_GpJPortReg_BaseAddress->ulJPMCSR)) = (LulSRRegContent); }
          {}
 ...
 void Port_SetToDioMode (Port_PinType Pin)
{
 
  {
     
    Port_SetToDioOrAltMode(Pin, (boolean)0x01);
  }
 ...
 void Port_SetToAlternateMode (Port_PinType Pin)
{
    ...
    
  {
    ...
    Port_SetToDioOrAltMode (Pin, (boolean)0x00);
  }
                                              ...
                                              boolean LblDioMode)
{
  ...
  const Port_NumRegs * LpPortNumRegs;
   
  LpSetPinDioAltMode = ((void *)0);
  ...
  LpSetPinDioAltMode = Port_SearchChangeablePinDetail (Pin,
                         &LucPortRegIndx, (uint8)0x10);
  if (((void *)0) != LpSetPinDioAltMode)
  {
    ...
    (uint8)0x0F))
    {
      ...
      if ((uint32)0x00020000UL == (LpPortNumRegs->ulRegListAvailable &
          (uint32)0x00020000UL))
      {
      ...
      if ((uint32)0x00000020UL == (LpPortNumRegs->ulRegListAvailable &
          (uint32)0x00000020UL))
      {
        if ((boolean)0x01 == LblDioMode)
        {
 ...
 
{
  ...
  const Port_NumRegs * LpPortReg;
   
  const Port_JTAGRegs * LpJPortReg;
   
  const Port_AnalogRegs * LpAPortReg;
  ...
  if (PORT_GROUP_NUMERIC == LenGroupType)
  {
    ...
    while ((LucLoopCount < LusNoOfPortReg) && (0U == LddReturnValue))
    {
      ...
      if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
          ((uint8)0x00 == LpPortReg->ucDeepStopSupp ))
      ...
      else
      {
        ...
        { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->ulPSR)) = ((LpPortReg->ulInitModePSRRegVal | (uint32)0xFFFF0000UL)); }
        { }
      }
      ...
      else
      {
        ...
        LucLoopTime = (uint8)0x14;

        LulProtectRegWrite = LpPortReg->ulInitModePODCRegVal & (~(uint32)0xFFFF0000UL);
        do
        {
          ...
          { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->ulPPCMD)) = (0xA5U); }
          


 
          { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->ulPODC)) = (LulProtectRegWrite); }
        ...
        while (((uint32)(uint8)0x01 ==
          Port_GaaPortReg_BaseAddress[LucIndex]->ulPPROTS)
                                                  && ((uint8)0x00 < LucLoopTime));
        { }
        ...
        if((uint32)0x00000800UL == (LpPortReg->ulRegListAvailable &
          (uint32)0x00000800UL))
        {
          ...
          do
          {
            ...
            { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->ulPDSC)) = (LulProtectRegWrite); }
        ...
        { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPU)) = ((LpPortReg->usInitModePURegVal)); }
        { }

        

 
        { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPD)) = ((LpPortReg->usInitModePDRegVal)); }
        { }

        

 
        { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPIS)) = ((LpPortReg->usInitModePISRegVal)); }
        { }
        ...
        if((uint32)0x00008000UL == (LpPortReg->ulRegListAvailable &
            (uint32)0x00008000UL))
        {
            ...
            { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPFC)) = ((LpPortReg->usInitModePFCRegVal)); (*(&Port_GstRamMirrorPortReg[LucIndex]. usPFC)) = ((LpPortReg->usInitModePFCRegVal)); }
            { }
        }
        else
        {
        ...
        if((uint32)0x00004000UL == (LpPortReg->ulRegListAvailable &
            (uint32)0x00004000UL))
        {

            { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPFCE)) = ((LpPortReg->usInitModePFCERegVal)); (*(&Port_GstRamMirrorPortReg[LucIndex]. usPFCE)) = ((LpPortReg->usInitModePFCERegVal)); }
          { }
        }
        else
        {
        ...
        if((uint32)0x00010000UL == (LpPortReg->ulRegListAvailable &
          (uint32)0x00010000UL))
        {

            { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPFCAE)) = (LpPortReg->usInitModePFCAERegVal); (*(&Port_GstRamMirrorPortReg[LucIndex]. usPFCAE)) = (LpPortReg->usInitModePFCAERegVal); }
          { }
        }
        else
        {
        ...
        if((uint8)0x00 !=
                         (LpPortReg->ulRegListAvailable & (uint32)0x00000020UL))
         
        {
          ...
          { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPIPC)) = ((LpPortReg->usInitModePIPCRegVal)); (*(&Port_GstRamMirrorPortReg[LucIndex]. usPIPC)) = ((LpPortReg->usInitModePIPCRegVal)); }
          { }
        }
        else
        {
        ...
        if((uint32)0x00020000UL == (LpPortReg->ulRegListAvailable &
            (uint32)0x00020000UL))
        {
            ...
            { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->ulPMCSR)) = ((LpPortReg->ulInitModePMCSRRegVal | (uint32)0xFFFF0000UL)); }
            { }
        ...
        { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPIBC)) = ((LpPortReg->usInitModePIBCRegVal)); }
        { }

        

 
        { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->usPBDC)) = ((LpPortReg->usInitModePBDCRegVal)); }
        { }


         
        { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->ulPMSR)) = ((LpPortReg->ulInitModePMSRRegVal | (uint32)0xFFFF0000UL)); }
        { }
      }
      LucLoopCount++;
  ...
  else
  {
    ...
    if ((PORT_GROUP_JTAG == LenGroupType) && (0U == LddReturnValue))
     
    {
      ...
      if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
        ((uint8)0x00 == LpJPortReg->ucDeepStopSupp ))
      ...
      else
      {
        ...
        { (*(&Port_GpJPortReg_BaseAddress->ulJPSR)) = ((LpJPortReg->ulInitModeJPSRRegVal | (uint32)0xFFFF0000UL)); }
      ...
      do
      {
        ...
        { (*(&Port_GpJPortReg_BaseAddress->ulJPPCMD)) = (0xA5U); }
        


 
        { (*(&Port_GpJPortReg_BaseAddress->ulJPODC)) = (LulProtectRegWrite); }
      ...
      do
      {
        ...
        { (*(&Port_GpJPortReg_BaseAddress->ulJPDSC)) = (LulProtectRegWrite); }
      ...
      { (*(&Port_GpJPortReg_BaseAddress->ucJPU)) = ((uint8)(LpJPortReg->usInitModeJPURegVal)); }
      { }

      

 
      { (*(&Port_GpJPortReg_BaseAddress->ucJPD)) = ((uint8)(LpJPortReg->usInitModeJPDRegVal)); }
      { }

      

 
      { (*(&Port_GpJPortReg_BaseAddress->ucJPIS)) = ((uint8)(LpJPortReg->usInitModeJPISRegVal)); }
      { }

      

 
      { (*(&Port_GpJPortReg_BaseAddress->ucJPISA)) = ((uint8)(LpJPortReg->usInitModeJPISARegVal)); }
      { }

      

 
      { (*(&Port_GpJPortReg_BaseAddress->ucJPFC)) = (((uint8)(LpJPortReg->usInitModeJPFCRegVal))); (*(&Port_GstRamMirrorJPortReg . ucJPFC)) = (((uint8)(LpJPortReg->usInitModeJPFCRegVal))); }
      ...
      { (*(&Port_GpJPortReg_BaseAddress->ucJPFCE)) = ((uint8)(LpJPortReg->usInitModeJPFCERegVal)); (*(&Port_GstRamMirrorJPortReg . ucJPFCE)) = ((uint8)(LpJPortReg->usInitModeJPFCERegVal)); }
      { }
      ...
      { (*(&Port_GpJPortReg_BaseAddress->ulJPMCSR)) = ((LpJPortReg->ulInitModeJPMCSRRegVal | (uint32)0xFFFF0000UL)); }
      { }
      ...
      { (*(&Port_GpJPortReg_BaseAddress->ucJPIBC)) = ((uint8)(LpJPortReg->usInitModeJPIBCRegVal)); }
      { }
      ...
      { (*(&Port_GpJPortReg_BaseAddress->ucJPBDC)) = ((uint8)(LpJPortReg->usInitModeJPBDCRegVal)); }
      ...
      { (*(&Port_GpJPortReg_BaseAddress->ulJPMSR)) = ((LpJPortReg->ulInitModeJPMSRRegVal | (uint32)0xFFFF0000UL)); }
      { }
    ...
    else
    {
      ...
      if (PORT_GROUP_ANALOG == LenGroupType)
      {
        ...
        while ((LucLoopCount < LucNoOfPortReg) && (0U == LddReturnValue))
        {
          ...
          if (((uint32)0x00000001UL == ((*((volatile uint32 *)0xFFF80B00UL)) & (uint32)0x00000001UL)) &&
          ((uint8)0x00 == LpAPortReg->ucDeepStopSupp ))
          ...
          else
          {
            ...
            { (*(&Port_GaaAPortReg_BaseAddress[LucIndex]->ulAPSR)) = ((LpAPortReg->ulInitModeAPSRRegVal | (uint32)0xFFFF0000UL)); }
            { }
          }
          ...
          else
          {
            ...
            { (*(&Port_GaaAPortReg_BaseAddress[LucIndex]->usAPIBC)) = ((LpAPortReg->usInitModeAPIBCRegVal)); }
            { }

            

 
            { (*(&Port_GaaAPortReg_BaseAddress[LucIndex]->usAPBDC)) = ((LpAPortReg->usInitModeAPBDCRegVal)); }
            { }

            

 
            { (*(&Port_GaaAPortReg_BaseAddress[LucIndex]->ulAPMSR)) = ((LpAPortReg->ulInitModeAPMSRRegVal | (uint32)0xFFFF0000UL)); }
            { }
          }
          LucLoopCount++;
...
static  const volatile Port_PinChangeableDetails *
Port_SearchChangeablePinDetail(
Port_PinType LddPinNumber, uint8* pPortRegIndex, uint8 LucModeCheck)
 
{
  ...
  const Port_NumRegs * LpSearchNumRegPtr;
  uint16 LusHigh;
   
  const Port_AnalogRegs * LpSearchAnalogRegPtr;
  ...
  LucLow = (uint8)0x00;
  LucRetPGIndx = (uint8)0xFF;
   
   
  LusListSearchId = LpSearchPtr->ddPinId;
   
  *pPortRegIndex = (uint8)0xFF;
  ...
  if ((uint8)0xFF != LucRetPGIndx)
  {
    ...
    if ((uint8)PORT_GROUP_NUMERIC == (LpRetPtr->ucPortType & (uint8)0x0F))
    ...
    {
      {
        ...
        if ((uint8)PORT_GROUP_ANALOG ==
                      (LpRetPtr->ucPortType & (uint8)0x0F))
 ...
 
{
  ...
  const Port_JTAGRegs * LpPortJRegs;
   
  const Port_AnalogRegs * LpPortAnalogRegs;
  ...
  if (PORT_GROUP_NUMERIC == LenGroupType)
  {
     ...
     
    {
      ...
      { (*(&Port_GaaPortReg_BaseAddress[LucIndex]->ulPMSR)) = ((LpPortNumRegs->ulMaskConfigPMSRRegVal)); }
  ...
  else
  {
    ...
    if (PORT_GROUP_JTAG == LenGroupType)
    {
      ...
      while ((uint8)0x00 < LucNoOfRegs)
      {
        ...
        { (*(&Port_GpJPortReg_BaseAddress->ulJPMSR)) = ((LpPortJRegs->ulMaskConfigJPMSRRegVal)); }
    ...
    else
    {
      ...
      if (PORT_GROUP_ANALOG == LenGroupType)
      {
        ...
        while ((uint8)0x00 < LucNoOfRegs)
        {
          ...
          { (*(&Port_GaaAPortReg_BaseAddress[LucIndex]->ulAPMSR)) = ((LpPortAnalogRegs->ulMaskConfigAPMSRRegVal)); }
...
static  void Port_FilterConfig(void)
{
  ...
  const volatile Port_FCLARegs * LpFCLAReg;
  ...
  while ((uint8)0x00 < LucNoOfRegs)
  {
    ...
    { (*(&Port_GpFclaReg_BaseAddress->ucCTLn_SIG[LpFCLAReg->usFCLARegOffset])) = (LpFCLAReg->ucFCLACTL); }
 ...
 void Port_SetPinDefaultMode (Port_PinType Pin)
 
{
  ...
  LusInitMode = (Port_PinModeType)0x00;
   
  LusPIPCInitMode = (Port_PinModeType)0x00;
    ...
    if (((void *)0) != LpModeChangeablePin)
    {
       ...
       
      {
         ...
         
        {
          ...
          if ((Port_PinModeType)0x00 != LusInitMode)
           
          {
                                      ...
                                      & (uint32)0x00004000UL))
            {
              ...
              { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->usPFCE)) = (LusSRRegContent); (*(&Port_GstRamMirrorPortReg[LucPortGroupIndex]. usPFCE)) = (LusSRRegContent); }
              {}
                                   ...
                                   & (uint32)0x00008000UL))
            {
              ...
              { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->usPFC)) = (LusSRRegContent); (*(&Port_GstRamMirrorPortReg[LucPortGroupIndex]. usPFC)) = (LusSRRegContent); }
              {}
                                                        ...
                                                        (uint32)0x00010000UL))
            {
              ...
              { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->usPFCAE)) = (LusSRRegContent); (*(&Port_GstRamMirrorPortReg[LucPortGroupIndex]. usPFCAE)) = (LusSRRegContent); }
              {}
                                                         ...
                                                         (uint32)0x00000020UL))
          {
            ...
            LusSRRegContent =
                ...
                (uint16)(~(LusPinPositionMask))) |
                (LusSRRegContent));
            { (*(&Port_GaaPortReg_BaseAddress[LucPortGroupIndex]->usPIPC)) = (LusSRRegContent); (*(&Port_GstRamMirrorPortReg[LucPortGroupIndex]. usPIPC)) = (LusSRRegContent); }
            {}
          ...
          if ((Port_PinModeType)0x00 == LusPIPCInitMode)
           
          {
            ...
            LulSRRegContent =
              ((uint32)(LusPinPositionMask)) << (uint8)0x10;
      ...
      else
      {
         ...
         
        {
           ...
           
          {
            ...
            { (*(&Port_GpJPortReg_BaseAddress->ucJPFCE)) = ((uint8)LusSRRegContent); (*(&Port_GstRamMirrorJPortReg . ucJPFCE)) = ((uint8)LusSRRegContent); }
            ...
            { (*(&Port_GpJPortReg_BaseAddress->ucJPFC)) = ((uint8)LusSRRegContent); (*(&Port_GstRamMirrorJPortReg . ucJPFC)) = ((uint8)LusSRRegContent); }
            {}
 ...
 void Port_SetPinDefaultDirection (Port_PinType Pin)
 ...
 
{
  ...
  else
  {
    ...
    versioninfo->moduleID = (uint16)124U;
     
    versioninfo->sw_major_version = 2U;
     
    versioninfo->sw_minor_version = 4U;
     
    versioninfo->sw_patch_version = 19U;
  }
}
 ...
 Std_ReturnType Port_CheckHWConsistency
(Port_HWConsistencyCheckType CheckType)
 
{
  ...
  volatile PortReg * LpPortRegBase;
  const Port_NumRegs * LpPortReg;
  Port_NumRegRamMirror * LpPortRegMirror;
   
  volatile APortReg * LpAPortRegBase;
  const Port_AnalogRegs * LpAPortReg;
   ...
   
  {
    if (PORT_HW_CONSIST_CHECK_STATIC == CheckType)
    {
      ...
      for (LucLoopCount = (uint8)0x00; (0U == LddCheckStatus) &&
        (LucLoopCount < Port_GpConfigPtr->ucNoOfPortNumRegs); LucLoopCount++)
      {
        ...
        if ((LpPortRegBase->usPU != LpPortReg->usInitModePURegVal) ||
            ...
            (LpPortRegBase->ulPODC != (LpPortReg->ulInitModePODCRegVal
                                                   & (~(uint32)0xFFFF0000UL))) ||
            (((uint32)0x00000800UL ==
            (LpPortReg->ulRegListAvailable & (uint32)0x00000800UL)) &&
      ...
      if ((Port_GpJPortReg_BaseAddress->ucJPU !=
          ...
          (Port_GpJPortReg_BaseAddress->ulJPODC !=
              (LpJPortReg->ulInitModeJPODCRegVal & (~(uint32)0xFFFF0000UL))) ||
          (Port_GpJPortReg_BaseAddress->ulJPDSC !=
              (LpJPortReg->ulInitModeJPDSCRegVal & (~(uint32)0xFFFF0000UL))) ||
    ...
    else if (PORT_HW_CONSIST_CHECK_DYNAMIC == CheckType)
    {
          ...
          (LucLoopCount < Port_GpConfigPtr->ucNoOfPortNumRegs); LucLoopCount++)
      {
        ...
        if ((((uint8)0x00 !=
            ...
            (((uint8)0x00 !=
                     (LpPortReg->ulRegListAvailable & (uint32)0x00004000UL)) &&
             (LpPortRegBase->usPFCE != LpPortRegMirror->usPFCE)) ||
            (((uint8)0x00 !=
                     (LpPortReg->ulRegListAvailable & (uint32)0x00008000UL)) &&
             (LpPortRegBase->usPFC != LpPortRegMirror->usPFC)) ||
            (((uint8)0x00 !=
                     (LpPortReg->ulRegListAvailable & (uint32)0x00010000UL)) &&
