...
void FirmwareUpdateSdkCycleProcess(MpuHalDataPack_t *pRxMsg)
{
    ...
    if ((pRxMsg == ((void *) 0)) || (pRxMsg->pDataBuffer == ((void *) 0))) 
    {
        return;
    }
    ...
    if (curAid == 0x03)
    {
        ...
        switch (s_UpdateMid)
        {
            ...
            case E_FirmwareUpdateSdkCmd_UnlockMcuFlash:
                ...
                {
                    LogHalPrint("SET EEIF ERROR: 0x%08X, 0x%08X\r\n", WriteData, dataRead);
                    dataTxAraay[2] = 0x01; 
                }
                dataTxLen = 3U;
                break;
            case E_FirmwareUpdateSdkCmd_SoftwareResetMcu:
                LogHalPrint("---08 Software Reset---\r\n");
                dataTxAraay[2] = 0x00;
                dataTxLen = 3U;
                break;
            case E_FirmwareUpdateSdkCmd_GetMcuBankId:
                ...
                break;
            default:
                LogHalPrint("OTA Invalid MID: 0x%02X\r\n", s_UpdateMid);
                break;
        }
