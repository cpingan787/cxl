...
static int16_t g_mpuHandleFault = -1;                      
...
void McuMpuSyncTaskMain(void)
{
    ...
    {
        timeSyncPack  = ((void *) 0);
        powerSyncPack = ((void *) 0);
        stateSyncPack = ((void *) 0);
        paramSyncPack = ((void *) 0);
        dtcSyncPack = ((void *) 0); 
        ...
        if(ret == 0)    
        {
            if(g_dataPack.aid == 0x01 && g_dataPack.mid == 0x02) 
            {
                timeSyncPack = &g_dataPack;
            }
            else if(g_dataPack.aid == 0x01 && g_dataPack.mid == 0x03)
            {
                paramSyncPack = &g_dataPack;
            }
            else if(g_dataPack.aid == 0x01 && (g_dataPack.mid == 0x10 || g_dataPack.mid == 0x11 || g_dataPack.mid == 0x16 || g_dataPack.mid == 0x17))
            {
                stateSyncPack = &g_dataPack;
            }
            else if(g_dataPack.aid == 0x01 && g_dataPack.mid == 0x04)
            {
                powerSyncPack = &g_dataPack;
            }
            else if(g_dataPack.aid == 0x30 && g_dataPack.mid == 0x01)
            {
