...
static uint8_t g_dataBuffer[2048] = {0};
static MpuHalDataPack_t  g_dataPack;
static uint8_t g_recvDataBuffer[2048] = {0};
...
void McuMpuSyncTaskMain(void)
{
...

    {
        ...
        if(ret == MPU_HAL_STATUS_OK)
        {
            ...
            {
        //         // if (g_dataPackFault.dataLength >= 12)       //mpu->mcu原始12字节数据调试打印
        //         // {
        //         //     TBOX_PRINT("RX MPU FAULT RAW: %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X\r\n",
        //         //                g_dataPackFault.pDataBuffer[0],
        //         //                g_dataPackFault.pDataBuffer[1],
        //         //                g_dataPackFault.pDataBuffer[2],
        //         //                g_dataPackFault.pDataBuffer[3],
        //         //                g_dataPackFault.pDataBuffer[4],
        //         //                g_dataPackFault.pDataBuffer[5],
        //         //                g_dataPackFault.pDataBuffer[6],
        //         //                g_dataPackFault.pDataBuffer[7],
        //         //                g_dataPackFault.pDataBuffer[8],
        //         //                g_dataPackFault.pDataBuffer[9],
        //         //                g_dataPackFault.pDataBuffer[10],
        //         //                g_dataPackFault.pDataBuffer[11]);
        //         // }
