...
/**
  ...
  RuleSource:puhua-rule.rcf 3.0.0
    ...
    \li VL_StbM_3673
      Reason: Confirm that there are no issues.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

    \li VL_StbM_4395
      Reason: The result of this logical operation might be always false, in sometimes.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
*/
/******************************************************************************
...
#define STBM_AR_MINOR_VERSION 5U
#define STBM_AR_PATCH_VERSION 0U
#define STBM_SW_MAJOR_VERSION 2U
#define STBM_SW_MINOR_VERSION 0U
#define STBM_SW_PATCH_VERSION 13U
