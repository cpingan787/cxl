...
#define ICU_MAX_CHANNEL_ID_CONFIGURED                      4U
...
#define ICU_MAX_8BIT_REGISTERS                             (uint8)4
...
#define ICU_EXT_INTP_CH06 0x02U
#define ICU_EXT_INTP_CH09 0x03U
#define ICU_EXT_INTP_CH02 0x04U

/* TRACE [R4, ICU221_Conf] */
/* TRACE [R4, ICU354_Conf] */
/* ICU Channel Handles */
#define IcuConf_IcuChannel_IcuChannel_0_Crash (Icu_ChannelType)0x00
#define IcuConf_IcuChannel_IcuChannel_2_NAD (Icu_ChannelType)0x02
#define IcuConf_IcuChannel_IcuChannel_3_EcallBtn (Icu_ChannelType)0x03
#define IcuConf_IcuChannel_IcuChannel_6_Rtc_int (Icu_ChannelType)0x04
