...
/* PRQA S 3326,3226 ++ */                /* VL_QAC_Crypto */
/* PRQA S 1863,1843,1842,1841,1840 ++ */ /* VL_QAC_Crypto */
/* PRQA S 4558,4542 ++ */                /* VL_QAC_Crypto */
/* PRQA S 3218 ++ */                     /* VL_QAC_Crypto */
/* PRQA S 1281 ++ */                     /* VL_QAC_Crypto */
/* PRQA S 2985 ++ */                     /* VL_QAC_Crypto */
    ...
    VAR(uint32, AUTOMATIC) ilen)
{
    ...
    if (left && ilen >= fill) /* PRQA S 3397 */ /* VL_QAC_Crypto */
    {
    ...
    while (ilen >= 64)
    {
        if ((ret = Crypto_internal_sha256_process(ctx, input)) != 0) /* PRQA S 2784 */ /* VL_QAC_Crypto */
        {
            goto exit;
        }
    ...
    P2VAR(uint8, AUTOMATIC, CRYPTO_APPL_DATA) output)
{
    ...
    if (E_NOT_OK != ret)
    {
        ...
        if (E_NOT_OK != ret)
        {
            ret = Crypto_sha256_finish_ret(&ctx, output); /* PRQA S 2784 */ /* VL_QAC_Crypto */
        }
    }
    return ret;
}
