...
/* Module       = F1K_translation_701560.h                                    */
/*============================================================================*/
/*                                  COPYRIGHT                                 */
/*============================================================================*/
 ...
 *                          5. 'RENESAS_ICRCANGRECC0_IMR' and
 *                          'RENESAS_ICRCANGRECC1_IMR' are added.
 *                          6. 'RENESAS_RSCAN_MAX_RAMPAGES_R7F701560' is added.
 ...
 * V2.1.5:  27-Apr-2018   : Following Changes are made:
 ...
 * V2.1.8:  10-Nov-2020  : #ARDAABD-4959 Added RENESAS_DEVICE_PIN define.
 * 
 */
/******************************************************************************/
/*******************************************************************************
...
#define RENESAS_PORTGROUP11_PINS         0-7
#define RENESAS_PORTGROUPANALOG0_PINS    0-15
#define RENESAS_PORTGROUPJTAG0_PINS      0-5
...
#define RENESAS_PG11_PINS_UNAVAILBALE   8-15
...
#define RENESAS_P0_5_RTCA0OUT_AT1OUT         0  // For Jtag Port
#define RENESAS_P8_5_INTP9_AT3IN             0
#define RENESAS_P8_6_RTCA0OUT_AT3OUT         0
#define RENESAS_P10_14_ADCA1TRG0_AT1IN       0
#define RENESAS_P11_0_ADCA1TRG2_AT2IN        0
...
#define RENESAS_P11  PORTGROUP_11_BITS_0_TO_7
#define RENESAS_AP0  PORTGROUPANALOG_0_BITS_0_TO_15
#define RENESAS_JP0  PORTGROUPJTAG_0_BITS_0_TO_5
...
#define RENESAS_INTP_SUPPORTED                    0-8_10-13
...
*******************************************************************************/
/* 100 pin device is having 48 PWM diag channels */
#define RENESAS_PWGA_R7F701560        48
...
#define RENESAS_DIAG_CHANNELS_AVAILABILITY        0-47
...
#define RENESAS_DEVICE_PIN                        F1K_100PIN
/*******************************************************************************
...
/* Available PWM Diag Channels for 100 pin Devices */

#define RENESAS_MAX_DIAG_CHANNEL   47
...
#define RENESAS_ADC1_CHANL_PIN                    PIN_NA
/* Diag Channel available for ADC0 */
#define RENESAS_ADC_DIAG_CHANL                    PIN_0-47
...
#define RENESAS_ADC_DEVICE_PIN                    100
/* ADC Device ADC1 availability */
#define RENESAS_ADC_HWUNIT1_AVBL                  0
...
#define RENESAS_AVAILABILITY_CSIG1                    0
...
#define RENESAS_PORTJTAG_0           PORTGROUPJTAG_0_PORTPIN_0_TO_5
...
#define RENESAS_PORT_11              PORTGROUP_11_PORTPIN_0_TO_7
...
/*Start address of 701560 */
#define RENESAS_START_ADDR        0xFEBD8000
/*End address of 701560 */
