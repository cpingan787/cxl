...
static void Os_IncrementCounterInternal(CounterType counterId);
...
static void Os_GetCounterValue(CounterType counterId, TickRefType value);
...
static void Os_GetElapsedValue(CounterType counterId, TickRefType value, TickRefType elapsedValue);
...
static void Os_GetElapsedValue(
    CounterType counterId,
    TickRefType value,
 ...
 
{
    ...
    if (Os_ObjectIDCheck((ObjectType)CounterID, (uint8)OS_OBJECT_COUNTER) != 1u)
    {
        err = 3U;
    }
    else if (OS_COUNTER_HARDWARE == Os_CounterCfg[CounterID].CounterProperty)
    {
        ...
        if (curCoreId != (Os_CounterCfg[CounterID]. HostCore))
        {
            err = 21U;
        }
        else
 ...
 
{
    ...
    else if (curCoreId != (Os_CounterCfg[CounterID]. HostCore))
    {
        err = 21U;
    }
    else
