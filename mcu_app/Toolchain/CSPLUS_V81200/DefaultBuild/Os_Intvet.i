...
void Os_ISR_SystemTimer_Core_0_Handler0(void)
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_SYS_TIMER_CORE0_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_SYS_TIMER_CORE0_ID); do { if (1u == Os_IsrCfg[CFG_SYS_TIMER_CORE0_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ;
    Os_ArchSystemTimerCore0();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_SYS_TIMER_CORE0_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RCAN1ERR_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RCAN1ERR_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RCAN1ERR_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RCAN1ERR_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RCAN1ERR_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RCAN1ERR_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RCAN1TRX_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RCAN1TRX_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RCAN1TRX_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RCAN1TRX_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RCAN1TRX_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RCAN1TRX_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RCANGRECC0_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RCANGRECC0_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RCANGRECC0_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RCANGRECC0_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RCANGRECC0_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RCANGRECC0_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_ADCA0I1_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_ADCA0I1_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_ADCA0I1_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_ADCA0I1_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_ADCA0I1_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_ADCA0I1_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_ADCA1I1_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_ADCA1I1_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_ADCA1I1_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_ADCA1I1_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_ADCA1I1_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_ADCA1I1_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_TAUJ0I0_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_TAUJ0I0_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_TAUJ0I0_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_TAUJ0I0_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_TAUJ0I0_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_TAUJ0I0_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_TAUD0I9_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_TAUD0I9_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_TAUD0I9_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_TAUD0I9_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_TAUD0I9_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_TAUD0I9_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_TAUB0I12_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_TAUB0I12_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_TAUB0I12_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_TAUB0I12_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_TAUB0I12_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_TAUB0I12_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_TAUB0I8_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_TAUB0I8_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_TAUB0I8_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_TAUB0I8_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_TAUB0I8_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_TAUB0I8_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_TAUB0I9_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_TAUB0I9_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_TAUB0I9_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_TAUB0I9_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_TAUB0I9_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_TAUB0I9_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_P1_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_P1_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_P1_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_P1_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_P1_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_P1_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_P2_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_P2_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_P2_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_P2_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_P2_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_P2_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_P5_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_P5_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_P5_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_P5_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_P5_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_P5_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_P6_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_P6_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_P6_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_P6_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_P6_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_P6_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_P7_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_P7_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_P7_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_P7_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_P7_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_P7_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_P9_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_P9_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_P9_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_P9_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_P9_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_P9_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_P14_IRQ_Handler(void) 
{
       
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_P14_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_P14_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_P14_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_P14_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_P14_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RLIN34TX0_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RLIN34TX0_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RLIN34TX0_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RLIN34TX0_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RLIN34TX0_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RLIN34TX0_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RLIN34RX1_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RLIN34RX1_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RLIN34RX1_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RLIN34RX1_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RLIN34RX1_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RLIN34RX1_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RLIN34ERR2_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RLIN34ERR2_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RLIN34ERR2_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RLIN34ERR2_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RLIN34ERR2_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RLIN34ERR2_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RLIN35TX0_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RLIN35TX0_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RLIN35TX0_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RLIN35TX0_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RLIN35TX0_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RLIN35TX0_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RLIN35RX1_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RLIN35RX1_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RLIN35RX1_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RLIN35RX1_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RLIN35RX1_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RLIN35RX1_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RLIN35ERR2_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RLIN35ERR2_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RLIN35ERR2_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RLIN35ERR2_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RLIN35ERR2_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RLIN35ERR2_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RIIC0TI_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RIIC0TI_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RIIC0TI_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RIIC0TI_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RIIC0TI_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RIIC0TI_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RIIC0EE_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RIIC0EE_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RIIC0EE_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RIIC0EE_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RIIC0EE_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RIIC0EE_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RIIC0RI_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RIIC0RI_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RIIC0RI_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RIIC0RI_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RIIC0RI_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RIIC0RI_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
...
void Os_ISR_RIIC0TEI_IRQ_Handler(void) 
{
    ...
    do { do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()] = Os_ArchTempSp; } else { Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()] = Os_ArchTempSp; } } while (0); do { Os_ArchTempSp = (((uint32)Os_ISR2Stack[CFG_ISR_RIIC0TEI_IRQ_ID]. StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0); ; Os_EnterISR2(CFG_ISR_RIIC0TEI_IRQ_ID); do { if (1u == Os_IsrCfg[CFG_ISR_RIIC0TEI_IRQ_ID]. NestedEnable) { __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) & 0xFFFFFF5FUL)); } } while (0); ; } while (0);
     
    ISR_RIIC0TEI_IRQ_Handler();
       
       
    do { ; ; __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL)); Os_ExitISR2(CFG_ISR_RIIC0TEI_IRQ_ID); do { if (0U == Os_Kernel_GetIntNestNumISR2()) { Os_ArchTempSp = Os_TaskCBExt[Os_Kernel_GetSysRunningTaskID()]; } else { Os_ArchTempSp = Os_IsrNestStack[Os_Kernel_GetIntNestNumISR2()]; } } while (0); Os_ISR2Exit();; } while (0);
