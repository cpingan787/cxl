...
Os_ResourceType Os_ICBisrC2ResourceStack[(5U)][(1U)];
...
Os_ResourceType Os_TCBTaskResourceStack[(3U)][(1U)];
...
const uint16* const Os_TaskResourceAccessMask[(3U)] =
...
const uint16* const Os_IsrResourceAccessMask[(5U)] =
...
const Os_ResourceCfgType Os_ResourceCfg[(1U)] =
 
{
    {
        ((Os_CoreIdType)0U),
        2U,	 
        OS_RES_OCCUPIED_BY_TASK,	 
    },
};
...
const Os_ResourceType Os_ResScheduler_Inf[(1U)] =
...
const uint16 Os_CfgStdResourceMax_Inf[(1U)] =
{
...
const Os_ResourceRangeType Os_StdResIdRange[(1U)] =
