...
const PduR_PBConfigType * PduR_ConfigStd = ((void *)0);
...
{
    {
        ...
        PduIdType destPduNumber = PduR_ConfigStd->PduRRoutingPathGroupRef[id].PduRDestPduRefNumber;
        for (PduIdType index = 0u; index < destPduNumber; index++)
        {
            PduIdType destPduId = PduR_ConfigStd->PduRRoutingPathGroupRef[id].PduRDestPduIdRef[index];
...
{
    {
        ...
        for (PduIdType index = 0u; index < destPduNumber; index++)
        {
            ...
            if (PduR_RoutingPathEnabled[destPduId])
            {
                PduR_RoutingPathEnabled[destPduId] = 0u;
            }
        }
        SchM_Exit_PduR_ExclusiveArea_Group();
    }
...
Std_ReturnType PduR_Transmit(PduIdType TxPduId, const PduInfoType* PduInfoPtr)
{
    Std_ReturnType result = 1U;
    {
        ...
        for (uint8 cnt = 0u; cnt < PduR_ConfigStd->PduRRoutingTableRef[PduR_ConfigStd->PduRConfigId]. PduRRoutingPathRef[TxPduId]. PduDestSum; cnt++)
        {
            PduIdType destPduId = PduR_ConfigStd->PduRRoutingTableRef[PduR_ConfigStd->PduRConfigId]. PduRRoutingPathRef[TxPduId]. PduRDestPduIdRef[cnt];
             
            if (PduR_IsRoutingPathEnable(destPduId))
            {
                Std_ReturnType tmpResult = 1U;
                switch (PduR_ConfigStd->PduRDestPduRef[destPduId]. routeType)
                {
...
Std_ReturnType PduR_CancelTransmit(PduIdType TxPduId)
{
    Std_ReturnType result = 1U;
    {
        ...
        uint8 destPduNum = PduR_ConfigStd->PduRRoutingTableRef[PduR_ConfigStd->PduRConfigId]. PduRRoutingPathRef[TxPduId]. PduDestSum;
...
{
    Std_ReturnType result = 1U;
    PduIdType srcPduId = PduR_ConfigStd->PduRDestPduRef[RxPduId]. PduRSrcPduRef[0u];
    {
...
{
    {
        uint8 destPduNum = PduR_ConfigStd->PduRRoutingTableRef[PduR_ConfigStd->PduRConfigId]. PduRRoutingPathRef[RxPduId]. PduDestSum;
        for (uint8 cnt = 0u; cnt < destPduNum; cnt++)
        {
            PduIdType destPduId = PduR_ConfigStd->PduRRoutingTableRef[PduR_ConfigStd->PduRConfigId]. PduRRoutingPathRef[RxPduId]. PduRDestPduIdRef[cnt];
            if (PduR_IsRoutingPathEnable(destPduId))
            {
...
{
    {
        ...
        PduIdType srcPduId = PduR_ConfigStd->PduRDestPduRef[TxPduId]. PduRSrcPduRef[0u];
        PduR_PduRIfTxConfirmation(srcPduId, TxPduId, 0U);
    }
}
...
BufReq_ReturnType PduR_TpCopyRxData(PduIdType id, const PduInfoType* info, PduLengthType* bufferSizePtr)
{
    ...
    {
        uint8 destPduNum = PduR_ConfigStd->PduRRoutingTableRef[PduR_ConfigStd->PduRConfigId]. PduRRoutingPathRef[id]. PduDestSum;
        for (uint8 cnt = 0u; cnt < destPduNum; cnt++)    
        {
            PduIdType destPduId = PduR_ConfigStd->PduRRoutingTableRef[PduR_ConfigStd->PduRConfigId]. PduRRoutingPathRef[id]. PduRDestPduIdRef[cnt];
            if (!PduR_IsRoutingPathEnable(destPduId))
            {
                continue;
            }
...
{
    PduIdType srcPdu = PduR_ConfigStd->PduRDestPduRef[id]. PduRSrcPduRef[0u];
    {
