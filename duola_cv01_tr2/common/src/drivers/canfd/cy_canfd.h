 ...
 *****************************************************************************/
typedef void (*cy_canfd_tx_msg_func_ptr_t)( uint8_t txMsgMarker);// xwm 2023.4.25
...
typedef void (*cy_canfd_error_func_ptr_t)(uint8_t enCanFDError);//xwm 2023.4.26
/**
 *****************************************************************************
...
cy_en_canfd_status_t CanFD_GetMsgFromTransmitMsgBuffer( cy_pstc_canfd_type_t pstcCanFD,uint8_t u8MsgBuf,cy_stc_canfd_msg_t* pstcMsg);
