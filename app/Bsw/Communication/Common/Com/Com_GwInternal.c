    ...
    Com_SignalIdType DestSignalId)
{
    ...
    Com_TxIPduRunTimeStateType* txIpduStatePtr = &Com_TxIPduRunTimeState[txPduId]; /* PRQA S 2932 */ /* VL_Com_2932 */
    ...
    if (0u != ILib_memcmp(&Com_TxIPduRuntimeBuff[txIPduBufId], &Com_GWSignal8BitBuff[SigBufId], len))
    {
