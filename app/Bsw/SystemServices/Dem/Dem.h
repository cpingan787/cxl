...
/**
  ...
  RuleSorce:puhua_rules-2024.12.rcf
    ...
    \li VL_Dem_1504
      Reason: variable design requires
      Risk: No risk.
    ...
    \li VL_Dem_1520
      Reason: Normal design of sub-function calls
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

    \li VL_Dem_2461
      Reason: The functional design needs to be handled within the loop.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

    \li VL_Dem_2463
      Reason: Necessary variable information update, does not lead to a dead loop.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
    ...
    \li VL_Dem_2472
     ...
     \li VL_Dem_2896
      Reason:  required type conversion.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
  ...
  different DTCs, events, pids, dids and other configuration conditions, as well as some precompiled macros
    ...
    \li VL_MTR_Dem_STCYC
      Reason: Due to the implementation requirements of some diagnostic functions, the functions were not
 ...
 * V2.1.16       2025-10-21  chao.sun       CPT-16110, Fix the issue with aged counter and aging counter calculation.
 *               2024-09-19  tao.yu         fix PermanentMemory and inter data process
 *******************************************************************************/
...
#define DEM_SW_PATCH_VERSION         16U
 ...
 */
/*************************************************************************/
extern FUNC(Std_ReturnType, DEM_CODE) Dem_SetDataOfPID21(P2CONST(uint8, AUTOMATIC, DEM_APPL_DATA) PID21value);
