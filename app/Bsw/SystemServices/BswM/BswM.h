...
/**
  ...
  RuleSorce:puhua-rule.rcf 2.3.1
    ...
    \li VL_BswM_2784
      Reason: Since the generated configuration code is an array, the parameter passed here is a variable, resulting in
  a violation of. Risk: No risk. Prevention: Functional reliability guaranteed by design.
    ...
    \li VL_BswM_1513
      Reason: Less exposure of internal data and easy for SchM maintainance.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

    \li VL_BswM_1520
      Reason: Functions are indirectly recrsive.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
