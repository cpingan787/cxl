...
static uint8 IsDateValid(void)
{
    ...
    if(retValue == 0U)
    {
        retValue = DataCompare(readData, FeeUser_Data_Store, (64u));
    }
...
uint8 EEIf_Write(uint32 sAddr, uint32 size, uint8* buf)
{
    ...
    uint32 endAddr = ((0xFF200000UL) + (0x2000u) - (64u));
    FeeUser_Data_Store[0] = ((0xA532u) >> 8) & 0xff;
    FeeUser_Data_Store[1] =  (0xA532u) & 0xff;
    ...
    {
        tem = DataWriteProcess((0xFF202000UL) - (0xFF200000UL), FeeUser_Data_Store, (64u));  
        if(tem == 0U)
        {
            tem = IsDateValid();
        }
        
        tem = DataEraseProcess(startAddr - (0xFF200000UL), (0x2000u));                                                        
    }
    if(tem == 1U)
    {
        startAddr = (0xFF202000UL);
        endAddr = ((0xFF202000UL) + (0x2000u) - (64u));
	startData = DataReadByAddr(startAddr);
	endData = DataReadByAddr(endAddr);
        if((startData != 0xFFFF ) && (endData != 0xFFFF))
        {
            tem = DataWriteProcess((0xFF200000UL) - (0xFF200000UL), FeeUser_Data_Store, (64u));
    ...
    if(tem == 1U)
    {
        ...
        for(i = 0; i < (128u); i++)
        {
            ...
            if(addrData == 0xFFFF)
            {
                ...
                tem =DataWriteProcess(startAddr - (0xFF200000UL) + i * 64 , FeeUser_Data_Store, (64u));
                if(tem == 0U)
                {
                    tem = IsDateValid();
                }
...
static uint8 DataReadBlockProcess(uint8* buf)
{
    ...
    if(startAddr != (0xFFFFFFFFu))
    {
        ...
        for(i = 0; i < (128u); i++)
        {
            uint32 SourceAddress  = startAddr + i * (64u);
            uint8  TargetAddressPtr[(64u)] = {0};
            DataReadProcess(SourceAddress - (0xFF200000UL), TargetAddressPtr, (64u));
            if((TargetAddressPtr[0] == (((0xA532u) >> 8) & 0xff)) && 
                (TargetAddressPtr[1] == ((0xA532u) & 0xff)))
            {
                CommF_DataCopy(buf, TargetAddressPtr, (64u));
                tem = 0U;
            }
            else
            {
...
uint8 EEIf_Read(uint32 sAddr, uint32 size, uint8* buf)
{
    ...
    uint8 tem = 1U;
    uint8 *pdata = ((void *)0);
    uint32 ValidSector_Addr = ValidSectorAdd((0xFF200000UL),(0xFF202000UL));
    if(ValidSector_Addr != (0xFFFFFFFFu))
    {
        for(i = 0; i < (128u); i++)
        {
            SourceAddress  = ValidSector_Addr +((128u) - 1 - i) * 64;
            uint8  TargetAddressPtr[(64u)] = {0};
            DataReadProcess(SourceAddress - (0xFF200000UL), TargetAddressPtr, (64u));
            if((TargetAddressPtr[0] == (((0xA532u) >> 8) & 0xff)) && 
                (TargetAddressPtr[1] == ((0xA532u) & 0xff)))
