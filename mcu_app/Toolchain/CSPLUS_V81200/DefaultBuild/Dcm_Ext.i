...
{
    (void)Det_ReportError((0x35u), (0x00u), (ApiId), (ErrorId));
}
...
extern Dcm_DspProgramType Dcm_DspProgram;

extern const Dcm_CfgType * DcmPbCfgPtr;

extern Dcm_MkCtrlType Dcm_MkCtrl;  

extern boolean gAppl_UpdataOK_ResponseFlag;

extern boolean Dcm_ReqSetProgConditions;
...
extern  Std_ReturnType DslInternal_RxIndicationDeal(uint8 ProtocolCfgCtrlId);
...
extern  void Dcm_ResetTime(uint32 * TimerPtr);
...
extern  void Dcm_GetTimeSpan(uint32 TimerPtr, uint32 * TimeSpanPtr);
...
extern  void DslInternal_InitDspProgramInfo(void);
...
extern  void DspInternal_DcmConfirmation(uint8 ProtocolCtrlId);
...
extern  Std_ReturnType Dcm_UdsSubServicesCheck(uint8 ProtocolCtrlId);
...
extern  Std_ReturnType DsdInternal_SearchSidTabServiceIndex(
    uint8 Sid,
    uint8 ProtocolCtrlId,
    uint16 * pSidTabIndex,
    uint16 * pSidTabServieCfgIndex);
...
extern  Std_ReturnType DsdInternal_SearchSidTabSubServiceIndex(
    uint8 ProtocolCtrlId,
    uint16 SidTabIndex,
    uint16 ServiceIndex,
    uint16 * pSubServieCfgIndex);
...
static inline  void DsdInternal_SetNrc(uint8 ProtocolCtrlId, Dcm_NegativeResponseCodeType Nrc)
{
    uint8 MsgCtrlIndexx;
...
extern  Std_ReturnType DsdInternal_RxIndication(uint8 ProtocolCtrlId);
...
extern  void DsdInternal_ProcessingDone(uint8 ProtocolCtrlId);
...
extern  void DsdInternal_TxConfirmation(uint8 ProtocolCtrlId);
...
static inline  void DslInternal_P2ServerStart(uint8 ProtocolCtrlId)
{
...
static inline  void DslInternal_P2ServerStop(uint8 ProtocolCtrlId)
{
    uint8 MsgCtrlIndexx = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
    Dcm_P2CtrlType* pDcm_P2Ctrl = &Dcm_MsgCtrl[MsgCtrlIndexx].Dcm_P2Ctrl;
...
extern  void DslInternal_P2ServerTimeout(uint8 ProtocolCtrlId);
...
static inline  Std_ReturnType DslInternal_MinIsLargerThanP2Server(uint8 ProtocolCtrlId)
{
    uint8 MsgCtrlIndexx = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
...
static inline  Std_ReturnType DslInternal_MaxIsLargerThanP2Server(uint8 ProtocolCtrlId)
{
    uint8 MsgCtrlIndexx = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
...
extern  Std_ReturnType DslInternal_ProtocolStop(uint8 ProtocolCtrlId);
...
static inline  void DslInternal_SetProtocolLinkLayerTimer(uint32 P2ServerTimer, uint32 P2StarServerTimer)
{
    uint8 Num;
    uint8 ProtocolCtrlId;
    uint32 P2ServerTime;
    ...
    for (ProtocolCtrlId = 0; ProtocolCtrlId < Num; ProtocolCtrlId++)
    {
        ...
        Dcm_ProtocolCtrl[ProtocolCtrlId].S3Server = 5000UL;  
    }
}
...
static inline  void
    Dcm_MemoryCopy(const uint8 * Source, uint8 * Dest, uint32 Length)
{
    uint32 Cnt;
...
static inline  void DslInternal_InitMsgCtrl(uint8 MsgCtrlId)
{
    if (MsgCtrlId < DcmPbCfgPtr->pDcmDslCfg->pDcmDslProtocol->DcmDslProtocolRow_Num)
    {
        ...
        pDcm_MsgCtrl->SID = (0xFFu);
        pDcm_MsgCtrl->Subfunction = (0xFFu);
        pDcm_MsgCtrl->NRC = (0xFFu);
        pDcm_MsgCtrl->SendFlag = 0u;
        pDcm_MsgCtrl->RspStyle = DCM_POS_RSP;
        pDcm_MsgCtrl->DcmTxPduId = (0xFFu);
        pDcm_MsgCtrl->Dcm_RxCtrlChannelIndex = (0xFFu);
        pDcm_MsgCtrl->Dcm_TxCtrlChannelIndex = (0xFFu);
        pDcm_MsgCtrl->MsgContext.DcmRxPduId = (0xFFu);
        pDcm_MsgCtrl->MsgContext.pReqData = ((void *)0);
        pDcm_MsgCtrl->MsgContext.ReqDataLen = 0;
        pDcm_MsgCtrl->MsgContext.pResData = ((void *)0);
        pDcm_MsgCtrl->MsgContext.ResDataLen = (0xFFFFFFFFUL);
        pDcm_MsgCtrl->MsgContext.MsgAddInfo.ReqType = (uint8)DCM_PHYSICAL;
        pDcm_MsgCtrl->MsgContext.MsgAddInfo.SuppressPosResponse = 0u;
        pDcm_MsgCtrl->MsgContext.MsgAddInfo.CancelOperation = 0u;
        pDcm_MsgCtrl->MsgContext.ResMaxDataLen = (0xFFFFFFFFUL);
        pDcm_MsgCtrl->MsgContext.IdContext = (0xFFu);
        pDcm_MsgCtrl->Dcm_P2Ctrl.Dcm_P2CurTimer = (0xFFFFFFFFUL);
        pDcm_MsgCtrl->Dcm_P2Ctrl.Dcm_P2ExpiredTimer = (0xFFFFFFFFUL);
        ...
        pDcm_MsgCtrl->Dcm_Ret = 1U;
        pDcm_MsgCtrl->Dcm_OpStatus = ((Dcm_OpStatusType)0x00u);
    }
}
...
static inline  void DslInternal_InitChannelCtrl(uint8 ChannelCtrlId)
{
    uint8 ChannelNum = Dcm_GetChannelNum();
    if (ChannelCtrlId < ChannelNum)
    {
        Dcm_ChannelCtrl[ChannelCtrlId].Dcm_ChannelCfgIndex = (0xFFu);
...
extern  void DslInternal_ResetResource(uint8 ProtocolCtrlId);
...
extern  BufReq_ReturnType Dcm_StartOfReception_Checklength(
    PduIdType id,
    const PduInfoType * info,
    PduLengthType TpSduLength,
    PduLengthType * bufferSizePtr);
...
static inline  uint8 Dcm_ClassifyServiceType(Dcm_ProtocolType protocolType)
{
    uint8 serviceType;
    switch (protocolType)
    {
    case ((Dcm_ProtocolType)0x00u):
    case ((Dcm_ProtocolType)0x01u):
    case ((Dcm_ProtocolType)0x02u):
        serviceType = (0x00u);
        break;
    case ((Dcm_ProtocolType)0x03u):
    case ((Dcm_ProtocolType)0x04u):
    case ((Dcm_ProtocolType)0x05u):
        serviceType = (0x01u);
        break;
    case ((Dcm_ProtocolType)0x06u):
    case ((Dcm_ProtocolType)0x07u):
    case ((Dcm_ProtocolType)0x08u):
        serviceType = (0x02u);
        break;
    case ((Dcm_ProtocolType)0x09u):
    case ((Dcm_ProtocolType)0x0Au):
    case ((Dcm_ProtocolType)0x0Bu):
        serviceType = (0x03u);
        break;
    default:
        serviceType = (0x04u);
...
extern  void DslInternal_ProcessingDone(uint8 ProtocolCtrlId);
...
static inline  void Dcm_MemSet(uint8 * Dest, uint8 Val, uint32 Size)
{
    uint32 Cnt = Size;
    while (Cnt > 0u)
    {
...
static  void DslInternal_SetSecurityLevel(Dcm_SecLevelType NewSec);
...
static  void Dcm_MainFunction_S3Timer(void);
...
static  void Dcm_MainFunction_SecTimer(void);
...
static  void Dcm_MainFunction_ReadSecTimer(void);
...
static  void DslInternal_InitSecCtrl(void);
...
static inline  void DslInternal_SetSesCtrlType(Dcm_SesCtrlType NewSes);
...
static  Std_ReturnType DslInternal_GetSesTimingValues(
...
static  void DslInternal_SetSesTimingValues(Dcm_SesCtrlType NewSes);
...
static  void DslInternal_DefaultToDefault(Dcm_SesCtrlType NewSes);
...
static  void DslInternal_DefaultToUndefault(Dcm_SesCtrlType NewSes);
...
static  void DslInternal_UndefaultToUndefault(Dcm_SesCtrlType NewSes);
...
static  void DslInternal_UndefaultTodefault(Dcm_SesCtrlType NewSes);
...
static  void DslInternal_SesTranslation(Dcm_SesCtrlType NewSes);
...
static  void DslInternal_S3ServerTimeout(void);
...
static inline  void DslInternal_InitSesCtrl(void);
...
Dcm_RoutineControlStateType Dcm_RoutineControlState[(11u)];

Dcm_CommCtrlType Dcm_CommCtrl[(1u)];
 

Dcm_SecCtrlType Dcm_SecCtrl;  

Dcm_SesCtrlCBType Dcm_SesCtrl;  

Dcm_ProtocolCtrlType Dcm_ProtocolCtrl[(1u)];
 

Dcm_ChannelCtrlType Dcm_ChannelCtrl[(2u)];
 

Dcm_MsgCtrlType Dcm_MsgCtrl[(1u)];
 

Dcm_ConnectionCtrlType Dcm_ConnectionCtrl[(1u)];
...
Dcm_FunctionMessageType Dcm_FunctionalMessage;
...
Dcm_OBDMessageType Dcm_OBDMessage;
 ...
 void Dcm_InterInit(void)
{
    ...
    Dcm_MemSet(Dcm_Channel, 0x00, (2048u));
    ...
    if (((void *)0) != DcmVinRef)
    {
        ...
        {
            Dcm_VIN.DcmVIN[Index] = 0xFF;
        }
        for (Index = 0; (Index < DcmDspDidSignalNum) && (Dcm_VIN.Flag == 1u); Index++)
        {
            const Dcm_DspDataType* pDidData = pDcmDspDidSignal[Index].pDcmDspDidData;
            VIN_Data = &(Dcm_VIN.DcmVIN[Offest]);
            if (((void *)0) != pDidData->DcmDspDataReadFnc)
            {
                ret = pDidData->DcmDspDataReadFnc(((Dcm_OpStatusType)0x00u), VIN_Data, &ErrorCode);
                if (0U != ret)
                {
                    Dcm_VIN.Flag = 0u;
                }
...
Dcm_InterDemTriggerOnDTCStatus(uint32 DTC, Dem_UdsStatusByteType DTCStatusOld, Dem_UdsStatusByteType DTCStatusNew)
{
 ...
 void Dcm_InterMainFunction(void)
{
 ...
 void Dcm_MainFunction_Pending2A(uint8 ProtocolCtrlId)
{
    (void)(ProtocolCtrlId);
}
 ...
 void DspInternal_DcmConfirmation_0x27(uint8 ProtocolCtrlId)
{
    ...
    if ((0x27u == Dcm_MsgCtrl[MsgCtrlId].SID) && (DCM_NEG_RSP == Dcm_MsgCtrl[MsgCtrlId].RspStyle)
        && (((Dcm_NegativeResponseCodeType)0x10u) == Dcm_MsgCtrl[MsgCtrlId].NRC))
    {
        ...
        && (DCM_SERVICE_KEY == Dcm_SecCtrl.Dcm_SecServiceState))
    {
        ...
        if (0U == ret)
        {
            ...
            if (pSecurityRow != ((void *)0))
            {
                ...
                if ((1u == pSecurityRow->DcmDspSecurityAttemptCounterEnabled)
                    && ((
                        (USE_ASYNCH_FNC == DcmDspSecurityUsePort)
                        || (USE_ASYNCH_CLIENT_SERVER == DcmDspSecurityUsePort))))
                {
                    if (Dcm_SetSecAttCounterFnc != ((void *)0))
                    {
 ...
 void DspInternal_DcmConfirmation_0x10(uint8 ProtocolCtrlId)
{
    uint8 MsgCtrlId;
    Std_ReturnType ret;
    uint8 iloop;
    Dcm_OpStatusType OpStatus = ((Dcm_OpStatusType)0x00u);
            ...
            if (Dcm_SesCtrl.Dcm_NewSes == pDcmDspSessionRow->DcmDspSessionLevel)
            {
                if ((DcmDspSessionForBoot == DCM_SYS_BOOT_RESPAPP) || (DcmDspSessionForBoot == DCM_OEM_BOOT_RESPAPP))
                {
                    ...
                    if (ret == 0U)
                    {
                        ...
                        (void)SchM_Switch_DcmEcuReset(((Rte_ModeType_DcmEcuReset)0x06u));
                    }
                    else if (ret == ((Std_ReturnType)10))
                    {
                        Dcm_ReqSetProgConditions = 1u;
                    }
                    else
                    {
 ...
 void DspInternal_DcmConfirmation_0x11(uint8 ProtocolCtrlId)
{
    uint8 MsgCtrlId;
    MsgCtrlId = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
    if (((DCM_POS_RSP == Dcm_MsgCtrl[MsgCtrlId].RspStyle) || (DCM_POS_RSP_SUPPRESS == Dcm_MsgCtrl[MsgCtrlId].RspStyle))
    ...
    {
        if (1u == gAppl_UpdataOK_ResponseFlag)
        {
            gAppl_UpdataOK_ResponseFlag = 0u;  
            DslInternal_SesRefresh(((Dcm_SesCtrlType)0x01u));
        }
        else
        {
 ...
 Std_ReturnType DsdInternal_ManufacturerIndication(uint8 ProtocolCtrlId)
{
    Std_ReturnType ret;
    (void)(ProtocolCtrlId);
    ret = 0U;
 ...
 void DsdInternal_ManufacturerConfirmation(uint8 ProtocolCtrlId)
{
    (void)(ProtocolCtrlId);
}
 ...
 Std_ReturnType DsdInternal_SupplierIndication(uint8 ProtocolCtrlId)
{
    Std_ReturnType ret;
    (void)(ProtocolCtrlId);
    ret = 0U;
 ...
 void DsdInternal_SupplierConfirmation(uint8 ProtocolCtrlId)
{
    (void)(ProtocolCtrlId);
}
...
DsdInternal_SesCheck(uint16 SidTabIndex, uint16 SidTabServieCfgIndex)
{
    ...
    if (0u != SesRefNum)
    {
        ...
        for (SesCfgIndex = 0; (SesCfgIndex < SesRefNum) && (0u == Flag); SesCfgIndex++)
        {
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        ...
        if (0u != SubServiceNum)
        {
            ...
            if (0u != SubSesRefNum)
            {
                ...
                ActiveSes = Dcm_MkCtrl.Dcm_ActiveSes;
                for (SesCfgIndex = 0; (SesCfgIndex < SubSesRefNum) && (0u == Flag); SesCfgIndex++)
                {
    ...
    if (1U == ret)
    {
        ...
        *ErrorCode = ((Dcm_NegativeResponseCodeType)0x7Eu);
    }
    return ret;
}
...
DsdInternal_DidSessionCheck(uint16 DidInfoCfgIndex, Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    if (((void *)0) == pDspDidRead)
    {
         
        *pNrc = ((Dcm_NegativeResponseCodeType)0x31u);
        ret = 1U;
    }
    else
    {
        ...
        {
            for (Index = 0; (Index < (DidReadSessionRefNum)) && (0u == Flag); Index++)
            {
 ...
 Std_ReturnType
DsdInternal_SecurityCheck(uint16 SidTabIndex, uint16 SidTabServieCfgIndex)
{
    uint8 SecRefNum;
    uint8 SecCfgIndex;
    const uint8* pSecCfg;
    ...
    if (SecRefNum != 0u)
    {
        ...
        for (SecCfgIndex = 0; (SecCfgIndex < SecRefNum) && (0u == Flag); SecCfgIndex++)
        {
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        ...
        if (0U == ret)
        {
            ...
            if (0u != SubServiceNum)
            {
                ...
                if (0u != SubSecRefNum)
                {
                    for (SecCfgIndex = 0; (SecCfgIndex < SubSecRefNum) && (0u == Flag); SecCfgIndex++)
                    {
    ...
    if (1U == ret)
    {
        ...
        *ErrorCode = ((Dcm_NegativeResponseCodeType)0x33u);
    }
    return ret;
}
...
DsdInternal_DidSecurityCheck(uint16 DidInfoCfgIndex, Dcm_NegativeResponseCodeType * pNrc)
{
    ...
    else
    {
        ...
        if (SecNum != 0u)
        {
            for (Index = 0; (Index < SecNum) && (0u == Flag); Index++)
            {
            ...
            if (0u == Flag)
            {
                ...
                *pNrc = ((Dcm_NegativeResponseCodeType)0x33u);
                ret = 1U;
            }
        }
    }
...
static  void DslInternal_SetSecurityLevel(Dcm_SecLevelType NewSec)
{
 ...
 void DslInternal_SetSecurityAccessStatus(Dcm_SecServiceStateType Status)
{
...
DslInternal_GetSecurityCfgBySecLevel(Dcm_SecLevelType Dcm_SecLevel, uint8 * SecCfgIndex)
{
    ...
    for (Index = 0; (Index < SecurityRow_Num) && (1U == ret); Index++)
    {
 ...
 void DslInternal_S3ServerStart(uint8 connectionId)
{
    Dcm_ResetTime(&Dcm_SesCtrl.Dcm_S3Ctrl.Dcm_S3CurTimer);
    SchM_Enter_Dcm_ExclusiveArea();
    Dcm_SesCtrl.Dcm_S3Ctrl.Dcm_S3ExpiredTimer = 5000UL;  
...
static  void DslInternal_S3ServerStop(void)
{
 ...
 void DslInternal_SesRefresh(Dcm_SesCtrlType NewSes)
{
 ...
 void DslInternal_InitConnectionCtrl(uint8 ConnectionCtrlId)
{
    if (ConnectionCtrlId < (1u))
    {
        SchM_Enter_Dcm_ExclusiveArea();
        Dcm_ConnectionCtrl[ConnectionCtrlId].Dcm_ConnectionCfgIndex = (0xFFu);
        Dcm_ConnectionCtrl[ConnectionCtrlId].Dcm_ConnectionActive = 0u;
        SchM_Exit_Dcm_ExclusiveArea();
    }
}
 ...
 void DslInternal_InitProtocolCtrl(uint8 ProtocolCtrlId)
{
    uint8 Index;
    const Dcm_DspSessionType* pDcm_DspSession = DcmPbCfgPtr->pDcmDspCfg->pDcm_DspSession;
    ...
    {
        if (((Dcm_SesCtrlType)0x01u) == (pDcm_DspSession->pDcmDspSessionRow)[Index].DcmDspSessionLevel)
        {
 ...
 void DslInternal_ProtocolStartSession(void)
{
    Dcm_SesCtrl.Dcm_NewSes = ((Dcm_SesCtrlType)0x01u);
    DslInternal_SesRefresh(Dcm_SesCtrl.Dcm_NewSes);
    (void)SchM_Switch_DcmDiagnosticSessionControl(((Rte_ModeType_DcmEcuReset)0x07u));
}
 ...
 uint8 Dcm_GetChannelNum(void)
{
 ...
 uint8 Dcm_GetProtocolMsgNum(void)
{
    return (1u);
}
 ...
 void Dcm_RestartS3timer(uint8 connectionId)
{
    uint8 Index;
    boolean Flag = 0u;
    uint8 ProtocolMsgNum = Dcm_GetProtocolMsgNum();
    if (((Dcm_SesCtrlType)0x01u) != Dcm_MkCtrl.Dcm_ActiveSes)
    {
        for (Index = 0; (Index < ProtocolMsgNum) && (0u == Flag); Index++)
        {
    ...
    PduLengthType * bufferSizePtr)
{
    ...
    ServiceType = Dcm_ClassifyServiceType(ProtocolId);
        ...
        if (bufRet == BUFREQ_OK)
        {
            ...
            if ((info != ((void *)0)) && (0u < info->SduLength))
            {
                if (DCM_FUNCTIONAL == RxAddrType)
                {
                    ...
                    case (0x00u): {
                        ...
                        Dcm_OBDMessage.Length = info->SduLength;  
                        bufRet = BUFREQ_OK;
                        break;
                    }
                    default:
                ...
                Dcm_ConnectionCtrl[ConnectionCfgCtrlId].Dcm_ConnectionActive = 1u;
                SchM_Exit_Dcm_ExclusiveArea();
        }
    return bufRet;
}
    ...
    uint8 ProtocolCfgId)
{
    ...
    {
        const Dcm_MsgCtrlType* pDcm_MsgCtrl = &Dcm_MsgCtrl[ProtocolCfgId];
            ...
            && ((*Sid != 0x3Eu) || (*SubFunction != 0x80u) || (0x02u != Dcm_FunctionalMessage.Length)))
        {
            ...
            Dcm_FunctionalMessage.ConcurrentTesterFailed = 1u;
        }
    }
    return bufRet;
}
 ...
 void
Dcm_TpRxIndication_SetTxPduId(uint8 MsgCtrlIndexx, const Dcm_DslConnectionType * pDslConnection)
{
    {
 ...
 boolean Dcm_CheckUDS0x86_TxConfirmation(uint8 ProtocolCfgCtrlId)
{
    boolean ret;
    ret = 1u;
    (void)(ProtocolCfgCtrlId);
    return ret;
}
 ...
 void Dcm_TxConfirmation_2A(PduIdType DcmTxPduId)
{
    (void)(DcmTxPduId);
}
...
static  void Dcm_MainFunction_SecTimer(void)
{
    ...
    if (0u == (Dcm_SecCtrl.Dcm_SecFlag & 0x02u))
    {
    ...
    else
    {
        ...
        for (SecCfgIndex = 0; SecCfgIndex < (1u); SecCfgIndex++)
        {
...
static  void Dcm_MainFunction_ReadSecTimer(void)
{
    ...
    uint8* pDcmFalseAcessCount = Dcm_SecCtrl.Dcm_FalseAcessCount;
        ...
        for (SecCfgIndex = Dcm_SecCtrl.Dcm_SecCfgIndex; (SecCfgIndex < (1u)) && (pSecurityRow != ((void *)0));
             SecCfgIndex++)
        {
            if ((1u == pSecurityRow->DcmDspSecurityAttemptCounterEnabled)
            ...
            {
                if (pSecurityRow->Dcm_GetSecurityAttemptCounterFnc != ((void *)0))
                {
                    Dcm_OpStatusType OpStatus = ((Dcm_OpStatusType)0x01u);
                    if ((Dcm_SecCtrl.Dcm_SecFlag & 0x04u) == 0u)
                    {
                        OpStatus = ((Dcm_OpStatusType)0x00u);
                    }
                    ret = pSecurityRow->Dcm_GetSecurityAttemptCounterFnc(OpStatus, &pDcmFalseAcessCount[SecCfgIndex]);
                    if (((Std_ReturnType)10) == ret)
                    {
                        Dcm_SecCtrl.Dcm_SecFlag |= 0x04u;
                        break;
                    }
                    else
                    {
        ...
        if (Dcm_SecCtrl.Dcm_SecCfgIndex == (1u))
        {
            Dcm_SecCtrl.Dcm_SecFlag |= 0x02u;
        }
    else
    {
        SecCfgIndex = Dcm_SecCtrl.Dcm_SecCfgIndex;
        pSecurityRow = &(DcmPbCfgPtr->pDcmDspCfg->pDcm_DspSecurity->pDcm_DspSecurityRow[SecCfgIndex]);
        pSecurityRow->Dcm_GetSecurityAttemptCounterFnc(((Dcm_OpStatusType)0x02u), &pDcmFalseAcessCount[SecCfgIndex]);

        for (SecCfgIndex = Dcm_SecCtrl.Dcm_SecCfgIndex; (SecCfgIndex < (1u)); SecCfgIndex++)
        {
            if ((1u == pSecurityRow->DcmDspSecurityAttemptCounterEnabled)
                && ((USE_ASYNCH_FNC == pSecurityRow->DcmDspSecurityUsePort)
                    || (USE_ASYNCH_CLIENT_SERVER == pSecurityRow->DcmDspSecurityUsePort)))
...
static  void DslInternal_InitSecCtrl(void)
{
    SchM_Enter_Dcm_ExclusiveArea();
    Dcm_SecCtrl.Dcm_SubfunctionForSeed = 0u;
    Dcm_SecCtrl.Dcm_ActiveSec = ((Dcm_SecLevelType)0x00u);
    Dcm_SecCtrl.Dcm_NewSec = ((Dcm_SecLevelType)0x00u);
    Dcm_SecCtrl.Dcm_SecServiceState = DCM_SERVICE_IDLE;
    Dcm_SecCtrl.Dcm_SecFlag = (Dcm_SecCtrl.Dcm_SecFlag & 0x00u) | 0x01u;
    Dcm_SecCtrl.Dcm_MaxReadoutTime = 0u;
    Dcm_SecCtrl.Dcm_SecCfgIndex = 0u;
    Dcm_SecCtrl.Dcm_OpStatus = ((Dcm_OpStatusType)0x00u);
    for (uint8 index = 0; index < (1u); index++)
    {
...
static  void DslInternal_UndefaultToUndefault(Dcm_SesCtrlType NewSes)
{
    DslInternal_SetSesCtrlType(NewSes);
    DslInternal_SetSesTimingValues(NewSes);
    DslInternal_SetSecurityLevel(((Dcm_SecLevelType)0x00u));
    DslInternal_SetSecurityAccessStatus(DCM_SERVICE_IDLE);
...
static  void DslInternal_SesTranslation(Dcm_SesCtrlType NewSes)
{
    ...
    {
        if (((Dcm_SesCtrlType)0x01u) == NewSes)
        {
...
{
    SchM_Enter_Dcm_ExclusiveArea();
    Dcm_SesCtrl.Dcm_ActiveSes = ((Dcm_SesCtrlType)0x01u);
    Dcm_SesCtrl.Dcm_NewSes = ((Dcm_SesCtrlType)0x01u);
    Dcm_SesCtrl.Dcm_S3Ctrl.Dcm_S3CurTimer = (0xFFFFFFFFUL);
    Dcm_SesCtrl.Dcm_S3Ctrl.Dcm_S3ExpiredTimer = (0xFFFFFFFFUL);
    Dcm_SesCtrl.Dcm_S3Ctrl.Dcm_S3State = DCM_S3TIMER_OFF;
 ...
 Std_ReturnType Dcm_TpRxIndication_3E80(uint8 connectionId)
{
    Std_ReturnType ret = 0U;
    uint8 Sid;
    uint8 SubFunction;
