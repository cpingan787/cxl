...
const Mcu_ConfigType * Mcu_GpConfigPtr;

 
const Mcu_ClockSetting * Mcu_GpClockSetting;

 
const Mcu_CkscSetting * Mcu_GpCkscSetting;

 

 
 
Mcu_LPSRegMirror Mcu_GddLpsRegRamMirror;
Mcu_ClkMntrReg0Mirror Mcu_GddClkMntrReg0RamMirror;
Mcu_ClkMntrReg1Mirror Mcu_GddClkMntrReg1RamMirror;
Mcu_ClkMntrReg2Mirror Mcu_GddClkMntrReg2RamMirror;
Mcu_ClkMntrReg3Mirror Mcu_GddClkMntrReg3RamMirror;
Mcu_TAUJOsRegMirror Mcu_GddTaujOsRegRamMirror;
Mcu_TAUJChRegMirror Mcu_GddTaujChRegRamMirror;
Mcu_ClkCntlRegMirror Mcu_GddClkCntlRegRamMirror;
...
boolean Mcu_GblDriverStatus = (boolean)0x00;

 
boolean Mcu_GblPllActCheck = (boolean)0x01;

boolean Mcu_GblResetFlag = 1U;
 
 
boolean Mcu_GblWakeUpPreparation = (uint8)0x01;
