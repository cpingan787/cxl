...
FUNC(void, DCM_CODE) Dcm_UDS0x86_Init(void)
{
    ...
    const Dcm_DspRoeTypes* pDspRoe = DcmPbCfgPtr->pDcmDspCfg->DcmDspRoe;
    ...
    for (iloop = 0; iloop < DCM_DSP_ROE_NUM; iloop++)
    {
        ...
        pDcm_RoeStates->Dcm_RoeEventStates = pDspRoe->DspRoeEvent[iloop].DcmDspRoeInitialEventStatus;
        pDcmDspRoeEventProperties = pDspRoe->DspRoeEvent[iloop].DspRoeEventProperties;
        if (DCM_ROE_STOPPED == pDcm_RoeStates->Dcm_RoeEventStates)
        {
            ...
            if (NULL_PTR != pDcmDspRoeEventProperties->pDcmDspRoeOnDTCStatusChange)
            {
                pDcm_RoeStates->DTCStatusMask =
                    pDcmDspRoeEventProperties->pDcmDspRoeOnDTCStatusChange->DcmDspRoeDTCStatusMask;
            }
            if (NULL_PTR != pDcmDspRoeEventProperties->DspRoeOnChangeOfDataIdentifier)
            {
                pDcm_RoeStates->DcmDspRoeDidRef =
                    pDcmDspRoeEventProperties->DspRoeOnChangeOfDataIdentifier->DcmDspRoeDidRef;
            }
        }
    }
    ...
    Dcm_DspRoeNeedSend.DcmDspRoeNeedSend = FALSE;
...
{
    const Dcm_DspRoeTypes* pDspRoe = DcmPbCfgPtr->pDcmDspCfg->DcmDspRoe;
    Dcm_DspRoeInterMessageTime = pDspRoe->DcmDspRoeInterMessageTime;
}
...
FUNC(void, DCM_CODE) Dcm_UDS0x86_CheckTimer(void)
{
    ...
    else
    {
        ...
        if ((Dcm_DspRoeNeedSend.DcmDspRoeNeedSend == TRUE) && (Find == FALSE))
        {
            Dcm_DspRoeNeedSend.DcmDspRoeNeedSend = FALSE;
    ...
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
    ...
    for (iloop = 0; (iloop < pDspRoe->DcmDspRoeEventWindowTimeNum) && (ret == E_NOT_OK); iloop++)
    {
        if (EventWindowTime == (uint8)pDspRoe->pDspRoeEventWindowTime[iloop].DspRoeEventWindowTime)
        {
            ret = E_OK;
        }
    }
    ...
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
        ...
        && ((Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[5] == 0x0Eu)))
    {
        ...
        {
            if (NULL_PTR
                != DcmPbCfgPtr->pDcmDspCfg->DcmDspRoe->DspRoeEvent[iloop]
                       .DspRoeEventProperties->pDcmDspRoeOnDTCStatusChange)
            {
    ...
    P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode)
{
    ...
    if (pReqData[5] == 0x22u)
    {
        ...
        for (iloop = 0; (iloop < DCM_DSP_ROE_NUM) && (Find == FALSE); iloop++)
        {
            ...
            if ((NULL_PTR
                 != DcmPbCfgPtr->pDcmDspCfg->DcmDspRoe->DspRoeEvent[iloop]
                        .DspRoeEventProperties->DspRoeOnChangeOfDataIdentifier)
...
static FUNC(Std_ReturnType, DCM_CODE)
    Dcm_Uds0X86SubDeal_0x04(uint8 ProtocolCtrlId, uint32 Offset, P2VAR(Dcm_MsgLenType, AUTOMATIC, DCM_VAR) ResLength)
{
    uint8 iloop;
    uint8 Cnt = 0;
    uint32 ResOffest = Offset + 2u;
    const Dcm_DspRoeEventType* pDcmDspRoeEvent = DcmPbCfgPtr->pDcmDspCfg->DcmDspRoe->DspRoeEvent;
    ...
    for (iloop = 0; iloop < DCM_DSP_ROE_NUM; iloop++)
    {
        ...
        {
            Cnt++;
            if (NULL_PTR != pDcmDspRoeEvent[iloop].DspRoeEventProperties->DspRoeOnChangeOfDataIdentifier)
            {
                ResOffest++;
            ...
            else if (NULL_PTR != pDcmDspRoeEvent[iloop].DspRoeEventProperties->pDcmDspRoeOnDTCStatusChange)
            {
                ResOffest++;
...
static FUNC(Std_ReturnType, DCM_CODE)
    Dcm_Uds0X86SubDeal_0x06(uint8 ProtocolCtrlId, uint32 Offset, P2VAR(Dcm_MsgLenType, AUTOMATIC, DCM_VAR) ResLength)
{
    uint8 iloop;
    uint8 MsgCtrlId = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
    boolean StoreEvent = (0u != (Dcm_MsgCtrl[MsgCtrlId].Subfunction & DCM_UDS86_SUBFUNCTION_BIT6_MASK))
...
FUNC(Std_ReturnType, DCM_CODE) Dcm_UDS0x86_ChangeOfDataIdentifier(uint8 RoeEventId)
{
    ...
    {
        if (RoeEventId == pDspRoe->DspRoeEvent[ROEIndex].DcmDspRoeEventId)
        {
            ProcressOn = TRUE;
            break;
        }
    ...
    if ((ProcressOn == TRUE) && (DCM_ROE_STARTED == pDcm_RoeStates->Dcm_RoeEventStates)
        && (NULL_PTR != pDspRoe->DspRoeEvent[ROEIndex].DspRoeEventProperties->DspRoeOnChangeOfDataIdentifier))
    {
        /*check all protocol whether have one protocol had already started*/
        for (iloop = 0; iloop < DCM_DSLPROTOCOLROW_NUM_MAX; iloop++)
        {
        ...
        else
        {
            ...
            Dcm_DspRoeNeedSend.DcmDspRoeNeedSend = TRUE;
...
Dcm_UDS0x86_DTCStatusChange(uint8 DTCStatusOld, uint8 DTCStatusNew)
{
    ...
    for (Cnt = 0; (Cnt < DCM_DSP_ROE_NUM) && (ProcressOn == TRUE); Cnt++)
    {
        ...
        if ((DCM_ROE_STARTED == pDcm_RoeStates->Dcm_RoeEventStates)
            && (NULL_PTR != pDspRoe->DspRoeEvent[Cnt].DspRoeEventProperties->pDcmDspRoeOnDTCStatusChange)
