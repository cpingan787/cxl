...
/**
  ...
  RuleSorce:puhua_rules-2024.12.rcf
    ...
    \li VL_Dcm_1752
      Reason: Global variables that are needed elsewhere
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
  ...
  context
    ...
    \li VL_MTR_Dcm_6610
      Reason: This document does not require too many annotations.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
*/
#ifndef DCM_H
 ...
 *            2025-05-22   li.feng             Add handling for the RTE_E_UNCONNECTED result.
 *            2025-07-04   li.feng             CPT-15044,fix after the S3 timeout, the notification was not sent to the
RTE.
 *            2025-08-18   li.feng             CPT-15565,Data length error when using variable parameters with 0x31.
============================================================================*/
