   ...
   Can_GaaControllerPCConfig0[] =
{
  /* Index: 0 - CanController */
  {
    ...
    (P2VAR(volatile uint16, CAN_CONFIG_DATA, REGSPACE)) 0xFFFEEA32UL,
    /* END Msg(2:0303)-1 */
    /* pICTx */
    /* MISRA Violation: START Msg(2:0303)-1 */
    (P2VAR(volatile uint16, CAN_CONFIG_DATA, REGSPACE)) 0xFFFEEA34UL,
    /* END Msg(2:0303)-1 */
    /* pICErr */
    /* MISRA Violation: START Msg(2:0303)-1 */
    (P2VAR(volatile uint16, CAN_CONFIG_DATA, REGSPACE)) 0xFFFEEA30UL,
    /* END Msg(2:0303)-1 */
    /* pICWakeup */
    /* MISRA Violation: START Msg(2:0303)-1 */
    (P2VAR(volatile uint16, CAN_CONFIG_DATA, REGSPACE)) 0xFFFFB04AUL,
    /* END Msg(2:0303)-1 */
    /* pFCLAReg */
    /* MISRA Violation: START Msg(2:0303)-1 */
    (P2VAR(volatile uint8, CAN_CONFIG_DATA, REGSPACE)) 0xFFC34020UL,
    /* END Msg(2:0303)-1 */
    /* ulWUFMask */
    CAN_RSCAN_WUF_CHANNEL_0
  }
};
/* END Msg(2:3408)-2 */
