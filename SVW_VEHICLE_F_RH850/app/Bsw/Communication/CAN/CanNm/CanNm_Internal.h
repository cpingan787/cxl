...
#define CANNM_CBV_BIT_RMR_MASK ((uint8)(0x01u))
...
#define CanNm_SetTxPduCbvBit(chIndex, mask) /* PRQA S 3472 */ /* VL_CanNm_MacroFunc */                                \
    do                                                                                                                \
    {                                                                                                                 \
...
#define CanNm_ClrTxPduCbvBit(chIndex, mask) /* PRQA S 3472 */ /* VL_CanNm_MacroFunc */                                 \
    do                                                                                                                 \
    {                                                                                                                  \
        if (CANNM_PDU_OFF != CanNm_CfgPtr->ChannelConfig[chIndex].PduCbvPosition)                                      \
        {                                                                                                              \
...
/* Aggregation raw PnBitVector from rxPdu */
#if (CANNM_PN_ERA_CALC_ENABLED == STD_ON) || (CANNM_PN_EIRA_CALC_ENABLED == STD_ON)
    uint8 aggRawPnData[CANNM_PN_INFO_LENGTH];
#endif
