 ...
 * V2.1.5:  22-Jun-2020  :  #ARDAABD-4015 - Changes name of variable "Luscount"
 *                             which is used in API Fls_FcuPerformBlankCheck to
 *                             "LulCount".
 * V2.1.6:  04-Aug-2021  :  As part of ARDAABD-6326, the following changes are
 *                          made:
 *                          a) Declaration of function 'Fls_FcuOffsetDataCopy'
 *                             is updated by changing the return type as uint8.
 *                          b) Copyright information is updated.
 * V2.1.7:  03-Sep-2025  :  As part of ARDAABD-10763, the following changes are
 *                          made: Add Fls_FcuCalculateBlankCheckAddr
 */
/******************************************************************************/
...
#define FLS_START_SEC_PRIVATE_CODE
#include FLS_MEMMAP_FILE
/* Declaration of internal function "Fls_FcuCalculateBlankCheckAddr" */
extern FUNC(uint32, FLS_PRIVATE_CODE) Fls_FcuCalculateBlankCheckAddr
