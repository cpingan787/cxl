...
BswM_MainFunction(void)
{
    ...
    if (BSWM_INITED == BswM_RuntimeStatus.bswmInitState)
    {
        ...
        if ((boolean)TRUE == result) /* PRQA S 2991,2995 */ /* VL_BswM_2991,VL_BswM_2995 */
        {
...
FUNC(boolean, BSWM_CODE) BswM_GetPartitionIdx(P2VAR(ApplicationType, AUTOMATIC, BSWM_VAR_CLEARED) partitionIdx)
{
