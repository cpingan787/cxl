...
static inline  void Dcm_MemSet(uint8 * Dest, uint8 Val, uint32 Size)
{
 ...
 void DspInternal_DcmConfirmation(uint8 ProtocolCtrlId)
{
    uint8 MsgCtrlId;
    ...
    if (((Dcm_NegativeResponseCodeType)0x78u) == (pDcm_MsgCtrl->NRC))
    {
 ...
 Std_ReturnType Dcm_UdsSubServicesCheck(uint8 ProtocolCtrlId)
{
