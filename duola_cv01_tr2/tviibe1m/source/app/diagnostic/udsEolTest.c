...
static const struc_ReadDidMap m_readDidMap[] = 
{
    ...
    {0xF187, Service22ReadPartNumber              },       //��ص�Ԫ�����         
    {0xF18A, Service22ReadSupplierId              },       //ϵͳ��Ӧ�̱�ʶ��  
    {0xF18B, Service22ReadManufactureDate         },       //ECU��������       
    {0xF18C, Service22ReadSerialNumber            },       //��ص�Ԫ���к�(ECU)   
    {0xF190, Service22ReadVIN                     },       //VIN m_VIN      
    {0xF193, Service22ReadEOLHardwareVersion         },       //��Ӧ��ECUӲ���汾��   
    {0xF195, Service22ReadSoftwareVersion         },       //��Ӧ��ECU�����汾��   
    {0xF197, Service22ReadPartName                },       //�������       
//    {0xF1B0, Service22ReadEcuMask                 },       //��ȫ��������
//    {0x1201, Service22ReadTboxCallNumber          },       //tbox�绰����    
...
//    {0x120C, Service22ReadIpAddress               },       //��ҵƽ̨��ַ 
//    {0x120D, Service22ReadIpPort                  },       //��ҵƽ̨�˿�       
...
//    {0x1218, Service22ReadSecurityVersion,        }, 
    {0x127A, Service22ReadWIFIModeStatus          },
    {0x127B, Service22ReadEMMCStatus              },
    {0x127C, Service22ReadRegisterFlag            },       //����ע��״̬          
    {0x127D, Service22ReadNetWorkType             },       //��������         
    {0x127E, Service22ReadPhoneSignal             },       //�����ź�ǿ��          
    {0x127F, Service22ReadApnNumber               },       //apn number           
    {0x1280, Service22ReadGNSSSLocationStatus     },       //GPS״̬               
    {0x1281, Service22ReadNetWorkProvider         },       //ע���¼״̬  
    ...
    /***************add***************************/
    {0xF192, Service22ReadHardwareNumber        },       //��Ӧ��ECUӲ���汾��   
    {0xF194, Service22ReadSoftwareNumber        },       //��Ӧ��ECU�����汾��
    {0x2409, Service22ReadEOLconfig             },       //�������� 
...
static const struc_WriteDidMap m_writeDidMap[] = 
{
    ...
    {0xF187, Service2EWritePartNumber,          },//EndModelPartNumber
    {0xF18A, Service2EWriteSupplierId,          },   
    {0xF193, Service2EWriteHardwareVersion,     }, 
    //{0xF195, Service2EWriteSoftwareVersion,     },   
    //{0xF197, Service2EWritePartName,            },    
    {0xF15A, Service2EWriteFingerPrint,          },
    {0xF18B, Service2EWriteManufactureDate,      },   
    {0xF190, Service2EWriteVIN,                  }, 
    {0xF1B0, Service2EWriteESKeyByEol,            },    
...
//    {0x127C, Service2EWriteTboxRegisterFlag,     },    
    {0x1286, Service2EWriteBluetoothName,        },    
    {0x1290, ServiceWritePowerOnCount,           },   
	{0xF1A2, Service2EWritePartName,			}, 	
    /***************add***************************/
    {0x2401, Service2EWriteVariantcode          },       //ECU����
    {0x2402, Service2EWriteEOLconfig            },       //������������     
//    {0x2403, Service2EWriteNationIpAddress      },       //����ƽ̨��ַ 
//    {0x2404, Service2EWriteNationIpPort         },       //����ƽ̨�˿�
//    {0x2405, Service2EWriteGovernmentIpAddress  },       //�ط�ƽ̨��ַ 
//    {0x2406, Service2EWriteGovernmentIpPort     },       //�ط�ƽ̨�˿�    
    ...
    {0xF192, Service2EWriteHardwareNumber        },       //��Ӧ��ECUӲ����   
    {0xF194, Service2EWriteSoftwareNumber        },       //��Ӧ��ECU������ 
    {0x2409, Service2EWriteEOLconfigByEol        },       //��������   
...
{
    {0x1301, ServiceSetTboxTestMode,            },
    {0x1303, ServiceSetTboxSleepMode,           },    
    {0x1304, ServiceSetApnPingTest,             },
    {0x1305, ServiceSetWifiConnectTest,         },  
    {0x1306, ServiceSetBlueToothConnectTest,    },
    {0x1307, ServiceSetCallNumberTest,          },      
    {0x1410, ServiceSetPinOUT_1State,           },
    {0x1411, ServiceSetPinOUT_2State,           },    
    {0x1412, ServiceSetPinLED_1State,           },
    {0x1413, ServiceSetPinLED_2State,           },  
    {0x1283, ServiceSetBatteryCharge,           },
    {0x1414, ServiceSetPinMuteState,            },   
};

static const struc_ReadDidMap m_routineResultDidMap[] = 
{
    {0x1304, ServiceGetApnPingTestResult,               },
    {0x1305, ServiceGetWifiConnectTestResult,           },    
    {0x1306, ServiceGetetBlueToothConnectTestResult,    },
    {0x1307, ServiceGetetCallNumberTestResult,          },  
...
static int16_t ServiceGetApnPingTestResult(uint8_t *pData,uint16_t *pLength)
{
  ...
  ret = 0;//test 
#else
  ret = McuControlGetCpuInfo(SYNC_CPU_GET_INFO_ITEM_APN_PING_RESULT,pData,pLength);
#endif
  return ret;
}
...
static int16_t ServiceGetWifiConnectTestResult(uint8_t *pData,uint16_t *pLength)
{
  ...
  ret = 0;//test
#else 
  ret = McuControlGetCpuInfo(SYNC_CPU_GET_INFO_ITEM_WIFI_CONNECT_RESULT,pData,pLength);
#endif
  return ret;
}
...
static int16_t ServiceGetetBlueToothConnectTestResult(uint8_t *pData,uint16_t *pLength)
{
  ...
  ret = 0;//test 
#else
  ret = McuControlGetCpuInfo(SYNC_CPU_GET_INFO_ITEM_BLUETOOTH_CONNECT_RESULT,pData,pLength);
#endif
  return ret;
}
...
static int16_t ServiceGetetCallNumberTestResult(uint8_t *pData,uint16_t *pLength)
{
  ...
  ret = 0;//test  
#else
  ret = McuControlGetCpuInfo(SYNC_CPU_GET_INFO_ITEM_CALL_TEST_RESULT,pData,pLength);
#endif  
  return ret;
}
...
static int16_t ServiceSetTboxTestMode(uint8_t *pData,uint16_t length)
{
  ...
  ret = 0;
#else
  ret = McuControlCpuInterface(SYNC_CPU_CONTROL_ITEM_TEST_MODE,&TestModeFlag,1);
#endif
  return ret;
}
...
{  
  ...
  ret = 0;
#else
  ret = McuControlCpuInterface(SYNC_CPU_CONTROL_ITEM_APN_PING,pData,dataLength);
#endif
  return ret;
}
...
static int16_t ServiceSetWifiConnectTest(uint8_t *pData,uint16_t dataLength)
{
  ...
  ret = 0;
#else
  ret = McuControlCpuInterface(SYNC_CPU_CONTROL_ITEM_WIFI_CONNECT,pData,dataLength);  
#endif
  return ret;
}
...
static int16_t ServiceSetBlueToothConnectTest(uint8_t *pData,uint16_t dataLength)
{
  ...
  ret = 0;
#else
  ret = McuControlCpuInterface(SYNC_CPU_CONTROL_ITEM_BLUETOOTH_CONNECT,pData,dataLength);
#endif
  return ret;
}
...
static int16_t ServiceSetCallNumberTest(uint8_t *pData,uint16_t dataLength)
{
  ...
  ret = 0;
#else
  ret = McuControlCpuInterface(SYNC_CPU_CONTROL_ITEM_CALL_TEST,pData,dataLength); 
#endif  
  return ret;
}
...
static int16_t ServiceReadPinEcallStatus(uint8_t *pData,uint16_t *pLength)
{
  ...
  ret = 0;
#else 
  ret = McuControlGetCpuInfo(SYNC_CPU_GET_INFO_ITEM_PIN_ECALL_STATE,pData,pLength);
#endif
  return ret;
}
...
static int16_t ServiceReadBlueToothName(uint8_t *pData,uint16_t *pLength)
{
  ...
  length = 0;
#else
  ret = BlueToothGetParameter(BLE_EXTERNAL_COMMAND_READ_NAME,pData,&length);
#endif  
  if(ret!=0)
  {
    return ret;
...
static int16_t Service2EWriteBluetoothName(uint8_t *Data,uint16_t len)
{
  ...
  ret = 0;
#else
  ret = BlueToothSetParameter(BLE_EXTERNAL_COMMAND_WRITE_NAME,Data,len);
#endif
  if(ret!=0)
  {
    return -1;
