...
Icu_ChannelRamDataType Icu_GstChannelRamData[8];
...
const Icu_ConfigType Icu_GstConfiguration[] =
{
...
const Icu_TAUUnitConfigType Icu_GstTAUUnitConfig[] =
{
...
const Icu_ChannelConfigType Icu_GstChannelConfig[] =
{
   
  {
    ...
    (volatile uint16 *) &(*((volatile uint16 *)0xFFC10200UL)),
     

     
     
    (volatile uint16 *) &(*((volatile uint16 *)0xffffb12cUL)),
   ...
   
  {
    ...
    (volatile uint16 *) &(*((volatile uint16 *)0xffffb12eUL)),
     

     
    (EcuM_WakeupSourceType) 0x00000000,
   ...
   
  {
    ...
    (volatile uint16 *) &(*((volatile uint16 *)0xffc10204UL)),
     

     
     
    (volatile uint16 *) &(*((volatile uint16 *)0xffffb19eUL)),
   ...
   
  {
    ...
    (volatile uint16 *) &(*((volatile uint16 *)0xFFC10220UL)),
     

     
     
    (volatile uint16 *) &(*((volatile uint16 *)0xffffb100UL)),
   ...
   
  {
    ...
    (volatile uint16 *) &(*((volatile uint16 *)0xffffb19aUL)),
   ...
   
  {
    ...
    (volatile uint16 *) &(*((volatile uint16 *)0xffffb05aUL)),
   ...
   
  {
    ...
    (volatile uint16 *) &(*((volatile uint16 *)0xffffb102UL)),
   ...
   
  {
    ...
    (volatile uint16 *) &(*((volatile uint16 *)0xffffb04eUL)),
     

     
    (uint32)((uint32)0x01u << (7)),
...
const Icu_TimerChannelConfigType Icu_GstTimerChannelConfig[] =
{
                        ...
                        Icu_GaaReg_8bit[(uint8)7] =
{
  ...
  (volatile uint8 *)0xffe300e0UL,

   
  (volatile uint8 *)0xffc34058UL,

  (volatile uint8 *)0xffc34038UL,

  (volatile uint8 *)0xffc34044UL,

  (volatile uint8 *)0xffc34034UL,

  (volatile uint8 *)0xffc3403cUL,

  (volatile uint8 *)0xffc34028UL
};
           ...
           Icu_GaaRegMirror_8bit[(uint8)7] =
{
  ...
  &(Icu_GaaFclaRegsMirror[5].ucMirrorFCLA0CTLm),

  &(Icu_GaaFclaRegsMirror[6].ucMirrorFCLA0CTLm),

  &(Icu_GaaFclaRegsMirror[7].ucMirrorFCLA0CTLm)
};
