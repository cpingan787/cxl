...
static int16_t PmMpuStartIsFinished(void)
{
    ...
    if((MpuPowerSyncSdkGetNadModuleStatus()==0))    // TODO guanyuan
    {
        return 0;
    }
    return 1;
...
//    else if(PeripheralHalGetKl15Status()==0) // TODO guanyuan
//    {
//        //电源管理状态进入延时唤醒状态
...
static void PmStatePreSleepNoticeProcess(uint32_t cycleTime)
{
    g_pmManage.sleepState = 0;
    g_pmManage.wakeDelayCount = 0;
    // if(g_pmManage.pPmConfig->deepSleepConfig.mpuDeepSleep!=0)   // TODO guanyuan
    // {
