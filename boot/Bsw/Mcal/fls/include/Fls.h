 ...
 *                              improved.
 * V2.1.7:  06-Nov-2020  :  Following changes are made:
 *                          1. As part of ARDAABD-4063, added the declarations
 *                             for the new APIs Fls_UseFlashControllerPreHook
 *                             and Fls_UseFlashControllerEndHook.
 * V2.1.8:  25-Sep-2025  :  Following changes are made:
...
(Fls_AddressType SourceAddress, P2VAR(uint8, AUTOMATIC, FLS_APPL_DATA)
TargetAddressPtr, Fls_LengthType Length);
#define FLS_STOP_SEC_PUBLIC_CODE
#include FLS_MEMMAP_FILE
#endif
...
/*FLS_H_300: FLS_ESDD_UD_268 */
#if (STD_ON == FLS_USEFLASHCONTROLLERHOOK)
#define FLS_START_SEC_PUBLIC_CODE
#include FLS_MEMMAP_FILE
/* Declaration of API "Fls_UseFlashControllerPreHook" */
extern FUNC(Fls_AccessStatusType, FLS_PUBLIC_CODE) Fls_UseFlashControllerPreHook
(Fls_CommandType CommandType);
/* Declaration of API "Fls_UseFlashControllerEndHook" */
extern FUNC(Fls_AccessStatusType, FLS_PUBLIC_CODE) Fls_UseFlashControllerEndHook
(void);
#define FLS_STOP_SEC_PUBLIC_CODE
#include FLS_MEMMAP_FILE
