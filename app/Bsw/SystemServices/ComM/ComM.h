...
/**
 ...
 separated into sub-functions
   ...
   \li VL_ComM_NoStatic
     Reason: Reason:ComM_UserReqMode will be used in ComM_Ch.c when enable wake up inhibition.
     Risk: No risk.
     Prevention: Functional reliability guaranteed by design.

   \li VL_ComM_NoStaticFunc
     Reason: Reason: ComM_HandleUserReqest will be used in ComM_Ch.c when enable wake up inhibition.
     Risk: No risk.
     Prevention: Provided to the application to use, the application use need to use the corresponding interface.

   \li VL_ComM_NoStaticVar
