...
static  Std_ReturnType Dcm_UdsSesAndSecCheck(
    const Dcm_DspCommonAuthorizationType * pDspCommonAuthorization,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    uint8 Index;
    boolean Flag = 0u;
    ...
    if (((void *)0) != pDspCommonAuthorization)
    {
        RoutineSesNum = pDspCommonAuthorization->DcmDspCommonAuthorizationSessionRefNum;
        if (RoutineSesNum != 0u)
        {
            for (Index = 0; (Index < RoutineSesNum) && (0u == Flag); Index++)
            {
    ...
    if (((void *)0) != pDspCommonAuthorization)
    {
        ...
        if ((RoutineSecNum != 0u) && (0U == ret))
        {
            for (Index = 0; (Index < RoutineSecNum) && (0u == Flag); Index++)
            {
...
static  Std_ReturnType Dcm_UdsRCSesAndSecCheck(
    uint8 ProtocolCtrlId,
    uint8 RoutineCfgIdx,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if ((0U == ret) && (SubFunction == (1u)) && (pDcmDspRoutine->DcmDspStartRoutine != ((void *)0)))
    {
    ...
    if ((0U == ret) && (SubFunction == (2u)) && (pDcmDspRoutine->DcmDspStopRoutine != ((void *)0)))
    {
    ...
    if ((0U == ret) && (SubFunction == (3u))
        && (pDcmDspRequestRoutineResults != ((void *)0)))
    {
    ...
    if ((0U == ret)
        && (pDcmDspRequestRoutineResults == ((void *)0))
        && (pDcmDspRoutine->DcmDspStopRoutine == ((void *)0))
        && (pDcmDspRoutine->DcmDspStartRoutine == ((void *)0))
    )
    {
...
static  uint32 Dcm_UdsRCStartRoutine(
    uint8 MsgCtrlId,
 ...
 
{
    ...
    if (0U == *ret)
    {
        if (((void *)0) != StartRoutine->DcmDspStartRoutineIn)
        {
        ...
        if (((void *)0) != StartRoutine->DcmDspStartRoutineOut)
        {
        ...
        if ((((void *)0) != StartRoutine->DcmDspStartRoutineIn)
            && (StartRoutine->DcmDspStartRoutineIn
                ...
                == DCM_VARIABLE_LENGTH))
        {
            if ((ReqLen + (4U)) > Dcm_MsgCtrl[MsgCtrlId].MsgContext.ReqDataLen)
            {
    ...
    if (0U == *ret)
    {
        ...
        Dcm_0x31Type->currentDataLength =
            (uint16)(Dcm_MsgCtrl[MsgCtrlId].MsgContext.ReqDataLen - ReqLen - (4U));
        *ret = (*StartRoutineFnc)(
            pInbuffer,
...
static  uint32 Dcm_UdsRCStopRoutine(
    uint8 MsgCtrlId,
    Dcm_0x31Types * Dcm_0x31Type,
    Std_ReturnType * ret,
    Dcm_NegativeResponseCodeType * ErrorCode)
 
{
    ...
    if (pDcmDspRoutine[*Dcm_0x31Type->pRoutineCfgId].DcmDspStopRoutine == ((void *)0))
    {
    ...
    if (0U == *ret)
    {
        ...
        if (StopRoutine->DcmDspStopRoutineIn != ((void *)0))
        {
        ...
        if (StopRoutine->DcmDspStopRoutineOut != ((void *)0))
        {
        ...
        if ((((void *)0) != StopRoutine->DcmDspStopRoutineIn)
    ...
    if ((0U == *ret) && (DCM_DSP_ROUTINE_ON != Dcm_RoutineControlState[*Dcm_0x31Type->pRoutineCfgId]))
    {
         
        *ErrorCode = ((Dcm_NegativeResponseCodeType)0x24u);
        *ret = 1U;
    }
    if (0U == *ret)
    {
        ...
        *ret = (*StopRoutineFnc)(
            ...
            &Dcm_0x31Type->currentDataLength,
            ErrorCode);
        if ((((void *)0) != StopRoutine->DcmDspStopRoutineOut)
...
static  uint32 Dcm_UdsRCReqRoutineResult(
    uint8 MsgCtrlId,
    Dcm_0x31Types * Dcm_0x31Type,
    Std_ReturnType * ret,
    Dcm_NegativeResponseCodeType * ErrorCode)
 
{
    ...
    if (((void *)0) == RequestRoutineResults)
    {
        *ErrorCode = ((Dcm_NegativeResponseCodeType)0x12u);
        *ret = 1U;
    }
    ...
    if (0U == *ret)
    {
        if (((void *)0) != RequestRoutineResults->DcmDspRequestRoutineResultsIn)
        {
        ...
        if (RequestRoutineResults->DcmDspRequestRoutineResultsOut != ((void *)0))
        {
    ...
    if (0U == *ret)
    {
        ...
        if (((void *)0) == RequestResultsFnc)
        {
            *ErrorCode = ((Dcm_NegativeResponseCodeType)0x31u);
            *ret = 1U;
        }
    }
    if ((0U == *ret) && (DCM_DSP_ROUTINE_INIT == Dcm_RoutineControlState[*Dcm_0x31Type->pRoutineCfgId]))
    {
    ...
    if (0U == *ret)
    {
        ...
        *ret = (*RequestResultsFnc)(
            ...
            &Dcm_0x31Type->currentDataLength,
            ErrorCode);
        if ((((void *)0) != RequestRoutineResults->DcmDspRequestRoutineResultsOut)
...
static  Std_ReturnType Dcm_RCConditonCheck(
    uint8 ProtocolCtrlId,
    const Dcm_0x31Types * Dcm_0x31Type,
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    Std_ReturnType ret = 0U;
    uint8 MsgCtrlId = Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex;
    ...
    if (0U == ret)
    {
        ...
        for (Index = 0; (Index < pDcmDspCfg->DcmDspRoutineNum) && (Find == 0u); Index++)
        {
            if ((routineId == pDcmDspRoutine[Index].DcmDspRoutineId)
                && (1u == pDcmDspRoutine[Index].DcmDspRoutineUsed))
            {
    ...
    Dcm_NegativeResponseCodeType * ErrorCode)
{
    ...
    if (0U == ret)
    {
        ...
        routineId = (uint16)((uint16)((uint16)pMsgContext->pReqData[2]) << 8u) | ((uint16)pMsgContext->pReqData[3]);
            ...
            if (0U == ret)
            {
                ...
                if ((SubFunction != (1u)) && (SubFunction != (2u))
                    && (SubFunction != (3u)))
                {
    ...
    if ((0U == ret) && ((ResLen + 4u) > (pDcmChannelCfg->Dcm_DslBufferSize)))
    {
    ...
    case 1U:
        break;
    case ((Std_ReturnType)10):
        Dcm_MsgCtrl[MsgCtrlId].Dcm_OpStatus = ((Dcm_OpStatusType)0x01u);
        break;
    default:
         
        DsdInternal_SetNrc(ProtocolCtrlId, ((Dcm_NegativeResponseCodeType)0x22u));
        DsdInternal_ProcessingDone(ProtocolCtrlId);
        ret = 1U;
        break;
    }
