    ...
    VAR(boolean, AUTOMATIC) Crc_IsFirstCall)
{
    ...
    {
        crc = Crc_StartValue8 & (uint8)0xff; /* PRQA S 2985 */ /* VL_Crc_Redudant */
        crc ^= CRC_XORVALUE8;
    }
...
/* check if it is hardware method to calculate */
    ...
    return crc & (uint8)0xff; /* PRQA S 2985 */ /* VL_Crc_Redudant */
}
#define CRC_STOP_SEC_CODE
#include "Crc_MemMap.h"
    ...
    VAR(boolean, AUTOMATIC) Crc_IsFirstCall)
{
    ...
    {
        crc = Crc_StartValue8H2F & (uint8)0xff; /* PRQA S 2985 */ /* VL_Crc_Redudant */
