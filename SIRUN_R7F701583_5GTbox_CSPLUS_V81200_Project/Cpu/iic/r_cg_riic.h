...
Macro definitions
***********************************************************************************************************************/
#define _RIIC_BITRATE_LOW_LEVEL_PERIOD           (0x0000001FUL) /* Bit Rate Low-Level Period */
#define _RIIC_BITRATE_HIGH_LEVEL_PERIOD          (0x00000007UL) /* Bit Rate High-Level Period */
