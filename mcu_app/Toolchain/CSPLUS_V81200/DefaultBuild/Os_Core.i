 ...
 
{
...

    {
        ...
        else if (1u == Os_CoreCB.CoreStateSynPoint[2][pScb->SysCore])
        ...
        else
        {
             ...
             
            {
                ...
                case OS_IDLE_NO_HALT:
                    ...
                    while (0u == Os_Hal_SetCoreMode(logCoreId, OS_CORE_MODE_IDLE))
                ...
                case OS_RUN:
                    ...
                    while (0u == Os_Hal_SetCoreMode(logCoreId, OS_CORE_MODE_RUN))
 ...
 
{
    ...
    {
        for (Os_CoreIdType loopCore = 0u; loopCore < (1U); loopCore++)
        {
 ...
 
{
...

    {
 ...
 
        {
            ...
            for (uint16 i = 0U; i < (1U); i++)
            {
                for (uint16 j = 0U; j < 4U; j++)
                {
                       
                    Os_CoreCB.CoreStateSynPoint[j][i] = 0u;
                     
                }
            }
            Os_CoreCB.AppMode[pScb->SysCore] = ((Os_AppModeType)0x0000U);
