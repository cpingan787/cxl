...
static Os_IsrType Os_SysIsrNestQueueCore0[(5U)];
...
const Os_StackType Os_ISR2Stack[(5U)] =
{
	...
	{((Os_StackPtrType)((&(Os_RCAN0ERR_IRQ_Stack_Core0)[0]) + (sizeof(Os_RCAN0ERR_IRQ_Stack_Core0) / sizeof((Os_RCAN0ERR_IRQ_Stack_Core0)[0])) - 8U)), ((Os_StackPtrType)(Os_RCAN0ERR_IRQ_Stack_Core0))},
	{((Os_StackPtrType)((&(Os_RCAN0TRX_IRQ_Stack_Core0)[0]) + (sizeof(Os_RCAN0TRX_IRQ_Stack_Core0) / sizeof((Os_RCAN0TRX_IRQ_Stack_Core0)[0])) - 8U)), ((Os_StackPtrType)(Os_RCAN0TRX_IRQ_Stack_Core0))},
	...
	{((Os_StackPtrType)((&(Os_WDTA1_IRQ_Stack_Core0)[0]) + (sizeof(Os_WDTA1_IRQ_Stack_Core0) / sizeof((Os_WDTA1_IRQ_Stack_Core0)[0])) - 8U)), ((Os_StackPtrType)(Os_WDTA1_IRQ_Stack_Core0))},
...
const Os_IsrCfgType Os_IsrCfg[(5U)] =
{
    {
        (0x108Eu),	 
		(0x00000000U),	 
