...
#define NvMBlock_DIDC006               16U // used in ParamSync ECALLnum
...
#define NvMBlock_DIDCE01               42U // used in RTC alarm flag
...
#define NvMBlock_DIDB001               54U
#define NvMBlock_DIDB004               55U
#define NvMBlock_listentiming               56U
#define NvMBlock_canUserMode               57U
#define NvMBlock_dtcEepromCheck               58U

/*The total number of user configured*/
#define NVM_BLOCK_NUM_ALL                                 58U
...
extern VAR(uint8, NVM_VAR_NOINIT) NvMBlockRamBuffer54[20];
extern VAR(uint8, NVM_VAR_NOINIT) NvMBlockRamBuffer55[24];
extern VAR(uint8, NVM_VAR_NOINIT) NvMBlockRamBuffer56[8];
extern VAR(uint8, NVM_VAR_NOINIT) NvMBlockRamBuffer57[8];
extern VAR(uint8, NVM_VAR_NOINIT) NvMBlockRamBuffer58[8];
...
extern VAR(uint32, NVM_VAR_NOINIT) NvMCrcBuf_NvMBlock_DIDB001[1];
extern VAR(uint32, NVM_VAR_NOINIT) NvMCrcBuf_NvMBlock_DIDB004[1];
extern VAR(uint32, NVM_VAR_NOINIT) NvMCrcBuf_NvMBlock_listentiming[1];
extern VAR(uint32, NVM_VAR_NOINIT) NvMCrcBuf_NvMBlock_canUserMode[1];
extern VAR(uint32, NVM_VAR_NOINIT) NvMCrcBuf_NvMBlock_dtcEepromCheck[1];
