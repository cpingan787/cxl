...
extern const Os_ReadyQueueManageType * const Os_ReadyQueMg_Inf[(1U)];
...
extern void Os_ISR_TAUB0I8_IRQ_Handler(void);
extern void Os_ISR_TAUB0I9_IRQ_Handler(void);
extern void Os_ISR_P1_IRQ_Handler(void);
extern void Os_ISR_P2_IRQ_Handler(void);
extern void Os_ISR_P5_IRQ_Handler(void);
extern void Os_ISR_P6_IRQ_Handler(void);
extern void Os_ISR_P7_IRQ_Handler(void);
extern void Os_ISR_P9_IRQ_Handler(void);
extern void Os_ISR_P14_IRQ_Handler(void);
...
extern const Os_IntInstallType Os_IntInstall[(28U)];

 

extern volatile Os_CoreCBType Os_CoreCB;
...
extern const Os_ResourceCfgType Os_ResourceCfg[(1U)];
extern const uint16 Os_CfgStdResourceMax_Inf[(1U)];
extern Os_RCBType* const Os_RCB[(1U)];
extern const Os_ResourceRangeType Os_StdResIdRange[(1U)];
extern const uint16* const Os_TaskResourceAccessMask[(7U)];
extern const uint16* const Os_IsrResourceAccessMask[(28U)];
extern Os_ResourceType Os_ICBisrC2ResourceStack[(28U)][(1U)];
extern Os_ResourceType Os_TCBTaskResourceStack[(7U)][(1U)];
extern const Os_ResourceType Os_ResScheduler_Inf[(1U)];
...
static void Os_InitScb(Os_SCBType *pScb, Os_CoreIdType coreId);
...
static void Os_InitScb(Os_SCBType *pScb, Os_CoreIdType coreId)
{
    ...
    pScb->SysHighPrio = ((Os_PriorityType)0xFFFFU);
    pScb->SysHighTaskId = (7U);     
    pScb->SysRunningTaskId = (7U);     
    pScb->SysRunningTCB = ((void *)0);
    pScb->QueueMg = Os_ReadyQueMg_Inf[coreId];

    pScb->SysInIsrCat2 = 0u;
    pScb->SysRunningIsrCat2Id = (28U);    
 ...
 
{
    ...
    if (((Os_CoreIdType)0xFFFFU) == pScb->SysCore)
    {
        err = 1U;
    }
    else
    {
        ...
        __ldsr_rh((5U), (0U), (__stsr_rh((5U), (0U)) | 0xA0UL));
        ...
        do { Os_ArchTempSp = (((uint32)Os_SystemStack_Inf[Os_Hal_GetCoreID()]->StackTop) & 0xFFFFFFFCUL); OS_SET_SP_VAL(); } while (0);    
...
void Os_ShutdownOS(StatusType error, Os_ShutdownAction action)
{
    ...
    for (;;)
    {
	Wdg_59_DriverA_TriggerFunc((boolean)0x01);
	
        if((Dio_ReadChannel((Dio_ChannelType)18) == 0U) || 
            (Dio_ReadChannel((Dio_ChannelType)13) == 0U) || 
            
            (Dio_ReadChannel((Dio_ChannelType)10) == 1U) || 
            (Dio_ReadChannel((Dio_ChannelType)15) == 1U) || 
            (Dio_ReadChannel((Dio_ChannelType)2) == 1U) || 
            (Dio_ReadChannel((Dio_ChannelType)8) == 0U) || 
            (Dio_ReadChannel((Dio_ChannelType)9) == 0U) || 
            (Dio_ReadChannel((Dio_ChannelType)16) == 0U))
        {
            Mcu_PerformReset();
        }
 ...
 
{
    ...
    Os_InitScb(pScb, coreId);  

     
    if (((Os_CoreIdType)0U) == coreId)
    {
           
        Os_CoreCB.CoreStateActive |= (uint8)(1u << ((Os_CoreIdType)0U));
         
        Os_CoreCB.CoreStatus[((Os_CoreIdType)0U)] = OS_RUN;
    }
...
void Os_SynPoint(uint8 point)
{
    ...
    if (point <= 4U)
    {
        ...
        Os_CoreCB.CoreStateSynPoint[point][localCoreId] = 1u;
         
        while (coreId < (1U))
        {
               
            if (1u == Os_CoreCB.CoreStateSynPoint[point][coreId])
...
{
    Os_AppModeType retAppMode = ((Os_AppModeType)0x0U);
    Os_CoreIdType coreId = Os_GetCoreIdLocal();
    ...
    for (Os_CoreIdType loop_core = 0u; loop_core < (1U); loop_core++)
    {
           
        if (((Os_AppModeType)0x0U) != Os_CoreCB.AppMode[loop_core])
         
        {
            if (((Os_AppModeType)0x0U) == retAppMode)
            {
 ...
 
{
    ...
    Os_CoreCB.AppMode[localCoreId] = ((Os_AppModeType)0x0000U);
