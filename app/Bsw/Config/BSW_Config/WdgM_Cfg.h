...
#define WDGM_FIRST_EXPIRED_SEID                  0x00000000U
#define WDGM_FIRST_EXPIRED_INVERSE_SEID          0x00000000U
...
#define  WDGM_MULTI_PARTITION_ENABLED           STD_OFF
