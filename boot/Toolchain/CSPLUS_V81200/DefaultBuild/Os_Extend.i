...
{
    if (((void *)0) == osVerInfoPtr)
    {
         
    }
    else
    {
        osVerInfoPtr->vendorID = (62U);
        osVerInfoPtr->moduleID = (1U);

        osVerInfoPtr->sw_major_version = 2U;
        osVerInfoPtr->sw_minor_version = 0U;
        osVerInfoPtr->sw_patch_version = 0U;
    }
}
...
Os_StackUsageType OSGetStackUsage(Os_StackObject stack, uint16 id)    
{
    ...
    uint32 const *ptr = ((void *)0);
    uint32 const *stackBottom = ((void *)0);
    uint32 const *stackTop = ((void *)0);
    boolean status = 1u;
    ...
    case OS_STACK_TASK:
        ...
        if (!( (((Os_TaskType)id) >= (Os_TaskIdRange[pScb->SysCore]. AllTask . Start)) && (((Os_TaskType)id) < (Os_TaskIdRange[pScb->SysCore]. AllTask . End))))
    ...
    case OS_STACK_ISR2:
        ...
        if (!( (((Os_IsrType)id) >= (Os_IsrIdRange[(Os_IsrCfg[(Os_IsrType)id]. HostCore)]. Isr2 . IsrStart)) && (((Os_IsrType)id) < (Os_IsrIdRange[(Os_IsrCfg[(Os_IsrType)id]. HostCore)]. Isr2 . IsrEnd))))
