...
#define DIO_MAXNOOFCHANNEL                  (Dio_ChannelType)6
...
#define DIO_PORT_GROUP_ARRAY_SIZE           5U

/* Array size for the channel structure */
#define DIO_CHANNEL_ARRAY_SIZE              6U
...
#define DioConf_DioPort_PortGroup0_Bits0_14 (Dio_PortType)0
#define DioConf_DioPort_PortGroup8_Bits0_12 (Dio_PortType)1
#define DioConf_DioPort_PortGroup9_Bits0_6  (Dio_PortType)2
#define DioConf_DioPort_PortGroup10_Bits0_15 (Dio_PortType)3
#define DioConf_DioPort_PortGroup11_Bits0_7 (Dio_PortType)4

/* The Pointer to Port Group name */

/* DIO Channel Configuration Handles */
#define DioConf_DioChannel_DIO_Channel_CanRx_DET_INT_Pin0_1 (Dio_ChannelType)0
#define DioConf_DioChannel_DIO_Channel_RTC_INT_Pin0_6 (Dio_ChannelType)1
#define DioConf_DioChannel_DIO_Channel_KL30_DOWN_DET_INT_Pin0_9 (Dio_ChannelType)2
#define DioConf_DioChannel_DIO_Channel_LTE_WAKEUP_MCU_Pin8_2 (Dio_ChannelType)3
#define DioConf_DioChannel_DIO_Channel_CAN_STB_Pin8_6 (Dio_ChannelType)4
#define DioConf_DioChannel_DIO_Channel_ECALL_BUTTON_DET_Pin9_1 (Dio_ChannelType)5

/* Channel Mapping for DioChannelBitPosition */
#define DioConfig0_DIO_Channel_CanRx_DET_INT_Pin0_1_bit (uint8)0x01
#define DioConfig0_DIO_Channel_RTC_INT_Pin0_6_bit (uint8)0x06
#define DioConfig0_DIO_Channel_KL30_DOWN_DET_INT_Pin0_9_bit (uint8)0x09
#define DioConfig0_DIO_Channel_LTE_WAKEUP_MCU_Pin8_2_bit (uint8)0x02
#define DioConfig0_DIO_Channel_CAN_STB_Pin8_6_bit (uint8)0x06
#define DioConfig0_DIO_Channel_ECALL_BUTTON_DET_Pin9_1_bit (uint8)0x01
