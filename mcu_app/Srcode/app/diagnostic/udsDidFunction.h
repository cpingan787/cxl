...
/*just write*/
int16_t Service2EWriteSecOCKeyF1C7(uint8_t *pData,uint16_t dataLength);//SecOC√‹‘ø HEX

int16_t Service2EWriteSK(uint8_t *pData,uint16_t dataLength);
//int16_t Service2EWriteECUSerialNumberF18C(uint8_t *pData,uint16_t dataLength);
